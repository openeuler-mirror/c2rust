...
pub use crate::src::HTMLparser::ptrdiff_t;
pub use crate::src::nanohttp::Byte;
pub use crate::src::nanohttp::uInt;
pub use crate::src::nanohttp::uLong;
pub use crate::src::nanohttp::Bytef;
pub type voidpc = *const libc::c_void;
pub use crate::src::nanohttp::voidpf;
pub type voidp = *mut libc::c_void;
pub use crate::src::nanohttp::alloc_func;
pub use crate::src::nanohttp::free_func;
// #[derive(Copy, Clone)]

pub use crate::src::nanohttp::z_stream_s;
pub use crate::src::nanohttp::z_stream;
pub use crate::src::nanohttp::z_streamp;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct gzFile_s {
...
pub use crate::src::python::libxml::xmlInputMatchCallback;
pub use crate::src::python::libxml::xmlInputOpenCallback;
...
pub use crate::src::catalog::xmlCatalogAllow;
