...
pub use crate::src::python::libxml::xmlParserSeverities;
...
pub use crate::src::xinclude::xmlXIncludeCtxtPtr;
pub use crate::src::xinclude::xmlXIncludeCtxt;
pub use crate::src::python::libxml::xmlTextReaderErrorFunc;
