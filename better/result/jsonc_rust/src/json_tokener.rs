...
pub extern "C" fn json_tokener_new_ex<'a1>(
    ...
    let mut fresh0 = unsafe { &mut ((*tok).stack) };
    *fresh0 = (unsafe { calloc(
    ...
    let mut fresh1 = unsafe { &mut ((*tok).pb) };
    *fresh1 = printbuf_new();
...
extern "C" fn json_tokener_reset_level<'a1>(
    ...
    let mut fresh2 = unsafe { &mut ((*((*tok).stack).offset(depth as isize)).current) };
    *fresh2 = 0 as *mut json_object;
    (unsafe { free((*((*tok).stack).offset(depth as isize)).obj_field_name as *mut libc::c_void) });
    let mut fresh3 = unsafe { &mut ((*((*tok).stack).offset(depth as isize)).obj_field_name) };
    *fresh3 = 0 as *mut i8;
}
#[no_mangle]
    ...
    } != 0
    {
            ...
            match (unsafe { (*((*tok).stack).offset((*tok).depth as isize)).state }) as u32 {
                0 => {
                    while is_ws_char(c) != 0 {
                        ...
                        let mut fresh4 = unsafe { &mut ((*tok).char_offset) };
                        *fresh4 += 1;
                        if c == 0
                ...
                2 => {
                    ...
                    let mut fresh7 = unsafe { &mut ((*tok).depth) };
                    *fresh7 -= 1;
                },
                26 => {
                    ...
                    while (unsafe { (*tok).st_pos }) < (unsafe { json_inf_str_len }) as i32 {
                                    ...
                                    != (unsafe { json_inf_str_invert[(*tok).st_pos as usize] }) as i32)
                        {
                            ...
                            let mut fresh8 = unsafe { &mut ((*tok).st_pos) };
                            *fresh8 += 1;
                            str = unsafe { str.offset(1) };
                            let mut fresh9 = unsafe { &mut ((*tok).char_offset) };
                            *fresh9 += 1;
                ...
                14 => {
                            ...
                            || (unsafe { (*tok).is_double }) == 0 && c as i32 == '.' as i32)
                    {
                        ...
                        str = unsafe { str.offset(1) };
                        let mut fresh30 = unsafe { &mut ((*tok).char_offset) };
                        *fresh30 += 1;
                        if !(c == 0
                            || (if (unsafe { (*tok).char_offset }) == len {
                                if (unsafe { (*tok).depth }) == 0 as i32
                            ...
                            && (c as i32 == 'i' as i32 || c as i32 == 'I' as i32)
                        {
                            ...
                            if (unsafe { (*tok).is_double }) != 0 && (unsafe { (*tok).flags }) & 0x1 as i32 == 0 {
                                while (unsafe { (*(*tok).pb).bpos }) > 1 as i32 {
                                    ...
                                    (unsafe { *((*(*tok).pb).buf)
                                        .offset(((*(*tok).pb).bpos - 1 as i32) as isize) =
                                        '\u{0}' as i32 as i8 });
                                    let mut fresh31 = unsafe { &mut ((*(*tok).pb).bpos) };
                                    *fresh31 -= 1;
                                }
                            }
                            let mut num64: i64 = 0;
                                ...
                                && json_parse_int64(unsafe { (*(*tok).pb).buf }, Some(&mut num64)) == 0 as i32
                            {
                                    ...
                                    && (unsafe { (*tok).flags }) & 0x1 as i32 != 0
                                {
                                    ...
                                    let mut fresh32 = unsafe { &mut ((*((*tok).stack)
                                    ...
                                    == 0 as i32
                            {
                                    ...
                                    && (unsafe { (*tok).flags }) & 0x1 as i32 != 0
                                {
                                    ...
                                    let mut fresh33 = unsafe { &mut ((*((*tok).stack)
                                        .offset((*tok).depth as isize))
                                    .current) };
                                    *fresh33 = json_object_new_int64(num64);
                                    ...
                                    let mut fresh34 = unsafe { &mut ((*((*tok).stack)
                                        .offset((*tok).depth as isize))
                                    .current) };
                ...
                24 | 15 => {
                    if c as i32 == ']' as i32 {
                        ...
                        let mut fresh36 = unsafe { &mut ((*tok).depth) };
                        *fresh36 += 1;
                        json_tokener_reset_level(tok, unsafe { (*tok).depth });
                    }
                },
                ...
                21 => {
                    if (unsafe { (*tok).depth }) >= (unsafe { (*tok).max_depth }) - 1 as i32 {
                        ...
                        let mut fresh42 = unsafe { &mut ((*tok).depth) };
                        *fresh42 += 1;
                        json_tokener_reset_level(tok, unsafe { (*tok).depth });
                    }
                },
        ...
        match current_block {
                ...
                loop {
                    if c as i32 == (unsafe { (*tok).quote_char }) as i32 {
                            ...
                            > (unsafe { str.offset_from(case_start_3) }) as i64
                        {
                            ...
                            let mut fresh37 = unsafe { &mut ((*(*tok).pb).bpos) };
                            *fresh37 =
                        ...
                        *fresh38 = unsafe { strdup((*(*tok).pb).buf) };
                            ...
                            > (unsafe { str.offset_from(case_start_3) }) as i64
                        {
                            ...
                            let mut fresh39 = unsafe { &mut ((*(*tok).pb).bpos) };
                            *fresh39 =
                        ...
                        str = unsafe { str.offset(1) };
                        let mut fresh40 = unsafe { &mut ((*tok).char_offset) };
                        *fresh40 += 1;
                        if !(c == 0
                            || (if (unsafe { (*tok).char_offset }) == len {
                                if (unsafe { (*tok).depth }) == 0 as i32
                            ...
                            > (unsafe { str.offset_from(case_start_3) }) as i64
                        {
                            ...
                            let mut fresh41 = unsafe { &mut ((*(*tok).pb).bpos) };
                            *fresh41 =
            ...
            5600328731811258759 => {
                loop {
                    if c == 0 || is_hex_char(c) == 0 {
                        ...
                        let mut fresh25 = unsafe { &mut ((*tok).st_pos) };
                        *fresh25 += 1;
                        if (unsafe { (*tok).st_pos }) >= 4 as i32 {
                            break;
                        }
                        str = unsafe { str.offset(1) };
                        let mut fresh26 = unsafe { &mut ((*tok).char_offset) };
                        *fresh26 += 1;
                        if !(if (unsafe { (*tok).char_offset }) == len {
                            if (unsafe { (*tok).depth }) == 0 as i32
                                && (unsafe { (*((*tok).stack).offset((*tok).depth as isize)).state }) as u32
                ...
                loop {
                    if c as i32 == (unsafe { (*tok).quote_char }) as i32 {
                            ...
                            > (unsafe { str.offset_from(case_start_1) }) as i64
                        {
                            ...
                            let mut fresh20 = unsafe { &mut ((*(*tok).pb).bpos) };
                            *fresh20 =
                        ...
                        *fresh21 = json_object_new_string_len(unsafe { (*(*tok).pb).buf }, unsafe { (*(*tok).pb).bpos });
                            ...
                            > (unsafe { str.offset_from(case_start_1) }) as i64
                        {
                            ...
                            let mut fresh22 = unsafe { &mut ((*(*tok).pb).bpos) };
                            *fresh22 =
                        ...
                        str = unsafe { str.offset(1) };
                        let mut fresh23 = unsafe { &mut ((*tok).char_offset) };
                        *fresh23 += 1;
                        if !(c == 0
                            || (if (unsafe { (*tok).char_offset }) == len {
                                if (unsafe { (*tok).depth }) == 0 as i32
                            ...
                            > (unsafe { str.offset_from(case_start_1) }) as i64
                        {
                            ...
                            let mut fresh24 = unsafe { &mut ((*(*tok).pb).bpos) };
                            *fresh24 =
            ...
            6662862405959679103 => {
                while c as i32 != '\n' as i32 {
                    str = unsafe { str.offset(1) };
                    let mut fresh17 = unsafe { &mut ((*tok).char_offset) };
                    *fresh17 += 1;
                    if !(c == 0
                        || (if (unsafe { (*tok).char_offset }) == len {
                            if (unsafe { (*tok).depth }) == 0 as i32
                        ...
                        > (unsafe { str.offset_from(case_start_0) }) as i64
                    {
                        ...
                        let mut fresh18 = unsafe { &mut ((*(*tok).pb).bpos) };
                    ...
                    > (unsafe { str.offset_from(case_start_0) }) as i64
                {
                    ...
                    let mut fresh19 = unsafe { &mut ((*(*tok).pb).bpos) };
            ...
            18221534353613080499 => {
                while c as i32 != '*' as i32 {
                    str = unsafe { str.offset(1) };
                    let mut fresh14 = unsafe { &mut ((*tok).char_offset) };
                    *fresh14 += 1;
                    if !(c == 0
                        || (if (unsafe { (*tok).char_offset }) == len {
                            if (unsafe { (*tok).depth }) == 0 as i32
                        ...
                        > (unsafe { str.offset_from(case_start) }) as i64
                    {
                        ...
                        let mut fresh15 = unsafe { &mut ((*(*tok).pb).bpos) };
                    ...
                    > (unsafe { str.offset(1 as i32 as isize).offset_from(case_start) }) as i64
                {
                    ...
                    let mut fresh16 = unsafe { &mut ((*(*tok).pb).bpos) };
            ...
            13823707972521062695 => {
                let mut fresh13 = unsafe { &mut ((*tok).st_pos) };
                *fresh13 += 1;
                current_block = 14910428593596980134;
            },
            6015864261243718670 => {
                let mut fresh29 = unsafe { &mut ((*tok).st_pos) };
                *fresh29 += 1;
                current_block = 14910428593596980134;
            },
            _ => {},
        ...
        str = unsafe { str.offset(1) };
        let mut fresh44 = unsafe { &mut ((*tok).char_offset) };
        *fresh44 += 1;
        if c == 0 {
            break;
        }
