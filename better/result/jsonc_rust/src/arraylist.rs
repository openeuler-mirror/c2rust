...
pub extern "C" fn array_list_new2(
    ...
    let mut fresh0 = unsafe { &mut ((*arr).free_fn) };
    *fresh0 = free_fn;
    let mut fresh1 = unsafe { &mut ((*arr).array) };
...
extern "C" fn array_list_expand_internal(
    ...
    let mut fresh2 = unsafe { &mut ((*arr).array) };
...
pub extern "C" fn array_list_shrink(
    ...
    let mut fresh3 = unsafe { &mut ((*arr).array) };
...
pub extern "C" fn array_list_put_idx(
    ...
    let mut fresh4 = unsafe { &mut (*((*arr).array).offset(idx as isize)) };
    *fresh4 = data;
...
pub extern "C" fn array_list_add(
    ...
    let mut fresh5 = unsafe { &mut (*((*arr).array).offset(idx as isize)) };
    *fresh5 = data;
    let mut fresh6 = unsafe { &mut ((*arr).length) };
...
pub extern "C" fn array_list_del_idx(
    ...
    let mut fresh7 = unsafe { &mut ((*arr).length) };
