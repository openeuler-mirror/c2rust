...
extern "C" fn xmlNanoFTPScanURL(mut ctx: *mut core::ffi::c_void, mut URL: *const i8) {
    ...
    if !(unsafe { (*ctxt).protocol }).is_null() {
        (unsafe {
            xmlFree.expect("non-null function pointer")((*ctxt).protocol as *mut libc::c_void)
        });
    ...
    if !(unsafe { (*ctxt).hostname }).is_null() {
        (unsafe {
            xmlFree.expect("non-null function pointer")((*ctxt).hostname as *mut libc::c_void)
        });
    ...
    *fresh4 = unsafe { xmlMemStrdup.expect("non-null function pointer")((*uri).server) };
    if !(unsafe { (*uri).path }).is_null() {
        ...
        *fresh6 = unsafe {
            xmlMemStrdup.expect("non-null function pointer")(b"/\0" as *const u8 as *const i8)
        };
    }
    ...
    if !(unsafe { (*uri).user }).is_null() {
        ...
        if cptr.is_null() {
            ...
            *fresh9 = unsafe {
                xmlMemStrdup.expect("non-null function pointer")(cptr.offset(1 as i32 as isize))
            };
        }
    }
    (unsafe { xmlFreeURI(uri) });
...
pub extern "C" fn xmlNanoFTPUpdateURL(mut ctx: *mut core::ffi::c_void, mut URL: *const i8) -> i32 {
    ...
    if (unsafe { strcmp((*ctxt).protocol, (*uri).scheme) }) != 0
        ...
        || (unsafe { (*uri).port }) != 0 as i32
            && (unsafe { (*ctxt).port }) != (unsafe { (*uri).port })
    {
        (unsafe { xmlFreeURI(uri) });
        return -(1 as i32);
    }
...
pub extern "C" fn xmlNanoFTPNewCtxt(mut URL: *const i8) -> *mut core::ffi::c_void {
    ...
    ret = (unsafe {
        xmlMalloc.expect("non-null function pointer")(::std::mem::size_of::<xmlNanoFTPCtxt>() as u64)
...
extern "C" fn xmlNanoFTPGetMore(mut ctx: *mut core::ffi::c_void) -> i32 {
    ...
    if (unsafe { (*ctxt).controlBufIndex }) < 0 as i32
        || (unsafe { (*ctxt).controlBufIndex }) > 1024 as i32
    {
        return -(1 as i32);
    }
    if (unsafe { (*ctxt).controlBufUsed }) < 0 as i32
        || (unsafe { (*ctxt).controlBufUsed }) > 1024 as i32
    {
        return -(1 as i32);
    }
...
extern "C" fn xmlNanoFTPReadResponse(mut ctx: *mut core::ffi::c_void) -> i32 {
    ...
    'c_9842: loop {
        ...
        ptr = (unsafe {
            &mut *((*ctxt).controlBuf)
                .as_mut_ptr()
                .offset((*ctxt).controlBufIndex as isize)
        }) as *mut i8;
        end = (unsafe {
            &mut *((*ctxt).controlBuf)
                .as_mut_ptr()
                .offset((*ctxt).controlBufUsed as isize)
        }) as *mut i8;
        while ptr < end {
    ...
    (unsafe {
        (*ctxt).controlBufIndex = ptr.offset_from(((*ctxt).controlBuf).as_mut_ptr()) as i64 as i32
    });
...
pub extern "C" fn xmlNanoFTPCheckResponse(mut ctx: *mut core::ffi::c_void) -> i32 {
    ...
    let fresh17;
    let fresh18 = (unsafe { &mut *(rfd.__fds_bits).as_mut_ptr().offset(0 as i32 as isize) })
        as *mut __fd_mask;
    (unsafe {
        asm ! ("cld; rep; stosq" , inlateout ("cx") c2rust_asm_casts :: AsmCast :: cast_in (fresh13 , fresh15) => fresh14 , inlateout ("di") c2rust_asm_casts :: AsmCast :: cast_in (fresh16 , fresh18) => fresh17 , inlateout ("ax") 0 as i32 => _ , options (preserves_flags))
    });
...
pub extern "C" fn xmlNanoFTPConnect(mut ctx: *mut core::ffi::c_void) -> i32 {
    ...
    if have_ipv6() != 0 {
        ...
        if !(unsafe { proxy }).is_null() {
            ...
            getaddrinfo((*ctxt).hostname, 0 as *const i8, &mut hints, &mut result)
        }) != 0 as i32
        {
            (unsafe {
                __xmlIOErr(
        ...
        tmp = result;
        while !tmp.is_null() {
            if (unsafe { (*tmp).ai_family }) == 2 as i32
                || (unsafe { (*tmp).ai_family }) == 10 as i32
            {
                break;
            }
        ...
        if (unsafe { (*tmp).ai_addrlen }) as size_t
            > ::std::mem::size_of::<sockaddr_storage>() as u64
        {
            if !result.is_null() {
                (unsafe { freeaddrinfo(result) });
        ...
        if (unsafe { (*tmp).ai_family }) == 10 as i32 {
            ...
            (unsafe {
                (*(&mut (*ctxt).ftpAddr as *mut sockaddr_storage as *mut sockaddr_in6)).sin6_port =
            ...
            (unsafe {
                (*(&mut (*ctxt).ftpAddr as *mut sockaddr_storage as *mut sockaddr_in)).sin_port =
                    __bswap_16(port as __uint16_t)
            });
        ...
        (unsafe {
            (*(&mut (*ctxt).ftpAddr as *mut sockaddr_storage as *mut sockaddr_in)).sin_family =
...
pub extern "C" fn xmlNanoFTPGetConnection(mut ctx: *mut core::ffi::c_void) -> i32 {
    ...
    if (unsafe { (*ctxt).ftpAddr.ss_family }) as i32 == 10 as i32 {
        ...
        (unsafe {
            (*(&mut dataAddr as *mut sockaddr_storage as *mut sockaddr_in6)).sin6_family =
        ...
        (unsafe {
            (*(&mut dataAddr as *mut sockaddr_storage as *mut sockaddr_in)).sin_family =
                2 as i32 as sa_family_t
        });
    ...
    if (unsafe { (*ctxt).passive }) != 0 {
        ...
        cur = (unsafe {
            &mut *((*ctxt).controlBuf)
                .as_mut_ptr()
                .offset((*ctxt).controlBufAnswer as isize)
        }) as *mut i8;
        ...
        if (unsafe { (*ctxt).ftpAddr.ss_family }) as i32 == 10 as i32 {
            ...
            (unsafe {
                (*(&mut dataAddr as *mut sockaddr_storage as *mut sockaddr_in6)).sin6_port =
            ...
            (unsafe {
                memcpy(
                    &mut (*(&mut dataAddr as *mut sockaddr_storage as *mut sockaddr_in)).sin_addr
                        as *mut in_addr as *mut libc::c_void,
                    &mut *ad.as_mut_ptr().offset(0 as i32 as isize) as *mut u8
                        as *const libc::c_void,
                    4 as i32 as u64,
                )
            });
            (unsafe {
                memcpy(
                    ...
                    &mut *ad.as_mut_ptr().offset(4 as i32 as isize) as *mut u8
                        as *const libc::c_void,
                    2 as i32 as u64,
                )
            });
        ...
        if (unsafe { (*ctxt).ftpAddr.ss_family }) as i32 == 10 as i32 {
            ...
            (unsafe {
                (*(&mut dataAddr as *mut sockaddr_storage as *mut sockaddr_in)).sin_port =
                    0 as i32 as in_port_t
            });
        }
        if (unsafe {
        ...
        if (unsafe { (*ctxt).ftpAddr.ss_family }) as i32 == 10 as i32 {
            ...
            portp = (unsafe {
                &mut (*(&mut dataAddr as *mut sockaddr_storage as *mut sockaddr_in6)).sin6_port
...
pub extern "C" fn xmlNanoFTPCloseConnection(mut ctx: *mut core::ffi::c_void) -> i32 {
    ...
    let fresh24;
    let fresh25 = (unsafe { &mut *(rfd.__fds_bits).as_mut_ptr().offset(0 as i32 as isize) })
        as *mut __fd_mask;
    (unsafe {
        asm ! ("cld; rep; stosq" , inlateout ("cx") c2rust_asm_casts :: AsmCast :: cast_in (fresh20 , fresh22) => fresh21 , inlateout ("di") c2rust_asm_casts :: AsmCast :: cast_in (fresh23 , fresh25) => fresh24 , inlateout ("ax") 0 as i32 => _ , options (preserves_flags))
    });
    ...
    let fresh30;
    let fresh31 = (unsafe { &mut *(efd.__fds_bits).as_mut_ptr().offset(0 as i32 as isize) })
        as *mut __fd_mask;
    (unsafe {
        asm ! ("cld; rep; stosq" , inlateout ("cx") c2rust_asm_casts :: AsmCast :: cast_in (fresh26 , fresh28) => fresh27 , inlateout ("di") c2rust_asm_casts :: AsmCast :: cast_in (fresh29 , fresh31) => fresh30 , inlateout ("ax") 0 as i32 => _ , options (preserves_flags))
    });
...
pub extern "C" fn xmlNanoFTPList(
    ...
    loop {
        ...
        let fresh48;
        let fresh49 = (unsafe { &mut *(rfd.__fds_bits).as_mut_ptr().offset(0 as i32 as isize) })
            as *mut __fd_mask;
        (unsafe {
            asm ! ("cld; rep; stosq" , inlateout ("cx") c2rust_asm_casts :: AsmCast :: cast_in (fresh44 , fresh46) => fresh45 , inlateout ("di") c2rust_asm_casts :: AsmCast :: cast_in (fresh47 , fresh49) => fresh48 , inlateout ("ax") 0 as i32 => _ , options (preserves_flags))
        });
        ...
        let fresh54;
        let fresh55 = (unsafe { &mut *(efd.__fds_bits).as_mut_ptr().offset(0 as i32 as isize) })
            as *mut __fd_mask;
        (unsafe {
            asm ! ("cld; rep; stosq" , inlateout ("cx") c2rust_asm_casts :: AsmCast :: cast_in (fresh50 , fresh52) => fresh51 , inlateout ("di") c2rust_asm_casts :: AsmCast :: cast_in (fresh53 , fresh55) => fresh54 , inlateout ("ax") 0 as i32 => _ , options (preserves_flags))
        });
...
pub extern "C" fn xmlNanoFTPGet(
    ...
    loop {
        ...
        let fresh60;
        let fresh61 = (unsafe { &mut *(rfd.__fds_bits).as_mut_ptr().offset(0 as i32 as isize) })
            as *mut __fd_mask;
        (unsafe {
            asm ! ("cld; rep; stosq" , inlateout ("cx") c2rust_asm_casts :: AsmCast :: cast_in (fresh56 , fresh58) => fresh57 , inlateout ("di") c2rust_asm_casts :: AsmCast :: cast_in (fresh59 , fresh61) => fresh60 , inlateout ("ax") 0 as i32 => _ , options (preserves_flags))
        });
        ...
        if res == 0 as i32 {
            ...
            if len < 0 as i32 {
                ...
                (unsafe {
                    callback.expect("non-null function pointer")(userData, buf.as_mut_ptr(), len)
                });
                (unsafe { close((*ctxt).dataFd) });
                (unsafe { (*ctxt).dataFd = -(1 as i32) });
                return -(1 as i32);
