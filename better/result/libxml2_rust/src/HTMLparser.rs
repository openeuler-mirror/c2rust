...
extern "C" fn bsearch(
    ...
    while __l < __u {
        ...
        __p = (unsafe { (__base as *const i8).offset(__idx.wrapping_mul(__size) as isize) })
            as *mut libc::c_void;
        __comparison = unsafe {
...
extern "C" fn htmlNodeInfoPush<'a1>(
    ...
    (unsafe {
        *((*ctxt).nodeInfoTab).offset((*ctxt).nodeInfoNr as isize) =
            *(borrow_mut(&mut value)).unwrap()
    });
    let fresh10 = unsafe { &mut ((*ctxt).nodeInfo) };
    *fresh10 = (unsafe { &mut *((*ctxt).nodeInfoTab).offset((*ctxt).nodeInfoNr as isize) })
...
extern "C" fn htmlNodeInfoPop<'a1>(
    ...
    *fresh13 -= 1;
    ...
    if (unsafe { (*ctxt).nodeInfoNr }) > 0 as i32 {
        ...
        *fresh14 = (unsafe {
            &mut *((*ctxt).nodeInfoTab).offset(((*ctxt).nodeInfoNr - 1 as i32) as isize)
        }) as *mut xmlParserNodeInfo;
    } else {
        ...
        if !(c as i32 & 0x40 as i32 == 0 as i32) {
            ...
            if !((unsafe { *cur.offset(1 as i32 as isize) }) as i32 & 0xc0 as i32 != 0x80 as i32) {
                if c as i32 & 0xe0 as i32 == 0xe0 as i32 {
                    ...
                    if (unsafe { *cur.offset(2 as i32 as isize) }) as i32 & 0xc0 as i32
                        != 0x80 as i32
                    {
                                ...
                                != 0x80 as i32
                        {
                            ...
                            *(borrow_mut(&mut len)).unwrap() = 4 as i32;
                            val = (((unsafe { *cur.offset(0 as i32 as isize) }) as i32
                                & 0x7 as i32)
                                << 18 as i32) as u32;
                            val |= (((unsafe { *cur.offset(1 as i32 as isize) }) as i32
                                & 0x3f as i32)
                                << 12 as i32) as u32;
                            val |= (((unsafe { *cur.offset(2 as i32 as isize) }) as i32
                                & 0x3f as i32)
                                << 6 as i32) as u32;
                            val |= ((unsafe { *cur.offset(3 as i32 as isize) }) as i32
                                & 0x3f as i32) as u32;
                    ...
                    *(borrow_mut(&mut len)).unwrap() = 2 as i32;
                    val = (((unsafe { *cur.offset(0 as i32 as isize) }) as i32 & 0x1f as i32)
                        << 6 as i32) as u32;
                    val |=
                        ((unsafe { *cur.offset(1 as i32 as isize) }) as i32 & 0x3f as i32) as u32;
...
extern "C" fn htmlCheckImplied(
    ...
    if (unsafe { xmlStrEqual(newtag, b"body\0" as *const u8 as *const i8 as *mut xmlChar) }) != 0
        || (unsafe { xmlStrEqual(newtag, b"head\0" as *const u8 as *const i8 as *mut xmlChar) })
            != 0
    {
        return;
    }
    if (unsafe { (*ctxt).nameNr }) <= 1 as i32
        && ((unsafe {
            ...
            || (unsafe {
                xmlStrEqual(newtag, b"style\0" as *const u8 as *const i8 as *mut xmlChar)
            }) != 0
            || (unsafe {
                xmlStrEqual(newtag, b"meta\0" as *const u8 as *const i8 as *mut xmlChar)
            }) != 0
            || (unsafe {
                xmlStrEqual(newtag, b"link\0" as *const u8 as *const i8 as *mut xmlChar)
            }) != 0
            || (unsafe {
                xmlStrEqual(newtag, b"title\0" as *const u8 as *const i8 as *mut xmlChar)
            }) != 0
            || (unsafe {
                xmlStrEqual(newtag, b"base\0" as *const u8 as *const i8 as *mut xmlChar)
            }) != 0)
    {
        if (unsafe { (*ctxt).html }) >= 3 as i32 {
            return;
        ...
        && (unsafe { xmlStrEqual(newtag, b"frame\0" as *const u8 as *const i8 as *mut xmlChar) })
            == 0
        && (unsafe {
            xmlStrEqual(
                newtag,
...
pub extern "C" fn htmlEncodeEntities<'a1, 'a2>(
    ...
    while in_0 < inend {
        ...
        if d < 0x80 as i32 as u32 {
            ...
            *(borrow_mut(&mut outlen)).unwrap() =
                (unsafe { out.offset_from(outstart) }) as i64 as i32;
            *(borrow_mut(&mut inlen)).unwrap() =
                (unsafe { processed.offset_from(instart) }) as i64 as i32;
            return -(2 as i32);
        } else {
            if d < 0xe0 as i32 as u32 {
                c = d & 0x1f as i32 as u32;
...
extern "C" fn areBlanks(
    ...
    while !lastChild.is_null()
        && (unsafe { (*lastChild).type_0 }) as u32 == XML_COMMENT_NODE as i32 as u32
    {
    ...
    if lastChild.is_null() {
        ...
        while (i as u64)
            < (::std::mem::size_of::<[*const i8; 53]>() as u64)
                .wrapping_div(::std::mem::size_of::<*const i8>() as u64)
        {
            if (unsafe { xmlStrEqual((*lastChild).name, allowPCData[i as usize] as *mut xmlChar) })
                != 0
            {
                return 0 as i32;
            }
...
pub extern "C" fn htmlNewDocNoDtD(
    ...
    cur = (unsafe {
        xmlMalloc.expect("non-null function pointer")(::std::mem::size_of::<xmlDoc>() as u64)
    }) as xmlDocPtr;
    if cur.is_null() {
        htmlErrMemory(
...
extern "C" fn htmlParseHTMLName(
    ...
    if !(0x41 as i32 <= (unsafe { *(*(*ctxt).input).cur }) as i32
    ...
    while i < 100 as i32
        && (0x41 as i32 <= (unsafe { *(*(*ctxt).input).cur }) as i32
            ...
            || (unsafe { *(*(*ctxt).input).cur }) as i32 == '.' as i32)
    {
        if (unsafe { *(*(*ctxt).input).cur }) as i32 >= 'A' as i32
            && (unsafe { *(*(*ctxt).input).cur }) as i32 <= 'Z' as i32
        {
...
extern "C" fn htmlParseHTMLName_nonInvasive(
    ...
    while i < 100 as i32
        && (0x41 as i32
            <= (unsafe { *((*(*ctxt).input).cur).offset((1 as i32 + i) as isize) }) as i32
            && (unsafe { *((*(*ctxt).input).cur).offset((1 as i32 + i) as isize) }) as i32
                <= 0x5a as i32
            || 0x61 as i32
                <= (unsafe { *((*(*ctxt).input).cur).offset((1 as i32 + i) as isize) }) as i32
...
extern "C" fn htmlParseHTMLAttribute(
    ...
    while (unsafe { *(*(*ctxt).input).cur }) as i32 != 0 as i32
        && (unsafe { *(*(*ctxt).input).cur }) as i32 != stop as i32
    {
        ...
        if (unsafe { *(*(*ctxt).input).cur }) as i32 == '&' as i32 {
            if (unsafe { *((*(*ctxt).input).cur).offset(1 as i32 as isize) }) as i32 == '#' as i32 {
                ...
                while bits >= 0 as i32 {
                    ...
                    out = unsafe { out.offset(1) };
                    (unsafe {
                        *fresh59 = (c >> bits & 0x3f as i32 as u32 | 0x80 as i32 as u32) as xmlChar
                    });
                    bits -= 6 as i32;
                }
                ...
                if name.is_null() {
                    ...
                    if (unsafe { out.offset_from(buffer) }) as i64
                    ...
                    while (unsafe { *cur }) as i32 != 0 as i32 {
                        ...
                        {
                            let mut indx_1: i32 =
                                (unsafe { out.offset_from(buffer) }) as i64 as i32;
                    ...
                    if c_0 < 0x80 as i32 as u32 {
                        ...
                        out = unsafe { out.offset(1) };
                        (unsafe {
                            *fresh65 = (c_0 >> 6 as i32 & 0x1f as i32 as u32 | 0xc0 as i32 as u32)
                                as xmlChar
                        });
                        bits_0 = 0 as i32;
                        ...
                        out = unsafe { out.offset(1) };
                        (unsafe {
                            *fresh66 = (c_0 >> 12 as i32 & 0xf as i32 as u32 | 0xe0 as i32 as u32)
                                as xmlChar
                        });
                        bits_0 = 6 as i32;
                    } else {
                        ...
                        out = unsafe { out.offset(1) };
                        (unsafe {
                            *fresh67 = (c_0 >> 18 as i32 & 0x7 as i32 as u32 | 0xf0 as i32 as u32)
                                as xmlChar
                        });
                        bits_0 = 12 as i32;
                    }
            ...
            while bits_1 >= 0 as i32 {
                ...
                out = unsafe { out.offset(1) };
                (unsafe {
                    *fresh73 = (c_1 >> bits_1 & 0x3f as i32 as u32 | 0x80 as i32 as u32) as xmlChar
                });
                bits_1 -= 6 as i32;
            }
            xmlNextChar(ctxt);
...
extern "C" fn htmlParseSystemLiteral(
    ...
    while (unsafe { *(*(*ctxt).input).cur }) as i32 != 0 as i32
        && (unsafe { *(*(*ctxt).input).cur }) as i32 != quote
    {
...
extern "C" fn htmlParseScript(mut ctxt: *mut crate::src::HTMLparser::_xmlParserCtxt) {
    ...
    while cur != 0 as i32 {
            ...
            && (unsafe { *((*(*ctxt).input).cur).offset(1 as i32 as isize) }) as i32 == '/' as i32
        {
            ...
            } else if (unsafe { *((*(*ctxt).input).cur).offset(2 as i32 as isize) }) as i32
                >= 'A' as i32
...
extern "C" fn htmlParseExternalID<'a1>(
    ...
    if ({
        ...
        if ::std::mem::size_of::<xmlChar>() as u64 > 1 as i32 as u64 {
            ...
            __res = unsafe {
                *(*__ctype_toupper_loc()).offset(*(*(*ctxt).input).cur as i32 as isize)
            };
        }
        __res
    }) == 'S' as i32
        ...
        while (unsafe { *(*(*ctxt).input).cur }) as i32 != ';' as i32 {
                ...
                && (unsafe { *(*(*ctxt).input).cur }) as i32 <= '9' as i32
            {
                if val < 0x110000 as i32 {
                    val =
                        val * 16 as i32 + ((unsafe { *(*(*ctxt).input).cur }) as i32 - '0' as i32);
                }
        ...
        *fresh104 = unsafe { (*fresh104).offset(2 as i32 as isize) };
        ...
        while (unsafe { *(*(*ctxt).input).cur }) as i32 != ';' as i32 {
                ...
                && (unsafe { *(*(*ctxt).input).cur }) as i32 <= '9' as i32
            {
                if val < 0x110000 as i32 {
                    val =
                        val * 10 as i32 + ((unsafe { *(*(*ctxt).input).cur }) as i32 - '0' as i32);
                }
                xmlNextChar(ctxt);
            } else {
                htmlParseErr(
...
extern "C" fn htmlCheckEncodingDirect(
    ...
    if ctxt.is_null()
        || encoding.is_null()
        || (unsafe { (*ctxt).options }) & HTML_PARSE_IGNORE_ENC as i32 != 0
    {
        return;
    }
    if !(unsafe { (*(*ctxt).input).encoding }).is_null() {
    ...
    if !encoding.is_null() {
        ...
        let mut handler: *mut crate::src::HTMLparser::_xmlCharEncodingHandler =
            0 as *mut xmlCharEncodingHandler;
        while (unsafe { *encoding }) as i32 == ' ' as i32
            || (unsafe { *encoding }) as i32 == '\t' as i32
        {
        ...
        *fresh106 = unsafe { xmlStrdup(encoding) };
            ...
            && !(unsafe { (*(*(*ctxt).input).buf).buffer }).is_null()
        {
            ...
            processed = (unsafe { ((*(*ctxt).input).cur).offset_from((*(*ctxt).input).base) })
                as i64 as i32;
            xmlBufShrink(
...
extern "C" fn htmlCheckEncoding(
    ...
    if !encoding.is_null()
        && ((unsafe { *encoding }) as i32 == 0x20 as i32
            || 0x9 as i32 <= (unsafe { *encoding }) as i32
                && (unsafe { *encoding }) as i32 <= 0xa as i32
            || (unsafe { *encoding }) as i32 == 0xd as i32)
    {
        encoding =
            unsafe { xmlStrcasestr(attvalue, b"=\0" as *const u8 as *const i8 as *mut xmlChar) };
    }
...
extern "C" fn htmlCheckMeta(
    ...
    while !att.is_null() {
            ...
            }) == 0
        {
            ...
            && (unsafe {
                xmlStrcasecmp(att, b"charset\0" as *const u8 as *const i8 as *mut xmlChar)
            }) == 0
        {
            htmlCheckEncodingDirect(ctxt, value);
        } else if !value.is_null()
            && (unsafe {
                xmlStrcasecmp(att, b"content\0" as *const u8 as *const i8 as *mut xmlChar)
            }) == 0
        {
            content = value;
        }
...
extern "C" fn htmlParseEndTag(mut ctxt: *mut crate::src::HTMLparser::_xmlParserCtxt) -> i32 {
    ...
    *fresh121 = unsafe { (*fresh121).offset(2 as i32 as isize) };
    ...
    if (unsafe { (*ctxt).depth }) > 0 as i32
        && ((unsafe { xmlStrEqual(name, b"html\0" as *const u8 as *const i8 as *mut xmlChar) })
            != 0
            || (unsafe { xmlStrEqual(name, b"body\0" as *const u8 as *const i8 as *mut xmlChar) })
                != 0
            || (unsafe { xmlStrEqual(name, b"head\0" as *const u8 as *const i8 as *mut xmlChar) })
                != 0)
    {
    ...
    loop {
            ...
            && (unsafe { *((*(*ctxt).input).cur).offset(1 as i32 as isize) }) as i32 == '/' as i32
        {
            if htmlParseEndTag(ctxt) != 0
                && (!currentNode.is_null() || (unsafe { (*ctxt).nameNr }) == 0 as i32)
            {
...
extern "C" fn htmlParserFinishElementParsing(
    ...
    if !(unsafe { (*ctxt).node }).is_null() && (unsafe { (*ctxt).record_info }) != 0 {
        (unsafe {
            (*(*ctxt).nodeInfo).end_pos = ((*(*ctxt).input).consumed).wrapping_add(
...
extern "C" fn htmlInitParserCtxt(mut ctxt: *mut crate::src::HTMLparser::_xmlParserCtxt) -> i32 {
    ...
    *fresh137 = xmlDictCreate();
    ...
    sax = (unsafe {
        xmlMalloc.expect("non-null function pointer")(::std::mem::size_of::<htmlSAXHandler>() as u64)
            ...
            18153031941552419006 => {
                if (unsafe { *buf.offset(base as isize) }) as i32 == first as i32 {
                    if third as i32 != 0 as i32 {
                        if (unsafe { *buf.offset((base + 1 as i32) as isize) }) as i32
                            != next as i32
                            || (unsafe { *buf.offset((base + 2 as i32) as isize) }) as i32
                                != third as i32
                        {
                            current_block_25 = 2668756484064249700;
                        } else {
...
extern "C" fn htmlParseLookupCommentEnd(
    ...
    let mut cur: i32 =
        (unsafe { ((*(*ctxt).input).cur).offset_from((*(*ctxt).input).base) }) as i64 as i32;
    while mark >= 0 as i32 {
        ...
        if mark < 0 as i32
            || (unsafe { *((*(*ctxt).input).cur).offset((mark + 2 as i32) as isize) }) as i32
                == '>' as i32
            || (unsafe { *((*(*ctxt).input).cur).offset((mark + 2 as i32) as isize) }) as i32
                == '!' as i32
                && (unsafe { *((*(*ctxt).input).cur).offset((mark + 3 as i32) as isize) }) as i32
                    == '>' as i32
        {
            return mark;
        }
            ...
            *fresh164 = unsafe { (*fresh164).offset(1 as i32 as isize) };
            ...
            match (unsafe { (*ctxt).instate }) as i32 {
                ...
                0 => {
                    ...
                    {
                        (unsafe {
                            ((*(*ctxt).sax).startDocument).expect("non-null function pointer")(
                                (*ctxt).userData,
                            )
                        });
                    }
                ...
                1 => {
                    ...
                    if cur as i32 == '<' as i32
                        && next as i32 == '!' as i32
                        && (unsafe { *((*in_0).cur).offset(2 as i32 as isize) }) as i32
                            == '-' as i32
                        && (unsafe { *((*in_0).cur).offset(3 as i32 as isize) }) as i32
                            == '-' as i32
                    {
                ...
                7 => {
                            ...
                            if !(unsafe { (*ctxt).sax }).is_null() {
                                    ...
                                    || cur as i32 == 0xd as i32
                                {
                                    if (unsafe { (*ctxt).keepBlanks }) != 0 {
                                        ...
                                        ((*(*ctxt).sax).ignorableWhitespace).is_some()
                                    } {
                                        (unsafe {
                        ...
                        }) != 0
                    {
                            ...
                            }) == 'E' as i32
                        {
                            ...
                            htmlParseDocTypeDecl(ctxt);
                        } else if (unsafe { *((*in_0).cur).offset(2 as i32 as isize) }) as i32
                            == '-' as i32
                            && (unsafe { *((*in_0).cur).offset(3 as i32 as isize) }) as i32
                                == '-' as i32
                        {
    ...
    *fresh208 = 0 as xmlDocPtr;
    if reuse == 0 {
        if (unsafe { (*ctxt).dictNames }) != 0
            && !ret.is_null()
            && (unsafe { (*ret).dict }) == (unsafe { (*ctxt).dict })
        {
