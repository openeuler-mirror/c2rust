...
extern "C" fn xmlReportError(
    ...
    match domain {
        ...
        8 => {
            (unsafe {
                channel.expect("non-null function pointer")(
                    data,
                    b"I/O \0" as *const u8 as *const i8,
                )
            });
        }
        11 => {
        ...
        22 => {
            (unsafe {
                channel.expect("non-null function pointer")(
                    data,
                    b"XSLT \0" as *const u8 as *const i8,
                )
            });
        }
        27 => {
    ...
    match level as u32 {
        0 => {
            (unsafe {
                channel.expect("non-null function pointer")(data, b": \0" as *const u8 as *const i8)
            });
        }
        1 => {
            (unsafe {
    ...
    if !str.is_null() {
        ...
        if len > 0 as i32
            && (unsafe { *str.offset((len - 1 as i32) as isize) }) as i32 != '\n' as i32
        {
            (unsafe {
                channel.expect("non-null function pointer")(
                    data,
