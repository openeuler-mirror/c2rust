...
extern "C" fn xmlNsCheckScope(
    ...
    if !node.is_null()
        && ((unsafe { (*node).type_0 }) as u32 == XML_DOCUMENT_NODE as i32 as u32
            || (unsafe { (*node).type_0 }) as u32 == XML_HTML_DOCUMENT_NODE as i32 as u32)
    {
        let mut oldNs: *mut crate::src::HTMLparser::_xmlNs =
            unsafe { (*(node as xmlDocPtr)).oldNs };
        if oldNs == ns {
            return 1 as i32;
        }
    }
...
extern "C" fn xmlCtxtDumpElemDecl(
    ...
    if (unsafe { (*ctxt).check }) == 0 {
        ...
        if (unsafe { (*elem).type_0 }) as u32 != XML_ELEMENT_NODE as i32 as u32
            && !(unsafe { (*elem).content }).is_null()
        {
            let mut buf: [i8; 5001] = [0; 5001];
            buf[0 as i32 as usize] = 0 as i32 as i8;
            (unsafe {
                xmlSnprintfElementContent(buf.as_mut_ptr(), 5000 as i32, (*elem).content, 1 as i32)
            });
        ...
        3 => {
            if (unsafe { (*ctxt).check }) == 0 {
                ...
                if (unsafe { (*node).name }) == (unsafe { xmlStringTextNoenc.as_ptr() }) {
                    (unsafe {
                        fprintf((*ctxt).output, b"TEXT no enc\0" as *const u8 as *const i8)
                    });
                } else {
                ...
                if (unsafe { (*ctxt).options }) & 1 as i32 != 0 {
                    if (unsafe { (*node).content })
                        == (unsafe { &mut (*node).properties }) as *mut *mut _xmlAttr
                            as *mut xmlChar
                    {
                        (unsafe {
                            fprintf((*ctxt).output, b" compact\n\0" as *const u8 as *const i8)
                        });
                    } else if xmlDictOwns(unsafe { (*ctxt).dict }, unsafe { (*node).content })
                        == 1 as i32
                    {
                        (unsafe {
                            fprintf((*ctxt).output, b" interned\n\0" as *const u8 as *const i8)
                        });
                    } else {
                        (unsafe { fprintf((*ctxt).output, b"\n\0" as *const u8 as *const i8) });
                    }
                ...
                if !((*(borrow_mut(&mut list)).unwrap()).nodesetval).is_null() {
                    ...
                    while indx < (unsafe { (*(*(borrow(&list)).unwrap()).nodesetval).nodeNr }) {
                        xmlShellPrintNodeCtxt(
                            borrow_mut(&mut ctxt),
                            unsafe {
                                *((*(*(borrow(&list)).unwrap()).nodesetval).nodeTab)
...
pub extern "C" fn xmlShellLoad<'a1, 'a2>(
    ...
    if !(unsafe { (*ctxt).doc }).is_null() {
        html = ((unsafe { (*(*ctxt).doc).type_0 }) as u32 == XML_HTML_DOCUMENT_NODE as i32 as u32)
            as i32;
    }
    if html != 0 {
    ...
    if !doc.is_null() {
        ...
        (unsafe {
            xmlFree.expect("non-null function pointer")((*ctxt).filename as *mut libc::c_void)
        });
...
pub extern "C" fn xmlShell(
    ...
    ctxt = (unsafe {
        xmlMalloc.expect("non-null function pointer")(::std::mem::size_of::<xmlShellCtxt>() as u64)
    }) as xmlShellCtxtPtr;
    if ctxt.is_null() {
        return;
    }
    ...
    *fresh34 = unsafe { xmlXPathNewContext((*ctxt).doc) };
    ...
    loop {
        ...
        prompt
            ...
            0 as i32 as i8;
        cmdline =
            unsafe { ((*ctxt).input).expect("non-null function pointer")(prompt.as_mut_ptr()) };
        if cmdline.is_null() {
            break;
        }
        cur = cmdline;
        ...
        if (unsafe { strcmp(command.as_mut_ptr(), b"help\0" as *const u8 as *const i8) }) == 0 {
            ...
            (unsafe {
                fprintf ((* ctxt) . output , b"\tdir [path]   dumps information about the node (namespace, attributes, content)\n\0" as * const u8 as * const i8 ,)
            });
            (unsafe {
                fprintf ((* ctxt) . output , b"\tdu [path]    show the structure of the subtree under path or the current node\n\0" as * const u8 as * const i8 ,)
            });
            (unsafe {
                fprintf(
                    (*ctxt).output,
            ...
            (unsafe {
                fprintf ((* ctxt) . output , b"\tset xml_fragment replace the current node content with the fragment parsed in context\n\0" as * const u8 as * const i8 ,)
            });
            (unsafe {
                fprintf ((* ctxt) . output , b"\txpath expr   evaluate the XPath expression in that context and print the result\n\0" as * const u8 as * const i8 ,)
            });
            (unsafe {
                fprintf ((* ctxt) . output , b"\tsetns nsreg  register a namespace to a prefix in the XPath evaluation context\n\0" as * const u8 as * const i8 ,)
            });
            (unsafe {
                fprintf ((* ctxt) . output , b"\t             format for nsreg is: prefix=[nsuri] (i.e. prefix= unsets a prefix)\n\0" as * const u8 as * const i8 ,)
            });
            (unsafe {
                fprintf(
                    (*ctxt).output,
            ...
            (unsafe {
                fprintf ((* ctxt) . output , b"\twhereis      display absolute path of [path] or current working directory\n\0" as * const u8 as * const i8 ,)
            });
            (unsafe {
                fprintf(
                    (*ctxt).output,
        ...
        } else if (unsafe { strcmp(command.as_mut_ptr(), b"load\0" as *const u8 as *const i8) })
            == 0
        {
            xmlShellLoad(
                ctxt,
        ...
        } else if (unsafe { strcmp(command.as_mut_ptr(), b"relaxng\0" as *const u8 as *const i8) })
            == 0
        {
            xmlShellRNGValidate(
                ctxt,
        ...
        } else if (unsafe { strcmp(command.as_mut_ptr(), b"save\0" as *const u8 as *const i8) })
            == 0
        {
            xmlShellSave(
                ctxt,
        ...
        } else if (unsafe { strcmp(command.as_mut_ptr(), b"write\0" as *const u8 as *const i8) })
            == 0
        {
        ...
        } else if (unsafe { strcmp(command.as_mut_ptr(), b"grep\0" as *const u8 as *const i8) })
            == 0
        {
            xmlShellGrep(
                ctxt,
        ...
        } else if (unsafe { strcmp(command.as_mut_ptr(), b"free\0" as *const u8 as *const i8) })
            == 0
        {
            if arg[0 as i32 as usize] as i32 == 0 as i32 {
        ...
        } else if (unsafe { strcmp(command.as_mut_ptr(), b"base\0" as *const u8 as *const i8) })
            == 0
        {
            xmlShellBase(
                ctxt,
        ...
        } else if (unsafe { strcmp(command.as_mut_ptr(), b"setns\0" as *const u8 as *const i8) })
            == 0
        {
            if arg[0 as i32 as usize] as i32 == 0 as i32 {
                (unsafe {
        ...
        } else if (unsafe { strcmp(command.as_mut_ptr(), b"xpath\0" as *const u8 as *const i8) })
            == 0
        {
            if arg[0 as i32 as usize] as i32 == 0 as i32 {
                (unsafe {
        ...
        } else if (unsafe { strcmp(command.as_mut_ptr(), b"setbase\0" as *const u8 as *const i8) })
            == 0
        {
            xmlShellSetBase(
                ctxt,
        ...
        {
            let mut dir_0: i32 = ((unsafe {
                strcmp(command.as_mut_ptr(), b"dir\0" as *const u8 as *const i8)
            }) == 0) as i32;
            if arg[0 as i32 as usize] as i32 == 0 as i32 {
                if dir_0 != 0 {
                    xmlShellDir(
        ...
        } else if (unsafe { strcmp(command.as_mut_ptr(), b"whereis\0" as *const u8 as *const i8) })
            == 0
        {
                        ...
                        1 => {
                            if !(unsafe { (*list).nodesetval }).is_null() {
                                if (unsafe { (*(*list).nodesetval).nodeNr }) == 1 as i32 {
                                    ...
                                    *fresh50 = unsafe {
                                        *((*(*list).nodesetval).nodeTab).offset(0 as i32 as isize)
                                    };
