...
extern "C" fn xmlNewPattern<'a1>() -> *mut crate::src::pattern::_xmlPattern<'a1> {
    ...
    cur = (unsafe {
        xmlMalloc.expect("non-null function pointer")(::std::mem::size_of::<xmlPattern>() as u64)
    }) as xmlPatternPtr;
    if cur.is_null() {
...
extern "C" fn xmlReversePattern<'a1>(mut comp: *mut crate::src::pattern::_xmlPattern<'a1>) -> i32 {
    ...
    if (unsafe { (*comp).nbStep }) > 0 as i32
        && (unsafe { (*((*comp).steps).offset(0 as i32 as isize)).op }) as u32
...
extern "C" fn xmlPatPushState<'a1>(
    ...
    *fresh24 = *fresh24 + 1;
    let fresh26 =
        unsafe { &mut ((*((*(borrow(&states)).unwrap()).states).offset(fresh25 as isize)).node) };
    *fresh26 = node;
    return 0 as i32;
}
    ...
    while i < (unsafe { (*comp).nbStep }) {
        ...
        match (*(borrow(&step)).unwrap()).op as u32 {
            ...
            2 => {
                ...
                {
                    current_block = 6451473480150109090;
                } else if (unsafe { xmlStrEqual((*(borrow(&step)).unwrap()).value, (*node).name) })
                    == 0
                {
                    current_block = 6451473480150109090;
                    ...
                    if ((*(borrow(&step)).unwrap()).value2).is_null() {
                        ...
                        xmlStrEqual((*(borrow(&step)).unwrap()).value2, (*(*node).ns).href)
                    }) == 0
                    {
                        current_block = 6451473480150109090;
                    } else {
                    ...
                    if !((*(borrow(&step)).unwrap()).value).is_null() {
                        while !lst.is_null() {
                            if (unsafe { (*lst).type_0 }) as u32 == XML_ELEMENT_NODE as i32 as u32
                                ...
                                && (unsafe {
                                    xmlStrEqual((*(borrow(&step)).unwrap()).value, (*lst).name)
                                }) != 0
                            {
                                break;
                            }
                ...
                if (unsafe { (*node).type_0 }) as u32 != XML_ATTRIBUTE_NODE as i32 as u32 {
                    ...
                    if !((*(borrow(&step)).unwrap()).value).is_null() {
                            ...
                            != (unsafe { *((*node).name).offset(0 as i32 as isize) }) as i32
                        {
                            ...
                            xmlStrEqual((*(borrow(&step)).unwrap()).value, (*node).name)
                        }) == 0
                        {
                            current_block = 6451473480150109090;
                        } else {
                ...
                match current_block {
                    ...
                    _ => {
                                ...
                                == XML_NAMESPACE_DECL as i32 as u32
                        {
                            ...
                            node = unsafe { (*node).parent };
                            while !node.is_null() {
                                if (unsafe { (*node).type_0 }) as u32
                                    == XML_ELEMENT_NODE as i32 as u32
                                    && (unsafe {
                                        *((*(borrow(&step)).unwrap()).value)
                                            .offset(0 as i32 as isize)
                                    }) as i32
                                        == (unsafe { *((*node).name).offset(0 as i32 as isize) })
                                            as i32
                                    && (unsafe {
                                        xmlStrEqual((*(borrow(&step)).unwrap()).value, (*node).name)
                                    }) != 0
            ...
            7 => {
                if (unsafe { (*node).type_0 }) as u32 != XML_ELEMENT_NODE as i32 as u32 {
                    ...
                    if ((*(borrow(&step)).unwrap()).value).is_null() {
                        ...
                        xmlStrEqual((*(borrow(&step)).unwrap()).value, (*(*node).ns).href)
                    }) == 0
                    {
                        current_block = 6451473480150109090;
                    } else {
...
extern "C" fn xmlPatScanName<'a1>(
    ...
    while (if val < 0x100 as i32 {
        ...
        || (if val < 0x100 as i32 {
            ...
            xmlCharInRange(
                val as u32,
                (Some(unsafe { &xmlIsCombiningGroup })).clone(),
            )
        }) != 0
        || (if val < 0x100 as i32 {
    ...
    if !(unsafe { (*ctxt).dict }).is_null() {
        ret = xmlDictLookup(
            unsafe { (*ctxt).dict },
            q,
            (unsafe { cur.offset_from(q) }) as i64 as i32,
        ) as *mut xmlChar;
    } else {
                    ...
                    while i < (unsafe { (*ctxt).nb_namespaces }) {
                        ...
                        }) != 0
                        {
                            if !(unsafe { (*(*ctxt).comp).dict }).is_null() {
                                ...
                                URL = unsafe {
                                    xmlStrdup(*((*ctxt).namespaces).offset((2 as i32 * i) as isize)
                                        as *mut xmlChar)
                                };
                            }
                            break;
        ...
        if name.is_null() {
            ...
            if (unsafe { *(*ctxt).cur }) as i32 == ':' as i32 {
                ...
                if (unsafe { *(*ctxt).cur }) as i32 != ':' as i32 {
                    ...
                    if (unsafe {
                        xmlStrEqual(name, b"child\0" as *const u8 as *const i8 as *const xmlChar)
                    }) != 0
                    {
                        if (unsafe { (*(*ctxt).comp).dict }).is_null() {
                            (unsafe {
                        ...
                        if name.is_null() {
                            ...
                            if (unsafe { *(*ctxt).cur }) as i32 == ':' as i32 {
                                    ...
                                    || (unsafe { *(*ctxt).cur }) as i32 == 0xd as i32
                                {
                                    ...
                                    token = xmlPatScanName(ctxt);
                                    if (unsafe { *prefix_0.offset(0 as i32 as isize) }) as i32
                                        == 'x' as i32
                                        && (unsafe { *prefix_0.offset(1 as i32 as isize) }) as i32
                                            == 'm' as i32
                                        && (unsafe { *prefix_0.offset(2 as i32 as isize) }) as i32
                                            == 'l' as i32
                                        && (unsafe { *prefix_0.offset(3 as i32 as isize) }) as i32
                                            == 0 as i32
                                    {
                                        if !(unsafe { (*(*ctxt).comp).dict }).is_null() {
                                            URL = xmlDictLookup(
                    ...
                    _ => {
                        ...
                        if (unsafe { (*ctxt).error }) != 0 as i32 {
                            ...
                            loop {
                                ...
                                if (unsafe { *((*ctxt).cur).offset(1 as i32 as isize) }) as i32
                                    == '/' as i32
                                {
                                    if xmlPatternAdd(
                                        ctxt,
...
extern "C" fn xmlNewStreamComp(mut size: i32) -> *mut crate::src::pattern::_xmlStreamComp {
    ...
    cur = (unsafe {
        xmlMalloc.expect("non-null function pointer")(::std::mem::size_of::<xmlStreamComp>() as u64)
    }) as xmlStreamCompPtr;
    if cur.is_null() {
            ...
            2 => {
                if (step.value).is_null() && (step.value2).is_null() {
                    if (unsafe { (*comp).nbStep }) == i + 1 as i32 && flags & 1 as i32 != 0 {
                        ...
                        if prevs != -(1 as i32) {
                            (unsafe {
                                (*((*stream).steps).offset(prevs as isize)).flags |= 32 as i32
                            });
                            prevs = -(1 as i32);
                        }
                    }
        ...
        12264624100856317061 => {
                    ...
                    == 0 as i32
            {
                ...
                if (unsafe { (*stream).nbStep }) > 0 as i32 {
                    if (unsafe { (*((*stream).steps).offset(0 as i32 as isize)).flags }) & 1 as i32
                        == 0 as i32
                    {
                        (unsafe {
                            (*((*stream).steps).offset(0 as i32 as isize)).flags |= 1 as i32
                        });
                    }
                }
            }
...
extern "C" fn xmlNewStreamCtxt(
    ...
    cur = (unsafe {
        xmlMalloc.expect("non-null function pointer")(::std::mem::size_of::<xmlStreamCtxt>() as u64)
    }) as xmlStreamCtxtPtr;
    if cur.is_null() {
...
pub extern "C" fn xmlFreeStreamCtxt(mut stream: *mut crate::src::pattern::_xmlStreamCtxt) {
    ...
    while !stream.is_null() {
        ...
        if !(unsafe { (*stream).states }).is_null() {
            (unsafe {
                xmlFree.expect("non-null function pointer")((*stream).states as *mut libc::c_void)
            });
        }
        ...
        if nodeType == XML_ELEMENT_NODE as i32 && name.is_null() && ns.is_null() {
            ...
            if (unsafe { (*comp).flags }) & (1 as i32) << 15 as i32 != 0 {
                if (unsafe { (*comp).nbStep }) == 0 as i32 {
                    ...
                    && (unsafe { (*((*comp).steps).offset(0 as i32 as isize)).nodeType })
                        == 100 as i32
                    && (unsafe { (*((*comp).steps).offset(0 as i32 as isize)).flags }) & 1 as i32
                        != 0
                {
                    ret = 1 as i32;
                } else if (unsafe { (*((*comp).steps).offset(0 as i32 as isize)).flags }) & 4 as i32
                    != 0
                {
                ...
                *fresh90 += 1;
                ...
                while i < m {
                    if (unsafe { (*comp).flags }) & (1 as i32) << 16 as i32 == 0 as i32 {
                        ...
                        if (unsafe {
                            *((*stream).states).offset(
                                (2 as i32 * ((*stream).nbState - 1 as i32) + 1 as i32) as isize,
                            )
                        }) < (unsafe { (*stream).level })
                        {
                            return -(1 as i32);
                        ...
                        if stepNr < 0 as i32 {
                            ...
                            tmp = unsafe {
                                *((*stream).states).offset((2 as i32 * i + 1 as i32) as isize)
                            };
                            if tmp > (unsafe { (*stream).level }) {
                                current_block = 11581334008138293573;
                            } else {
                                desc =
                                    (unsafe { (*((*comp).steps).offset(stepNr as isize)).flags })
                                        & 1 as i32;
                        ...
                        2516253395664191498 => {
                            ...
                            if step.nodeType != nodeType {
                                if step.nodeType == XML_ATTRIBUTE_NODE as i32 {
                                    if (unsafe { (*comp).flags }) & (1 as i32) << 16 as i32
                                        == 0 as i32
                                    {
                                        (unsafe {
    ...
    loop {
        ...
        *fresh97 = cur;
        ...
        if streamable != 0 {
            if type_0 == 0 as i32 {
                type_0 =
                    (unsafe { (*cur).flags }) & ((1 as i32) << 8 as i32 | (1 as i32) << 9 as i32);
