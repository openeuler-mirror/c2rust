        ...
        if cur != host {
            if (unsafe { (*uri).cleanup }) & 2 as i32 != 0 {
                ...
                *fresh9 = xmlStrndup(
                    ...
                    (unsafe { cur.offset_from(host) }) as i64 as i32,
                ) as *mut i8;
            } else {
...
pub extern "C" fn xmlCreateURI() -> *mut crate::src::uri::_xmlURI {
    ...
    ret = (unsafe {
        xmlMalloc.expect("non-null function pointer")(::std::mem::size_of::<xmlURI>() as u64)
    }) as xmlURIPtr;
    if ret.is_null() {
                            ...
                            if !(unsafe { (*uri).user }).is_null() {
                                ...
                                loop {
                                        ...
                                        || (unsafe { *p }) as i32 == ',' as i32
                                    {
                                        ...
                                        p = unsafe { p.offset(1) };
                                        let mut val_0: i32 =
                                            (unsafe { *(fresh39 as *mut u8) }) as i32;
                                        ...
                                        len = len + 1;
                                        (unsafe {
                                            *ret.offset(fresh41 as isize) = (hi_0
                                                + (if hi_0 > 9 as i32 {
                                                    'A' as i32 - 10 as i32
                                                } else {
                                                    '0' as i32
                                        ...
                                        len = len + 1;
                                        (unsafe {
                                            *ret.offset(fresh42 as isize) = (lo_0
                                                + (if lo_0 > 9 as i32 {
                                                    'A' as i32 - 10 as i32
                                                } else {
                                                    '0' as i32
                        ...
                        _ => {
                            ...
                            loop {
                                    ...
                                    || (unsafe { *p }) as i32 == '+' as i32
                                {
                                    ...
                                    len = len + 1;
                                    (unsafe {
                                        *ret.offset(fresh52 as isize) = (hi_1
                                            + (if hi_1 > 9 as i32 {
                                                'A' as i32 - 10 as i32
                                            } else {
                                                '0' as i32
                                    ...
                                    len = len + 1;
                                    (unsafe {
                                        *ret.offset(fresh53 as isize) = (lo_1
                                            + (if lo_1 > 9 as i32 {
                                                'A' as i32 - 10 as i32
                                            } else {
                                                '0' as i32
                        ...
                        if !(unsafe { (*uri).path }).is_null() {
                            ...
                            if !(unsafe { (*uri).scheme }).is_null()
                                ...
                                && ((unsafe { *p.offset(1 as i32 as isize) }) as i32 >= 'a' as i32
                                    && (unsafe { *p.offset(1 as i32 as isize) }) as i32
                                        <= 'z' as i32
                                    || (unsafe { *p.offset(1 as i32 as isize) }) as i32
                                        >= 'A' as i32
                                        && (unsafe { *p.offset(1 as i32 as isize) }) as i32
                            ...
                            match current_block {
                                ...
                                _ => loop {
                                        ...
                                        || (unsafe { *p }) as i32 == ',' as i32
                                    {
                                        ...
                                        p = unsafe { p.offset(1) };
                                        let mut val_2: i32 =
                                            (unsafe { *(fresh62 as *mut u8) }) as i32;
                                        ...
                                        len = len + 1;
                                        (unsafe {
                                            *ret.offset(fresh64 as isize) = (hi_2
                                                + (if hi_2 > 9 as i32 {
                                                    'A' as i32 - 10 as i32
                                                } else {
                                                    '0' as i32
                                        ...
                                        len = len + 1;
                                        (unsafe {
                                            *ret.offset(fresh65 as isize) = (lo_2
                                                + (if lo_2 > 9 as i32 {
                                                    'A' as i32 - 10 as i32
                                                } else {
                                                    '0' as i32
                                        ...
                                        _ => {
                                            ...
                                            loop {
                                                        ...
                                                        || (unsafe { *p }) as i32 == ']' as i32)
                                                {
                                                    ...
                                                    len = len + 1;
                                                    (unsafe {
                                                        *ret.offset(fresh73 as isize) =
                                                            '%' as i32 as xmlChar
                                                    });
                                                    let mut fresh74 = len;
                                                    len = len + 1;
                                                    (unsafe {
                                                        *ret.offset(fresh74 as isize) = (hi_3
                                                            + (if hi_3 > 9 as i32 {
                                                                'A' as i32 - 10 as i32
                                                            } else {
                                                                '0' as i32
                                                    ...
                                                    len = len + 1;
                                                    (unsafe {
                                                        *ret.offset(fresh75 as isize) = (lo_3
                                                            + (if lo_3 > 9 as i32 {
                                                                'A' as i32 - 10 as i32
                                                            } else {
                                                                '0' as i32
                            ...
                            _ => {
                                ...
                                loop {
                                            ...
                                            || (unsafe { *p }) as i32 == ']' as i32)
                                    {
                                        ...
                                        p = unsafe { p.offset(1) };
                                        let mut val_4: i32 =
                                            (unsafe { *(fresh79 as *mut u8) }) as i32;
                                        ...
                                        len = len + 1;
                                        (unsafe {
                                            *ret.offset(fresh81 as isize) = (hi_4
                                                + (if hi_4 > 9 as i32 {
                                                    'A' as i32 - 10 as i32
                                                } else {
                                                    '0' as i32
                                        ...
                                        len = len + 1;
                                        (unsafe {
                                            *ret.offset(fresh82 as isize) = (lo_4
                                                + (if lo_4 > 9 as i32 {
                                                    'A' as i32 - 10 as i32
                                                } else {
                                                    '0' as i32
    ...
    's_39: while (unsafe { *cur.offset(0 as i32 as isize) }) as i32 != '\u{0}' as i32 {
            ...
            && (unsafe { *cur.offset(1 as i32 as isize) }) as i32 == '/' as i32
        {
            ...
            while (unsafe { *cur.offset(0 as i32 as isize) }) as i32 != '/' as i32 {
                ...
                (unsafe {
                    *fresh93.offset(0 as i32 as isize) = *fresh92.offset(0 as i32 as isize)
                });
            }
            while (unsafe { *cur.offset(0 as i32 as isize) }) as i32 == '/' as i32
                && (unsafe { *cur.offset(1 as i32 as isize) }) as i32 == '/' as i32
    ...
    if (unsafe { *path.offset(0 as i32 as isize) }) as i32 == '/' as i32 {
        ...
        if cur != path {
            ...
            while (unsafe { *cur.offset(0 as i32 as isize) }) as i32 != '\u{0}' as i32 {
                ...
                out = unsafe { out.offset(1) };
                (unsafe {
                    *fresh99.offset(0 as i32 as isize) = *fresh98.offset(0 as i32 as isize)
                });
            }
...
pub extern "C" fn xmlURIUnescapeString(
    ...
    if target.is_null() {
        ret = (unsafe {
            xmlMallocAtomic.expect("non-null function pointer")((len + 1 as i32) as size_t)
        }) as *mut i8;
        if ret.is_null() {
    ...
    while len > 0 as i32 {
            ...
            && is_hex(unsafe { *in_0.offset(2 as i32 as isize) }) != 0
        {
            ...
            } else if (unsafe { *in_0 }) as i32 >= 'a' as i32
                && (unsafe { *in_0 }) as i32 <= 'f' as i32
            {
...
pub extern "C" fn xmlURIEscapeStr(mut str: *const u8, mut list: *const u8) -> *mut u8 {
    ...
    len += 20 as i32;
    ret = (unsafe { xmlMallocAtomic.expect("non-null function pointer")(len as size_t) })
        as *mut xmlChar;
    if ret.is_null() {
    ...
    while (unsafe { *in_0 }) as i32 != 0 as i32 {
            ...
            && (xmlStrchr(list, ch)).is_null()
        {
            ...
            if val as i32 <= 9 as i32 {
                ...
                out = out + 1;
                (unsafe {
                    *ret.offset(fresh105 as isize) =
                        ('A' as i32 + val as i32 - 0xa as i32) as xmlChar
                });
            }
                                ...
                                if !res.is_null() {
                                            ...
                                            && (unsafe { (*ref_0).server }).is_null())
                                    {
                                        if !(unsafe { (*bas).scheme }).is_null() {
                                            ...
                                            *fresh111 = unsafe {
                                                xmlMemStrdup.expect("non-null function pointer")(
                                                    (*bas).scheme,
                                                )
                                            };
                                        }
                                            ...
                                            || !(unsafe { (*ref_0).server }).is_null()
                                        {
                                                    ...
                                                    == '/' as i32
                                            {
                                                ...
                                                *fresh132 = unsafe {
                                                ...
                                                len = 2 as i32;
                                                if !(unsafe { (*ref_0).path }).is_null() {
                                                    len = (len as u64).wrapping_add(
                                                        unsafe { strlen((*ref_0).path) },
                                                    )
                                                        as i32
                                                        as i32;
                                                }
                                                ...
                                                *fresh133 = (unsafe {
                                                ...
                                                if (unsafe { (*res).path }).is_null() {
                                                    ...
                                                    (unsafe {
                                                        *((*res).path).offset(0 as i32 as isize) =
                                                            0 as i32 as i8
                                                    });
                                                    cur = 0 as i32;
                                                    out = 0 as i32;
                                                            ...
                                                            != 0 as i32
                                                    {
                                                        ...
                                                        while (unsafe {
                                                            *((*ref_0).path).offset(indx as isize)
                                                        })
                                                            as i32
                                                            != 0 as i32
                                                        {
                        ...
                        _ => {
                            ...
                            ) != 0
                            {
                                ...
                                if (unsafe { *rptr }) as i32 == '.' as i32
                                    && (unsafe { *rptr.offset(1 as i32 as isize) }) as i32
                                        == '/' as i32
                                {
                                    rptr = unsafe { rptr.offset(2 as i32 as isize) };
                                }
                                if (unsafe { *bptr }) as i32 == '.' as i32
                                    && (unsafe { *bptr.offset(1 as i32 as isize) }) as i32
                                        == '/' as i32
                                {
                                    bptr = unsafe { bptr.offset(2 as i32 as isize) };
                                } else if (unsafe { *bptr }) as i32 == '/' as i32
                                    && (unsafe { *rptr }) as i32 != '/' as i32
                                {
                                    ...
                                    == (unsafe { *rptr.offset(pos as isize) }) as i32
                                {
                                    ...
                                    ix = pos;
                                    while ix > 0 as i32 {
                                        if (unsafe { *rptr.offset((ix - 1 as i32) as isize) })
                                            as i32
                                            == '/' as i32
                                        {
                                            break;
                                    ...
                                    uptr =
                                        (unsafe { &mut *rptr.offset(ix as isize) }) as *mut xmlChar;
                                    while (unsafe { *bptr.offset(ix as isize) }) as i32 != 0 as i32
                                    {
                                        if (unsafe { *bptr.offset(ix as isize) }) as i32
                                            == '/' as i32
                                        {
                                            nbslash += 1;
                                        }
                                    ...
                                    if nbslash == 0 as i32
                                        && (unsafe { *uptr.offset(0 as i32 as isize) }) == 0
                                    {
                                        val = xmlStrdup(
                                            b"./\0" as *const u8 as *const i8 as *mut xmlChar,
                                        );
                                            ...
                                            if val.is_null() {
                                                ...
                                                if !uptr.is_null() {
                                                    if vptr > val
                                                        && len > 0 as i32
                                                        && (unsafe {
                                                            *uptr.offset(0 as i32 as isize)
                                                        })
                                                            as i32
                                                            == '/' as i32
                                                        && (unsafe {
                                                            *vptr.offset(-(1 as i32) as isize)
                                                        })
                                                            as i32
                                                            == '/' as i32
                                                    {
                                                    ...
                                                    (unsafe {
                                                        *vptr.offset((len - 1 as i32) as isize) =
                                                            0 as i32 as xmlChar
                                                    });
                                                }
                                                vptr = val;
            ...
            match current_block {
                ...
                _ => {
                    ...
                    if !escURI.is_null() {
                        ...
                        (unsafe {
                            xmlFree.expect("non-null function pointer")(escURI as *mut libc::c_void)
                        });
                    }
                }
            }
