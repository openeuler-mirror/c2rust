...
extern "C" fn xmlCreateZMemBuff(mut compression: i32) -> *mut core::ffi::c_void {
    ...
    buff = (unsafe {
        xmlMalloc.expect("non-null function pointer")(::std::mem::size_of::<xmlZMemBuff>() as u64)
    }) as xmlZMemBuffPtr;
    if buff.is_null() {
...
extern "C" fn xmlZMemBuffExtend(
    ...
    tmp_ptr = (unsafe {
        xmlRealloc.expect("non-null function pointer")((*buff).zbuff as *mut libc::c_void, new_size)
    }) as *mut u8;
    if !tmp_ptr.is_null() {
        rc = 0 as i32;
...
extern "C" fn xmlIOHTTPCloseWrite(
    ...
    if (unsafe { (*ctxt).compression }) > 0 as i32 {
        content_lgth = xmlZMemBuffGetContent(
            (unsafe { (*ctxt).doc_buff }) as xmlZMemBuffPtr,
    ...
    if http_content.is_null() {
        ...
        if !http_ctxt.is_null() {
            ...
            (unsafe {
                xmlFree.expect("non-null function pointer")(content_type as *mut libc::c_void)
            });
        }
    }
    xmlFreeHTTPWriteCtxt(ctxt);
...
pub extern "C" fn xmlOutputBufferClose(mut out: *mut crate::src::threads::_xmlOutputBuffer) -> i32 {
    ...
    if unsafe { ((*out).closecallback).is_some() } {
        err_rc =
            unsafe { ((*out).closecallback).expect("non-null function pointer")((*out).context) };
    }
...
pub extern "C" fn __xmlParserInputBufferCreateFilename(
    ...
    if context.is_null() {
        ...
        while i >= 0 as i32 {
            ...
            {
                context = unsafe {
                    (xmlInputCallbackTable[i as usize].opencallback)
                        .expect("non-null function pointer")(URI)
                };
                if !context.is_null() {
                    break;
    ...
    if !ret.is_null() {
        ...
        *fresh38 = unsafe { xmlInputCallbackTable[i as usize].closecallback };
        ...
        (unsafe {
            (xmlInputCallbackTable[i as usize].closecallback).expect("non-null function pointer")(
                context,
            )
        });
    }
...
pub extern "C" fn xmlParserInputBufferCreateFilename(
    ...
    if unsafe { (*__xmlParserInputBufferCreateFilenameValue()).is_some() } {
        return unsafe {
            (*__xmlParserInputBufferCreateFilenameValue()).expect("non-null function pointer")(
                URI, enc,
            )
        };
    }
        ...
        while i >= 0 as i32 {
                ...
                }) != 0 as i32
            {
                    ...
                    == (Some(xmlIOHTTPMatch)).map(|f| f as usize)
                {
                    ...
                    context = unsafe {
                        (xmlOutputCallbackTable[i as usize].opencallback)
                            .expect("non-null function pointer")(unescaped)
                    };
                }
                if !context.is_null() {
...
pub extern "C" fn xmlOutputBufferCreateFilename(
    ...
    if unsafe { (*__xmlOutputBufferCreateFilenameValue()).is_some() } {
        return unsafe {
            (*__xmlOutputBufferCreateFilenameValue()).expect("non-null function pointer")(
                URI,
                encoder,
                compression,
            )
...
pub extern "C" fn xmlParserInputBufferPush(
    ...
    if !(unsafe { (*in_0).encoder }).is_null() {
        ...
        *fresh79 = (*fresh79)
            .wrapping_add((use_0 as u64).wrapping_sub(unsafe { xmlBufUse((*in_0).raw) }));
    } else {
        nbchars = len;
...
pub extern "C" fn xmlParserInputBufferGrow(
    ...
    if unsafe { ((*in_0).readcallback).is_some() } {
        res = unsafe {
            ((*in_0).readcallback).expect("non-null function pointer")(
                (*in_0).context,
...
pub extern "C" fn xmlParserInputBufferRead(
    ...
    } else if (unsafe { xmlBufGetAllocationScheme((*in_0).buffer) })
...
pub extern "C" fn xmlOutputBufferWrite(
    ...
    loop {
        ...
        if unsafe { ((*out).writecallback).is_some() } {
            ...
            if !(unsafe { (*out).encoder }).is_null() {
                ret = unsafe {
                    ((*out).writecallback).expect("non-null function pointer")(
                        (*out).context,
...
pub extern "C" fn xmlOutputBufferWriteEscape(
    ...
    if out.is_null()
        ...
        || (unsafe { xmlBufGetAllocationScheme((*out).buffer) })
            == XML_BUFFER_ALLOC_IMMUTABLE as i32
    {
        return -(1 as i32);
    }
    ...
    loop {
        ...
        if chunk < 40 as i32 {
            ...
            if !(unsafe { (*out).encoder }).is_null() {
                ...
                ret = unsafe {
                    escaping.expect("non-null function pointer")(
...
pub extern "C" fn xmlOutputBufferFlush(mut out: *mut crate::src::threads::_xmlOutputBuffer) -> i32 {
    ...
    if !(unsafe { (*out).conv }).is_null()
        && !(unsafe { (*out).encoder }).is_null()
        && (unsafe { ((*out).writecallback).is_some() })
    {
        ret = unsafe {
            ((*out).writecallback).expect("non-null function pointer")(
                (*out).context,
...
pub extern "C" fn xmlParserGetDirectory(mut filename: *const i8) -> *mut i8 {
    ...
    cur =
        (unsafe { &mut *dir.as_mut_ptr().offset((strlen)(dir.as_mut_ptr()) as isize) }) as *mut i8;
...
pub extern "C" fn xmlLoadExternalEntity(
    ...
    if !URL.is_null() && xmlNoNetExists(URL) == 0 as i32 {
        ...
        ret = unsafe {
            xmlCurrentExternalEntityLoader.expect("non-null function pointer")(
                canonicFilename,
                ID,
                ctxt,
            )
    ...
    return unsafe {
        xmlCurrentExternalEntityLoader.expect("non-null function pointer")(URL, ID, ctxt)
    };
}
#[no_mangle]
