...
extern "C" fn xmlParserEntityCheck(
    ...
    if replacement != 0 as i32 as u64 {
        ...
        consumed =
            (consumed as u64).wrapping_add(unsafe { (*ctxt).sizeentities }) as size_t as size_t;
...
extern "C" fn xmlDetectSAX2(mut ctxt: *mut crate::src::HTMLparser::_xmlParserCtxt) {
    ...
    if !sax.is_null()
        ...
        && ((unsafe { ((*sax).startElementNs).is_some() })
            ...
            || (unsafe { ((*sax).startElement).is_none() })
                && (unsafe { ((*sax).endElement).is_none() }))
    {
...
extern "C" fn xmlAddDefAttrs(
    ...
    match current_block {
        13183875560443969876 => {
            ...
            defaults =
                xmlHashLookup2(unsafe { (*ctxt).attsDefault }, name, prefix) as xmlDefAttrsPtr;
            if defaults.is_null() {
                defaults = (unsafe {
...
extern "C" fn spacePop(mut ctxt: *mut crate::src::HTMLparser::_xmlParserCtxt) -> i32 {
    ...
    *fresh76 -= 1;
    if (unsafe { (*ctxt).spaceNr }) > 0 as i32 {
        ...
        *fresh77 =
            (unsafe { &mut *((*ctxt).spaceTab).offset(((*ctxt).spaceNr - 1 as i32) as isize) })
                as *mut i32;
    } else {
...
extern "C" fn xmlGROW(mut ctxt: *mut crate::src::HTMLparser::_xmlParserCtxt) {
    ...
    if (unsafe { (*(*ctxt).input).cur }) > (unsafe { (*(*ctxt).input).end })
        || (unsafe { (*(*ctxt).input).cur }) < (unsafe { (*(*ctxt).input).base })
    {
        xmlHaltParser(ctxt);
        xmlFatalErr(
            ctxt,
...
pub extern "C" fn xmlSkipBlankChars(mut ctxt: *mut crate::src::HTMLparser::_xmlParserCtxt) -> i32 {
        ...
        || (unsafe { (*ctxt).instate }) as i32 == XML_PARSER_START as i32
    {
        ...
        *fresh82 = cur;
        ...
        let mut expandPE: i32 = ((unsafe { (*ctxt).external }) != 0 as i32
            || (unsafe { (*ctxt).inputNr }) != 1 as i32) as i32;
        loop {
                ...
                || (unsafe { *(*(*ctxt).input).cur }) as i32 == 0xd as i32
            {
                ...
                if expandPE == 0 as i32
                    || ((unsafe { *((*(*ctxt).input).cur).offset(1 as i32 as isize) }) as i32
                        == 0x20 as i32
                        || 0x9 as i32
                            <= (unsafe { *((*(*ctxt).input).cur).offset(1 as i32 as isize) })
                                as i32
                            && (unsafe { *((*(*ctxt).input).cur).offset(1 as i32 as isize) })
                                as i32
                                <= 0xa as i32
...
pub extern "C" fn xmlPushInput(
    ...
    if (unsafe { (*ctxt).inputNr }) > 40 as i32
        && (unsafe { (*ctxt).options }) & XML_PARSE_HUGE as i32 == 0 as i32
        ...
        && (unsafe { *((*(*ctxt).input).cur).offset(2 as i32 as isize) }) as i32 == 'x' as i32
    {
        ...
        *fresh83 = unsafe { (*fresh83).offset(3 as i32 as isize) };
        ...
        while (unsafe { *(*(*ctxt).input).cur }) as i32 != ';' as i32 {
            ...
            {
                val = val * 16 as i32
                    + ((unsafe { *(*(*ctxt).input).cur }) as i32 - 'a' as i32)
                    + 10 as i32;
            } else if (unsafe { *(*(*ctxt).input).cur }) as i32 >= 'A' as i32
                && (unsafe { *(*(*ctxt).input).cur }) as i32 <= 'F' as i32
                && count < 20 as i32
...
pub extern "C" fn xmlStringLenDecodeEntities(
    ...
    if (unsafe { (*ctxt).depth }) > 40 as i32
        && (unsafe { (*ctxt).options }) & XML_PARSE_HUGE as i32 == 0 as i32
    ...
    buffer = (unsafe { xmlMallocAtomic.expect("non-null function pointer")(buffer_size) })
        as *mut xmlChar;
    if buffer.is_null() {
        ...
        's_81: loop {
            ...
            if c == '&' as i32 && (unsafe { *str.offset(1 as i32 as isize) }) as i32 == '#' as i32 {
                ...
                if !ent.is_null() {
                    ...
                    *fresh92 =
                        (*fresh92).wrapping_add(((unsafe { (*ent).checked }) / 2 as i32) as u64);
                }
                if !ent.is_null()
                        ...
                        == XML_INTERNAL_PREDEFINED_ENTITY as i32 as u32
                {
                    if !(unsafe { (*ent).content }).is_null() {
                        if 0 as i32 == 1 as i32 {
                            ...
                            nbchars = nbchars.wrapping_add(1);
                            (unsafe {
                                *buffer.offset(fresh93 as isize) =
                ...
                if !ent.is_null() {
                    ...
                    *fresh102 =
                        (*fresh102).wrapping_add(((unsafe { (*ent).checked }) / 2 as i32) as u64);
                }
                if !ent.is_null() {
                    if (unsafe { (*ent).content }).is_null() {
...
extern "C" fn areBlanks(
    ...
    if lastChild.is_null() {
        ...
        if !(unsafe { (*(*ctxt).node).children }).is_null()
            && (unsafe { xmlNodeIsText((*(*ctxt).node).children) }) != 0
        {
            return 0 as i32;
        }
    }
    ...
    *(borrow_mut(&mut prefix)).unwrap() = 0 as *mut xmlChar;
    ...
    if c == ':' as i32 {
        ...
        *(borrow_mut(&mut prefix)).unwrap() = ret;
        if c == 0 as i32 {
            return unsafe {
                xmlStrndup(b"\0" as *const u8 as *const i8 as *mut xmlChar, 0 as i32)
            };
        }
        len = 0 as i32;
            ...
            || c == ':' as i32)
        {
            ...
            if !((if first < 0x100 as i32 {
                ...
                xmlCharInRange(
                    first as u32,
                    (Some(unsafe { &xmlIsBaseCharGroup })).clone(),
                )
            }) != 0
...
extern "C" fn xmlParseNameAndCompare(
    ...
    while (unsafe { *in_0 }) as i32 != 0 as i32
        && (unsafe { *in_0 }) as i32 == (unsafe { *cmp }) as i32
    {
        in_0 = unsafe { in_0.offset(1) };
    ...
    if (unsafe { *cmp }) as i32 == 0 as i32
        && ((unsafe { *in_0 }) as i32 == '>' as i32
            || ((unsafe { *in_0 }) as i32 == 0x20 as i32
                || 0x9 as i32 <= (unsafe { *in_0 }) as i32
                    && (unsafe { *in_0 }) as i32 <= 0xa as i32
                || (unsafe { *in_0 }) as i32 == 0xd as i32))
    {
        let fresh139 = unsafe { &mut ((*(*ctxt).input).col) };
        *fresh139 =
            (*fresh139 as i64 + (unsafe { in_0.offset_from((*(*ctxt).input).cur) }) as i64) as i32;
...
extern "C" fn xmlParseStringName<'a1>(
    ...
    while xmlIsNameChar(ctxt, c) != 0 {
        if l == 1 as i32 {
            ...
            len +=
                xmlCopyCharMultiByte(unsafe { &mut *buf.as_mut_ptr().offset(len as isize) }, c);
        }
        cur = unsafe { cur.offset(l as isize) };
        c = xmlStringCurrentChar(ctxt, cur, Some(&mut l));
        if len >= 100 as i32 {
                        ...
                        loop {
                            ...
                            if (unsafe { *cur }) as i32 == '%' as i32
                                || (unsafe { *cur }) as i32 == '&' as i32
                                    && (unsafe { *cur.offset(1 as i32 as isize) }) as i32
                                        != '#' as i32
                            {
...
extern "C" fn xmlParseAttValueComplex<'a1>(
    ...
    buf =
        (unsafe { xmlMallocAtomic.expect("non-null function pointer")(buf_size) }) as *mut xmlChar;
    if buf.is_null() {
        current_block = 4728557498262148097;
    } else {
        c = xmlCurrentChar(ctxt, Some(&mut l));
        's_99: loop {
            if !((unsafe { *((*(*ctxt).input).cur).offset(0 as i32 as isize) }) as i32
                != limit as i32
                && (if c < 0x100 as i32 {
                ...
                && (unsafe { (*ctxt).options }) & XML_PARSE_HUGE as i32 == 0 as i32
            {
                ...
                if c == '&' as i32 {
                    in_space = 0 as i32;
                    if (unsafe { *((*(*ctxt).input).cur).offset(1 as i32 as isize) }) as i32
                        == '#' as i32
                    {
                        ...
                        } else if !ent.is_null() && (unsafe { (*ctxt).replaceEntities }) != 0 as i32
                        {
                                ...
                                && (unsafe { (*ent).checked }) == 0 as i32
                            {
                                ...
                                *fresh181 -= 1;
                                ...
                                (unsafe {
                                    (*ent).checked = diff.wrapping_mul(2 as i32 as u64) as i32
                                });
                                if !rep.is_null() {
                                    if !(unsafe { xmlStrchr(rep, '<' as i32 as xmlChar) })
                                        .is_null()
                                    {
                                        (unsafe { (*ent).checked |= 1 as i32 });
                                    }
                        ...
                        if len != 0 as i32 as u64 || normalize == 0 {
                            if normalize == 0 || in_space == 0 {
                                if l == 1 as i32 {
                                    ...
                                    len = len.wrapping_add(1);
                                    (unsafe {
                                        *buf.offset(fresh186 as isize) = 0x20 as i32 as xmlChar
                                    });
                                } else {
                ...
                if (unsafe { (*ctxt).instate }) as i32 == XML_PARSER_EOF as i32 {
                    ...
                    if in_space != 0 && normalize != 0 {
                        while len > 0 as i32 as u64
                            && (unsafe { *buf.offset(len.wrapping_sub(1 as i32 as u64) as isize) })
                                as i32
                                == 0x20 as i32
                        {
        ...
        loop {
            ...
            if (unsafe { *in_0 }) as i32 == 0xa as i32 {
                ...
                if (unsafe { *in_0 }) as i32 == '<' as i32 {
                    ...
                    if nbchar > 0 as i32 {
                        ...
                        *fresh198 = in_0;
                        ...
                        {
                            (unsafe {
                                ((*(*ctxt).sax).characters).expect("non-null function pointer")(
                                    (*ctxt).userData,
                                    tmp,
                                    nbchar,
                                )
                ...
                *fresh203 = in_0;
                ...
                if !((unsafe { *in_0 }) as i32 >= 0x20 as i32
        ...
        }) != 0
    {
        ...
        if l == 1 as i32 {
            ...
            nbchar += xmlCopyCharMultiByte(
                unsafe { &mut *buf.as_mut_ptr().offset(nbchar as isize) },
                cur,
            );
        }
        if (unsafe { *(*(*ctxt).input).cur }) as i32 == '\n' as i32 {
        ...
        if nbchar >= 300 as i32 {
            ...
            if !(unsafe { (*ctxt).sax }).is_null() && (unsafe { (*ctxt).disableSAX }) == 0 {
                if areBlanks(ctxt, buf.as_mut_ptr(), nbchar, 0 as i32) != 0 {
                    if unsafe { ((*(*ctxt).sax).ignorableWhitespace).is_some() } {
                        (unsafe {
                            ((*(*ctxt).sax).ignorableWhitespace).expect("non-null function pointer")(
                                (*ctxt).userData,
                                buf.as_mut_ptr(),
                                nbchar,
                            )
    ...
    }) != 0)
    {
        ...
        if !(marker as i32 != '\'' as i32 && marker as i32 != '"' as i32) {
            ...
            if !((unsafe { *tmp }) as i32 == 0 as i32) {
                ...
                tmp = unsafe { tmp.offset(1) };
                while (unsafe { *tmp }) as i32 == 0x20 as i32
                    || 0x9 as i32 <= (unsafe { *tmp }) as i32
                        && (unsafe { *tmp }) as i32 <= 0xa as i32
                    || (unsafe { *tmp }) as i32 == 0xd as i32
                {
                    tmp = unsafe { tmp.offset(1) };
                }
        ...
        if !target.is_null() {
                    ...
                    == '>' as i32
            {
                ...
                *fresh237 = unsafe { (*fresh237).offset(2 as i32 as isize) };
                ...
                {
                    (unsafe {
                        ((*(*ctxt).sax).processingInstruction).expect("non-null function pointer")(
                            (*ctxt).userData,
                            target,
                            0 as *const xmlChar,
                        )
...
pub extern "C" fn xmlParseNotationDecl(mut ctxt: *mut crate::src::HTMLparser::_xmlParserCtxt) {
    ...
    if (unsafe { *((*(*ctxt).input).cur as *mut u8).offset(0 as i32 as isize) }) as i32
        ...
        && (unsafe { *((*(*ctxt).input).cur as *mut u8).offset(7 as i32 as isize) }) as i32
            == 'I' as i32
        && (unsafe { *((*(*ctxt).input).cur as *mut u8).offset(8 as i32 as isize) }) as i32
            == 'O' as i32
        && (unsafe { *((*(*ctxt).input).cur as *mut u8).offset(9 as i32 as isize) }) as i32
            == 'N' as i32
    {
        let mut inputid: i32 = unsafe { (*(*ctxt).input).id };
        if (unsafe { (*ctxt).progressive }) == 0 as i32
        ...
        *fresh243 = unsafe { (*fresh243).offset(10 as i32 as isize) };
        ...
        if (unsafe { *(*(*ctxt).input).cur }) as i32 == '>' as i32 {
            ...
            {
                (unsafe {
                    ((*(*ctxt).sax).notationDecl).expect("non-null function pointer")(
                        (*ctxt).userData,
                        name,
                        Pubid,
                        Systemid,
        ...
        *fresh244 = unsafe { (*fresh244).offset(8 as i32 as isize) };
        ...
        if isParameter != 0 {
                ...
                || (unsafe { *(*(*ctxt).input).cur }) as i32 == '\'' as i32
            {
                ...
                if !value.is_null() {
                    ...
                    {
                        (unsafe {
                            ((*(*ctxt).sax).entityDecl).expect("non-null function pointer")(
                                (*ctxt).userData,
                                name,
            ...
            || (unsafe { *(*(*ctxt).input).cur }) as i32 == '\'' as i32
        {
                    ...
                    == 'A' as i32
            {
                ...
                *fresh247 = unsafe { (*fresh247).offset(5 as i32 as isize) };
                ...
                {
                    (unsafe {
                        ((*(*ctxt).sax).unparsedEntityDecl).expect("non-null function pointer")(
                            (*ctxt).userData,
                            name,
                            literal,
                            URI,
        ...
        if !((unsafe { (*ctxt).instate }) as i32 == XML_PARSER_EOF as i32) {
            ...
            if !orig.is_null() {
                ...
                if isParameter != 0 {
                    if !(unsafe { (*ctxt).sax }).is_null()
                        && (unsafe { ((*(*ctxt).sax).getParameterEntity).is_some() })
                    {
                        cur = unsafe {
                            ((*(*ctxt).sax).getParameterEntity).expect("non-null function pointer")(
                                (*ctxt).userData,
                                name,
                            )
                        };
                    ...
                    if !(unsafe { (*ctxt).sax }).is_null()
                        && (unsafe { ((*(*ctxt).sax).getEntity).is_some() })
                    {
                        cur = unsafe {
                            ((*(*ctxt).sax).getEntity).expect("non-null function pointer")(
                                (*ctxt).userData,
                                name,
                            )
                        };
...
extern "C" fn xmlParseElementChildrenContentDeclPriv(
        ...
        && (unsafe { (*ctxt).instate }) as i32 != XML_PARSER_EOF as i32
    {
        if (unsafe { *(*(*ctxt).input).cur }) as i32 == ',' as i32 {
            ...
            xmlNextChar(ctxt);
            op = unsafe {
                xmlNewDocElementContent((*ctxt).myDoc, 0 as *const xmlChar, XML_ELEMENT_CONTENT_SEQ)
            };
            if op.is_null() {
                if !last.is_null() && last != ret {
                    (unsafe { xmlFreeDocElementContent((*ctxt).myDoc, last) });
    ...
    if (unsafe { *(*(*ctxt).input).cur }) as i32 == '?' as i32 {
        ...
        if !ret.is_null() {
            ...
            cur = ret;
            while !cur.is_null()
                && (unsafe { (*cur).type_0 }) as u32 == XML_ELEMENT_CONTENT_OR as i32 as u32
            {
                if !(unsafe { (*cur).c1 }).is_null()
                    && ((unsafe { (*(*cur).c1).ocur }) as u32
        ...
        *fresh290 = unsafe { (*fresh290).offset(9 as i32 as isize) };
        ...
        if (unsafe { *(*(*ctxt).input).cur }) as i32 != '>' as i32 {
                ...
                && (unsafe { ((*(*ctxt).sax).elementDecl).is_some() })
            {
                ...
                (unsafe {
                    ((*(*ctxt).sax).elementDecl).expect("non-null function pointer")(
                        (*ctxt).userData,
                        name,
                        ret,
                        content,
    ...
    's_11: while (unsafe { (*ctxt).instate }) as i32 != XML_PARSER_EOF as i32 {
            ...
            && (unsafe { *((*(*ctxt).input).cur).offset(2 as i32 as isize) }) as i32 == '[' as i32
        {
            ...
            *fresh294 = unsafe { (*fresh294).offset(3 as i32 as isize) };
            ...
            } else if (unsafe { *((*(*ctxt).input).cur as *mut u8).offset(0 as i32 as isize) })
                as i32
                == 'I' as i32
                && (unsafe { *((*(*ctxt).input).cur as *mut u8).offset(1 as i32 as isize) }) as i32
                    == 'G' as i32
    ...
    if (unsafe { *(*(*ctxt).input).cur }) as i32 == '<' as i32 {
        if (unsafe { *((*(*ctxt).input).cur).offset(1 as i32 as isize) }) as i32 == '!' as i32 {
            match (unsafe { *((*(*ctxt).input).cur).offset(2 as i32 as isize) }) as i32 {
                69 => {
                    if (unsafe { *((*(*ctxt).input).cur).offset(3 as i32 as isize) }) as i32
                        == 'L' as i32
                    {
                        xmlParseElementDecl(ctxt);
                    } else if (unsafe { *((*(*ctxt).input).cur).offset(3 as i32 as isize) }) as i32
                        == 'N' as i32
                    {
        ...
        } else if (unsafe { *((*(*ctxt).input).cur).offset(1 as i32 as isize) }) as i32
            == '?' as i32
        {
            xmlParsePI(ctxt);
        }
    ...
    *fresh302 = version;
        ...
        && (unsafe { *((*(*ctxt).input).cur).offset(1 as i32 as isize) }) as i32 == '>' as i32
    {
        ...
        *fresh303 = unsafe { (*fresh303).offset(2 as i32 as isize) };
        ...
        xmlFatalErr(ctxt, XML_ERR_XMLDECL_NOT_FINISHED, 0 as *const i8);
        while (unsafe { *(*(*ctxt).input).cur }) as i32 != 0
            && (unsafe { *(*(*ctxt).input).cur }) as i32 != '>' as i32
        {
...
pub extern "C" fn xmlParseReference(mut ctxt: *mut crate::src::HTMLparser::_xmlParserCtxt) {
        ...
        if (unsafe { (*ctxt).charset }) != XML_CHAR_ENCODING_UTF8 as i32 {
            ...
            if 0 as i32 == 1 as i32 {
                ...
                i += xmlCopyCharMultiByte(
                    unsafe { &mut *out.as_mut_ptr().offset(i as isize) },
                    value,
                );
            }
    ...
    if ((unsafe { (*ent).checked }) == 0 as i32
        || (unsafe { (*ent).children }).is_null()
            && (unsafe { (*ctxt).options }) & XML_PARSE_NOENT as i32 != 0)
        && ((unsafe { (*ent).etype }) as u32 != XML_EXTERNAL_GENERAL_PARSED_ENTITY as i32 as u32
            || (unsafe { (*ctxt).options }) & (XML_PARSE_NOENT as i32 | XML_PARSE_DTDVALID as i32)
                != 0)
    {
        let mut oldnbent: u64 = unsafe { (*ctxt).nbentities };
        let mut diff: u64 = 0;
        ...
        if (unsafe { (*ent).etype }) as u32 == XML_INTERNAL_GENERAL_ENTITY as i32 as u32 {
            ...
            *fresh308 -= 1;
        } else if (unsafe { (*ent).etype }) as u32
    ...
    if (unsafe { (*ctxt).replaceEntities }) != 0 || (unsafe { (*ent).children }).is_null() {
        if !(unsafe { (*ctxt).node }).is_null() && !(unsafe { (*ent).children }).is_null() {
                ...
                || (unsafe { (*ctxt).parseMode }) as u32 == XML_PARSE_READER as i32 as u32
            {
                ...
                *fresh322 =
                    (*fresh322).wrapping_add(((unsafe { (*ent).length }) + 5 as i32) as u64);
                if xmlParserEntityCheck(
                    ctxt,
                    0 as i32 as size_t,
                    ent,
                    unsafe { (*ctxt).sizeentcopy },
                ) != 0
                {
                    return;
                }
                ...
                *fresh324 =
                    (*fresh324).wrapping_add(((unsafe { (*ent).length }) + 5 as i32) as u64);
                if xmlParserEntityCheck(
                    ctxt,
                    0 as i32 as size_t,
                    ent,
    ...
    *fresh334 = (*fresh334).wrapping_add(1);
        ...
        && (unsafe { (*entity).etype }) as u32 != XML_EXTERNAL_PARAMETER_ENTITY as i32 as u32
    {
        ...
        if (unsafe { (*entity).etype }) as u32 == XML_EXTERNAL_PARAMETER_ENTITY as i32 as u32 {
            ...
            if (unsafe { ((*(*ctxt).input).end).offset_from((*(*ctxt).input).cur) }) as i64
                >= 4 as i32 as i64
            {
                start[0 as i32 as usize] = unsafe { *(*(*ctxt).input).cur };
                ...
                start[2 as i32 as usize] =
                    unsafe { *((*(*ctxt).input).cur).offset(2 as i32 as isize) };
...
pub extern "C" fn xmlParseDocTypeDecl(mut ctxt: *mut crate::src::HTMLparser::_xmlParserCtxt) {
    ...
    *fresh345 = ExternalID;
    ...
    {
        (unsafe {
            ((*(*ctxt).sax).internalSubset).expect("non-null function pointer")(
                (*ctxt).userData,
                name,
                ExternalID,
                URI,
...
extern "C" fn xmlParseInternalSubset(mut ctxt: *mut crate::src::HTMLparser::_xmlParserCtxt) {
    if (unsafe { *(*(*ctxt).input).cur }) as i32 == '[' as i32 {
        ...
        xmlNextChar(ctxt);
        while ((unsafe { *(*(*ctxt).input).cur }) as i32 != ']' as i32
            || (unsafe { (*ctxt).inputNr }) > baseInputNr)
            && (unsafe { (*ctxt).instate }) as i32 != XML_PARSER_EOF as i32
        {
            let mut id: i32 = unsafe { (*(*ctxt).input).id };
            let mut cons: u64 = (unsafe { (*(*ctxt).input).consumed }).wrapping_add(
...
pub extern "C" fn xmlParseAttribute<'a1>(
    ...
    *(borrow_mut(&mut value)).unwrap() = 0 as *mut xmlChar;
    ...
    {
        if (unsafe { xmlStrEqual(val, b"default\0" as *const u8 as *const i8 as *mut xmlChar) })
            != 0
        {
            (unsafe { *(*ctxt).space = 0 as i32 });
        } else if (unsafe {
            xmlStrEqual(val, b"preserve\0" as *const u8 as *const i8 as *mut xmlChar)
        }) != 0
        {
            (unsafe { *(*ctxt).space = 1 as i32 });
        } else {
...
pub extern "C" fn xmlParseStartTag(
    ...
    *fresh347 = unsafe { (*fresh347).offset(1) };
                    ...
                    match current_block {
                        ...
                        _ => {
                            ...
                            *fresh354 = 0 as *const xmlChar;
                            let fresh355 =
                                unsafe { &mut (*atts.offset((nbatts + 1 as i32) as isize)) };
        ...
        && (unsafe { (*ctxt).disableSAX }) == 0
    {
        if nbatts > 0 as i32 {
            (unsafe {
                ((*(*ctxt).sax).startElement).expect("non-null function pointer")(
                    (*ctxt).userData,
                    name,
                    atts,
                )
    ...
    if !atts.is_null() {
        ...
        while i < nbatts {
            if !(unsafe { *atts.offset(i as isize) }).is_null() {
                (unsafe {
                    xmlFree.expect("non-null function pointer")(*atts.offset(i as isize)
                        as *mut xmlChar
                        as *mut libc::c_void)
                });
            }
...
extern "C" fn xmlParseEndTag1(
    ...
    *fresh356 = unsafe { (*fresh356).offset(2 as i32 as isize) };
    ...
    {
        (unsafe {
            ((*(*ctxt).sax).endElement).expect("non-null function pointer")(
                (*ctxt).userData,
                (*ctxt).name,
            )
        });
    ...
    if (unsafe { *(*(*ctxt).input).cur }) as i32 == ':' as i32 {
        ...
        if l.is_null() {
            ...
            if l.is_null() {
                ...
                (unsafe {
                    xmlFree.expect("non-null function pointer")(l as *mut i8 as *mut libc::c_void)
                });
            }
    ...
    if (unsafe { *cmp }) as i32 == 0 as i32 && (unsafe { *in_0 }) as i32 == ':' as i32 {
                    ...
                    || (unsafe { *in_0 }) as i32 == 0xd as i32))
        {
            ...
            *fresh359 = (*fresh359 as i64
                + (unsafe { in_0.offset_from((*(*ctxt).input).cur) }) as i64)
                as i32;
...
extern "C" fn xmlParseAttValueInternal<'a1, 'a2>(
    ...
    if normalize != 0 {
            ...
            && (unsafe { *in_0 }) as i32 != '<' as i32
        {
            ...
            in_0 = unsafe { in_0.offset(1) };
            if (unsafe { *fresh362 }) as i32 == 0x20 as i32
                && (unsafe { *in_0 }) as i32 == 0x20 as i32
            {
                break;
            }
    ...
    match current_block {
        ...
        _ => {
            ...
            if !borrow(&len).is_none() {
                *(borrow_mut(&mut len)).unwrap() =
                    (unsafe { last.offset_from(start) }) as i64 as i32;
...
extern "C" fn xmlParseAttribute2<'a1, 'a2, 'a3, 'a4>(
    ...
    *(borrow_mut(&mut value)).unwrap() = 0 as *mut xmlChar;
    ...
    if *(borrow(&prefix)).unwrap() == (unsafe { (*ctxt).str_xml }) {
        if (unsafe { (*ctxt).pedantic }) != 0
            && (unsafe { xmlStrEqual(name, b"lang\0" as *const u8 as *const i8 as *mut xmlChar) })
                != 0
        {
        ...
        9587810615301548814 => {
            if (unsafe { (*(*ctxt).input).id }) != inputid {
                ...
                if !(unsafe { (*ctxt).attsDefault }).is_null() {
                    ...
                    defaults = xmlHashLookup2(unsafe { (*ctxt).attsDefault }, localname, prefix)
                        as xmlDefAttrsPtr;
                    if !defaults.is_null() {
                        i = 0 as i32;
                        loop {
                            ...
                            if attname == (unsafe { (*ctxt).str_xmlns }) && aprefix.is_null() {
                                ...
                                if !(j < nbatts) {
                                    ...
                                    nbatts = nbatts + 1;
                                    let fresh383 =
                                        unsafe { &mut (*atts.offset(fresh382 as isize)) };
                                    *fresh383 = attname;
                                    let mut fresh384 = nbatts;
                                    nbatts = nbatts + 1;
                                    let fresh385 =
                                        unsafe { &mut (*atts.offset(fresh384 as isize)) };
                                    *fresh385 = aprefix;
                                    if aprefix.is_null() {
                                        let mut fresh386 = nbatts;
                                        nbatts = nbatts + 1;
                                        let fresh387 =
                                            unsafe { &mut (*atts.offset(fresh386 as isize)) };
                                        *fresh387 = 0 as *const xmlChar;
                                    } else {
                                        let mut fresh388 = nbatts;
                                        nbatts = nbatts + 1;
                                        let fresh389 =
                                            unsafe { &mut (*atts.offset(fresh388 as isize)) };
                                        *fresh389 = xmlGetNamespace(ctxt, aprefix);
                                    }
                                    let mut fresh390 = nbatts;
                                    nbatts = nbatts + 1;
                                    let fresh391 =
                                        unsafe { &mut (*atts.offset(fresh390 as isize)) };
                                    *fresh391 = *crate::__laertes_array::Get::<&_>::get_offset(
                                    ...
                                    nbatts = nbatts + 1;
                                    let fresh393 =
                                        unsafe { &mut (*atts.offset(fresh392 as isize)) };
                    ...
                    _ => {
                        ...
                        while i < nbatts {
                            if !(unsafe { *atts.offset((i + 1 as i32) as isize) }).is_null() {
                                ...
                                let fresh394 =
                                    unsafe { &mut (*atts.offset((i + 2 as i32) as isize)) };
                                *fresh394 = nsname;
                            } else {
                            ...
                            j = 0 as i32;
                            while j < i {
                                if (unsafe { *atts.offset(i as isize) })
                                    == (unsafe { *atts.offset(j as isize) })
                                {
                                        ...
                                        == (unsafe { *atts.offset((j + 1 as i32) as isize) })
                                    {
                                        ...
                                        && (unsafe { *atts.offset((j + 2 as i32) as isize) })
                                            == nsname
                                    {
                                        xmlNsErr(
                                            ctxt,
...
extern "C" fn xmlParseEndTag2<'a1>(
    ...
    *fresh395 = unsafe { (*fresh395).offset(2 as i32 as isize) };
    ...
    {
        (unsafe {
            ((*(*ctxt).sax).endElementNs).expect("non-null function pointer")(
                (*ctxt).userData,
                (*ctxt).name,
                (*((tag).clone()).unwrap()).prefix,
    ...
    *fresh411 = unsafe { (*fresh411).offset(l as isize) };
    if !(unsafe { (*ctxt).sax }).is_null() && (unsafe { (*ctxt).disableSAX }) == 0 {
        if unsafe { ((*(*ctxt).sax).cdataBlock).is_some() } {
            (unsafe {
                ((*(*ctxt).sax).cdataBlock).expect("non-null function pointer")(
                    (*ctxt).userData,
                    buf,
                    len,
                )
...
pub extern "C" fn xmlParseContent(mut ctxt: *mut crate::src::HTMLparser::_xmlParserCtxt) {
    ...
    if (unsafe { (*ctxt).instate }) as i32 != XML_PARSER_EOF as i32
        && (unsafe { (*ctxt).nameNr }) > nameNr
    {
        let mut name: *const u8 =
            unsafe { *((*ctxt).nameTab).offset(((*ctxt).nameNr - 1 as i32) as isize) };
        let mut line: i32 =
            unsafe { (*((*ctxt).pushTab).offset(((*ctxt).nameNr - 1 as i32) as isize)).line };
        xmlFatalErrMsgStrIntStr(
            ctxt,
...
pub extern "C" fn xmlParseDocument(mut ctxt: *mut crate::src::HTMLparser::_xmlParserCtxt) -> i32 {
    ...
    xmlDetectSAX2(ctxt);
    if !(unsafe { (*ctxt).sax }).is_null()
        && (unsafe { ((*(*ctxt).sax).setDocumentLocator).is_some() })
    {
        (unsafe {
            ((*(*ctxt).sax).setDocumentLocator).expect("non-null function pointer")(
                (*ctxt).userData,
            ...
            >= 4 as i32 as i64
    {
        ...
        enc = xmlDetectCharEncoding(
            unsafe { &mut *start.as_mut_ptr().offset(0 as i32 as isize) },
            4 as i32,
        );
        if enc as i32 != XML_CHAR_ENCODING_NONE as i32 {
            xmlSwitchEncoding(ctxt, enc);
            ...
            == 'E' as i32
    {
        ...
        {
            (unsafe {
                ((*(*ctxt).sax).externalSubset).expect("non-null function pointer")(
                    (*ctxt).userData,
                    (*ctxt).intSubName,
                    (*ctxt).extSubSystem,
                    (*ctxt).extSubURI,
        ...
        if tmp < (unsafe { (*(*ctxt).input).base }) {
            ...
            *(borrow_mut(&mut lastlt)).unwrap() = tmp;
            ...
            while tmp < (unsafe { (*(*ctxt).input).end }) && (unsafe { *tmp }) as i32 != '>' as i32
            {
                if (unsafe { *tmp }) as i32 == '\'' as i32 {
                    tmp = unsafe { tmp.offset(1) };
                    while tmp < (unsafe { (*(*ctxt).input).end })
                        && (unsafe { *tmp }) as i32 != '\'' as i32
                    {
                        tmp = unsafe { tmp.offset(1) };
                    }
            ...
            if tmp < (unsafe { (*(*ctxt).input).end }) {
                *(borrow_mut(&mut lastgt)).unwrap() = tmp;
                ...
                tmp = unsafe { tmp.offset(-1) };
                while tmp >= (unsafe { (*(*ctxt).input).base })
                    && (unsafe { *tmp }) as i32 != '>' as i32
                {
                    tmp = unsafe { tmp.offset(-1) };
                }
...
extern "C" fn xmlCheckCdataPush(mut utf: *const u8, mut len: i32, mut complete: i32) -> i32 {
    ...
    while ix < len {
        ...
        if c as i32 & 0x80 as i32 == 0 as i32 {
            ...
            if (unsafe { *utf.offset((ix + 1 as i32) as isize) }) as i32 & 0xc0 as i32
                != 0x80 as i32
            {
                return -ix;
            }
            ...
            if (unsafe { *utf.offset((ix + 1 as i32) as isize) }) as i32 & 0xc0 as i32
                != 0x80 as i32
                || (unsafe { *utf.offset((ix + 2 as i32) as isize) }) as i32 & 0xc0 as i32
                    != 0x80 as i32
            {
                return -ix;
            }
            ...
            if (unsafe { *utf.offset((ix + 1 as i32) as isize) }) as i32 & 0xc0 as i32
                ...
                || (unsafe { *utf.offset((ix + 2 as i32) as isize) }) as i32 & 0xc0 as i32
                    != 0x80 as i32
                || (unsafe { *utf.offset((ix + 3 as i32) as isize) }) as i32 & 0xc0 as i32
                    != 0x80 as i32
            {
                return -ix;
            }
...
extern "C" fn xmlParseTryOrFinish(
    ...
    loop {
        ...
        if (unsafe { (*ctxt).errNo }) != XML_ERR_OK as i32
            && (unsafe { (*ctxt).disableSAX }) == 1 as i32
        {
            return 0 as i32;
        }
        ...
        match (unsafe { (*ctxt).instate }) as i32 {
            ...
            0 => {
                if (unsafe { (*ctxt).charset }) == XML_CHAR_ENCODING_NONE as i32 {
                    ...
                    if cur as i32 == 0 as i32 {
                        ...
                        xmlHaltParser(ctxt);
                        if !(unsafe { (*ctxt).sax }).is_null()
                            && (unsafe { ((*(*ctxt).sax).endDocument).is_some() })
                        {
                            (unsafe {
                                ((*(*ctxt).sax).endDocument).expect("non-null function pointer")(
                                    (*ctxt).userData,
                                )
                            });
                        }
                        ...
                        if (unsafe { *((*(*ctxt).input).cur).offset(2 as i32 as isize) }) as i32
                            == 'x' as i32
                                    ...
                                    == 0xd as i32)
                        {
                            ...
                            *fresh440 =
                                unsafe { xmlCharStrdup(b"1.0\0" as *const u8 as *const i8) };
                            if !(unsafe { (*ctxt).sax }).is_null()
                                && (unsafe { ((*(*ctxt).sax).startDocument).is_some() })
                                && (unsafe { (*ctxt).disableSAX }) == 0
                            {
            ...
            8 => {
                ...
                if base_0 < 0 as i32 {
                    ...
                    let mut tmp: i32 = 0;
                    tmp =
                        xmlCheckCdataPush(unsafe { (*(*ctxt).input).cur }, 300 as i32, 0 as i32);
                    if tmp < 0 as i32 {
                        tmp = -tmp;
            ...
            3 => {
                ...
                let mut use_0: u64 = 0;
                base_1 = (unsafe { ((*(*ctxt).input).cur).offset_from((*(*ctxt).input).base) })
                    as i64 as i32;
                if base_1 < 0 as i32 {
                    return 0 as i32;
                }
                    ...
                    if quote as i32 != 0 as i32 {
                            ...
                            && (unsafe { *buf.offset(base_1 as isize) }) as i32 == '<' as i32
                        {
                            ...
                            if ((base_1 as u32).wrapping_add(4 as i32 as u32) as u64) < use_0
                                ...
                                && (unsafe { *buf.offset((base_1 + 2 as i32) as isize) }) as i32
                                    == '-' as i32
                                && (unsafe { *buf.offset((base_1 + 3 as i32) as isize) }) as i32
                                    == '-' as i32
                            {
                                while ((base_1 as u32).wrapping_add(3 as i32 as u32) as u64) < use_0
                                {
                                    if (unsafe { *buf.offset(base_1 as isize) }) as i32
                                        == '-' as i32
                                        && (unsafe { *buf.offset((base_1 + 1 as i32) as isize) })
                                            as i32
                                            == '-' as i32
                                        && (unsafe { *buf.offset((base_1 + 2 as i32) as isize) })
                                            as i32
                                            == '>' as i32
                                    {
                                        found = 1 as i32;
                        ...
                        match current_block {
                            ...
                            _ => {
                                ...
                                } else if (unsafe { *buf.offset(base_1 as isize) }) as i32
                                    == '\'' as i32
                                {
                                    quote = '\'' as i32 as xmlChar;
                                } else if (unsafe { *buf.offset(base_1 as isize) }) as i32
                                    == ']' as i32
                                {
                                        ...
                                        == ']' as i32
                                    {
                                        ...
                                        loop {
                                            ...
                                            if (unsafe { *buf.offset((base_1 + i) as isize) })
                                                as i32
                                                == '>' as i32
                                            {
                                                ...
                                                || 0x9 as i32
                                                    ...
                                                    && (unsafe {
                                                        *buf.offset((base_1 + i) as isize)
                                                        ...
                                                        as i32
                                                        <= 0xa as i32
                                                || (unsafe { *buf.offset((base_1 + i) as isize) })
                                                    as i32
                                                    == 0xd as i32)
                                            {
                                                break;
            ...
            && (unsafe { (*ctxt).instate }) as i32 != XML_PARSER_EOF as i32
        {
                ...
                && !(unsafe { (*(*(*ctxt).input).buf).encoder }).is_null()
            {
                ...
                if (unsafe { (*(*(*ctxt).input).buf).rawconsumed }) < len as u64 {
                    len = (len as u64)
                        .wrapping_sub(unsafe { (*(*(*ctxt).input).buf).rawconsumed })
                        as u32 as u32;
                }
                if size as u32 > len {
                ...
                && !(unsafe { (*(*ctxt).input).buf }).is_null()
            {
                    ...
                    && !(unsafe { (*in_0).raw }).is_null()
                {
                    ...
                    let mut base_0: u64 =
                        xmlBufGetInputBase(unsafe { (*in_0).buffer }, unsafe { (*ctxt).input });
                    let mut current: u64 =
                        (unsafe { ((*(*ctxt).input).cur).offset_from((*(*ctxt).input).base) })
                            as i64 as size_t;
        ...
        if remain != 0 as i32 {
            ...
            if terminate != 0
                ...
                || xmlParseCheckTransition(
                    ctxt,
                    (unsafe { &*((*(*ctxt).input).base).offset(old_avail as isize) })
...
pub extern "C" fn xmlCreatePushParserCtxt(
    ...
    *fresh460 = buf;
    ...
    } else if !(unsafe { (*ctxt).input }).is_null()
        && !(unsafe { (*(*ctxt).input).buf }).is_null()
    {
        let mut base: u64 = xmlBufGetInputBase(
            unsafe { (*(*(*ctxt).input).buf).buffer },
...
pub extern "C" fn xmlSAXParseDTD(
    ...
    if !(unsafe { (*ctxt).sax }).is_null()
        && (unsafe { ((*(*ctxt).sax).resolveEntity).is_some() })
    {
        input = unsafe {
            ((*(*ctxt).sax).resolveEntity).expect("non-null function pointer")(
                (*ctxt).userData,
                ExternalID,
                systemIdCanonic,
            )
...
extern "C" fn xmlParseExternalEntityPrivate<'a1>(
    ...
    if depth > 40 as i32
        && (oldctxt.is_null()
            || (unsafe { (*oldctxt).options }) & XML_PARSE_HUGE as i32 == 0 as i32)
        || depth > 1024 as i32
    {
    ...
    *fresh499 = ctxt as *mut libc::c_void;
    ...
    if !(unsafe { (*ctxt).input }).is_null() && !oldctxt.is_null() {
        ...
        *fresh528 = (*fresh528).wrapping_add(
            (unsafe { ((*(*ctxt).input).cur).offset_from((*(*ctxt).input).base) }) as i64 as u64,
        );
    }
    if !oldctxt.is_null() && (unsafe { (*ctxt).lastError.code }) != XML_ERR_OK as i32 {
        xmlCopyError(
            unsafe { &mut (*ctxt).lastError },
            unsafe { &mut (*oldctxt).lastError },
        );
    }
    if !sax.is_null() {
...
extern "C" fn xmlParseBalancedChunkMemoryInternal<'a1>(
    ...
    let mut ret: u32 = XML_ERR_OK;
    let mut i: i32 = 0;
    if (unsafe { (*oldctxt).depth }) > 40 as i32
        && (unsafe { (*oldctxt).options }) & XML_PARSE_HUGE as i32 == 0 as i32
...
pub extern "C" fn xmlCtxtReset(mut ctxt: *mut crate::src::HTMLparser::_xmlParserCtxt) {
    ...
    *fresh638 = 0 as *const xmlChar;
    if !(unsafe { (*ctxt).directory }).is_null()
        && (dict.is_null()
            || xmlDictOwns(dict, (unsafe { (*ctxt).directory }) as *const xmlChar) == 0 as i32)
    {
        (unsafe {
    ...
    *fresh639 = 0 as *mut i8;
    if !(unsafe { (*ctxt).extSubURI }).is_null()
        && (dict.is_null()
            || xmlDictOwns(dict, (unsafe { (*ctxt).extSubURI }) as *const xmlChar) == 0 as i32)
    {
        (unsafe {
            xmlFree.expect("non-null function pointer")(
    ...
    *fresh640 = 0 as *mut xmlChar;
    if !(unsafe { (*ctxt).extSubSystem }).is_null()
        && (dict.is_null()
            || xmlDictOwns(dict, (unsafe { (*ctxt).extSubSystem }) as *const xmlChar) == 0 as i32)
    {
        (unsafe {
            xmlFree.expect("non-null function pointer")(
...
pub extern "C" fn xmlReadIO(
    ...
    xmlInitParser();
    input =
        unsafe { xmlParserInputBufferCreateIO(ioread, ioclose, ioctx, XML_CHAR_ENCODING_NONE) };
    if input.is_null() {
        if ioclose.is_some() {
            (unsafe { ioclose.expect("non-null function pointer")(ioctx) });
        }
