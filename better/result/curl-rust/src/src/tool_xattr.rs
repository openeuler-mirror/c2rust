...
extern "C" fn stripcredentials<'a1>(mut url: Option<&'a1 mut *mut i8>) -> bool {
    ...
    if !u.is_null() {
        ...
        if !(uc as u64 != 0) {
            ...
            if !(uc as u64 != 0) {
                ...
                if !(uc as u64 != 0) {
                    uc = curl_url_get(u, CURLUPART_URL, Some(&mut nurl), 0 as i32 as u32);
                    if !(uc as u64 != 0) {
                        curl_url_cleanup(u);
