...
#[no_mangle]
pub static mut easysrc_decl: *mut crate::src::src::slist_wc::slist_wc =
    0 as *const slist_wc as *mut slist_wc;
#[no_mangle]
pub static mut easysrc_data: *mut crate::src::src::slist_wc::slist_wc =
    0 as *const slist_wc as *mut slist_wc;
#[no_mangle]
pub static mut easysrc_code: *mut crate::src::src::slist_wc::slist_wc =
    0 as *const slist_wc as *mut slist_wc;
#[no_mangle]
pub static mut easysrc_toohard: *mut crate::src::src::slist_wc::slist_wc =
    0 as *const slist_wc as *mut slist_wc;
#[no_mangle]
pub static mut easysrc_clean: *mut crate::src::src::slist_wc::slist_wc =
    0 as *const slist_wc as *mut slist_wc;
#[no_mangle]
...
extern "C" fn easysrc_free() {
    slist_wc_free_all(unsafe { easysrc_decl });
    (unsafe { easysrc_decl = 0 as *mut slist_wc });
    slist_wc_free_all(unsafe { easysrc_data });
    (unsafe { easysrc_data = 0 as *mut slist_wc });
    slist_wc_free_all(unsafe { easysrc_code });
    (unsafe { easysrc_code = 0 as *mut slist_wc });
    slist_wc_free_all(unsafe { easysrc_toohard });
    (unsafe { easysrc_toohard = 0 as *mut slist_wc });
    slist_wc_free_all(unsafe { easysrc_clean });
    (unsafe { easysrc_clean = 0 as *mut slist_wc });
}
#[no_mangle]
pub extern "C" fn easysrc_add<'a1>(
    mut plist: Option<&'a1 mut *mut crate::src::src::slist_wc::slist_wc>,
    mut line: *const i8,
) -> u32 {
    let mut ret: u32 = CURLE_OK;
    let mut list: *mut crate::src::src::slist_wc::slist_wc =
        slist_wc_append(*(borrow_mut(&mut plist)).unwrap(), line);
    if list.is_null() {
        easysrc_free();
...
#[no_mangle]
pub extern "C" fn easysrc_init() -> u32 {
    let mut ret: u32 = easysrc_add(
        Some(unsafe { &mut easysrc_code }),
...
#[no_mangle]
pub extern "C" fn easysrc_perform() -> u32 {
    if !(unsafe { easysrc_toohard }).is_null() {
        ...
        let mut ret: u32 = easysrc_add(Some(unsafe { &mut easysrc_code }), b"\0" as *const u8 as *const i8);
        if ret as u64 != 0 {
            return ret;
        }
        i = 0 as i32;
        loop {
            ...
            let mut ret_0: u32 = easysrc_add(Some(unsafe { &mut easysrc_code }), c);
            if ret_0 as u64 != 0 {
                return ret_0;
            }
            i += 1;
        ...
        if !(unsafe { easysrc_toohard }).is_null() {
            ...
            while !ptr.is_null() {
                let mut ret_1: u32 = easysrc_add(Some(unsafe { &mut easysrc_code }), unsafe { (*ptr).data });
                if ret_1 as u64 != 0 {
                    return ret_1;
                }
                ptr = unsafe { (*ptr).next };
        ...
        let mut ret_2: u32 = easysrc_add(Some(unsafe { &mut easysrc_code }), b"\0" as *const u8 as *const i8);
        if ret_2 as u64 != 0 {
            return ret_2;
        }
        let mut ret_3: u32 =
            easysrc_add(Some(unsafe { &mut easysrc_code }), b"*/\0" as *const u8 as *const i8);
        if ret_3 as u64 != 0 {
            return ret_3;
        }
        slist_wc_free_all(unsafe { easysrc_toohard });
    ...
    let mut ret_4: u32 = easysrc_add(Some(unsafe { &mut easysrc_code }), b"\0" as *const u8 as *const i8);
    if ret_4 as u64 != 0 {
        return ret_4;
    }
    ...
    let mut ret_6: u32 = easysrc_add(Some(unsafe { &mut easysrc_code }), b"\0" as *const u8 as *const i8);
    if ret_6 as u64 != 0 {
        return ret_6;
    }
    return CURLE_OK;
...
#[no_mangle]
pub extern "C" fn easysrc_cleanup() -> u32 {
    let mut ret: u32 = easysrc_add(
        Some(unsafe { &mut easysrc_code }),
...
#[no_mangle]
pub extern "C" fn dumpeasysrc(mut config: *mut crate::src::src::tool_cb_dbg::GlobalConfig) {
    let mut ptr: *mut crate::src::lib::http2::curl_slist = 0 as *mut curl_slist;
