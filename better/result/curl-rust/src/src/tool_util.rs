...
#[no_mangle]
pub extern "C" fn tvnow() -> crate::src::lib::openldap::timeval {
...
#[no_mangle]
pub extern "C" fn tvdiff(
    mut newer: crate::src::lib::openldap::timeval,
    mut older: crate::src::lib::openldap::timeval,
) -> i64 {
