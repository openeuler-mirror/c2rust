...
#[no_mangle]
pub extern "C" fn Curl_urldecode<'a1, 'a2>(
    ...
    loop {
        ...
        if '%' as i32 == in_0 as i32
            ...
            && Curl_isxdigit((unsafe { *string.offset(1 as i32 as isize) }) as u8 as i32) != 0
            && Curl_isxdigit((unsafe { *string.offset(2 as i32 as isize) }) as u8 as i32) != 0
        {
...
#[no_mangle]
pub extern "C" fn curl_easy_unescape<'a1>(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    mut string: *const i8,
    mut length: i32,
...
#[no_mangle]
pub extern "C" fn curl_free(mut p: *mut core::ffi::c_void) {
