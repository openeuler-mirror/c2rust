...
pub extern "C" fn curl_version() -> *mut i8 {
    ...
    j = 0 as i32;
    while j < i {
        let mut n: u64 = unsafe { strlen(src[j as usize]) };
...
#[no_mangle]
pub extern "C" fn curl_version_info<'a1>(
    mut _stamp: u32,
) -> *mut crate::src::lib::version::curl_version_info_data<'a1>
where
    'a1: 'static,
{
    static mut ssl_buffer: [i8; 80] = [0; 80];
    Curl_ssl_version(
        unsafe { ssl_buffer.as_mut_ptr() },
