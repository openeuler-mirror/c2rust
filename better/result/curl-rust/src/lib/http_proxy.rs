...
extern "C" fn https_proxy_connect(
    ...
    if !(unsafe { (*conn).bits.proxy_ssl_connected[sockindex as usize] }) {
        result = Curl_ssl_connect_nonblocking(
            ...
            1 as i32 != 0,
            sockindex,
            unsafe { &mut *((*conn).bits.proxy_ssl_connected)
                .as_mut_ptr()
...
pub extern "C" fn Curl_proxy_connect(
    ...
    if (unsafe { ((*conn).bits).tunnel_proxy() }) as i32 != 0 && (unsafe { ((*conn).bits).httpproxy() }) as i32 != 0 {
        ...
        let mut fresh0 = unsafe { &mut ((*data).state.aptr.proxyuserpwd) };
        *fresh0 = 0 as *mut i8;
    }
    return CURLE_OK;
}
#[no_mangle]
pub extern "C" fn Curl_connect_complete(
    mut conn: *mut crate::src::lib::http2::connectdata,
) -> bool {
    return (unsafe { (*conn).connect_state }).is_null()
        || (unsafe { (*(*conn).connect_state).tunnel_state }) as u32 >= TUNNEL_COMPLETE as i32 as u32;
}
#[no_mangle]
pub extern "C" fn Curl_connect_ongoing(mut conn: *mut crate::src::lib::http2::connectdata) -> bool {
    return !(unsafe { (*conn).connect_state }).is_null()
        && (unsafe { (*(*conn).connect_state).tunnel_state }) as u32 <= TUNNEL_COMPLETE as i32 as u32;
}
#[no_mangle]
pub extern "C" fn Curl_connect_getsock(mut conn: *mut crate::src::lib::http2::connectdata) -> i32 {
    let mut http: Option<&'_ mut crate::src::lib::http2::HTTP> =
        Option::<&'_ mut crate::src::lib::http2::HTTP>::None;
    http = Some(unsafe { &mut (*(*conn).connect_state).http_proxy });
...
extern "C" fn connect_init(
    ...
    if !reinit {
        ...
        s = (unsafe { Curl_ccalloc.expect("non-null function pointer")(
            1 as i32 as size_t,
        ...
        let mut fresh1 = unsafe { &mut ((*conn).connect_state) };
        *fresh1 = s;
        Curl_dyn_init(unsafe { &mut (*s).rcvbuf }, 16384 as i32 as size_t);
        let mut fresh2 = unsafe { &mut ((*s).prot_save) };
        *fresh2 = unsafe { (*data).req.p.http };
        let mut fresh3 = unsafe { &mut ((*data).req.p.http) };
        *fresh3 = unsafe { &mut (*s).http_proxy };
        Curl_conncontrol(conn, 0 as i32);
    } else {
        s = unsafe { (*conn).connect_state };
        Curl_dyn_reset(Some(unsafe { &mut (*s).rcvbuf }));
    }
    (unsafe { (*s).tunnel_state = TUNNEL_INIT });
    (unsafe { (*s).keepon = KEEPON_CONNECT });
    (unsafe { (*s).cl = 0 as i32 as curl_off_t });
    (unsafe { (*s).set_close_connection(0 as i32 as bit) });
    return CURLE_OK;
}
extern "C" fn connect_done(mut data: *mut crate::src::lib::http2::Curl_easy) {
    let mut conn: *mut crate::src::lib::http2::connectdata = unsafe { (*data).conn };
    let mut s: *mut crate::src::lib::ftp::http_connect_state = unsafe { (*conn).connect_state };
    if (unsafe { (*s).tunnel_state }) as u32 != TUNNEL_EXIT as i32 as u32 {
        (unsafe { (*s).tunnel_state = TUNNEL_EXIT });
        Curl_dyn_free(unsafe { &mut (*s).rcvbuf });
        Curl_dyn_free(unsafe { &mut (*s).req });
        let mut fresh4 = unsafe { &mut ((*data).req.p.http) };
        *fresh4 = unsafe { (*s).prot_save };
        let mut fresh5 = unsafe { &mut ((*s).prot_save) };
...
extern "C" fn CONNECT_host<'a1, 'a2>(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    mut conn: *mut crate::src::lib::http2::connectdata,
    ...
    if hostname != (unsafe { (*conn).host.name }) as *const i8 {
    ...
    if (Curl_checkProxyheaders(data, conn, b"Host\0" as *const u8 as *const i8)).is_null() {
        host = unsafe { curl_maprintf(b"Host: %s\r\n\0" as *const u8 as *const i8, hostheader) };
        if host.is_null() {
...
extern "C" fn CONNECT(
    ...
    let mut result: u32 = CURLE_OK;
    let mut conn: *mut crate::src::lib::http2::connectdata = unsafe { (*data).conn };
    let mut tunnelsocket: i32 = unsafe { (*conn).sock[sockindex as usize] };
    let mut s: *mut crate::src::lib::ftp::http_connect_state = unsafe { (*conn).connect_state };
    ...
    loop {
        let mut check: i64 = 0;
        if TUNNEL_INIT as i32 as u32 == (unsafe { (*s).tunnel_state }) as u32 {
            let mut req: *mut crate::src::lib::http2::dynbuf = unsafe { &mut (*s).req };
            let mut hostheader: *mut i8 = 0 as *mut i8;
            let mut host: *mut i8 = 0 as *mut i8;
            (unsafe { Curl_infof(
                data,
                b"Establish HTTP proxy tunnel to %s:%d\0" as *const u8 as *const i8,
                hostname,
                remote_port,
            ) });
            ...
            *fresh7 = 0 as *mut i8;
            ...
            if result as u64 == 0 {
                let mut httpv: *const i8 =
                    if (unsafe { (*conn).http_proxy.proxytype }) as u32 == CURLPROXY_HTTP_1_0 as i32 as u32 {
                ...
                if result as u64 != 0 {
                    (unsafe { Curl_failf(
                        data,
                        b"Failed sending CONNECT to proxy\0" as *const u8 as *const i8,
                    ) });
                }
            }
            ...
            (unsafe { (*s).tunnel_state = TUNNEL_CONNECT });
        }
        check = Curl_timeleft(
            data,
        ...
        if check <= 0 as i32 as i64 {
            (unsafe { Curl_failf(
                data,
                b"Proxy CONNECT aborted due to timeout\0" as *const u8 as *const i8,
            ) });
            return CURLE_OPERATION_TIMEDOUT;
        }
        if !Curl_conn_data_pending(conn, sockindex) && (unsafe { (*http).sending }) as u64 == 0 {
            return CURLE_OK;
        }
        if (unsafe { (*http).sending }) as u32 == HTTPSEND_REQUEST as i32 as u32 {
            ...
            if (unsafe { (*s).nsend }) != 0 {
                ...
                let mut fresh9 = unsafe { &mut ((*s).nsend) };
                *fresh9 = (*fresh9 as u64).wrapping_sub(bytes_written as u64) as size_t as size_t;
                let mut fresh10 = &mut ((*(borrow_mut(&mut k)).unwrap()).upload_fromhere);
                *fresh10 = unsafe { (*fresh10).offset(bytes_written as isize) };
                return result;
            }
        ...
        while (unsafe { (*s).keepon }) as u64 != 0 {
            ...
            if result as u64 != 0 {
                ...
                {
                    let mut fresh11 = unsafe { &mut ((*conn).bits) };
                    (*fresh11).set_proxy_connect_closed(1 as i32 as bit);
                    (unsafe { Curl_infof(
                        data,
                        b"Proxy CONNECT connection closed\0" as *const u8 as *const i8,
                    ) });
                } else {
                    error = 1 as i32;
                    (unsafe { Curl_failf(data, b"Proxy CONNECT aborted\0" as *const u8 as *const i8) });
                }
                (unsafe { (*s).keepon = KEEPON_DONE });
                break;
            } else if (unsafe { (*s).keepon }) as u32 == KEEPON_IGNORE as i32 as u32 {
                if (unsafe { (*s).cl }) != 0 {
                    let mut fresh12 = unsafe { &mut ((*s).cl) };
                    *fresh12 -= 1;
                    if !((unsafe { (*s).cl }) <= 0 as i32 as i64) {
                        continue;
                    }
                    (unsafe { (*s).keepon = KEEPON_DONE });
                    ...
                    if r as i32 == CHUNKE_STOP as i32 {
                        (unsafe { Curl_infof(data, b"chunk reading DONE\0" as *const u8 as *const i8) });
                        (unsafe { (*s).keepon = KEEPON_DONE });
                        (unsafe { (*s).tunnel_state = TUNNEL_COMPLETE });
                    }
                }
                    ...
                    != 0
                {
                    (unsafe { Curl_failf(
                        data,
                        b"CONNECT response too large!\0" as *const u8 as *const i8,
                    ) });
                ...
                linep = Curl_dyn_ptr(unsafe { &mut (*s).rcvbuf });
                perline = Curl_dyn_len(unsafe { &mut (*s).rcvbuf });
                result = CURLE_OK as i32 as CURLcode;
                if result as u64 != 0 {
                    return result;
                }
                Curl_debug(data, CURLINFO_HEADER_IN, linep, perline);
                if (unsafe { ((*data).set).suppress_connect_headers() }) == 0 {
                ...
                let mut fresh13 = unsafe { &mut ((*data).info.header_size) };
                *fresh13 += perline as i64;
                if '\r' as i32 == (unsafe { *linep.offset(0 as i32 as isize) }) as i32
                    || '\n' as i32 == (unsafe { *linep.offset(0 as i32 as isize) }) as i32
                {
                    if 407 as i32 == (*(borrow(&k)).unwrap()).httpcode
                        && (unsafe { ((*data).state).authproblem() }) == 0
                    {
                        (unsafe { (*s).keepon = KEEPON_IGNORE });
                        if (unsafe { (*s).cl }) != 0 {
                            (unsafe { Curl_infof(
                                data,
                                b"Ignore %ld bytes of response-body\0" as *const u8 as *const i8,
                                (*s).cl,
                            ) });
                        } else if (unsafe { (*s).chunked_encoding() }) != 0 {
                            let mut r_0: i32 = CHUNKE_OK;
                            let mut extra_0: u32 = CURLE_OK;
                            (unsafe { Curl_infof(
                                data,
                                b"Ignore chunked response-body\0" as *const u8 as *const i8,
                            ) });
                            (*(borrow_mut(&mut k)).unwrap()).set_ignorebody(1 as i32 as bit);
                            if (unsafe { *linep.offset(1 as i32 as isize) }) as i32 == '\n' as i32 {
                                linep = unsafe { linep.offset(1) };
                            }
                            r_0 = Curl_httpchunk_read(
                                data,
                                unsafe { linep.offset(1 as i32 as isize) },
                                1 as i32 as ssize_t,
                                &mut gotbytes,
                                Some(&mut extra_0),
                            );
                    ...
                    if (unsafe { (*s).keepon }) as u32 == KEEPON_DONE as i32 as u32 && (unsafe { (*s).cl }) == 0 {
                        (unsafe { (*s).tunnel_state = TUNNEL_COMPLETE });
                    }
                } else {
                    if curl_strnequal(
                    ...
                    ) != 0
                    {
                        if (*(borrow(&k)).unwrap()).httpcode / 100 as i32 == 2 as i32 {
                            ...
                            curlx_strtoofft(
                                unsafe { linep
                                    .offset(strlen(b"Content-Length:\0" as *const u8 as *const i8)
                                        as isize) },
                                Option::<&'_ mut *mut i8>::None,
                                10 as i32,
                                Some(unsafe { &mut (*s).cl }),
                            );
                        }
                        ...
                        (unsafe { (*s).set_close_connection(1 as i32 as bit) });
                    } else if curl_strnequal(
                    ...
                    ) != 0
                    {
                        if (*(borrow(&k)).unwrap()).httpcode / 100 as i32 == 2 as i32 {
                            ...
                            (unsafe { Curl_infof(
                                data,
                                b"CONNECT responded chunked\0" as *const u8 as *const i8,
                            ) });
                            (unsafe { (*s).set_chunked_encoding(1 as i32 as bit) });
                    ...
                    {
                        (unsafe { (*data).info.httpproxycode = (*(borrow_mut(&mut k)).unwrap()).httpcode });
                    }
                    Curl_dyn_reset(Some(unsafe { &mut (*s).rcvbuf }));
                }
            }
        ...
        if (unsafe { (*s).close_connection() }) as i32 != 0 && !(unsafe { (*data).req.newurl }).is_null() {
            Curl_closesocket(data, conn, unsafe { (*conn).sock[sockindex as usize] });
            (unsafe { (*conn).sock[sockindex as usize] = -(1 as i32) });
            break;
        } else {
            if !(unsafe { (*data).req.newurl }).is_null()
                && TUNNEL_COMPLETE as i32 as u32 == (unsafe { (*s).tunnel_state }) as u32
            {
    ...
    if (unsafe { (*data).info.httpproxycode }) / 100 as i32 != 2 as i32 {
        if (unsafe { (*s).close_connection() }) as i32 != 0 && !(unsafe { (*data).req.newurl }).is_null() {
            ...
            (unsafe { Curl_infof(data, b"Connect me again please\0" as *const u8 as *const i8) });
            connect_done(data);
        } else {
            (unsafe { Curl_cfree.expect("non-null function pointer")((*data).req.newurl as *mut libc::c_void) });
            let mut fresh15 = unsafe { &mut ((*data).req.newurl) };
            *fresh15 = 0 as *mut i8;
        ...
        (unsafe { Curl_failf(
            data,
            b"Received HTTP code %d from proxy after CONNECT\0" as *const u8 as *const i8,
            (*data).req.httpcode,
        ) });
        return CURLE_RECV_ERROR;
    }
    ...
    let mut fresh16 = unsafe { &mut ((*data).state.aptr.proxyuserpwd) };
    *fresh16 = 0 as *mut i8;
    let mut fresh17 = unsafe { &mut ((*data).state.aptr.proxyuserpwd) };
    *fresh17 = 0 as *mut i8;
    let mut fresh18 = unsafe { &mut ((*data).state.authproxy) };
    (*fresh18).set_done(1 as i32 as bit);
    let mut fresh19 = unsafe { &mut ((*data).state.authproxy) };
    ...
    let mut fresh20 = unsafe { &mut ((*data).req) };
    (*fresh20).set_ignorebody(0 as i32 as bit);
    let mut fresh21 = unsafe { &mut ((*conn).bits) };
    (*fresh21).set_rewindaftersend(0 as i32 as bit);
    Curl_dyn_free(unsafe { &mut (*s).rcvbuf });
    return CURLE_OK;
}
#[no_mangle]
pub extern "C" fn Curl_connect_free(mut data: *mut crate::src::lib::http2::Curl_easy) {
    let mut conn: *mut crate::src::lib::http2::connectdata = unsafe { (*data).conn };
    let mut s: *mut crate::src::lib::ftp::http_connect_state = unsafe { (*conn).connect_state };
    if !s.is_null() {
        (unsafe { Curl_cfree.expect("non-null function pointer")(s as *mut libc::c_void) });
        let mut fresh22 = unsafe { &mut ((*conn).connect_state) };
