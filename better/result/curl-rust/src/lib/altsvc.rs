...
extern "C" fn alpn2alpnid(mut name: *mut i8) -> u32 {
...
extern "C" fn altsvc_free(mut as_0: *mut crate::src::lib::altsvc::altsvc) {
...
extern "C" fn altsvc_createid(
    ...
    let mut as_0: *mut crate::src::lib::altsvc::altsvc = (unsafe { Curl_ccalloc
    ...
    if 9 as i32 == rc {
        ...
        if !as_0.is_null() {
            ...
            Curl_llist_insert_next(
                unsafe { &mut (*asi).list },
                unsafe { (*asi).list.tail },
                as_0 as *const libc::c_void,
                unsafe { &mut (*as_0).node },
            );
        }
    }
    return CURLE_OK;
...
extern "C" fn altsvc_load(
    ...
    let mut fresh2 = unsafe { &mut ((*asi).filename) };
    *fresh2 = unsafe { Curl_cstrdup.expect("non-null function pointer")(file) };
    ...
    if !fp.is_null() {
        ...
        if line.is_null() {
            (unsafe { Curl_cfree.expect("non-null function pointer")((*asi).filename as *mut libc::c_void) });
            let mut fresh3 = unsafe { &mut ((*asi).filename) };
            *fresh3 = 0 as *mut i8;
...
extern "C" fn altsvc_out(
    mut as_0: *mut crate::src::lib::altsvc::altsvc,
    ...
    let mut result: u32 = Curl_gmtime(unsafe { (*as_0).expires }, &mut stamp);
    if result as u64 != 0 {
        return result;
    }
...
#[no_mangle]
pub extern "C" fn Curl_altsvc_init() -> *mut crate::src::lib::altsvc::altsvcinfo {
    let mut asi: *mut crate::src::lib::altsvc::altsvcinfo = (unsafe { Curl_ccalloc
        .expect("non-null function pointer")(
    ...
    Curl_llist_init(Some(unsafe { &mut (*asi).list }), None);
    (unsafe { (*asi).flags = ((1 as i32) << 3 as i32 | (1 as i32) << 4 as i32) as i64 });
    return asi;
}
#[no_mangle]
pub extern "C" fn Curl_altsvc_load(
    mut asi: *mut crate::src::lib::altsvc::altsvcinfo,
    mut file: *const i8,
) -> u32 {
    let mut result: u32 = CURLE_OK;
...
#[no_mangle]
pub extern "C" fn Curl_altsvc_ctrl(
    mut asi: *mut crate::src::lib::altsvc::altsvcinfo,
    ctrl: i64,
) -> u32 {
    if ctrl == 0 {
...
#[no_mangle]
pub extern "C" fn Curl_altsvc_cleanup<'a1>(
    mut altsvcp: Option<&'a1 mut *mut crate::src::lib::altsvc::altsvcinfo>,
) {
    ...
    if !(*(borrow_mut(&mut altsvcp)).unwrap()).is_null() {
        let mut altsvc: *mut crate::src::lib::altsvc::altsvcinfo =
            *(borrow_mut(&mut altsvcp)).unwrap();
        e = unsafe { (*altsvc).list.head };
        while !e.is_null() {
            let mut as_0: *mut crate::src::lib::altsvc::altsvc = (unsafe { (*e).ptr }) as *mut altsvc;
            n = unsafe { (*e).next };
            altsvc_free(as_0);
            e = n;
        }
...
extern "C" fn altsvc_flush(
    ...
    while !e.is_null() {
        ...
        if srcalpnid as u32 == (unsafe { (*as_0).src.alpnid }) as u32
            ...
            && Curl_strcasecompare(srchost, unsafe { (*as_0).src.host }) != 0
        {
            Curl_llist_remove(unsafe { &mut (*asi).list }, e, 0 as *mut libc::c_void);
            altsvc_free(as_0);
        }
        e = n;
    }
...
pub extern "C" fn Curl_altsvc_parse(
    ...
    if Curl_strcasecompare(alpnbuf.as_mut_ptr(), b"clear\0" as *const u8 as *const i8) != 0 {
        return CURLE_OK;
    }
    while (unsafe { *p }) as i32 == '=' as i32 {
        ...
        if (unsafe { *p }) as i32 != ':' as i32 {
            ...
            while (unsafe { *p }) as i32 != 0
                && (Curl_isalnum((unsafe { *p }) as u8 as i32) != 0
                    || (unsafe { *p }) as i32 == '.' as i32
                    || (unsafe { *p }) as i32 == '-' as i32)
            {
                p = unsafe { p.offset(1) };
        ...
        loop {
            ...
            {
                if Curl_strcasecompare(b"ma\0" as *const u8 as *const i8, option.as_mut_ptr()) != 0
                {
...
#[no_mangle]
pub extern "C" fn Curl_altsvc_lookup<'a1>(
    mut asi: *mut crate::src::lib::altsvc::altsvcinfo,
    mut srcalpnid: u32,
    mut srchost: *const i8,
    mut srcport: i32,
    ...
    while !e.is_null() {
        ...
        if (unsafe { (*as_0).expires }) < now {
            ...
            && Curl_strcasecompare(unsafe { (*as_0).src.host }, srchost) != 0
