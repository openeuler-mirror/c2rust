...
pub static mut Curl_handler_smtp: crate::src::lib::http2::Curl_handler =  {
    {
        let mut init = Curl_handler {
            ...
            setup_connection: Some(smtp_setup_connection),
            do_it: Some(smtp_do),
            done: Some(smtp_done),
            do_more: None,
            connect_it: Some(smtp_connect),
            connecting: Some(smtp_multi_statemach),
            doing: Some(smtp_doing),
            proto_getsock: Some(smtp_getsock),
            doing_getsock: Some(smtp_getsock),
            domore_getsock: None,
            perform_getsock: None,
            disconnect: Some(smtp_disconnect),
            readwrite: None,
...
static mut saslsmtp: crate::src::lib::http2::SASLproto =  {
    {
        let mut init = SASLproto {
            ...
            sendauth: Some(smtp_perform_auth),
            sendcont: Some(smtp_continue_auth),
            getmessage: Some(smtp_get_message),
        };
        init
    }
};
extern "C" fn smtp_to_smtps(mut conn: *mut crate::src::lib::http2::connectdata) {
...
extern "C" fn smtp_endofresp(
    ...
    let mut smtpc: Option<&'_ mut crate::src::lib::http2::smtp_conn> =
        Some(unsafe { &mut (*conn).proto.smtpc });
    ...
    if (unsafe { *line.offset(3 as i32 as isize) }) as i32 == ' ' as i32 || len == 5 as i32 as u64 {
        ...
        && ((*(borrow(&smtpc)).unwrap()).state as u32 == SMTP_EHLO as i32 as u32
            || (*(borrow(&smtpc)).unwrap()).state as u32 == SMTP_COMMAND as i32 as u32)
    {
        result = 1 as i32 != 0;
...
extern "C" fn state(mut data: *mut crate::src::lib::http2::Curl_easy, mut newstate: u32) {
    let mut smtpc: Option<&'_ mut crate::src::lib::http2::smtp_conn> =
        Some(unsafe { &mut (*(*data).conn).proto.smtpc });
    (*(borrow_mut(&mut smtpc)).unwrap()).state = newstate;
}
extern "C" fn smtp_perform_ehlo(mut data: *mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut result: u32 = CURLE_OK;
    let mut conn: *mut crate::src::lib::http2::connectdata = unsafe { (*data).conn };
    let mut smtpc: *mut crate::src::lib::http2::smtp_conn = unsafe { &mut (*conn).proto.smtpc };
...
extern "C" fn smtp_perform_upgrade_tls(mut data: *mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut conn: *mut crate::src::lib::http2::connectdata = unsafe { (*data).conn };
    let mut smtpc: Option<&'_ mut crate::src::lib::http2::smtp_conn> =
        Some(unsafe { &mut (*conn).proto.smtpc });
    ...
    if result as u64 == 0 {
        if (*(borrow(&smtpc)).unwrap()).state as u32 != SMTP_UPGRADETLS as i32 as u32 {
...
extern "C" fn smtp_perform_authentication(mut data: *mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut result: u32 = CURLE_OK;
    let mut conn: *mut crate::src::lib::http2::connectdata = unsafe { (*data).conn };
    let mut smtpc: Option<&'_ mut crate::src::lib::http2::smtp_conn> =
        Some(unsafe { &mut (*conn).proto.smtpc });
    let mut progress: u32 = SASL_IDLE;
    if !(*(borrow(&smtpc)).unwrap()).auth_supported
        || !Curl_sasl_can_authenticate(Some(&mut (*(borrow_mut(&mut smtpc)).unwrap()).sasl), conn)
    {
...
extern "C" fn smtp_perform_command(mut data: *mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut result: u32 = CURLE_OK;
    let mut conn: *mut crate::src::lib::http2::connectdata = unsafe { (*data).conn };
    let mut smtp: *mut crate::src::lib::http2::SMTP = unsafe { (*data).req.p.smtp };
    if !(unsafe { (*smtp).rcpt }).is_null() {
        ...
        if (unsafe { (*smtp).custom }).is_null() || (unsafe { *((*smtp).custom).offset(0 as i32 as isize) }) == 0 {
            ...
            result = smtp_parse_address(data, unsafe { (*(*smtp).rcpt).data }, Some(&mut address), &mut host);
            if result as u64 != 0 {
                return result;
            }
...
extern "C" fn smtp_perform_mail(mut data: *mut crate::src::lib::http2::Curl_easy) -> u32 {
    ...
    if (unsafe { (*data).set.mimepost.kind }) as u32 != MIMEKIND_NONE as i32 as u32 {
        ...
        let mut fresh3 = unsafe { &mut ((*data).state.fread_func) };
        *fresh3 = unsafe { core::intrinsics::transmute::<
            Option<
            ...
            >,
        >(Some(Curl_mime_read)) };
        let mut fresh4 = unsafe { &mut ((*data).state.in_0) };
    ...
    if (unsafe { (*conn).proto.smtpc.utf8_supported }) as i32 != 0 && !utf8 {
        let mut smtp: *mut crate::src::lib::http2::SMTP = unsafe { (*data).req.p.smtp };
        let mut rcpt: *mut crate::src::lib::http2::curl_slist = unsafe { (*smtp).rcpt };
        while !rcpt.is_null() && !utf8 {
            if !Curl_is_ASCII_name(unsafe { (*rcpt).data }) {
                utf8 = 1 as i32 != 0;
            }
...
extern "C" fn smtp_perform_rcpt_to(mut data: *mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut result: u32 = CURLE_OK;
    let mut conn: *mut crate::src::lib::http2::connectdata = unsafe { (*data).conn };
    let mut smtp: *mut crate::src::lib::http2::SMTP = unsafe { (*data).req.p.smtp };
    let mut address: *mut i8 = 0 as *mut i8;
...
extern "C" fn smtp_state_command_resp(
        ...
        || (unsafe { (*smtp).rcpt }).is_null() && smtpcode / 100 as i32 != 2 as i32 && smtpcode != 1 as i32
    {
        ...
        if smtpcode != 1 as i32 {
            if !(unsafe { (*smtp).rcpt }).is_null() {
                let mut fresh6 = unsafe { &mut ((*smtp).rcpt) };
...
extern "C" fn smtp_state_rcpt_resp(
    ...
    if !is_smtp_blocking_err {
        let mut fresh7 = unsafe { &mut ((*smtp).rcpt) };
...
extern "C" fn smtp_statemachine(
    ...
    let mut smtpc: *mut crate::src::lib::http2::smtp_conn = unsafe { &mut (*conn).proto.smtpc };
    let mut pp: *mut crate::src::lib::http2::pingpong = unsafe { &mut (*smtpc).pp };
...
extern "C" fn smtp_multi_statemach(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    mut done: *mut bool,
) -> u32 {
    let mut result: u32 = CURLE_OK;
    ...
    (unsafe { *done = if (*(borrow(&smtpc)).unwrap()).state as u32 == SMTP_STOP as i32 as u32 {
        1 as i32
    } else {
        0 as i32
    } != 0 });
...
extern "C" fn smtp_block_statemach(
    ...
    let mut smtpc: Option<&'_ mut crate::src::lib::http2::smtp_conn> =
        Some(unsafe { &mut (*conn).proto.smtpc });
    while (*(borrow(&smtpc)).unwrap()).state as u32 != SMTP_STOP as i32 as u32 && result as u64 == 0
    {
        result = Curl_pp_statemach(
            data,
            &mut (*(borrow_mut(&mut smtpc)).unwrap()).pp,
...
extern "C" fn smtp_init(mut data: *mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut result: u32 = CURLE_OK;
    let mut smtp: *mut crate::src::lib::http2::SMTP = 0 as *mut crate::src::lib::http2::SMTP;
    let mut fresh8 = unsafe { &mut ((*data).req.p.smtp) };
...
extern "C" fn smtp_getsock(
    ...
    return Curl_pp_getsock(data, Some(unsafe { &mut (*conn).proto.smtpc.pp }), socks);
}
extern "C" fn smtp_connect(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    mut done: *mut bool,
) -> u32 {
    let mut result: u32 = CURLE_OK;
    let mut conn: *mut crate::src::lib::http2::connectdata = unsafe { (*data).conn };
    let mut smtpc: *mut crate::src::lib::http2::smtp_conn = unsafe { &mut (*conn).proto.smtpc };
    let mut pp: Option<&'_ mut crate::src::lib::http2::pingpong> = Some(unsafe { &mut (*smtpc).pp });
    ...
    *fresh9 = Some(smtp_statemachine);
    let mut fresh10 = &mut ((*(borrow_mut(&mut pp)).unwrap()).endofresp);
    *fresh10 = Some(smtp_endofresp);
    Curl_sasl_init(Some(unsafe { &mut (*smtpc).sasl }), unsafe { &saslsmtp });
...
extern "C" fn smtp_done(
    ...
    let mut pp: Option<&'_ mut crate::src::lib::http2::pingpong> =
        Some(unsafe { &mut (*conn).proto.smtpc.pp });
    ...
    let mut fresh11 = unsafe { &mut ((*smtp).custom) };
    *fresh11 = 0 as *mut i8;
    if status as u64 != 0 {
...
extern "C" fn smtp_perform<'a1>(
    ...
    let mut fresh13 = unsafe { &mut ((*smtp).rcpt) };
...
extern "C" fn smtp_disconnect(
    ...
    Curl_sasl_cleanup(
        conn,
        (*(borrow_mut(&mut smtpc)).unwrap()).sasl.authused as u32,
    );
    (unsafe { Curl_cfree.expect("non-null function pointer")(
        (*(borrow_mut(&mut smtpc)).unwrap()).domain as *mut libc::c_void,
    ) });
    let mut fresh14 = &mut ((*(borrow_mut(&mut smtpc)).unwrap()).domain);
    *fresh14 = 0 as *mut i8;
    return CURLE_OK;
}
extern "C" fn smtp_dophase_done(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    mut _connected: bool,
) -> u32 {
    let mut smtp: *mut crate::src::lib::http2::SMTP = unsafe { (*data).req.p.smtp };
...
extern "C" fn smtp_setup_connection(
    ...
    let mut result: u32 = CURLE_OK;
    let mut fresh15 = unsafe { &mut ((*conn).bits) };
...
extern "C" fn smtp_parse_url_options(mut conn: *mut crate::src::lib::http2::connectdata) -> u32 {
    let mut result: u32 = CURLE_OK;
    let mut smtpc: Option<&'_ mut crate::src::lib::http2::smtp_conn> =
        Some(unsafe { &mut (*conn).proto.smtpc });
...
extern "C" fn smtp_parse_url_path(mut data: *mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut conn: *mut crate::src::lib::http2::connectdata = unsafe { (*data).conn };
    let mut smtpc: Option<&'_ mut crate::src::lib::http2::smtp_conn> =
        Some(unsafe { &mut (*conn).proto.smtpc });
...
extern "C" fn smtp_parse_custom_request(mut data: *mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut result: u32 = CURLE_OK;
    let mut smtp: *mut crate::src::lib::http2::SMTP = unsafe { (*data).req.p.smtp };
...
extern "C" fn smtp_parse_address<'a1>(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    mut fqma: *const i8,
...
#[no_mangle]
pub extern "C" fn Curl_smtp_escape_eob(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    nread: i64,
) -> u32 {
    let mut i: i64 = 0;
    ...
    while i < nread {
        if (*(unsafe { core::intrinsics::transmute::<&'_ [u8; 6], &'_ [i8; 6]>(b"\r\n.\r\n\0") }))
            [(unsafe { (*smtp).eob }) as usize] as i32
            == (unsafe { *((*data).req.upload_fromhere).offset(i as isize) }) as i32
        {
            let mut fresh18 = unsafe { &mut ((*smtp).eob) };
    ...
    if si != nread {
        let mut fresh20 = unsafe { &mut ((*data).req.upload_fromhere) };
        *fresh20 = scratch;
        let mut fresh21 = unsafe { &mut ((*data).state.scratch) };
        *fresh21 = scratch;
