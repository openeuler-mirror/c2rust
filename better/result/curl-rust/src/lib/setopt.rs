    ...
    *(borrow_mut(&mut blobp)).unwrap() = 0 as *mut curl_blob;
    if !blob.is_null() {
        ...
        if (unsafe { (*blob).flags }) & 1 as i32 as u32 != 0 {
            let mut fresh0 = unsafe { &mut ((*nblob).data) };
...
extern "C" fn setstropt_userpwd<'a1, 'a2>(
    mut option: *mut i8,
    ...
    if !option.is_null() {
        result = Curl_parse_login_details(
            option,
            unsafe { strlen(option) },
            borrow_mut(&mut if !borrow(&userp).is_none() {
                Some(&mut user)
            } else {
                Option::<&'_ mut *mut i8>::None
            }),
            borrow_mut(&mut if !borrow(&passwdp).is_none() {
                Some(&mut passwd)
            } else {
                Option::<&'_ mut *mut i8>::None
            }),
...
pub extern "C" fn Curl_vsetopt(
    ...
    match option as u32 {
        ...
        75 => {
            let mut fresh1 = unsafe { &mut ((*data).set) };
        ...
        74 => {
            let mut fresh2 = unsafe { &mut ((*data).set) };
        ...
        41 => {
            let mut fresh3 = unsafe { &mut ((*data).set) };
            (*fresh3).set_verbose(
                (if 0 as i32 as i64 != (unsafe { param.arg::<i64>() }) {
                    1 as i32
                } else {
        ...
        42 => {
            let mut fresh4 = unsafe { &mut ((*data).set) };
        ...
        43 => {
            let mut fresh5 = unsafe { &mut ((*data).set) };
        ...
        44 => {
            let mut fresh6 = unsafe { &mut ((*data).set) };
        ...
        45 => {
            let mut fresh7 = unsafe { &mut ((*data).set) };
        ...
        245 => {
            let mut fresh8 = unsafe { &mut ((*data).set) };
        ...
        46 | 54 => {
            let mut fresh9 = unsafe { &mut ((*data).set) };
            (*fresh9).set_upload(
                (if 0 as i32 as i64 != (unsafe { param.arg::<i64>() }) {
                    1 as i32
                } else {
            ...
            if (unsafe { ((*data).set).upload() }) != 0 {
                ...
                let mut fresh10 = unsafe { &mut ((*data).set) };
        ...
        69 => {
            let mut fresh11 = unsafe { &mut ((*data).set) };
        ...
        242 => {
            let mut fresh12 = unsafe { &mut ((*data).set) };
        ...
        53 => {
            let mut fresh13 = unsafe { &mut ((*data).set) };
        ...
        32 | 250 => {
            ...
            let mut primary: Option<&'_ mut crate::src::lib::http2::ssl_primary_config> =
                Some(unsafe { &mut (*data).set.ssl.primary });
            if option as u32 != CURLOPT_SSLVERSION as i32 as u32 {
                primary = Some(unsafe { &mut (*data).set.proxy_ssl.primary });
            }
            arg = unsafe { param.arg::<i64>() };
        ...
        10165 => {
                    ...
                    && (unsafe { (*data).set.postfieldsize }) > -(1 as i32) as size_t as curl_off_t
            {
                ...
                if p.is_null() {
                    ...
                    let mut fresh14 =
                        unsafe { &mut ((*data).set.str_0[STRING_COPYPOSTFIELDS as i32 as usize]) };
                    *fresh14 = p;
                }
            }
            let mut fresh15 = unsafe { &mut ((*data).set.postfields) };
            *fresh15 =
                (unsafe { (*data).set.str_0[STRING_COPYPOSTFIELDS as i32 as usize] }) as *mut libc::c_void;
            (unsafe { (*data).set.method = HTTPREQ_POST });
        }
        10015 => {
            let mut fresh16 = unsafe { &mut ((*data).set.postfields) };
        ...
        60 => {
                    ...
                    == (unsafe { (*data).set.str_0[STRING_COPYPOSTFIELDS as i32 as usize] }) as *mut libc::c_void
            {
                ...
                let mut fresh17 = unsafe { &mut ((*data).set.postfields) };
        ...
        30120 => {
                    ...
                    == (unsafe { (*data).set.str_0[STRING_COPYPOSTFIELDS as i32 as usize] }) as *mut libc::c_void
            {
                ...
                let mut fresh18 = unsafe { &mut ((*data).set.postfields) };
                *fresh18 = 0 as *mut libc::c_void;
            }
            (unsafe { (*data).set.postfieldsize = bigsize });
        }
        58 => {
            let mut fresh19 = unsafe { &mut ((*data).set) };
        ...
        207 => {
            let mut fresh20 = unsafe { &mut ((*data).set) };
        ...
        52 => {
            let mut fresh21 = unsafe { &mut ((*data).set) };
        ...
        105 => {
            let mut fresh22 = unsafe { &mut ((*data).set) };
        ...
        47 => {
            if (unsafe { param.arg::<i64>() }) != 0 {
                (unsafe { (*data).set.method = HTTPREQ_POST });
                let mut fresh23 = unsafe { &mut ((*data).set) };
        ...
        10269 => {
            result = Curl_mime_set_subparts(
                ...
                unsafe { param.arg::<*mut curl_mime>() },
                0 as i32,
            );
            if result as u64 == 0 {
                (unsafe { (*data).set.method = HTTPREQ_POST_MIME });
                let mut fresh26 = unsafe { &mut ((*data).set) };
        ...
        10016 => {
            if (unsafe { ((*data).state).referer_alloc() }) != 0 {
                ...
                let mut fresh27 = unsafe { &mut ((*data).state.referer) };
                *fresh27 = 0 as *mut i8;
            ...
            let mut fresh29 = unsafe { &mut ((*data).state.referer) };
        ...
        10023 => {
            let mut fresh30 = unsafe { &mut ((*data).set.headers) };
            *fresh30 = unsafe { param.arg::<*mut curl_slist>() };
        }
        10228 => {
            let mut fresh31 = unsafe { &mut ((*data).set.proxyheaders) };
            *fresh31 = unsafe { param.arg::<*mut curl_slist>() };
        }
        229 => {
            arg = unsafe { param.arg::<i64>() };
            let mut fresh32 = unsafe { &mut ((*data).set) };
        ...
        10104 => {
            let mut fresh33 = unsafe { &mut ((*data).set.http200aliases) };
        ...
        10031 => {
            ...
            if !argptr.is_null() {
                ...
                cl = curl_slist_append(unsafe { (*data).state.cookielist }, argptr);
                if cl.is_null() {
                    curl_slist_free_all(unsafe { (*data).state.cookielist });
                    let mut fresh34 = unsafe { &mut ((*data).state.cookielist) };
                    *fresh34 = 0 as *mut curl_slist;
                    return CURLE_OUT_OF_MEMORY;
                }
                let mut fresh35 = unsafe { &mut ((*data).state.cookielist) };
                *fresh35 = cl;
            } else {
                curl_slist_free_all(unsafe { (*data).state.cookielist });
                let mut fresh36 = unsafe { &mut ((*data).state.cookielist) };
                *fresh36 = 0 as *mut curl_slist;
                if (unsafe { (*data).share }).is_null() || (unsafe { (*(*data).share).cookies }).is_null() {
                    Curl_cookie_clearall(unsafe { (*data).cookies });
                    Curl_cookie_cleanup(unsafe { (*data).cookies });
                }
                let mut fresh37 = unsafe { &mut ((*data).cookies) };
        ...
        10082 => {
            ...
            let mut fresh38 = unsafe { &mut ((*data).cookies) };
            *fresh38 = newcookies;
        }
        96 => {
            let mut fresh39 = unsafe { &mut ((*data).set) };
        ...
        10135 => {
            argptr = unsafe { param.arg::<*mut i8>() };
            if !argptr.is_null() {
                if Curl_strcasecompare(argptr, b"ALL\0" as *const u8 as *const i8) != 0 {
                    Curl_share_lock(data, CURL_LOCK_DATA_COOKIE, CURL_LOCK_ACCESS_SINGLE);
                    Curl_cookie_clearall(unsafe { (*data).cookies });
                    Curl_share_unlock(data, CURL_LOCK_DATA_COOKIE);
                } else if Curl_strcasecompare(argptr, b"SESS\0" as *const u8 as *const i8) != 0 {
                    Curl_share_lock(data, CURL_LOCK_DATA_COOKIE, CURL_LOCK_ACCESS_SINGLE);
                    Curl_cookie_clearsess(unsafe { (*data).cookies });
                    Curl_share_unlock(data, CURL_LOCK_DATA_COOKIE);
                } else if Curl_strcasecompare(argptr, b"FLUSH\0" as *const u8 as *const i8) != 0 {
                    Curl_flush_cookies(data, 0 as i32 != 0);
                } else if Curl_strcasecompare(argptr, b"RELOAD\0" as *const u8 as *const i8) != 0 {
                    Curl_cookie_loadfiles(data);
                } else {
                    if (unsafe { (*data).cookies }).is_null() {
                        let mut fresh40 = unsafe { &mut ((*data).cookies) };
                    ...
                    if argptr.is_null() || (unsafe { (*data).cookies }).is_null() {
                        ...
                        ) != 0
                        {
                            Curl_cookie_add(
                                ...
                                1 as i32 != 0,
                                0 as i32 != 0,
                                unsafe { argptr.offset(11 as i32 as isize) },
                                0 as *const i8,
                                0 as *const i8,
                                1 as i32 != 0,
                            );
        ...
        80 => {
            if (unsafe { param.arg::<i64>() }) != 0 {
                (unsafe { (*data).set.method = HTTPREQ_GET });
                let mut fresh41 = unsafe { &mut ((*data).set) };
                (*fresh41).set_upload(0 as i32 as bit);
                let mut fresh42 = unsafe { &mut ((*data).set) };
        ...
        285 => {
            ...
            let mut fresh43 = unsafe { &mut ((*data).set) };
        ...
        107 => {
            ...
            if auth == 0 as i32 as u64 {
                ...
                let mut fresh44 = unsafe { &mut ((*data).state.authhost) };
                (*fresh44).set_iestyle(
        ...
        61 => {
            let mut fresh46 = unsafe { &mut ((*data).set) };
        ...
        111 => {
            ...
            if auth_0 == 0 as i32 as u64 {
                ...
                let mut fresh47 = unsafe { &mut ((*data).state.authproxy) };
                (*fresh47).set_iestyle(
        ...
        166 => match unsafe { param.arg::<i64>() } {
            0 => {
                let mut fresh49 = unsafe { &mut ((*data).set) };
                (*fresh49).set_proxy_transfer_mode(0 as i32 as bit);
            }
            1 => {
                let mut fresh50 = unsafe { &mut ((*data).set) };
        ...
        10029 => {
            let mut fresh51 = unsafe { &mut ((*data).set.writeheader) };
            *fresh51 = unsafe { param.arg::<*mut libc::c_void>() };
        }
        10010 => {
            let mut fresh52 = unsafe { &mut ((*data).set.errorbuffer) };
            *fresh52 = unsafe { param.arg::<*mut i8>() };
        }
        10001 => {
            let mut fresh53 = unsafe { &mut ((*data).set.out) };
        ...
        50 => {
            let mut fresh55 = unsafe { &mut ((*data).set) };
        ...
        10017 => {
            ...
            let mut fresh56 = unsafe { &mut ((*data).set) };
        ...
        106 => {
            let mut fresh57 = unsafe { &mut ((*data).set) };
        ...
        85 => {
            let mut fresh58 = unsafe { &mut ((*data).set) };
        ...
        188 => {
            let mut fresh59 = unsafe { &mut ((*data).set) };
        ...
        137 => {
            let mut fresh60 = unsafe { &mut ((*data).set) };
        ...
        10063 => {
            ...
            let mut fresh61 = unsafe { &mut ((*data).set) };
            (*fresh61).set_krb(
        ...
        10009 => {
            let mut fresh62 = unsafe { &mut ((*data).set.in_set) };
        ...
        10282 => {
            let mut fresh63 = unsafe { &mut ((*data).set.uh) };
        ...
        10002 => {
            if (unsafe { ((*data).state).url_alloc() }) != 0 {
                ...
                let mut fresh64 = unsafe { &mut ((*data).state.url) };
                *fresh64 = 0 as *mut i8;
                let mut fresh65 = unsafe { &mut ((*data).state) };
            ...
            let mut fresh66 = unsafe { &mut ((*data).state.url) };
        ...
        10039 => {
            let mut fresh67 = unsafe { &mut ((*data).set.postquote) };
            *fresh67 = unsafe { param.arg::<*mut curl_slist>() };
        }
        10093 => {
            let mut fresh68 = unsafe { &mut ((*data).set.prequote) };
            *fresh68 = unsafe { param.arg::<*mut curl_slist>() };
        }
        10028 => {
            let mut fresh69 = unsafe { &mut ((*data).set.quote) };
            *fresh69 = unsafe { param.arg::<*mut curl_slist>() };
        }
        10203 => {
            let mut fresh70 = unsafe { &mut ((*data).set.resolve) };
            *fresh70 = unsafe { param.arg::<*mut curl_slist>() };
            let mut fresh71 = unsafe { &mut ((*data).state.resolve) };
            *fresh71 = unsafe { (*data).set.resolve };
        }
        20056 => {
            let mut fresh72 = unsafe { &mut ((*data).set.fprogress) };
            *fresh72 = unsafe { core::intrinsics::transmute::<
            ...
            if unsafe { ((*data).set.fprogress).is_some() } {
                let mut fresh73 = unsafe { &mut ((*data).progress) };
                (*fresh73).set_callback(1 as i32 as bit);
            } else {
                let mut fresh74 = unsafe { &mut ((*data).progress) };
                (*fresh74).set_callback(0 as i32 as bit);
            }
        }
        20219 => {
            let mut fresh75 = unsafe { &mut ((*data).set.fxferinfo) };
            *fresh75 = unsafe { core::intrinsics::transmute::<
                *mut unsafe extern "C" fn(
                    _: *mut core::ffi::c_void,
                    _: i64,
                    _: i64,
            ...
            if unsafe { ((*data).set.fxferinfo).is_some() } {
                let mut fresh76 = unsafe { &mut ((*data).progress) };
                (*fresh76).set_callback(1 as i32 as bit);
            } else {
                let mut fresh77 = unsafe { &mut ((*data).progress) };
                (*fresh77).set_callback(0 as i32 as bit);
            }
        }
        10057 => {
            let mut fresh78 = unsafe { &mut ((*data).set.progress_client) };
        ...
        20094 => {
            let mut fresh79 = unsafe { &mut ((*data).set.fdebug) };
            *fresh79 = unsafe { core::intrinsics::transmute::<
                *mut unsafe extern "C" fn(
        ...
        10095 => {
            let mut fresh80 = unsafe { &mut ((*data).set.debugdata) };
            *fresh80 = unsafe { param.arg::<*mut libc::c_void>() };
        }
        10037 => {
            let mut fresh81 = unsafe { &mut ((*data).set.err) };
            *fresh81 = unsafe { param.arg::<*mut FILE>() };
            if (unsafe { (*data).set.err }).is_null() {
                let mut fresh82 = unsafe { &mut ((*data).set.err) };
                *fresh82 = unsafe { stderr };
            }
        }
        20079 => {
            let mut fresh83 = unsafe { &mut ((*data).set.fwrite_header) };
            *fresh83 = unsafe { core::intrinsics::transmute::<
                *mut unsafe extern "C" fn(
                    _: *mut i8,
                    _: u64,
                    _: u64,
        ...
        20011 => {
            let mut fresh84 = unsafe { &mut ((*data).set.fwrite_func) };
            *fresh84 = unsafe { core::intrinsics::transmute::<
                *mut unsafe extern "C" fn(
                    _: *mut i8,
                    _: u64,
                    _: u64,
            ...
            if unsafe { ((*data).set.fwrite_func).is_none() } {
                let mut fresh85 = unsafe { &mut ((*data).set) };
                (*fresh85).set_is_fwrite_set(0 as i32 as bit);
                let mut fresh86 = unsafe { &mut ((*data).set.fwrite_func) };
                *fresh86 = unsafe { core::intrinsics::transmute::<
                    Option<
                        unsafe extern "C" fn(
                            _: *const core::ffi::c_void,
                            _: u64,
                ...
                let mut fresh87 = unsafe { &mut ((*data).set) };
                (*fresh87).set_is_fwrite_set(1 as i32 as bit);
            }
        }
        20012 => {
            let mut fresh88 = unsafe { &mut ((*data).set.fread_func_set) };
            *fresh88 = unsafe { core::intrinsics::transmute::<
                *mut unsafe extern "C" fn(
                    _: *mut i8,
                    _: u64,
                    _: u64,
            ...
            if unsafe { ((*data).set.fread_func_set).is_none() } {
                let mut fresh89 = unsafe { &mut ((*data).set) };
                (*fresh89).set_is_fread_set(0 as i32 as bit);
                let mut fresh90 = unsafe { &mut ((*data).set.fread_func_set) };
                *fresh90 = unsafe { core::intrinsics::transmute::<
                    Option<
                        unsafe extern "C" fn(
                            _: *mut core::ffi::c_void,
                            _: u64,
                ...
                let mut fresh91 = unsafe { &mut ((*data).set) };
                (*fresh91).set_is_fread_set(1 as i32 as bit);
            }
        }
        20167 => {
            let mut fresh92 = unsafe { &mut ((*data).set.seek_func) };
            *fresh92 = unsafe { core::intrinsics::transmute::<
                *mut unsafe extern "C" fn(_: *mut core::ffi::c_void, _: i64, _: i32) -> i32,
                Option<unsafe extern "C" fn(_: *mut core::ffi::c_void, _: i64, _: i32) -> i32>,
            >(param.arg::<*mut unsafe extern "C" fn(
                *mut libc::c_void,
                curl_off_t,
                i32,
        ...
        10168 => {
            let mut fresh93 = unsafe { &mut ((*data).set.seek_client) };
            *fresh93 = unsafe { param.arg::<*mut libc::c_void>() };
        }
        20142 => {
            let mut fresh94 = unsafe { &mut ((*data).set.convfromnetwork) };
            *fresh94 = unsafe { core::intrinsics::transmute::<
                *mut unsafe extern "C" fn(_: *mut i8, _: u64) -> u32,
                Option<unsafe extern "C" fn(_: *mut i8, _: u64) -> u32>,
            >(
                param.arg::<*mut unsafe extern "C" fn(*mut i8, size_t) -> CURLcode>()
            ) };
        }
        20143 => {
            let mut fresh95 = unsafe { &mut ((*data).set.convtonetwork) };
            *fresh95 = unsafe { core::intrinsics::transmute::<
                *mut unsafe extern "C" fn(_: *mut i8, _: u64) -> u32,
                Option<unsafe extern "C" fn(_: *mut i8, _: u64) -> u32>,
            >(
                param.arg::<*mut unsafe extern "C" fn(*mut i8, size_t) -> CURLcode>()
        ...
        20144 => {
            let mut fresh96 = unsafe { &mut ((*data).set.convfromutf8) };
            *fresh96 = unsafe { core::intrinsics::transmute::<
                *mut unsafe extern "C" fn(_: *mut i8, _: u64) -> u32,
                Option<unsafe extern "C" fn(_: *mut i8, _: u64) -> u32>,
            >(
                param.arg::<*mut unsafe extern "C" fn(*mut i8, size_t) -> CURLcode>()
        ...
        20130 => {
            let mut fresh97 = unsafe { &mut ((*data).set.ioctl_func) };
            *fresh97 = unsafe { core::intrinsics::transmute::<
                *mut unsafe extern "C" fn(
                    _: *mut crate::src::lib::http2::Curl_easy,
                    _: i32,
                    _: *mut core::ffi::c_void,
        ...
        10131 => {
            let mut fresh98 = unsafe { &mut ((*data).set.ioctl_client) };
        ...
        27 => {
            let mut fresh99 = unsafe { &mut ((*data).set) };
            (*fresh99).set_crlf(
                (if 0 as i32 as i64 != (unsafe { param.arg::<i64>() }) {
                    1 as i32
                } else {
        ...
        274 => {
            let mut fresh100 = unsafe { &mut ((*data).set) };
        ...
        64 => {
            let mut fresh101 = unsafe { &mut ((*data).set.ssl.primary) };
            ...
            if !(unsafe { (*data).conn }).is_null() {
                let mut fresh102 = unsafe { &mut ((*(*data).conn).ssl_config) };
                (*fresh102).set_verifypeer(unsafe { ((*data).set.ssl.primary).verifypeer() });
            }
        }
        306 => {
            let mut fresh103 = unsafe { &mut ((*data).set) };
        ...
        248 => {
            let mut fresh104 = unsafe { &mut ((*data).set.proxy_ssl.primary) };
            ...
            if !(unsafe { (*data).conn }).is_null() {
                let mut fresh105 = unsafe { &mut ((*(*data).conn).proxy_ssl_config) };
                (*fresh105).set_verifypeer(unsafe { ((*data).set.proxy_ssl.primary).verifypeer() });
            }
        }
        81 => {
            arg = unsafe { param.arg::<i64>() };
            let mut fresh106 = unsafe { &mut ((*data).set.ssl.primary) };
            ...
            if !(unsafe { (*data).conn }).is_null() {
                let mut fresh107 = unsafe { &mut ((*(*data).conn).ssl_config) };
                (*fresh107).set_verifyhost(unsafe { ((*data).set.ssl.primary).verifyhost() });
            }
        }
        307 => {
            arg = unsafe { param.arg::<i64>() };
            let mut fresh108 = unsafe { &mut ((*data).set) };
        ...
        249 => {
            arg = unsafe { param.arg::<i64>() };
            let mut fresh109 = unsafe { &mut ((*data).set.proxy_ssl.primary) };
            ...
            if !(unsafe { (*data).conn }).is_null() {
                let mut fresh110 = unsafe { &mut ((*(*data).conn).proxy_ssl_config) };
        ...
        232 => {
            if !Curl_ssl_cert_status_request() {
                ...
                let mut fresh111 = unsafe { &mut ((*data).set.ssl.primary) };
                ...
                if !(unsafe { (*data).conn }).is_null() {
                    let mut fresh112 = unsafe { &mut ((*(*data).conn).ssl_config) };
        ...
        308 => {
            if !Curl_ssl_cert_status_request() {
                ...
                let mut fresh113 = unsafe { &mut ((*data).set) };
        ...
        20108 => {
            if (unsafe { (*Curl_ssl).supports }) & ((1 as i32) << 3 as i32) as u32 != 0 {
                let mut fresh114 = unsafe { &mut ((*data).set.ssl.fsslctx) };
                *fresh114 = unsafe { core::intrinsics::transmute::<
                    *mut unsafe extern "C" fn(
                        _: *mut crate::src::lib::http2::Curl_easy,
                        _: *mut core::ffi::c_void,
                        _: *mut core::ffi::c_void,
        ...
        10109 => {
            if (unsafe { (*Curl_ssl).supports }) & ((1 as i32) << 3 as i32) as u32 != 0 {
                let mut fresh115 = unsafe { &mut ((*data).set.ssl.fsslctxp) };
        ...
        233 => {
            if !Curl_ssl_false_start() {
                ...
                let mut fresh116 = unsafe { &mut ((*data).set.ssl) };
        ...
        172 => {
            if (unsafe { (*Curl_ssl).supports }) & ((1 as i32) << 1 as i32) as u32 != 0 {
                let mut fresh117 = unsafe { &mut ((*data).set.ssl) };
        ...
        10070 => {
            let mut fresh118 = unsafe { &mut ((*data).set.telnet_options) };
        ...
        280 => {
            ...
            let mut fresh119 = unsafe { &mut ((*data).state.ulbuf) };
            *fresh119 = 0 as *mut i8;
        }
        99 => {
            let mut fresh120 = unsafe { &mut ((*data).set) };
        ...
        10103 => {
            let mut fresh133 = unsafe { &mut ((*data).set.private_data) };
        ...
        216 => {
            arg = unsafe { param.arg::<i64>() };
            let mut fresh134 = unsafe { &mut ((*data).set.ssl) };
            (*fresh134)
                .set_enable_beast((arg & ((1 as i32) << 0 as i32) as i64 != 0) as i32 as bit);
            let mut fresh135 = unsafe { &mut ((*data).set.ssl) };
            (*fresh135).set_no_revoke((arg & ((1 as i32) << 1 as i32) as i64 != 0) as i32 as bit);
            let mut fresh136 = unsafe { &mut ((*data).set.ssl) };
            (*fresh136)
                .set_no_partialchain((arg & ((1 as i32) << 2 as i32) as i64 != 0) as i32 as bit);
            let mut fresh137 = unsafe { &mut ((*data).set.ssl) };
            (*fresh137)
                .set_revoke_best_effort((arg & ((1 as i32) << 3 as i32) as i64 != 0) as i32 as bit);
            let mut fresh138 = unsafe { &mut ((*data).set.ssl) };
            (*fresh138)
                .set_native_ca_store((arg & ((1 as i32) << 4 as i32) as i64 != 0) as i32 as bit);
            let mut fresh139 = unsafe { &mut ((*data).set.ssl) };
            (*fresh139)
                .set_auto_client_cert((arg & ((1 as i32) << 5 as i32) as i64 != 0) as i32 as bit);
        }
        261 => {
            arg = unsafe { param.arg::<i64>() };
            let mut fresh140 = unsafe { &mut ((*data).set.proxy_ssl) };
            (*fresh140)
                .set_enable_beast((arg & ((1 as i32) << 0 as i32) as i64 != 0) as i32 as bit);
            let mut fresh141 = unsafe { &mut ((*data).set.proxy_ssl) };
            (*fresh141).set_no_revoke((arg & ((1 as i32) << 1 as i32) as i64 != 0) as i32 as bit);
            let mut fresh142 = unsafe { &mut ((*data).set.proxy_ssl) };
            (*fresh142)
                .set_no_partialchain((arg & ((1 as i32) << 2 as i32) as i64 != 0) as i32 as bit);
            let mut fresh143 = unsafe { &mut ((*data).set.proxy_ssl) };
            (*fresh143)
                .set_revoke_best_effort((arg & ((1 as i32) << 3 as i32) as i64 != 0) as i32 as bit);
            let mut fresh144 = unsafe { &mut ((*data).set.proxy_ssl) };
            (*fresh144)
                .set_native_ca_store((arg & ((1 as i32) << 4 as i32) as i64 != 0) as i32 as bit);
            let mut fresh145 = unsafe { &mut ((*data).set.proxy_ssl) };
            (*fresh145)
                .set_auto_client_cert((arg & ((1 as i32) << 5 as i32) as i64 != 0) as i32 as bit);
        }
        10298 => {
        ...
        121 => {
            let mut fresh146 = unsafe { &mut ((*data).set) };
        ...
        136 => {
            let mut fresh147 = unsafe { &mut ((*data).set) };
        ...
        141 => {
            let mut fresh148 = unsafe { &mut ((*data).set) };
        ...
        20148 => {
            let mut fresh149 = unsafe { &mut ((*data).set.fsockopt) };
            *fresh149 = unsafe { core::intrinsics::transmute::<
                *mut unsafe extern "C" fn(_: *mut core::ffi::c_void, _: i32, _: u32) -> i32,
                Option<unsafe extern "C" fn(_: *mut core::ffi::c_void, _: i32, _: u32) -> i32>,
            >(param.arg::<*mut unsafe extern "C" fn(
                *mut libc::c_void,
                curl_socket_t,
                curlsocktype,
        ...
        10149 => {
            let mut fresh150 = unsafe { &mut ((*data).set.sockopt_client) };
            *fresh150 = unsafe { param.arg::<*mut libc::c_void>() };
        }
        20163 => {
            let mut fresh151 = unsafe { &mut ((*data).set.fopensocket) };
            *fresh151 = unsafe { core::intrinsics::transmute::<
                *mut unsafe extern "C" fn(
                    _: *mut core::ffi::c_void,
                    _: u32,
        ...
        10164 => {
            let mut fresh152 = unsafe { &mut ((*data).set.opensocket_client) };
            *fresh152 = unsafe { param.arg::<*mut libc::c_void>() };
        }
        20208 => {
            let mut fresh153 = unsafe { &mut ((*data).set.fclosesocket) };
            *fresh153 = unsafe { core::intrinsics::transmute::<
                *mut unsafe extern "C" fn(_: *mut core::ffi::c_void, _: i32) -> i32,
                Option<unsafe extern "C" fn(_: *mut core::ffi::c_void, _: i32) -> i32>,
            >(
                param.arg::<*mut unsafe extern "C" fn(*mut libc::c_void, curl_socket_t) -> i32>(),
            ) };
        }
        20272 => {
            let mut fresh154 = unsafe { &mut ((*data).set.resolver_start) };
            *fresh154 = unsafe { core::intrinsics::transmute::<
                *mut unsafe extern "C" fn(
                    _: *mut core::ffi::c_void,
                    _: *mut core::ffi::c_void,
                    _: *mut core::ffi::c_void,
        ...
        10273 => {
            let mut fresh155 = unsafe { &mut ((*data).set.resolver_start_client) };
            *fresh155 = unsafe { param.arg::<*mut libc::c_void>() };
        }
        10209 => {
            let mut fresh156 = unsafe { &mut ((*data).set.closesocket_client) };
            *fresh156 = unsafe { param.arg::<*mut libc::c_void>() };
        }
        150 => {
            let mut fresh157 = unsafe { &mut ((*data).set.ssl.primary) };
            ...
            let mut fresh158 = unsafe { &mut ((*data).set.proxy_ssl.primary) };
            (*fresh158).set_sessionid(unsafe { ((*data).set.ssl.primary).sessionid() });
        }
        157 => {
            let mut fresh159 = unsafe { &mut ((*data).set) };
        ...
        158 => {
            let mut fresh160 = unsafe { &mut ((*data).set) };
        ...
        10187 => {
            let mut fresh161 = unsafe { &mut ((*data).set.mail_rcpt) };
            *fresh161 = unsafe { param.arg::<*mut curl_slist>() };
        }
        290 => {
            let mut fresh162 = unsafe { &mut ((*data).set) };
        ...
        218 => {
            let mut fresh163 = unsafe { &mut ((*data).set) };
        ...
        10195 => {
            let mut fresh164 = unsafe { &mut ((*data).set.rtp_out) };
            *fresh164 = unsafe { param.arg::<*mut libc::c_void>() };
        }
        20196 => {
            let mut fresh165 = unsafe { &mut ((*data).set.fwrite_rtp) };
            *fresh165 = unsafe { core::intrinsics::transmute::<
                *mut unsafe extern "C" fn(
                    _: *mut i8,
                    _: u64,
                    _: u64,
        ...
        197 => {
            let mut fresh166 = unsafe { &mut ((*data).set) };
        ...
        20198 => {
            let mut fresh167 = unsafe { &mut ((*data).set.chunk_bgn) };
            *fresh167 = unsafe { core::intrinsics::transmute::<
                *mut unsafe extern "C" fn(
                    _: *const core::ffi::c_void,
                    _: *mut core::ffi::c_void,
                    _: i32,
        ...
        20199 => {
            let mut fresh168 = unsafe { &mut ((*data).set.chunk_end) };
            *fresh168 = unsafe { core::intrinsics::transmute::<
                *mut unsafe extern "C" fn(_: *mut core::ffi::c_void) -> i64,
                Option<unsafe extern "C" fn(_: *mut core::ffi::c_void) -> i64>,
            >(
                param.arg::<*mut unsafe extern "C" fn(*mut libc::c_void) -> i64>()
            ) };
        }
        20200 => {
            let mut fresh169 = unsafe { &mut ((*data).set.fnmatch) };
            *fresh169 = unsafe { core::intrinsics::transmute::<
                *mut unsafe extern "C" fn(
                    _: *mut core::ffi::c_void,
                    _: *const i8,
                    _: *const i8,
        ...
        10201 => {
            let mut fresh170 = unsafe { &mut ((*data).wildcard.customptr) };
            *fresh170 = unsafe { param.arg::<*mut libc::c_void>() };
        }
        10202 => {
            let mut fresh171 = unsafe { &mut ((*data).set.fnmatch_data) };
        ...
        10206 => {
            ...
            if argptr.is_null()
                || Curl_strncasecompare(
                    ...
                    unsafe { strlen(b"SRP\0" as *const u8 as *const i8) },
                ) != 0
            {
                (unsafe { (*data).set.ssl.authtype = CURL_TLSAUTH_SRP });
            } else {
        ...
        213 => {
            let mut fresh172 = unsafe { &mut ((*data).set) };
        ...
        244 => {
            let mut fresh173 = unsafe { &mut ((*data).set) };
        ...
        225 => {
            let mut fresh174 = unsafe { &mut ((*data).set) };
        ...
        226 => {
            let mut fresh175 = unsafe { &mut ((*data).set) };
        ...
        10231 => {
            let mut fresh176 = unsafe { &mut ((*data).set) };
        ...
        10264 => {
            let mut fresh177 = unsafe { &mut ((*data).set) };
        ...
        234 => {
            let mut fresh178 = unsafe { &mut ((*data).set) };
        ...
        237 => {
            let mut fresh179 = unsafe { &mut ((*data).set) };
        ...
        10240 | 10241 => {
            let mut dep: *mut crate::src::lib::http2::Curl_easy = unsafe { param.arg::<*mut Curl_easy>() };
        ...
        10243 => {
            let mut fresh180 = unsafe { &mut ((*data).set.connect_to) };
            *fresh180 = unsafe { param.arg::<*mut curl_slist>() };
        }
        265 => {
            let mut fresh181 = unsafe { &mut ((*data).set) };
        ...
        275 => {
            let mut fresh182 = unsafe { &mut ((*data).set) };
        ...
        278 => {
            let mut fresh183 = unsafe { &mut ((*data).set) };
        ...
        10279 => {
            ...
            let mut fresh184 = unsafe { &mut ((*data).set) };
            (*fresh184).set_doh(
        ...
        20283 => {
            let mut fresh185 = unsafe { &mut ((*data).set.trailer_callback) };
            * fresh185 = unsafe { core :: intrinsics :: transmute :: < * mut unsafe extern "C" fn (_ : * mut * mut crate :: src :: lib :: http2 :: curl_slist , _ : * mut core :: ffi :: c_void ,) -> i32 , Option < unsafe extern "C" fn (_ : * mut * mut crate :: src :: lib :: http2 :: curl_slist , _ : * mut core :: ffi :: c_void ,) -> i32 > > (param . arg :: < * mut unsafe extern "C" fn (* mut * mut curl_slist , * mut libc :: c_void ,) -> i32 , > () ,) } ;
        }
        10284 => {
            let mut fresh186 = unsafe { &mut ((*data).set.trailer_data) };
            *fresh186 = unsafe { param.arg::<*mut libc::c_void>() };
        }
        20301 => {
            let mut fresh187 = unsafe { &mut ((*data).set.hsts_read) };
            *fresh187 = unsafe { core::intrinsics::transmute::<
                *mut unsafe extern "C" fn(
                    _: *mut crate::src::lib::http2::Curl_easy,
        ...
        10302 => {
            let mut fresh188 = unsafe { &mut ((*data).set.hsts_read_userp) };
            *fresh188 = unsafe { param.arg::<*mut libc::c_void>() };
        }
        20303 => {
            let mut fresh189 = unsafe { &mut ((*data).set.hsts_write) };
            *fresh189 = unsafe { core::intrinsics::transmute::<
                *mut unsafe extern "C" fn(
                    _: *mut crate::src::lib::http2::Curl_easy,
                    _: *mut crate::src::lib::http2::curl_hstsentry,
        ...
        10304 => {
            let mut fresh190 = unsafe { &mut ((*data).set.hsts_write_userp) };
            *fresh190 = unsafe { param.arg::<*mut libc::c_void>() };
        }
        10300 => {
            if (unsafe { (*data).hsts }).is_null() {
                let mut fresh191 = unsafe { &mut ((*data).hsts) };
            ...
            if !argptr.is_null() {
                Curl_hsts_loadfile(data, unsafe { (*data).hsts }, argptr);
            }
        }
        299 => {
            arg = unsafe { param.arg::<i64>() };
            if arg & ((1 as i32) << 0 as i32) as i64 != 0 {
                if (unsafe { (*data).hsts }).is_null() {
                    let mut fresh192 = unsafe { &mut ((*data).hsts) };
        ...
        10287 => {
            if (unsafe { (*data).asi }).is_null() {
                let mut fresh193 = unsafe { &mut ((*data).asi) };
            ...
            if !argptr.is_null() {
                Curl_altsvc_load(unsafe { (*data).asi }, argptr);
            }
        }
        286 => {
            if (unsafe { (*data).asi }).is_null() {
                let mut fresh194 = unsafe { &mut ((*data).asi) };
            ...
            arg = unsafe { param.arg::<i64>() };
            result = Curl_altsvc_ctrl(unsafe { (*data).asi }, arg);
            if result as u64 != 0 {
                return result;
            }
        }
