...
#[no_mangle]
pub extern "C" fn Curl_sha256it(mut output: *mut u8, mut input: *const u8, length: u64) {
    ...
    [{
        let mut init = HMAC_params {
            ...
            >(core::intrinsics::transmute::<
                Option<
                    unsafe extern "C" fn(_: *mut crate::src::lib::sha256::SHA256state_st) -> i32,
                >,
                Option<unsafe extern "C" fn() -> ()>,
            >(Some(SHA256_Init))),
            ...
            >(core::intrinsics::transmute::<
                Option<
                    unsafe extern "C" fn(
                        _: *mut crate::src::lib::sha256::SHA256state_st,
