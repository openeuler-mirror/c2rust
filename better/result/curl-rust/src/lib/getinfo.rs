...
pub struct Curl_ssl {
    ...
    >,
    pub data_pending:
        Option<unsafe extern "C" fn(_: *const crate::src::lib::http2::connectdata, _: i32) -> bool>,
    pub random: Option<
        unsafe extern "C" fn(_: *mut crate::src::lib::http2::Curl_easy, _: *mut u8, _: u64) -> u32,
    >,
    ...
    >,
    pub getsock: Option<
        unsafe extern "C" fn(_: *mut crate::src::lib::http2::connectdata, _: *mut i32) -> i32,
    >,
    pub get_internals: Option<
        unsafe extern "C" fn(
            _: *mut crate::src::lib::http2::ssl_connect_data,
            _: u32,
        ) -> *mut core::ffi::c_void,
    >,
    ...
    pub set_engine: Option<
        unsafe extern "C" fn(_: *mut crate::src::lib::http2::Curl_easy, _: *const i8) -> u32,
    >,
    pub set_engine_default:
        Option<unsafe extern "C" fn(_: *mut crate::src::lib::http2::Curl_easy) -> u32>,
    pub engines_list: Option<
        unsafe extern "C" fn(
            _: *mut crate::src::lib::http2::Curl_easy,
    ...
    >,
    pub disassociate_connection:
        Option<unsafe extern "C" fn(_: *mut crate::src::lib::http2::Curl_easy, _: i32) -> ()>,
}
impl Curl_ssl {
    pub const fn new() -> Self {
        Curl_ssl {
...
#[no_mangle]
pub extern "C" fn Curl_initinfo(mut data: *mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut pro: Option<&'_ mut crate::src::lib::http2::Progress> = Some(unsafe { &mut (*data).progress });
    let mut info: Option<&'_ mut crate::src::lib::http2::PureInfo> = Some(unsafe { &mut (*data).info });
    ...
    (unsafe { Curl_cfree.expect("non-null function pointer")(
        (*(borrow_mut(&mut info)).unwrap()).contenttype as *mut libc::c_void,
    ) });
    let mut fresh0 = &mut ((*(borrow_mut(&mut info)).unwrap()).contenttype);
    *fresh0 = 0 as *mut i8;
    (unsafe { Curl_cfree.expect("non-null function pointer")(
        (*(borrow_mut(&mut info)).unwrap()).wouldredirect as *mut libc::c_void,
    ) });
...
extern "C" fn getinfo_long(
    ...
    match info as u32 {
        ...
        2097181 => {
            sockfd = Curl_getconnectinfo(
                data,
                Option::<&'_ mut *mut crate::src::lib::http2::connectdata>::None,
            );
            if sockfd != -(1 as i32) {
...
extern "C" fn getinfo_slist(
    ...
    match info as u32 {
        ...
        4194347 | 4194349 => {
            let mut tsip: *mut *mut crate::src::lib::http2::curl_tlssessioninfo =
                param_slistp as *mut *mut curl_tlssessioninfo;
            let mut tsi: *mut crate::src::lib::http2::curl_tlssessioninfo = unsafe { &mut (*data).tsi };
            let mut conn: *mut crate::src::lib::http2::connectdata = unsafe { (*data).conn };
            (unsafe { *tsip = tsi });
            (unsafe { (*tsi).backend = Curl_ssl_backend() as curl_sslbackend });
            let mut fresh3 = unsafe { &mut ((*tsi).internals) };
            ...
            if !conn.is_null() && (unsafe { (*tsi).backend }) as u32 != CURLSSLBACKEND_NONE as i32 as u32 {
                        ...
                        .wrapping_div(::std::mem::size_of::<ssl_connect_data>() as u64)
                {
                    if (unsafe { ((*conn).ssl[i as usize]).use_0() }) != 0 {
                        let mut fresh4 = unsafe { &mut ((*tsi).internals) };
...
extern "C" fn getinfo_socket(
    ...
    match info as u32 {
        5242924 => {
            (unsafe { *param_socketp = Curl_getconnectinfo(
                data,
                Option::<&'_ mut *mut crate::src::lib::http2::connectdata>::None,
            ) });
        }
