...
#[no_mangle]
pub extern "C" fn Curl_num_addresses(
...
pub extern "C" fn Curl_printable_address(
    ...
    match unsafe { (*ai).ai_family } {
        2 => {
            let mut sa4: *const crate::src::lib::connect::sockaddr_in =
                (unsafe { (*ai).ai_addr }) as *const libc::c_void as *const sockaddr_in;
            let mut ipaddr4: *const crate::src::lib::connect::in_addr = unsafe { &(*sa4).sin_addr };
            (unsafe { inet_ntop(
                (*ai).ai_family,
        ...
        10 => {
            let mut sa6: *const crate::src::lib::connect::sockaddr_in6 =
                (unsafe { (*ai).ai_addr }) as *const libc::c_void as *const sockaddr_in6;
            let mut ipaddr6: *const crate::src::lib::connect::in6_addr = unsafe { &(*sa6).sin6_addr };
            (unsafe { inet_ntop(
                (*ai).ai_family,
...
extern "C" fn create_hostcache_id(
    ...
    let mut len: u64 = unsafe { strlen(name) };
...
extern "C" fn hostcache_timestamp_remove(
    ...
    let mut data: *mut crate::src::lib::hostip::hostcache_prune_data =
        datap as *mut hostcache_prune_data;
...
extern "C" fn hostcache_prune(
    ...
    Curl_hash_clean_with_criterium(
        ...
        Some(hostcache_timestamp_remove),
    );
}
#[no_mangle]
pub extern "C" fn Curl_hostcache_prune(mut data: *mut crate::src::lib::http2::Curl_easy) {
    let mut now: i64 = 0;
...
pub extern "C" fn Curl_fetch_addr(
    ...
    if !dns.is_null() {
        let mut fresh5 = unsafe { &mut ((*dns).inuse) };
        *fresh5 += 1;
    }
    if !(unsafe { (*data).share }).is_null() {
        Curl_share_unlock(data, CURL_LOCK_DATA_DNS);
...
extern "C" fn Curl_shuffle_addr<'a1>(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    ...
    if num_addrs > 1 as i32 {
        let mut nodes: *mut *mut crate::src::lib::http2::Curl_addrinfo =
            0 as *mut *mut Curl_addrinfo;
        (unsafe { Curl_infof(
            data,
        ...
        if !nodes.is_null() {
            ...
            let mut fresh6 = unsafe { &mut (*nodes.offset(0 as i32 as isize)) };
            *fresh6 = *(borrow_mut(&mut addr)).unwrap();
            i = 1 as i32;
            while i < num_addrs {
                let mut fresh7 = unsafe { &mut (*nodes.offset(i as isize)) };
            ...
            if !rnd.is_null() {
                if Curl_rand(data, rnd as *mut u8, rnd_size) as u32 == CURLE_OK as i32 as u32 {
                    let mut swap_tmp: *mut crate::src::lib::http2::Curl_addrinfo =
                        0 as *mut Curl_addrinfo;
                    i = num_addrs - 1 as i32;
                    while i > 0 as i32 {
                        swap_tmp = unsafe { *nodes.offset(
                            (*rnd.offset(i as isize)).wrapping_rem((i + 1 as i32) as u32) as isize,
                        ) };
                        let mut fresh8 = unsafe { &mut (*nodes.offset(
                            (*rnd.offset(i as isize)).wrapping_rem((i + 1 as i32) as u32) as isize,
                        )) };
                        *fresh8 = unsafe { *nodes.offset(i as isize) };
                        let mut fresh9 = unsafe { &mut (*nodes.offset(i as isize)) };
                        *fresh9 = swap_tmp;
                        i -= 1;
                    }
                    i = 1 as i32;
                    while i < num_addrs {
                        let mut fresh10 = unsafe { &mut ((**nodes.offset((i - 1 as i32) as isize)).ai_next) };
                        *fresh10 = unsafe { *nodes.offset(i as isize) };
                        i += 1;
                    }
                    let mut fresh11 =
                        unsafe { &mut ((**nodes.offset((num_addrs - 1 as i32) as isize)).ai_next) };
                    *fresh11 = 0 as *mut Curl_addrinfo;
                    *(borrow_mut(&mut addr)).unwrap() = unsafe { *nodes.offset(0 as i32 as isize) };
                }
...
pub extern "C" fn Curl_cache_addr(
    ...
    let mut fresh12 = unsafe { &mut ((*dns).addr) };
    *fresh12 = addr;
    ...
    dns = dns2;
    let mut fresh13 = unsafe { &mut ((*dns).inuse) };
    *fresh13 += 1;
    return dns;
}
extern "C" fn get_localhost6(mut port: i32) -> *mut crate::src::lib::http2::Curl_addrinfo {
    ...
    let hostlen: u64 = unsafe { strlen(b"localhost\0" as *const u8 as *const i8) };
    ...
    let mut fresh14 = unsafe { &mut ((*ca).ai_next) };
    *fresh14 = 0 as *mut Curl_addrinfo;
    let mut fresh15 = unsafe { &mut ((*ca).ai_addr) };
    *fresh15 = (unsafe { (ca as *mut i8).offset(::std::mem::size_of::<Curl_addrinfo>() as u64 as isize) })
    ...
    let mut fresh16 = unsafe { &mut ((*ca).ai_canonname) };
...
extern "C" fn get_localhost(mut port: i32) -> *mut crate::src::lib::http2::Curl_addrinfo {
    let mut ca: *mut crate::src::lib::http2::Curl_addrinfo = 0 as *mut Curl_addrinfo;
    ...
    (unsafe { (*ca).ai_protocol = IPPROTO_TCP as i32 });
    (unsafe { (*ca).ai_addrlen = ss_size as curl_socklen_t });
    let mut fresh17 = unsafe { &mut ((*ca).ai_addr) };
    *fresh17 = (unsafe { (ca as *mut i8).offset(::std::mem::size_of::<Curl_addrinfo>() as u64 as isize) })
    ...
    let mut fresh18 = unsafe { &mut ((*ca).ai_canonname) };
    *fresh18 = unsafe { ((*ca).ai_addr as *mut i8).offset(ss_size as isize) };
    (unsafe { strcpy((*ca).ai_canonname, b"localhost\0" as *const u8 as *const i8) });
    let mut fresh19 = unsafe { &mut ((*ca).ai_next) };
    *fresh19 = get_localhost6(port);
    return ca;
}
#[no_mangle]
pub extern "C" fn Curl_ipv6works(mut data: *mut crate::src::lib::http2::Curl_easy) -> bool {
    if !data.is_null() {
        return unsafe { (*(*data).multi).ipv6_works };
    } else {
        let mut ipv6_works: i32 = -(1 as i32);
        let mut s: i32 = unsafe { socket(10 as i32, SOCK_DGRAM as i32, 0 as i32) };
        if s == -(1 as i32) {
            ipv6_works = 0 as i32;
        } else {
            ipv6_works = 1 as i32;
...
#[no_mangle]
pub extern "C" fn Curl_resolv<'a1>(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    mut hostname: *const i8,
    mut port: i32,
    mut allowDOH: bool,
    ...
    *(borrow_mut(&mut entry)).unwrap() = 0 as *mut Curl_dns_entry;
    let mut fresh20 = unsafe { &mut ((*conn).bits) };
    ...
    if !dns.is_null() {
        ...
        let mut fresh21 = unsafe { &mut ((*dns).inuse) };
        *fresh21 += 1;
    ...
    if dns.is_null() {
        ...
        if addr.is_null() {
            ...
            if Curl_strcasecompare(hostname, b"localhost\0" as *const u8 as *const i8) != 0 {
...
#[no_mangle]
pub extern "C" fn Curl_resolv_timeout<'a1>(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    mut hostname: *const i8,
    mut port: i32,
    mut entry: Option<&'a1 mut *mut crate::src::lib::http2::Curl_dns_entry>,
...
#[no_mangle]
pub extern "C" fn Curl_resolv_unlock(
    mut data: *mut crate::src::lib::http2::Curl_easy,
...
extern "C" fn freednsentry(mut freethis: *mut core::ffi::c_void) {
    let mut dns: *mut crate::src::lib::http2::Curl_dns_entry = freethis as *mut Curl_dns_entry;
    let mut fresh22 = unsafe { &mut ((*dns).inuse) };
    *fresh22 -= 1;
    if (unsafe { (*dns).inuse }) == 0 as i32 as i64 {
        Curl_freeaddrinfo(unsafe { (*dns).addr });
        (unsafe { Curl_cfree.expect("non-null function pointer")(dns as *mut libc::c_void) });
    }
}
#[no_mangle]
pub extern "C" fn Curl_mk_dnscache<'a1>(
    ...
    return Curl_hash_init(
        ...
        7 as i32,
        Some(Curl_hash_str),
        Some(Curl_str_key_compare),
        Some(freednsentry),
    );
}
#[no_mangle]
pub extern "C" fn Curl_hostcache_clean(
    mut data: *mut crate::src::lib::http2::Curl_easy,
...
#[no_mangle]
pub extern "C" fn Curl_loadhostpairs(mut data: *mut crate::src::lib::http2::Curl_easy) -> u32 {
    ...
    let mut fresh23 = unsafe { &mut ((*data).state) };
        ...
        if !(unsafe { (*hostp).data }).is_null() {
            if (unsafe { *((*hostp).data).offset(0 as i32 as isize) }) as i32 == '-' as i32 {
                        ...
                        || (unsafe { *end_ptr }) as i32 != ':' as i32)
                    {
                        ...
                        loop {
                            ...
                            if ai.is_null() {
                                ...
                                let mut fresh24 = unsafe { &mut ((*tail).ai_next) };
                                *fresh24 = ai;
                ...
                if !dns.is_null() {
                    ...
                    let mut fresh25 = unsafe { &mut ((*dns).inuse) };
                    *fresh25 -= 1;
                }
                if !(unsafe { (*data).share }).is_null() {
                    Curl_share_unlock(data, CURL_LOCK_DATA_DNS);
                    ...
                    && hostname[1 as i32 as usize] as i32 == '\u{0}' as i32
                {
                    ...
                    let mut fresh26 = unsafe { &mut ((*data).state) };
    ...
    let mut fresh27 = unsafe { &mut ((*data).state.resolve) };
    *fresh27 = 0 as *mut curl_slist;
    return CURLE_OK;
}
#[no_mangle]
pub extern "C" fn Curl_resolv_check<'a1>(
    mut data: *mut crate::src::lib::http2::Curl_easy,
...
#[no_mangle]
pub extern "C" fn Curl_once_resolved<'a1>(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    ...
    if !(unsafe { (*data).state.async_0.dns }).is_null() {
        let mut fresh28 = unsafe { &mut ((*conn).dns_entry) };
        *fresh28 = unsafe { (*data).state.async_0.dns };
        let mut fresh29 = unsafe { &mut ((*data).state.async_0.dns) };
...
#[no_mangle]
pub extern "C" fn Curl_resolver_error(mut data: *mut crate::src::lib::http2::Curl_easy) -> u32 {
