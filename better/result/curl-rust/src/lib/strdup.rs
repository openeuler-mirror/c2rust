...
pub extern "C" fn Curl_memdup(
    ...
    let mut buffer: *mut core::ffi::c_void =
        unsafe { Curl_cmalloc.expect("non-null function pointer")(length) };
    if buffer.is_null() {
...
pub extern "C" fn Curl_saferealloc(
    ...
    let mut datap: *mut core::ffi::c_void =
        unsafe { Curl_crealloc.expect("non-null function pointer")(ptr, size) };
