...
extern "C" {
    ...
    fn nghttp2_session_want_read(session: *mut crate::src::lib::speedcheck::nghttp2_session)
        -> i32;
    ...
    fn nghttp2_session_callbacks_set_error_callback(
        ...
        error_callback_0: Option<
            unsafe extern "C" fn(
                _: *mut crate::src::lib::speedcheck::nghttp2_session,
                _: *const i8,
                _: u64,
                _: *mut core::ffi::c_void,
            ) -> i32,
    ...
    fn nghttp2_session_callbacks_del(
        callbacks: *mut crate::src::lib::http2::nghttp2_session_callbacks,
    );
    fn nghttp2_session_callbacks_set_send_callback(
        cbs: *mut crate::src::lib::http2::nghttp2_session_callbacks,
        send_callback_0: Option<
            unsafe extern "C" fn(
                _: *mut crate::src::lib::speedcheck::nghttp2_session,
                _: *const u8,
                _: u64,
    ...
    fn nghttp2_session_callbacks_set_on_frame_recv_callback(
        cbs: *mut crate::src::lib::http2::nghttp2_session_callbacks,
        on_frame_recv_callback: Option<
            unsafe extern "C" fn(
                _: *mut crate::src::lib::speedcheck::nghttp2_session,
                _: *const crate::src::lib::http2::nghttp2_frame,
                _: *mut core::ffi::c_void,
            ) -> i32,
        >,
    );
    fn nghttp2_session_callbacks_set_on_data_chunk_recv_callback(
        cbs: *mut crate::src::lib::http2::nghttp2_session_callbacks,
        on_data_chunk_recv_callback: Option<
            unsafe extern "C" fn(
                _: *mut crate::src::lib::speedcheck::nghttp2_session,
                _: u8,
                _: i32,
    ...
    fn nghttp2_session_callbacks_set_on_stream_close_callback(
        cbs: *mut crate::src::lib::http2::nghttp2_session_callbacks,
        on_stream_close_callback: Option<
            unsafe extern "C" fn(
                _: *mut crate::src::lib::speedcheck::nghttp2_session,
                _: i32,
                _: u32,
    ...
    fn nghttp2_session_callbacks_set_on_begin_headers_callback(
        cbs: *mut crate::src::lib::http2::nghttp2_session_callbacks,
        on_begin_headers_callback: Option<
            unsafe extern "C" fn(
                _: *mut crate::src::lib::speedcheck::nghttp2_session,
                _: *const crate::src::lib::http2::nghttp2_frame,
                _: *mut core::ffi::c_void,
...
impl UrlState {
    pub const fn new() -> Self {
        UrlState { conn_cache : (0 as * mut crate :: src :: lib :: http2 :: conncache) , keeps_speed : crate :: src :: lib :: http2 :: curltime :: new () , lastconnect_id : 0 , headerb : crate :: src :: lib :: http2 :: dynbuf :: new () , buffer : (0 as * mut i8) , ulbuf : (0 as * mut i8) , current_speed : 0 , first_host : (0 as * mut i8) , retrycount : 0 , first_remote_port : 0 , session : (0 as * mut crate :: src :: lib :: http2 :: Curl_ssl_session) , sessionage : 0 , tempwrite : [crate :: src :: lib :: http2 :: tempbuf :: new () , crate :: src :: lib :: http2 :: tempbuf :: new () , crate :: src :: lib :: http2 :: tempbuf :: new () ,] , tempcount : 0 , os_errno : 0 , scratch : (0 as * mut i8) , followlocation : 0 , prev_signal : None , digest : crate :: src :: lib :: http2 :: digestdata :: new () , proxydigest : crate :: src :: lib :: http2 :: digestdata :: new () , authhost : crate :: src :: lib :: http2 :: auth :: new () , authproxy : crate :: src :: lib :: http2 :: auth :: new () , async_0 : crate :: src :: lib :: http2 :: Curl_async :: new () , engine : (0 as * mut core :: ffi :: c_void) , expiretime : crate :: src :: lib :: http2 :: curltime :: new () , timenode : crate :: src :: lib :: http2 :: Curl_tree :: new () , timeoutlist : crate :: src :: lib :: http2 :: Curl_llist :: new () , expires : [crate :: src :: lib :: http2 :: time_node :: new () , crate :: src :: lib :: http2 :: time_node :: new () , crate :: src :: lib :: http2 :: time_node :: new () , crate :: src :: lib :: http2 :: time_node :: new () , crate :: src :: lib :: http2 :: time_node :: new () , crate :: src :: lib :: http2 :: time_node :: new () , crate :: src :: lib :: http2 :: time_node :: new () , crate :: src :: lib :: http2 :: time_node :: new () , crate :: src :: lib :: http2 :: time_node :: new () , crate :: src :: lib :: http2 :: time_node :: new () , crate :: src :: lib :: http2 :: time_node :: new () , crate :: src :: lib :: http2 :: time_node :: new () , crate :: src :: lib :: http2 :: time_node :: new () ,] , most_recent_ftp_entrypath : (0 as * mut i8) , httpwant : 0 , httpversion : 0 , prev_block_had_trailing_cr : [0 ,] , c2rust_padding : [0 , 0 , 0 , 0 , 0 ,] , crlf_conversions : 0 , range : (0 as * mut i8) , resume_from : 0 , rtsp_next_client_CSeq : 0 , rtsp_next_server_CSeq : 0 , rtsp_CSeq_recv : 0 , infilesize : 0 , drain : 0 , fread_func : None , in_0 : (0 as * mut core :: ffi :: c_void) , stream_depends_on : (0 as * mut crate :: src :: lib :: http2 :: Curl_easy) , stream_weight : 0 , uh : (0 as * mut crate :: src :: lib :: urlapi :: Curl_URL) , up : crate :: src :: lib :: http2 :: urlpieces :: new () , httpreq : 0 , url : (0 as * mut i8) , referer : (0 as * mut i8) , cookielist : (0 as * mut crate :: src :: lib :: http2 :: curl_slist) , resolve : (0 as * mut crate :: src :: lib :: http2 :: curl_slist) , trailers_bytes_sent : 0 , trailers_buf : crate :: src :: lib :: http2 :: dynbuf :: new () , trailers_state : 0 , aptr : crate :: src :: lib :: http2 :: dynamically_allocated_data :: new () , multi_owned_by_easy_this_is_a_follow_refused_stream_errorbuf_allow_port_authproblem_ftp_trying_alternative_wildcardmatch_expect100header_disableexpect_use_range_rangestringalloc_done_stream_depends_e_previouslypending_cookie_engine_prefer_ascii_list_only_url_alloc_referer_alloc_wildcard_resolve : [0 , 0 , 0 ,] , c2rust_padding_0 : [0 , 0 , 0 , 0 , 0 ,] }
    }
}
...
impl UrlState {
    ...
    pub fn set_multi_owned_by_easy(&mut self, int: bit) {
        use c2rust_bitfields::FieldType;
        let field = & mut self . multi_owned_by_easy_this_is_a_follow_refused_stream_errorbuf_allow_port_authproblem_ftp_trying_alternative_wildcardmatch_expect100header_disableexpect_use_range_rangestringalloc_done_stream_depends_e_previouslypending_cookie_engine_prefer_ascii_list_only_url_alloc_referer_alloc_wildcard_resolve ;
        let (lhs_bit, rhs_bit) = (0usize, 0usize);
        int.set_field(field, (lhs_bit, rhs_bit));
    }
    #[doc = " This method allows you to read from a bitfield to a value"]
    pub fn multi_owned_by_easy(&self) -> bit {
        use c2rust_bitfields::FieldType;
        type IntType = u32;
        let field = & self . multi_owned_by_easy_this_is_a_follow_refused_stream_errorbuf_allow_port_authproblem_ftp_trying_alternative_wildcardmatch_expect100header_disableexpect_use_range_rangestringalloc_done_stream_depends_e_previouslypending_cookie_engine_prefer_ascii_list_only_url_alloc_referer_alloc_wildcard_resolve ;
        let (lhs_bit, rhs_bit) = (0usize, 0usize);
        <IntType as FieldType>::get_field(field, (lhs_bit, rhs_bit))
    }
    #[doc = " This method allows you to write to a bitfield with a value"]
...
impl std::default::Default for dynamically_allocated_data {
    fn default() -> Self {
        dynamically_allocated_data::new()
    }
}
...
impl Progress {
    pub const fn new() -> Self {
        Progress {
            ...
            speeder: [0, 0, 0, 0, 0, 0],
            speeder_time: [
                crate::src::lib::http2::curltime::new(),
                crate::src::lib::http2::curltime::new(),
                crate::src::lib::http2::curltime::new(),
                crate::src::lib::http2::curltime::new(),
                crate::src::lib::http2::curltime::new(),
...
impl CookieInfo {
    pub const fn new() -> Self {
        CookieInfo {
            cookies: [
                (0 as *mut crate::src::lib::http2::Cookie),
                (0 as *mut crate::src::lib::http2::Cookie),
                (0 as *mut crate::src::lib::http2::Cookie),
                (0 as *mut crate::src::lib::http2::Cookie),
                (0 as *mut crate::src::lib::http2::Cookie),
...
pub struct UserDefined {
    ...
    pub fread_func_set:
        Option<unsafe extern "C" fn(_: *mut i8, _: u64, _: u64, _: *mut core::ffi::c_void) -> u64>,
    pub fprogress: Option<
        unsafe extern "C" fn(_: *mut core::ffi::c_void, _: f64, _: f64, _: f64, _: f64) -> i32,
    >,
    pub fxferinfo: Option<
        unsafe extern "C" fn(_: *mut core::ffi::c_void, _: i64, _: i64, _: i64, _: i64) -> i32,
    >,
    pub fdebug: Option<
        unsafe extern "C" fn(
    ...
    pub fopensocket: Option<
        unsafe extern "C" fn(
            _: *mut core::ffi::c_void,
            _: u32,
            _: *mut crate::src::lib::http2::curl_sockaddr,
        ) -> i32,
    >,
    ...
    pub hsts_read: Option<
        unsafe extern "C" fn(
            _: *mut crate::src::lib::http2::Curl_easy,
            _: *mut crate::src::lib::http2::curl_hstsentry,
            _: *mut core::ffi::c_void,
        ) -> u32,
    >,
    pub hsts_read_userp: *mut core::ffi::c_void,
    pub hsts_write: Option<
        unsafe extern "C" fn(
            _: *mut crate::src::lib::http2::Curl_easy,
            _: *mut crate::src::lib::http2::curl_hstsentry,
            _: *mut crate::src::lib::http2::curl_index,
            _: *mut core::ffi::c_void,
        ) -> u32,
    >,
    ...
    pub ssh_keyfunc: Option<
        unsafe extern "C" fn(
            _: *mut crate::src::lib::http2::Curl_easy,
            _: *const crate::src::lib::http2::curl_khkey,
            _: *const crate::src::lib::http2::curl_khkey,
            _: u32,
            _: *mut core::ffi::c_void,
        ) -> i32,
    ...
    pub rtspreq: u32,
    pub rtspversion: i64,
    pub chunk_bgn: Option<
        unsafe extern "C" fn(_: *const core::ffi::c_void, _: *mut core::ffi::c_void, _: i32) -> i64,
    >,
    pub chunk_end: Option<unsafe extern "C" fn(_: *mut core::ffi::c_void) -> i64>,
    pub fnmatch:
        Option<unsafe extern "C" fn(_: *mut core::ffi::c_void, _: *const i8, _: *const i8) -> i32>,
    ...
    pub fmultidone:
        Option<unsafe extern "C" fn(_: *mut crate::src::lib::http2::Curl_easy, _: u32) -> i32>,
    pub dohfor: *mut crate::src::lib::http2::Curl_easy,
    pub uh: *mut crate::src::lib::urlapi::Curl_URL,
    pub trailer_data: *mut core::ffi::c_void,
    pub trailer_callback: Option<
        unsafe extern "C" fn(
            _: *mut *mut crate::src::lib::http2::curl_slist,
            _: *mut core::ffi::c_void,
        ) -> i32,
    >,
...
impl UserDefined {
    pub const fn new() -> Self {
        UserDefined { err : (0 as * mut crate :: src :: lib :: http2 :: _IO_FILE) , debugdata : (0 as * mut core :: ffi :: c_void) , errorbuffer : (0 as * mut i8) , proxyport : 0 , out : (0 as * mut core :: ffi :: c_void) , in_set : (0 as * mut core :: ffi :: c_void) , writeheader : (0 as * mut core :: ffi :: c_void) , rtp_out : (0 as * mut core :: ffi :: c_void) , use_port : 0 , httpauth : 0 , proxyauth : 0 , socks5auth : 0 , maxredirs : 0 , keep_post : 0 , postfields : (0 as * mut core :: ffi :: c_void) , seek_func : None , postfieldsize : 0 , localport : 0 , localportrange : 0 , fwrite_func : None , fwrite_header : None , fwrite_rtp : None , fread_func_set : None , fprogress : None , fxferinfo : None , fdebug : None , ioctl_func : None , fsockopt : None , sockopt_client : (0 as * mut core :: ffi :: c_void) , fopensocket : None , opensocket_client : (0 as * mut core :: ffi :: c_void) , fclosesocket : None , closesocket_client : (0 as * mut core :: ffi :: c_void) , seek_client : (0 as * mut core :: ffi :: c_void) , convfromnetwork : None , convtonetwork : None , convfromutf8 : None , hsts_read : None , hsts_read_userp : (0 as * mut core :: ffi :: c_void) , hsts_write : None , hsts_write_userp : (0 as * mut core :: ffi :: c_void) , progress_client : (0 as * mut core :: ffi :: c_void) , ioctl_client : (0 as * mut core :: ffi :: c_void) , timeout : 0 , connecttimeout : 0 , accepttimeout : 0 , happy_eyeballs_timeout : 0 , server_response_timeout : 0 , maxage_conn : 0 , tftp_blksize : 0 , filesize : 0 , low_speed_limit : 0 , low_speed_time : 0 , max_send_speed : 0 , max_recv_speed : 0 , set_resume_from : 0 , headers : (0 as * mut crate :: src :: lib :: http2 :: curl_slist) , proxyheaders : (0 as * mut crate :: src :: lib :: http2 :: curl_slist) , httppost : (0 as * mut crate :: src :: lib :: http2 :: curl_httppost) , mimepost : crate :: src :: lib :: http2 :: curl_mimepart :: new () , quote : (0 as * mut crate :: src :: lib :: http2 :: curl_slist) , postquote : (0 as * mut crate :: src :: lib :: http2 :: curl_slist) , prequote : (0 as * mut crate :: src :: lib :: http2 :: curl_slist) , source_quote : (0 as * mut crate :: src :: lib :: http2 :: curl_slist) , source_prequote : (0 as * mut crate :: src :: lib :: http2 :: curl_slist) , source_postquote : (0 as * mut crate :: src :: lib :: http2 :: curl_slist) , telnet_options : (0 as * mut crate :: src :: lib :: http2 :: curl_slist) , resolve : (0 as * mut crate :: src :: lib :: http2 :: curl_slist) , connect_to : (0 as * mut crate :: src :: lib :: http2 :: curl_slist) , timecondition : 0 , proxytype : 0 , timevalue : 0 , method : 0 , httpwant : 0 , ssl : crate :: src :: lib :: http2 :: ssl_config_data :: new () , proxy_ssl : crate :: src :: lib :: http2 :: ssl_config_data :: new () , general_ssl : crate :: src :: lib :: http2 :: ssl_general_config :: new () , dns_cache_timeout : 0 , buffer_size : 0 , upload_buffer_size : 0 , private_data : (0 as * mut core :: ffi :: c_void) , http200aliases : (0 as * mut crate :: src :: lib :: http2 :: curl_slist) , ipver : 0 , max_filesize : 0 , ftp_filemethod : 0 , ftpsslauth : 0 , ftp_ccc : 0 , ftp_create_missing_dirs : 0 , ssh_keyfunc : None , ssh_keyfunc_userp : (0 as * mut core :: ffi :: c_void) , use_netrc : 0 , use_ssl : 0 , new_file_perms : 0 , new_directory_perms : 0 , ssh_auth_types : 0 , str_0 : [(0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) , (0 as * mut i8) ,] , blobs : [(0 as * mut crate :: src :: lib :: http2 :: curl_blob) , (0 as * mut crate :: src :: lib :: http2 :: curl_blob) , (0 as * mut crate :: src :: lib :: http2 :: curl_blob) , (0 as * mut crate :: src :: lib :: http2 :: curl_blob) , (0 as * mut crate :: src :: lib :: http2 :: curl_blob) , (0 as * mut crate :: src :: lib :: http2 :: curl_blob) , (0 as * mut crate :: src :: lib :: http2 :: curl_blob) , (0 as * mut crate :: src :: lib :: http2 :: curl_blob) ,] , scope_id : 0 , allowed_protocols : 0 , redir_protocols : 0 , mail_rcpt : (0 as * mut crate :: src :: lib :: http2 :: curl_slist) , rtspreq : 0 , rtspversion : 0 , chunk_bgn : None , chunk_end : None , fnmatch : None , fnmatch_data : (0 as * mut core :: ffi :: c_void) , gssapi_delegation : 0 , tcp_keepidle : 0 , tcp_keepintvl : 0 , maxconnects : 0 , expect_100_timeout : 0 , stream_depends_on : (0 as * mut crate :: src :: lib :: http2 :: Curl_easy) , stream_weight : 0 , stream_dependents : (0 as * mut crate :: src :: lib :: http2 :: Curl_http2_dep) , resolver_start : None , resolver_start_client : (0 as * mut core :: ffi :: c_void) , upkeep_interval_ms : 0 , fmultidone : None , dohfor : (0 as * mut crate :: src :: lib :: http2 :: Curl_easy) , uh : (0 as * mut crate :: src :: lib :: urlapi :: Curl_URL) , trailer_data : (0 as * mut core :: ffi :: c_void) , trailer_callback : None , is_fread_set_is_fwrite_set_free_referer_tftp_no_options_sep_headers_cookiesession_crlf_strip_path_slash_ssh_compression_get_filetime_tunnel_thru_httpproxy_prefer_ascii_remote_append_list_only_ftp_use_port_ftp_use_epsv_ftp_use_eprt_ftp_use_pret_ftp_skip_ip_hide_progress_http_fail_on_error_http_keep_sending_on_error_http_follow_location_http_transfer_encoding_allow_auth_to_other_hosts_include_header_http_set_referer_http_auto_referer_opt_no_body_upload_verbose_krb_reuse_forbid_reuse_fresh_no_signal_tcp_nodelay_ignorecl_connect_only_http_te_skip_http_ce_skip_proxy_transfer_mode_sasl_ir_wildcard_enabled_tcp_keepalive_tcp_fastopen_ssl_enable_npn_ssl_enable_alpn_path_as_is_pipewait_suppress_connect_headers_dns_shuffle_addresses_stream_depends_e_haproxyprotocol_abstract_unix_socket_disallow_username_in_url_doh_doh_get_doh_verifypeer_doh_verifyhost_doh_verifystatus_http09_allowed_mail_rcpt_allowfails : [0 , 0 , 0 , 0 , 0 , 0 , 0 , 0 ,] }
    }
}
...
impl UserDefined {
    ...
    pub fn set_is_fread_set(&mut self, int: bit) {
        use c2rust_bitfields::FieldType;
        let field = & mut self . is_fread_set_is_fwrite_set_free_referer_tftp_no_options_sep_headers_cookiesession_crlf_strip_path_slash_ssh_compression_get_filetime_tunnel_thru_httpproxy_prefer_ascii_remote_append_list_only_ftp_use_port_ftp_use_epsv_ftp_use_eprt_ftp_use_pret_ftp_skip_ip_hide_progress_http_fail_on_error_http_keep_sending_on_error_http_follow_location_http_transfer_encoding_allow_auth_to_other_hosts_include_header_http_set_referer_http_auto_referer_opt_no_body_upload_verbose_krb_reuse_forbid_reuse_fresh_no_signal_tcp_nodelay_ignorecl_connect_only_http_te_skip_http_ce_skip_proxy_transfer_mode_sasl_ir_wildcard_enabled_tcp_keepalive_tcp_fastopen_ssl_enable_npn_ssl_enable_alpn_path_as_is_pipewait_suppress_connect_headers_dns_shuffle_addresses_stream_depends_e_haproxyprotocol_abstract_unix_socket_disallow_username_in_url_doh_doh_get_doh_verifypeer_doh_verifyhost_doh_verifystatus_http09_allowed_mail_rcpt_allowfails ;
        let (lhs_bit, rhs_bit) = (0usize, 0usize);
        int.set_field(field, (lhs_bit, rhs_bit));
    }
    #[doc = " This method allows you to read from a bitfield to a value"]
    pub fn is_fread_set(&self) -> bit {
        use c2rust_bitfields::FieldType;
        type IntType = u32;
        let field = & self . is_fread_set_is_fwrite_set_free_referer_tftp_no_options_sep_headers_cookiesession_crlf_strip_path_slash_ssh_compression_get_filetime_tunnel_thru_httpproxy_prefer_ascii_remote_append_list_only_ftp_use_port_ftp_use_epsv_ftp_use_eprt_ftp_use_pret_ftp_skip_ip_hide_progress_http_fail_on_error_http_keep_sending_on_error_http_follow_location_http_transfer_encoding_allow_auth_to_other_hosts_include_header_http_set_referer_http_auto_referer_opt_no_body_upload_verbose_krb_reuse_forbid_reuse_fresh_no_signal_tcp_nodelay_ignorecl_connect_only_http_te_skip_http_ce_skip_proxy_transfer_mode_sasl_ir_wildcard_enabled_tcp_keepalive_tcp_fastopen_ssl_enable_npn_ssl_enable_alpn_path_as_is_pipewait_suppress_connect_headers_dns_shuffle_addresses_stream_depends_e_haproxyprotocol_abstract_unix_socket_disallow_username_in_url_doh_doh_get_doh_verifypeer_doh_verifyhost_doh_verifystatus_http09_allowed_mail_rcpt_allowfails ;
        let (lhs_bit, rhs_bit) = (0usize, 0usize);
        <IntType as FieldType>::get_field(field, (lhs_bit, rhs_bit))
    }
    #[doc = " This method allows you to write to a bitfield with a value"]
...
impl ssl_config_data {
    pub const fn new() -> Self {
        ssl_config_data { primary : crate :: src :: lib :: http2 :: ssl_primary_config :: new () , certverifyresult : 0 , CRLfile : (0 as * mut i8) , fsslctx : None , fsslctxp : (0 as * mut core :: ffi :: c_void) , cert_type : (0 as * mut i8) , key : (0 as * mut i8) , key_blob : (0 as * mut crate :: src :: lib :: http2 :: curl_blob) , key_type : (0 as * mut i8) , key_passwd : (0 as * mut i8) , username : (0 as * mut i8) , password : (0 as * mut i8) , authtype : 0 , certinfo_falsestart_enable_beast_no_revoke_no_partialchain_revoke_best_effort_native_ca_store_auto_client_cert : [0 ,] , c2rust_padding : [0 , 0 , 0 ,] }
    }
}
...
impl ssl_config_data {
    ...
    pub fn set_certinfo(&mut self, int: bit) {
        use c2rust_bitfields::FieldType;
        let field = & mut self . certinfo_falsestart_enable_beast_no_revoke_no_partialchain_revoke_best_effort_native_ca_store_auto_client_cert ;
        let (lhs_bit, rhs_bit) = (0usize, 0usize);
        int.set_field(field, (lhs_bit, rhs_bit));
    }
    #[doc = " This method allows you to read from a bitfield to a value"]
    pub fn certinfo(&self) -> bit {
        use c2rust_bitfields::FieldType;
        type IntType = u32;
        let field = & self . certinfo_falsestart_enable_beast_no_revoke_no_partialchain_revoke_best_effort_native_ca_store_auto_client_cert ;
        let (lhs_bit, rhs_bit) = (0usize, 0usize);
        <IntType as FieldType>::get_field(field, (lhs_bit, rhs_bit))
    }
    #[doc = " This method allows you to write to a bitfield with a value"]
...
pub struct mime_encoder {
    ...
    pub encodefunc: Option<
        unsafe extern "C" fn(
            ...
            _: u64,
            _: bool,
            _: *mut crate::src::lib::http2::curl_mimepart,
        ) -> u64,
    >,
    pub sizefunc:
        Option<unsafe extern "C" fn(_: *mut crate::src::lib::http2::curl_mimepart) -> i64>,
}
impl mime_encoder {
    pub const fn new() -> Self {
        mime_encoder {
...
impl SingleRequest {
    ...
    pub fn set_header(&mut self, int: bit) {
        use c2rust_bitfields::FieldType;
        let field = & mut self . header_content_range_upload_done_ignorebody_http_bodyless_chunk_ignore_cl_upload_chunky_getheader_forbidchunk ;
        let (lhs_bit, rhs_bit) = (0usize, 0usize);
        int.set_field(field, (lhs_bit, rhs_bit));
    }
    #[doc = " This method allows you to read from a bitfield to a value"]
    pub fn header(&self) -> bit {
        use c2rust_bitfields::FieldType;
        type IntType = u32;
        let field = & self . header_content_range_upload_done_ignorebody_http_bodyless_chunk_ignore_cl_upload_chunky_getheader_forbidchunk ;
        let (lhs_bit, rhs_bit) = (0usize, 0usize);
        <IntType as FieldType>::get_field(field, (lhs_bit, rhs_bit))
    }
    #[doc = " This method allows you to write to a bitfield with a value"]
...
impl dohdata {
    pub const fn new() -> Self {
        dohdata {
            ...
            probe: [
                crate::src::lib::http2::dnsprobe::new(),
                crate::src::lib::http2::dnsprobe::new(),
            ],
            pending: 0,
            port: 0,
...
pub struct SASLproto {
    ...
    pub sendauth: Option<
        unsafe extern "C" fn(
            _: *mut crate::src::lib::http2::Curl_easy,
            _: *mut crate::src::lib::http2::connectdata,
            _: *const i8,
            _: *const i8,
        ) -> u32,
    >,
...
impl http_conn {
    pub const fn new() -> Self {
        http_conn {
            ...
            local_settings: [
                crate::src::lib::http2::nghttp2_settings_entry::new(),
                crate::src::lib::http2::nghttp2_settings_entry::new(),
                crate::src::lib::http2::nghttp2_settings_entry::new(),
            ],
...
pub struct Curl_handler {
    ...
    >,
    pub do_it: Option<
        unsafe extern "C" fn(_: *mut crate::src::lib::http2::Curl_easy, _: *mut bool) -> u32,
    >,
    pub done: Option<
        unsafe extern "C" fn(_: *mut crate::src::lib::http2::Curl_easy, _: u32, _: bool) -> u32,
    >,
    pub do_more:
        Option<unsafe extern "C" fn(_: *mut crate::src::lib::http2::Curl_easy, _: *mut i32) -> u32>,
...
impl ConnectBits {
    pub const fn new() -> Self {
        ConnectBits { tcpconnect : [false , false ,] , proxy_ssl_connected : [false , false ,] , httpproxy_socksproxy_proxy_user_passwd_tunnel_proxy_proxy_connect_closed_close_reuse_altused_conn_to_host_conn_to_port_proxy_user_passwd_ipv6_ip_ipv6_do_more_protoconnstart_retry_authneg_rewindaftersend_ftp_use_epsv_ftp_use_eprt_ftp_use_data_ssl_ftp_use_control_ssl_netrc_bound_multiplex_tcp_fastopen_tls_enable_npn_tls_enable_alpn_connect_only_doh_abstract_unix_socket_tls_upgraded_sock_accepted_parallel_connect : [0 , 0 , 0 , 0 , 0 ,] , c2rust_padding : [0 , 0 , 0 ,] }
    }
}
...
impl ConnectBits {
    ...
    pub fn set_httpproxy(&mut self, int: bit) {
        use c2rust_bitfields::FieldType;
        let field = & mut self . httpproxy_socksproxy_proxy_user_passwd_tunnel_proxy_proxy_connect_closed_close_reuse_altused_conn_to_host_conn_to_port_proxy_user_passwd_ipv6_ip_ipv6_do_more_protoconnstart_retry_authneg_rewindaftersend_ftp_use_epsv_ftp_use_eprt_ftp_use_data_ssl_ftp_use_control_ssl_netrc_bound_multiplex_tcp_fastopen_tls_enable_npn_tls_enable_alpn_connect_only_doh_abstract_unix_socket_tls_upgraded_sock_accepted_parallel_connect ;
        let (lhs_bit, rhs_bit) = (0usize, 0usize);
        int.set_field(field, (lhs_bit, rhs_bit));
    }
    #[doc = " This method allows you to read from a bitfield to a value"]
    pub fn httpproxy(&self) -> bit {
        use c2rust_bitfields::FieldType;
        type IntType = u32;
        let field = & self . httpproxy_socksproxy_proxy_user_passwd_tunnel_proxy_proxy_connect_closed_close_reuse_altused_conn_to_host_conn_to_port_proxy_user_passwd_ipv6_ip_ipv6_do_more_protoconnstart_retry_authneg_rewindaftersend_ftp_use_epsv_ftp_use_eprt_ftp_use_data_ssl_ftp_use_control_ssl_netrc_bound_multiplex_tcp_fastopen_tls_enable_npn_tls_enable_alpn_connect_only_doh_abstract_unix_socket_tls_upgraded_sock_accepted_parallel_connect ;
        let (lhs_bit, rhs_bit) = (0usize, 0usize);
        <IntType as FieldType>::get_field(field, (lhs_bit, rhs_bit))
    }
    #[doc = " This method allows you to write to a bitfield with a value"]
...
pub type nghttp2_data_source_read_callback<'a1, 'a2, 'a3, 'a4, 'a5> = Option<
    unsafe extern "C" fn(
        _: Option<&'a1 mut crate::src::lib::speedcheck::nghttp2_session>,
        _: i32,
        _: Option<&'a2 mut u8>,
        _: u64,
        _: Option<&'a3 mut u32>,
        _: Option<&'a4 mut crate::src::lib::http2::nghttp2_data_source>,
        _: Option<&'a5 mut core::ffi::c_void>,
    ) -> i64,
>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct nghttp2_data_provider {
    ...
    pub read_callback: Option<
        unsafe extern "C" fn(
            ...
            _: u64,
            _: *mut u32,
            _: *mut crate::src::lib::http2::nghttp2_data_source,
            _: *mut core::ffi::c_void,
        ) -> i64,
    >,
}
...
pub type nghttp2_send_callback<'a1, 'a2, 'a3> = Option<
    unsafe extern "C" fn(
        _: Option<&'a1 mut crate::src::lib::speedcheck::nghttp2_session>,
        _: Option<&'a2 u8>,
        _: u64,
...
>;
pub type nghttp2_on_frame_recv_callback<'a1, 'a2, 'a3> = Option<
    unsafe extern "C" fn(
        _: Option<&'a1 mut crate::src::lib::speedcheck::nghttp2_session>,
        _: Option<&'a2 crate::src::lib::http2::nghttp2_frame>,
        _: Option<&'a3 mut core::ffi::c_void>,
    ) -> i32,
>;
pub type nghttp2_on_data_chunk_recv_callback<'a1, 'a2, 'a3> = Option<
    unsafe extern "C" fn(
        _: Option<&'a1 mut crate::src::lib::speedcheck::nghttp2_session>,
        _: u8,
        _: i32,
...
>;
pub type nghttp2_on_stream_close_callback<'a1, 'a2> = Option<
    unsafe extern "C" fn(
        _: Option<&'a1 mut crate::src::lib::speedcheck::nghttp2_session>,
        _: i32,
        _: u32,
...
>;
pub type nghttp2_on_begin_headers_callback<'a1, 'a2, 'a3> = Option<
    unsafe extern "C" fn(
        _: Option<&'a1 mut crate::src::lib::speedcheck::nghttp2_session>,
        _: Option<&'a2 crate::src::lib::http2::nghttp2_frame>,
        _: Option<&'a3 mut core::ffi::c_void>,
...
>;
pub type nghttp2_on_header_callback<'a1, 'a2, 'a3, 'a4, 'a5> = Option<
    unsafe extern "C" fn(
        _: Option<&'a1 mut crate::src::lib::speedcheck::nghttp2_session>,
        _: Option<&'a2 crate::src::lib::http2::nghttp2_frame>,
        _: Option<&'a3 u8>,
...
>;
pub type nghttp2_error_callback<'a1, 'a2, 'a3> = Option<
    unsafe extern "C" fn(
        _: Option<&'a1 mut crate::src::lib::speedcheck::nghttp2_session>,
        _: Option<&'a2 i8>,
        _: u64,
...
#[no_mangle]
pub extern "C" fn Curl_http2_init_state<'a1>(
    mut state: Option<&'a1 mut crate::src::lib::http2::UrlState>,
) {
    (*(borrow_mut(&mut state)).unwrap()).stream_weight = 16 as i32;
}
#[no_mangle]
pub extern "C" fn Curl_http2_init_userset<'a1>(
    mut set: Option<&'a1 mut crate::src::lib::http2::UserDefined>,
) {
...
extern "C" fn http2_getsock(
    ...
    let mut c: Option<&'_ crate::src::lib::http2::http_conn> = Some(unsafe { &mut (*conn).proto.httpc });
    ...
    if (*(borrow(&k)).unwrap()).keepon & ((1 as i32) << 1 as i32 | (1 as i32) << 5 as i32)
        == (1 as i32) << 1 as i32
        || (unsafe { nghttp2_session_want_write((*((c).clone()).unwrap()).h2) }) != 0
    {
        bitmap |= (1 as i32) << 16 as i32 + 0 as i32;
    }
    return bitmap;
}
extern "C" fn http2_stream_free(mut http: *mut crate::src::lib::http2::HTTP) {
    if !http.is_null() {
        Curl_dyn_free(unsafe { &mut (*http).header_recvbuf });
...
extern "C" fn http2_disconnect(
    ...
    let mut c: Option<&'_ mut crate::src::lib::http2::http_conn> = Some(unsafe { &mut (*conn).proto.httpc });
    (unsafe { nghttp2_session_del((*(borrow_mut(&mut c)).unwrap()).h2) });
    (unsafe { Curl_cfree.expect("non-null function pointer")(
        (*(borrow_mut(&mut c)).unwrap()).inbuf as *mut libc::c_void,
    ) });
    let mut fresh2 = &mut ((*(borrow_mut(&mut c)).unwrap()).inbuf);
    *fresh2 = 0 as *mut i8;
    return CURLE_OK;
}
extern "C" fn http2_connisdead(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    mut conn: *mut crate::src::lib::http2::connectdata,
) -> bool {
    let mut sval: i32 = 0;
    ...
    if sval == 0 as i32 {
        ...
        if !dead {
            ...
            let mut httpc: Option<&'_ mut crate::src::lib::http2::http_conn> =
                Some(unsafe { &mut (*conn).proto.httpc });
            let mut nread: i64 = -(1 as i32) as ssize_t;
            if ((*(borrow(&httpc)).unwrap()).recv_underlying).is_some() {
                nread = unsafe { ((*(borrow(&httpc)).unwrap()).recv_underlying)
...
extern "C" fn set_transfer<'a1>(
    mut c: Option<&'a1 mut crate::src::lib::http2::http_conn>,
    mut data: *mut crate::src::lib::http2::Curl_easy,
) {
    let mut fresh3 = &mut ((*(borrow_mut(&mut c)).unwrap()).trnsfr);
    *fresh3 = data;
}
extern "C" fn get_transfer<'a1>(
    mut c: Option<&'a1 mut crate::src::lib::http2::http_conn>,
) -> *mut crate::src::lib::http2::Curl_easy {
...
extern "C" fn http2_conncheck(
    ...
    if checks_to_perform & ((1 as i32) << 1 as i32) as u32 != 0 {
        ...
        let mut elapsed: i64 = Curl_timediff(now, unsafe { (*conn).keepalive });
        if elapsed > (unsafe { (*data).set.upkeep_interval_ms }) {
            rc = unsafe { nghttp2_submit_ping(
    ...
    if send_frames {
        ...
        rc = unsafe { nghttp2_session_send((*(borrow_mut(&mut c)).unwrap()).h2) };
        if rc != 0 {
            (unsafe { Curl_failf(
                data,
...
#[no_mangle]
pub extern "C" fn Curl_http2_setup_req(mut data: *mut crate::src::lib::http2::Curl_easy) {
    let mut http: *mut crate::src::lib::http2::HTTP = unsafe { (*data).req.p.http };
    (unsafe { (*http).bodystarted = 0 as i32 != 0 });
    (unsafe { (*http).status_code = -(1 as i32) });
    let mut fresh4 = unsafe { &mut ((*http).pausedata) };
    *fresh4 = 0 as *const uint8_t;
    ...
    let mut fresh5 = unsafe { &mut ((*http).mem) };
    *fresh5 = 0 as *mut i8;
...
#[no_mangle]
pub extern "C" fn Curl_http2_setup_conn(mut conn: *mut crate::src::lib::http2::connectdata) {
...
static mut Curl_handler_http2: crate::src::lib::http2::Curl_handler =  {
    {
        let mut init = Curl_handler {
            ...
            setup_connection: None,
            do_it: Some(Curl_http),
            done: Some(Curl_http_done),
            do_more: None,
            connect_it: None,
            connecting: None,
            doing: None,
            proto_getsock: Some(http2_getsock),
            doing_getsock: Some(http2_getsock),
            domore_getsock: None,
            perform_getsock: Some(http2_getsock),
            disconnect: Some(http2_disconnect),
            readwrite: None,
            connection_check: Some(http2_conncheck),
            attach: None,
            defport: 80 as i32,
...
#[no_mangle]
pub extern "C" fn Curl_http2_ver(mut p: *mut i8, mut len: u64) {
    let mut h2: *mut crate::src::lib::http2::nghttp2_info = unsafe { nghttp2_version(0 as i32) };
...
extern "C" fn send_callback(
    ...
    written = unsafe { ((*(borrow(&c)).unwrap()).send_underlying).expect("non-null function pointer")(
        data,
        0 as i32,
...
#[no_mangle]
pub extern "C" fn curl_pushheader_bynum<'a1>(
    mut h: Option<&'a1 mut crate::src::lib::http2::curl_pushheaders>,
    mut num: u64,
) -> *mut i8 {
    if borrow(&h).is_none()
        || !(!((*(borrow(&h)).unwrap()).data).is_null()
            && (unsafe { (*(*(borrow(&h)).unwrap()).data).magic }) == 0xc0dedbad as u32)
    {
        return 0 as *mut i8;
    } else {
        let mut stream: *mut crate::src::lib::http2::HTTP =
            unsafe { (*(*(borrow_mut(&mut h)).unwrap()).data).req.p.http };
...
#[no_mangle]
pub extern "C" fn curl_pushheader_byname<'a1>(
    mut h: Option<&'a1 mut crate::src::lib::http2::curl_pushheaders>,
    mut header: *const i8,
) -> *mut i8 {
    if borrow(&h).is_none()
        ...
        || !(unsafe { strchr(header.offset(1 as i32 as isize), ':' as i32) }).is_null()
    {
        ...
        let mut stream: *mut crate::src::lib::http2::HTTP =
            unsafe { (*(*(borrow_mut(&mut h)).unwrap()).data).req.p.http };
        let mut len: u64 = unsafe { strlen(header) };
        let mut i: u64 = 0;
...
extern "C" fn drained_transfer<'a1>(
    mut data: *mut crate::src::lib::http2::Curl_easy,
...
extern "C" fn drain_this<'a1>(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    mut httpc: Option<&'a1 mut crate::src::lib::http2::http_conn>,
) {
    let mut fresh7 = unsafe { &mut ((*data).state.drain) };
    *fresh7 = (*fresh7).wrapping_add(1);
    let mut fresh8 = &mut ((*(borrow_mut(&mut httpc)).unwrap()).drain_total);
    *fresh8 = (*fresh8).wrapping_add(1);
}
extern "C" fn duphandle(
    mut data: *mut crate::src::lib::http2::Curl_easy,
) -> *mut crate::src::lib::http2::Curl_easy {
    let mut second: *mut crate::src::lib::http2::Curl_easy = curl_easy_duphandle(data);
    if !second.is_null() {
        let mut http: *mut crate::src::lib::http2::HTTP = (unsafe { Curl_ccalloc
            .expect("non-null function pointer")(
            1 as i32 as size_t,
        ...
        if http.is_null() {
            ...
            let mut fresh9 = unsafe { &mut ((*second).req.p.http) };
            *fresh9 = http;
            Curl_dyn_init(
                unsafe { &mut (*http).header_recvbuf },
...
extern "C" fn set_transfer_url<'a1>(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    ...
    match current_block {
        8515828400728868193 => {
            ...
            if !v.is_null() {
                uc = curl_url_set(u, CURLUPART_HOST, v, 0 as i32 as u32);
                if uc as u64 != 0 {
                    rc = 2 as i32;
                    current_block = 15190465896548324989;
                } else {
            ...
            match current_block {
                ...
                _ => {
                    ...
                    if !v.is_null() {
                        uc = curl_url_set(u, CURLUPART_PATH, v, 0 as i32 as u32);
                        if uc as u64 != 0 {
                            rc = 3 as i32;
                            current_block = 15190465896548324989;
                        } else {
                    ...
                    match current_block {
                        15190465896548324989 => {}
                        _ => {
                            uc = curl_url_get(u, CURLUPART_URL, Some(&mut url), 0 as i32 as u32);
                            if uc as u64 != 0 {
                                rc = 4 as i32;
                            }
                        }
    ...
    let mut fresh10 = unsafe { &mut ((*data).state) };
    (*fresh10).set_url_alloc(1 as i32 as bit);
    let mut fresh11 = unsafe { &mut ((*data).state.url) };
    *fresh11 = url;
    return 0 as i32;
}
extern "C" fn push_promise(
    ...
    if unsafe { ((*(*data).multi).push_cb).is_some() } {
        ...
        let mut httpc: Option<&'_ mut crate::src::lib::http2::http_conn> =
            Option::<&'_ mut crate::src::lib::http2::http_conn>::None;
        let mut i: u64 = 0;
                    ...
                    *fresh12 = 0 as *mut *mut i8;
                    ...
                    if rv != 0 {
                        ...
                        *fresh13 = 0 as *mut HTTP;
                        ...
                        rc = Curl_multi_add_perform(unsafe { (*data).multi }, newhandle, conn);
                        if rc as u64 != 0 {
                            (unsafe { Curl_infof(
                                data,
                            ...
                            http2_stream_free(unsafe { (*newhandle).req.p.http });
                            let mut fresh14 = unsafe { &mut ((*newhandle).req.p.http) };
                            *fresh14 = 0 as *mut HTTP;
                            Curl_close(Some(&mut newhandle));
                            rv = 1 as i32;
                        } else {
                            httpc = Some(unsafe { &mut (*conn).proto.httpc });
                            ...
                            if rv != 0 {
                                ...
                                Curl_dyn_init(
                                    unsafe { &mut (*newstream).header_recvbuf },
                                    (128 as i32 * 1024 as i32) as size_t,
                                );
                                Curl_dyn_init(
                                    unsafe { &mut (*newstream).trailer_recvbuf },
                                    (128 as i32 * 1024 as i32) as size_t,
                                );
                            }
                        }
...
extern "C" fn multi_connchanged(mut multi: *mut crate::src::lib::http2::Curl_multi) {
...
extern "C" fn on_frame_recv(
    ...
    let mut left: u64 = 0;
    let mut ncopy: u64 = 0;
    let mut stream_id: i32 = unsafe { (*frame).hd.stream_id };
    let mut result: u32 = CURLE_OK;
    if stream_id == 0 {
        if (unsafe { (*frame).hd.type_0 }) as i32 == NGHTTP2_SETTINGS as i32 {
            let mut max_conn: u32 = (*(borrow_mut(&mut httpc)).unwrap())
                .settings
                .max_concurrent_streams;
            (*(borrow_mut(&mut httpc)).unwrap())
                .settings
                .max_concurrent_streams = unsafe { nghttp2_session_get_remote_settings(
                session,
                NGHTTP2_SETTINGS_MAX_CONCURRENT_STREAMS,
            ) };
            (*(borrow_mut(&mut httpc)).unwrap()).settings.enable_push =
                (unsafe { nghttp2_session_get_remote_settings(session, NGHTTP2_SETTINGS_ENABLE_PUSH) }) != 0;
    ...
    match (unsafe { (*frame).hd.type_0 }) as i32 {
        ...
        1 => {
            if !(unsafe { (*stream).bodystarted }) {
                ...
                result = Curl_dyn_add(
                    unsafe { &mut (*stream).header_recvbuf },
                    b"\r\n\0" as *const u8 as *const i8,
                );
                if result as u64 != 0 {
                    return NGHTTP2_ERR_CALLBACK_FAILURE as i32;
                }
                left = (Curl_dyn_len(unsafe { &mut (*stream).header_recvbuf }))
                ...
                let mut fresh15 = unsafe { &mut ((*stream).nread_header_recvbuf) };
                *fresh15 = (*fresh15 as u64).wrapping_add(ncopy) as size_t as size_t;
                let mut fresh16 = unsafe { &mut ((*stream).len) };
                *fresh16 = (*fresh16 as u64).wrapping_sub(ncopy) as size_t as size_t;
                let mut fresh17 = unsafe { &mut ((*stream).memlen) };
...
extern "C" fn on_data_chunk_recv(
    ...
    let mut fresh18 = unsafe { &mut ((*stream).len) };
    *fresh18 = (*fresh18 as u64).wrapping_sub(nread) as size_t as size_t;
    let mut fresh19 = unsafe { &mut ((*stream).memlen) };
    *fresh19 = (*fresh19 as u64).wrapping_add(nread) as size_t as size_t;
    drain_this(data_s, Some(unsafe { &mut (*conn).proto.httpc }));
    if get_transfer(borrow_mut(&mut httpc)) != data_s {
        Curl_expire(data_s, 0 as i32 as timediff_t, EXPIRE_RUN_NOW);
    }
    if nread < len {
        let mut fresh20 = unsafe { &mut ((*stream).pausedata) };
...
extern "C" fn on_begin_headers(
    ...
    let mut stream: *mut crate::src::lib::http2::HTTP = 0 as *mut HTTP;
    let mut data_s: *mut crate::src::lib::http2::Curl_easy =
        0 as *mut crate::src::lib::http2::Curl_easy;
...
extern "C" fn decode_status_code(mut value: *const u8, mut len: u64) -> i32 {
    let mut i: i32 = 0;
    let mut res: i32 = 0;
...
extern "C" fn on_header(
    ...
    if (unsafe { (*frame).hd.type_0 }) as i32 == NGHTTP2_PUSH_PROMISE as i32 {
        ...
        if (unsafe { strcmp(b":authority\0" as *const u8 as *const i8, name as *const i8) }) == 0 {
            ...
            if Curl_strcasecompare(check, value as *const i8) == 0
                && ((unsafe { (*conn).remote_port }) != (unsafe { (*(*conn).given).defport })
                    || Curl_strcasecompare(unsafe { (*conn).host.name }, value as *const i8) == 0)
            {
        ...
        if (unsafe { (*stream).push_headers }).is_null() {
            ...
            let mut fresh21 = unsafe { &mut ((*stream).push_headers) };
            *fresh21 = (unsafe { Curl_cmalloc.expect("non-null function pointer")(
            ...
            let mut fresh22 = unsafe { &mut ((*stream).push_headers_alloc) };
            *fresh22 = (*fresh22 as u64).wrapping_mul(2 as i32 as u64) as size_t as size_t;
            headp = Curl_saferealloc(
                (unsafe { (*stream).push_headers }) as *mut libc::c_void,
                (unsafe { (*stream).push_headers_alloc })
                    .wrapping_mul(::std::mem::size_of::<*mut i8>() as u64),
            ) as *mut *mut i8;
            if headp.is_null() {
                let mut fresh23 = unsafe { &mut ((*stream).push_headers) };
                *fresh23 = 0 as *mut *mut i8;
                return NGHTTP2_ERR_TEMPORAL_CALLBACK_FAILURE as i32;
            }
            let mut fresh24 = unsafe { &mut ((*stream).push_headers) };
            *fresh24 = headp;
        }
        h = unsafe { curl_maprintf(b"%s:%s\0" as *const u8 as *const i8, name, value) };
        if !h.is_null() {
            let mut fresh25 = unsafe { &mut ((*stream).push_headers_used) };
            let mut fresh26 = *fresh25;
            *fresh25 = (*fresh25).wrapping_add(1);
            let mut fresh27 = unsafe { &mut (*((*stream).push_headers).offset(fresh26 as isize)) };
            *fresh27 = h;
        }
        return 0 as i32;
    }
...
extern "C" fn populate_settings<'a1>(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    mut httpc: Option<&'a1 mut crate::src::lib::http2::http_conn>,
) {
    let mut iv: *mut crate::src::lib::http2::nghttp2_settings_entry =
...
#[no_mangle]
pub extern "C" fn Curl_http2_done(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    mut premature: bool,
) {
    let mut http: *mut crate::src::lib::http2::HTTP = unsafe { (*data).req.p.http };
    let mut httpc: Option<&'_ mut crate::src::lib::http2::http_conn> =
        Some(unsafe { &mut (*(*data).conn).proto.httpc });
    Curl_dyn_free(unsafe { &mut (*http).header_recvbuf });
    Curl_dyn_free(unsafe { &mut (*http).trailer_recvbuf });
    if !(unsafe { (*http).push_headers }).is_null() {
        while (unsafe { (*http).push_headers_used }) > 0 as i32 as u64 {
            ...
            let mut fresh31 = unsafe { &mut ((*http).push_headers_used) };
            *fresh31 = (*fresh31).wrapping_sub(1);
        }
        (unsafe { Curl_cfree.expect("non-null function pointer")((*http).push_headers as *mut libc::c_void) });
        let mut fresh32 = unsafe { &mut ((*http).push_headers) };
    ...
    if premature {
        ...
        {
            (unsafe { nghttp2_session_send((*(borrow_mut(&mut httpc)).unwrap()).h2) });
        }
        if (unsafe { (*http).stream_id }) == (*(borrow(&httpc)).unwrap()).pause_stream_id {
            (unsafe { Curl_infof(
                data,
...
extern "C" fn http2_init(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    mut conn: *mut crate::src::lib::http2::connectdata,
) -> u32 {
    if (unsafe { (*conn).proto.httpc.h2 }).is_null() {
        let mut rc: i32 = 0;
        let mut callbacks: *mut crate::src::lib::http2::nghttp2_session_callbacks =
            0 as *mut nghttp2_session_callbacks;
        let mut fresh33 = unsafe { &mut ((*conn).proto.httpc.inbuf) };
        *fresh33 =
        ...
        (unsafe { nghttp2_session_callbacks_set_send_callback(callbacks, Some(send_callback)) });
        (unsafe { nghttp2_session_callbacks_set_on_frame_recv_callback(callbacks, Some(on_frame_recv)) });
        (unsafe { nghttp2_session_callbacks_set_on_data_chunk_recv_callback(
            callbacks,
            Some(on_data_chunk_recv),
        ) });
        (unsafe { nghttp2_session_callbacks_set_on_stream_close_callback(callbacks, Some(on_stream_close)) });
        (unsafe { nghttp2_session_callbacks_set_on_begin_headers_callback(callbacks, Some(on_begin_headers)) });
        (unsafe { nghttp2_session_callbacks_set_on_header_callback(callbacks, Some(on_header)) });
        (unsafe { nghttp2_session_callbacks_set_error_callback(callbacks, Some(error_callback)) });
...
pub extern "C" fn Curl_http2_request_upgrade(
    ...
    let mut k: Option<&'_ mut crate::src::lib::http2::SingleRequest> = Some(unsafe { &mut (*data).req });
    let mut binsettings: *mut u8 = unsafe { ((*conn).proto.httpc.binsettings).as_mut_ptr() };
    let mut httpc: Option<&'_ mut crate::src::lib::http2::http_conn> =
        Some(unsafe { &mut (*conn).proto.httpc });
...
extern "C" fn should_close_session<'a1>(
    mut httpc: Option<&'a1 mut crate::src::lib::http2::http_conn>,
) -> i32 {
    return ((*(borrow(&httpc)).unwrap()).drain_total == 0 as i32 as u64
        && (unsafe { nghttp2_session_want_read((*(borrow_mut(&mut httpc)).unwrap()).h2) }) == 0
        && (unsafe { nghttp2_session_want_write((*(borrow_mut(&mut httpc)).unwrap()).h2) }) == 0)
        as i32;
}
extern "C" fn h2_process_pending_input<'a1>(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    mut httpc: Option<&'a1 mut crate::src::lib::http2::http_conn>,
    mut err: *mut u32,
) -> i32 {
    ...
    let mut rv: i64 = 0;
    nread = ((*(borrow(&httpc)).unwrap()).inbuflen)
        .wrapping_sub((*(borrow(&httpc)).unwrap()).nread_inbuf) as ssize_t;
    inbuf = unsafe { ((*(borrow(&httpc)).unwrap()).inbuf)
        .offset((*(borrow(&httpc)).unwrap()).nread_inbuf as isize) };
    set_transfer(borrow_mut(&mut httpc), data);
    rv = unsafe { nghttp2_session_mem_recv(
        (*(borrow_mut(&mut httpc)).unwrap()).h2,
        inbuf as *const uint8_t,
        nread as size_t,
    ) };
    ...
    if (unsafe { nghttp2_session_check_request_allowed((*(borrow_mut(&mut httpc)).unwrap()).h2) }) == 0 as i32 {
        Curl_conncontrol(unsafe { (*data).conn }, 1 as i32);
    }
    if should_close_session(borrow_mut(&mut httpc)) != 0 {
        let mut stream: *mut crate::src::lib::http2::HTTP = unsafe { (*data).req.p.http };
...
pub extern "C" fn Curl_http2_done_sending(
        ...
        || (unsafe { (*conn).handler }) == (unsafe { &Curl_handler_http2 }) as *const Curl_handler
    {
        ...
        let mut httpc: Option<&'_ mut crate::src::lib::http2::http_conn> =
            Some(unsafe { &mut (*conn).proto.httpc });
        let mut h2: *mut crate::src::lib::speedcheck::nghttp2_session =
            (*(borrow_mut(&mut httpc)).unwrap()).h2;
...
extern "C" fn http2_handle_stream_close(
    ...
    let mut httpc: Option<&'_ mut crate::src::lib::http2::http_conn> =
        Some(unsafe { &mut (*conn).proto.httpc });
    if (*(borrow(&httpc)).unwrap()).pause_stream_id == (unsafe { (*stream).stream_id }) {
        (*(borrow_mut(&mut httpc)).unwrap()).pause_stream_id = 0 as i32;
    }
    drained_transfer(data, borrow_mut(&mut httpc));
    ...
    if (unsafe { (*stream).error }) == NGHTTP2_REFUSED_STREAM as i32 as u32 {
        ...
        let mut fresh35 = unsafe { &mut ((*data).state) };
    ...
    if Curl_dyn_len(unsafe { &mut (*stream).trailer_recvbuf }) != 0 {
        let mut trailp: *mut i8 = Curl_dyn_ptr(unsafe { &mut (*stream).trailer_recvbuf });
        ...
        loop {
            ...
            result = Curl_client_write(data, (1 as i32) << 1 as i32, trailp, len);
            if result as u64 != 0 {
                (unsafe { *err = result });
                return -(1 as i32) as ssize_t;
            }
...
extern "C" fn h2_pri_spec(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    mut pri_spec: *mut crate::src::lib::http2::nghttp2_priority_spec,
) {
    let mut depstream: *mut crate::src::lib::http2::HTTP =
    ...
    let mut fresh36 = unsafe { &mut ((*data).state) };
    (*fresh36).set_stream_depends_e(unsafe { ((*data).set).stream_depends_e() });
    let mut fresh37 = unsafe { &mut ((*data).state.stream_depends_on) };
...
extern "C" fn http2_recv(
    ...
    let mut fresh38 = unsafe { &mut ((*stream).upload_mem) };
    *fresh38 = 0 as *const uint8_t;
    (unsafe { (*stream).upload_len = 0 as i32 as size_t });
    if (unsafe { (*stream).bodystarted }) as i32 != 0
        && (unsafe { (*stream).nread_header_recvbuf }) < Curl_dyn_len(unsafe { &mut (*stream).header_recvbuf })
    {
        let mut left: u64 = (Curl_dyn_len(unsafe { &mut (*stream).header_recvbuf }))
            .wrapping_sub(unsafe { (*stream).nread_header_recvbuf });
        ...
        let mut fresh39 = unsafe { &mut ((*stream).nread_header_recvbuf) };
    ...
    if (unsafe { (*data).state.drain }) != 0 && (unsafe { (*stream).memlen }) != 0 {
        if mem != (unsafe { (*stream).mem }) {
            ...
            let mut fresh40 = unsafe { &mut ((*stream).mem) };
            *fresh40 = mem;
        }
        if (*(borrow(&httpc)).unwrap()).pause_stream_id == (unsafe { (*stream).stream_id })
            && (unsafe { (*stream).pausedata }).is_null()
        {
            (*(borrow_mut(&mut httpc)).unwrap()).pause_stream_id = 0 as i32;
            if h2_process_pending_input(data, borrow_mut(&mut httpc), err) != 0 as i32 {
                return -(1 as i32) as ssize_t;
        ...
        *fresh42 = (*fresh42 as u64).wrapping_sub(nread as u64) as size_t as size_t;
        ...
        if (*(borrow(&httpc)).unwrap()).pause_stream_id != 0 {
            ...
            let mut fresh44 = unsafe { &mut ((*stream).mem) };
            *fresh44 = mem;
            ...
            if (*(borrow(&httpc)).unwrap()).inbuflen == 0 as i32 as u64 {
                ...
                nread = ((*(borrow(&httpc)).unwrap()).inbuflen)
                    .wrapping_sub((*(borrow(&httpc)).unwrap()).nread_inbuf)
                    as ssize_t;
            }
    ...
    if (unsafe { (*stream).memlen }) != 0 {
        let mut retlen: i64 = (unsafe { (*stream).memlen }) as ssize_t;
        (unsafe { (*stream).memlen = 0 as i32 as size_t });
        if !((*(borrow(&httpc)).unwrap()).pause_stream_id == (unsafe { (*stream).stream_id })) {
            if !(unsafe { (*stream).closed }) {
                drained_transfer(data, borrow_mut(&mut httpc));
...
extern "C" fn contains_trailers(mut p: *const i8, mut len: u64) -> bool {
...
extern "C" fn inspect_header(
    ...
    match namelen {
        ...
        7 => {
            return (if Curl_strncasecompare(b"upgrade\0" as *const u8 as *const i8, name, namelen)
                != 0
            {
                HEADERINST_IGNORE as i32
            } else {
        ...
        10 => {
            return (if Curl_strncasecompare(
                ...
                || Curl_strncasecompare(b"keep-alive\0" as *const u8 as *const i8, name, namelen)
                    != 0
            {
                HEADERINST_IGNORE as i32
            } else {
...
extern "C" fn http2_send(
    ...
    if (unsafe { (*stream).stream_id }) != -(1 as i32) {
        ...
        let mut fresh45 = unsafe { &mut ((*stream).upload_mem) };
        *fresh45 = mem as *const uint8_t;
        ...
        let mut fresh46 = unsafe { &mut ((*stream).upload_mem) };
    ...
    if !(nheader < 2 as i32 as u64) {
        ...
        if !line_end.is_null() {
            ...
            if !(end.is_null() || end == hdbuf) {
                let mut fresh47 = unsafe { &mut ((*nva.offset(0 as i32 as isize)).name) };
                *fresh47 = b":method\0" as *const u8 as *const i8 as *mut u8;
                ...
                let mut fresh48 = unsafe { &mut ((*nva.offset(0 as i32 as isize)).value) };
                *fresh48 = hdbuf as *mut u8;
                            ...
                            .wrapping_sub(unsafe { (*nva.offset(0 as i32 as isize)).namelen })
                {
                    ...
                    if !(end.is_null() || end == hdbuf) {
                        let mut fresh49 = unsafe { &mut ((*nva.offset(1 as i32 as isize)).name) };
                        *fresh49 = b":path\0" as *const u8 as *const i8 as *mut u8;
                        ...
                        let mut fresh50 = unsafe { &mut ((*nva.offset(1 as i32 as isize)).value) };
                        *fresh50 = hdbuf as *mut u8;
                                    ...
                                    .wrapping_sub(unsafe { (*nva.offset(1 as i32 as isize)).namelen })
                        {
                            ...
                            let mut fresh51 = unsafe { &mut ((*nva.offset(2 as i32 as isize)).name) };
                            *fresh51 = b":scheme\0" as *const u8 as *const i8 as *mut u8;
                            ...
                            if (unsafe { (*(*conn).handler).flags }) & ((1 as i32) << 0 as i32) as u32 != 0 {
                                let mut fresh52 = unsafe { &mut ((*nva.offset(2 as i32 as isize)).value) };
                                *fresh52 = b"https\0" as *const u8 as *const i8 as *mut u8;
                            } else {
                                let mut fresh53 = unsafe { &mut ((*nva.offset(2 as i32 as isize)).value) };
                                        ...
                                        .wrapping_sub(unsafe { (*nva.offset(2 as i32 as isize)).namelen })
                            {
                                ...
                                loop {
                                    ...
                                    {
                                        authority_idx = i;
                                        let mut fresh54 = unsafe { &mut ((*nva.offset(i as isize)).name) };
                                        *fresh54 =
                                        ...
                                        let mut fresh55 = unsafe { &mut ((*nva.offset(i as isize)).name) };
                                    ...
                                    ) as u32
                                    {
                                        ...
                                        2 => {
                                            let mut fresh56 =
                                                unsafe { &mut ((*nva.offset(i as isize)).value) };
                                ...
                                match current_block {
                                    ...
                                    _ => {
                                        if authority_idx != 0 && authority_idx != 3 as i32 as u64 {
                                            let mut authority: crate::src::lib::http2::nghttp2_nv =
                                        ...
                                        match (unsafe { (*data).state.httpreq }) as u32 {
                                            1 | 2 | 3 | 4 => {
                                                ...
                                                data_prd.read_callback =
                                                    Some(data_source_read_callback);
...
pub extern "C" fn Curl_http2_setup(
    ...
    Curl_dyn_init(
        unsafe { &mut (*stream).trailer_recvbuf },
        (128 as i32 * 1024 as i32) as size_t,
    );
    (unsafe { (*stream).upload_left = 0 as i32 as curl_off_t });
    let mut fresh58 = unsafe { &mut ((*stream).upload_mem) };
    *fresh58 = 0 as *const uint8_t;
    (unsafe { (*stream).upload_len = 0 as i32 as size_t });
    let mut fresh59 = unsafe { &mut ((*stream).mem) };
    *fresh59 = unsafe { (*data).state.buffer };
    ...
    if (unsafe { (*(*conn).handler).flags }) & ((1 as i32) << 0 as i32) as u32 != 0 {
        let mut fresh60 = unsafe { &mut ((*conn).handler) };
        *fresh60 = unsafe { &Curl_handler_http2_ssl };
    } else {
        let mut fresh61 = unsafe { &mut ((*conn).handler) };
        *fresh61 = unsafe { &Curl_handler_http2 };
    }
    result = http2_init(data, conn);
    if result as u64 != 0 {
        Curl_dyn_free(unsafe { &mut (*stream).header_recvbuf });
        return result;
    }
    (unsafe { Curl_infof(
        data,
    ...
    let mut fresh62 = unsafe { &mut ((*conn).bits) };
...
pub extern "C" fn Curl_http2_switched(
    ...
    *fresh64 = unsafe { (*conn).send[0 as i32 as usize] };
    let mut fresh65 = unsafe { &mut ((*conn).recv[0 as i32 as usize]) };
    *fresh65 = Some(http2_recv);
    let mut fresh66 = unsafe { &mut ((*conn).send[0 as i32 as usize]) };
    *fresh66 = Some(http2_send);
    ...
    if nread != 0 {
        (unsafe { memcpy(
            (*(borrow_mut(&mut httpc)).unwrap()).inbuf as *mut libc::c_void,
            mem as *const libc::c_void,
            nread,
        ) });
    }
...
#[no_mangle]
pub extern "C" fn Curl_http2_stream_pause(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    mut pause: bool,
) -> u32 {
    if (unsafe { (*(*(*data).conn).handler).protocol })
        ...
        || (unsafe { (*(*data).conn).proto.httpc.h2 }).is_null()
    {
        ...
        let mut httpc: Option<&'_ mut crate::src::lib::http2::http_conn> =
            Some(unsafe { &mut (*(*data).conn).proto.httpc });
        let mut window: u32 = (!pause as i32 * (32 as i32 * 1024 as i32 * 1024 as i32)) as uint32_t;
...
pub extern "C" fn Curl_http2_add_child(
    ...
    if !parent.is_null() {
        let mut tail: Option<&'_ mut *mut crate::src::lib::http2::Curl_http2_dep> =
            Option::<&'_ mut *mut crate::src::lib::http2::Curl_http2_dep>::None;
        let mut dep: *mut crate::src::lib::http2::Curl_http2_dep = (unsafe { Curl_ccalloc
            .expect("non-null function pointer")(
            1 as i32 as size_t,
        ...
        let mut fresh67 = unsafe { &mut ((*dep).data) };
        *fresh67 = child;
        if !(unsafe { (*parent).set.stream_dependents }).is_null() && exclusive as i32 != 0 {
            let mut node: *mut crate::src::lib::http2::Curl_http2_dep =
                unsafe { (*parent).set.stream_dependents };
            while !node.is_null() {
                let mut fresh68 = unsafe { &mut ((*(*node).data).set.stream_depends_on) };
                *fresh68 = child;
                node = unsafe { (*node).next };
            }
            tail = Some(unsafe { &mut (*child).set.stream_dependents });
            while !(*(borrow_mut(&mut tail)).unwrap()).is_null() {
                tail = Some(unsafe { &mut (**(borrow_mut(&mut tail)).unwrap()).next });
            }
            *(borrow_mut(&mut tail)).unwrap() = unsafe { (*parent).set.stream_dependents };
            let mut fresh69 = unsafe { &mut ((*parent).set.stream_dependents) };
            *fresh69 = 0 as *mut Curl_http2_dep;
        }
        tail = Some(unsafe { &mut (*parent).set.stream_dependents });
        while !(*(borrow_mut(&mut tail)).unwrap()).is_null() {
            let mut fresh70 = unsafe { &mut ((*(**(borrow_mut(&mut tail)).unwrap()).data).set) };
            (*fresh70).set_stream_depends_e(0 as i32 as bit);
            tail = Some(unsafe { &mut (**(borrow_mut(&mut tail)).unwrap()).next });
        }
        *(borrow_mut(&mut tail)).unwrap() = dep;
    }
    let mut fresh71 = unsafe { &mut ((*child).set.stream_depends_on) };
    *fresh71 = parent;
    let mut fresh72 = unsafe { &mut ((*child).set) };
    (*fresh72).set_stream_depends_e(exclusive as bit);
    return CURLE_OK;
}
#[no_mangle]
pub extern "C" fn Curl_http2_remove_child(
    mut parent: *mut crate::src::lib::http2::Curl_easy,
    mut child: *mut crate::src::lib::http2::Curl_easy,
) {
    let mut last: *mut crate::src::lib::http2::Curl_http2_dep = 0 as *mut Curl_http2_dep;
    let mut data: *mut crate::src::lib::http2::Curl_http2_dep = unsafe { (*parent).set.stream_dependents };
    ...
    if !data.is_null() {
        if !last.is_null() {
            let mut fresh73 = unsafe { &mut ((*last).next) };
            *fresh73 = unsafe { (*data).next };
        } else {
            let mut fresh74 = unsafe { &mut ((*parent).set.stream_dependents) };
            *fresh74 = unsafe { (*data).next };
        }
        (unsafe { Curl_cfree.expect("non-null function pointer")(data as *mut libc::c_void) });
    }
    let mut fresh75 = unsafe { &mut ((*child).set.stream_depends_on) };
    *fresh75 = 0 as *mut Curl_easy;
    let mut fresh76 = unsafe { &mut ((*child).set) };
    (*fresh76).set_stream_depends_e(0 as i32 as bit);
}
#[no_mangle]
pub extern "C" fn Curl_http2_cleanup_dependencies(
    mut data: *mut crate::src::lib::http2::Curl_easy,
) {
    while !(unsafe { (*data).set.stream_dependents }).is_null() {
        let mut tmp: *mut crate::src::lib::http2::Curl_easy = unsafe { (*(*data).set.stream_dependents).data };
...
#[no_mangle]
pub extern "C" fn Curl_h2_http_1_1_error(mut data: *mut crate::src::lib::http2::Curl_easy) -> bool {
    let mut stream: *mut crate::src::lib::http2::HTTP = unsafe { (*data).req.p.http };
