...
extern "C" {
    fn pthread_create(
        ...
        __start_routine: Option<
            unsafe extern "C" fn(_: *mut core::ffi::c_void) -> *mut core::ffi::c_void,
        >,
        __arg: *mut core::ffi::c_void,
    ) -> i32;
    fn pthread_join(__th: u64, __thread_return: *mut *mut core::ffi::c_void) -> i32;
...
impl std::default::Default for Curl_actual_call {
    fn default() -> Self {
        Curl_actual_call::new()
    }
}
extern "C" fn curl_thread_create_thunk(mut arg: *mut core::ffi::c_void) -> *mut core::ffi::c_void {
    let mut ac: *mut crate::src::lib::curl_threads::Curl_actual_call = arg as *mut Curl_actual_call;
    let mut func: Option<unsafe extern "C" fn(_: *mut core::ffi::c_void) -> u32> = unsafe { (*ac).func };
    let mut real_arg: *mut core::ffi::c_void = unsafe { (*ac).arg };
...
pub extern "C" fn Curl_thread_create(
    ...
    let mut t: *mut u64 = (unsafe { Curl_cmalloc.expect("non-null function pointer")(::std::mem::size_of::<
        pthread_t,
    >() as u64) }) as *mut pthread_t;
    let mut ac: *mut crate::src::lib::curl_threads::Curl_actual_call =
    ...
    if !ac.is_null() && !t.is_null() {
        let mut fresh0 = unsafe { &mut ((*ac).func) };
        *fresh0 = func;
        let mut fresh1 = unsafe { &mut ((*ac).arg) };
        *fresh1 = arg;
        if !((unsafe { pthread_create(
            t,
            0 as *const pthread_attr_t,
            Some(curl_thread_create_thunk),
...
#[no_mangle]
pub extern "C" fn Curl_thread_destroy(mut hnd: *mut u64) {
    if !hnd.is_null() {
...
#[no_mangle]
pub extern "C" fn Curl_thread_join<'a1>(mut hnd: Option<&'a1 mut *mut u64>) -> i32 {
    let mut ret: i32 = ((unsafe { pthread_join(
        **(borrow_mut(&mut hnd)).unwrap(),
        0 as *mut *mut libc::c_void,
    ) }) == 0 as i32) as i32;
    (unsafe { Curl_cfree.expect("non-null function pointer")(
        *(borrow_mut(&mut hnd)).unwrap() as *mut libc::c_void
    ) });
