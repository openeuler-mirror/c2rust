...
pub extern "C" fn Curl_pp_state_timeout(
    ...
    let mut response_time: i64 = if (unsafe { (*data).set.server_response_timeout }) != 0 {
        unsafe { (*data).set.server_response_timeout }
    } else {
        unsafe { (*pp).response_time }
    };
    timeout_ms = response_time - Curl_timediff(Curl_now(), unsafe { (*pp).response });
    if (unsafe { (*data).set.timeout }) != 0 && !disconnecting {
        let mut timeout2_ms: i64 = (unsafe { (*data).set.timeout }) - Curl_timediff(Curl_now(), unsafe { (*conn).now });
...
pub extern "C" fn Curl_pp_statemach(
    ...
    if Curl_ssl_data_pending(conn, 0 as i32) {
        ...
        rc = 1 as i32;
    } else if (unsafe { (*pp).sendleft }) == 0 && Curl_ssl_data_pending(conn, 0 as i32) as i32 != 0 {
        rc = 1 as i32;
    } else {
...
#[no_mangle]
pub extern "C" fn Curl_pp_init<'a1>(
    mut data: *mut crate::src::lib::http2::Curl_easy,
...
#[no_mangle]
pub extern "C" fn Curl_pp_setup<'a1>(mut pp: Option<&'a1 mut crate::src::lib::http2::pingpong>) {
    Curl_dyn_init(
...
#[no_mangle]
pub extern "C" fn Curl_pp_vsendf<'a1>(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    mut pp: Option<&'a1 mut crate::src::lib::http2::pingpong>,
    mut fmt: *const i8,
...
#[no_mangle]
pub extern "C" fn Curl_pp_readresp<'a1>(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    mut sockfd: i32,
    mut pp: *mut crate::src::lib::http2::pingpong,
    mut code: *mut i32,
    ...
    *(borrow_mut(&mut size)).unwrap() = 0 as i32 as size_t;
        ...
        && (keepon as i32 != 0 && result as u64 == 0)
    {
        if !(unsafe { (*pp).cache }).is_null() {
            ...
            let mut fresh4 = unsafe { &mut ((*pp).cache) };
            *fresh4 = 0 as *mut i8;
            ...
            result = Curl_read(
                ...
                sockfd,
                ptr,
                ((unsafe { (*data).set.buffer_size }) as u64).wrapping_sub(unsafe { (*pp).nread_resp }),
                Some(&mut gotbytes),
            );
        ...
        if keepon {
            if gotbytes <= 0 as i32 as i64 {
                ...
                let mut fresh5 = unsafe { &mut ((*data).req.headerbytecount) };
                *fresh5 += gotbytes;
                let mut fresh6 = unsafe { &mut ((*pp).nread_resp) };
                *fresh6 = (*fresh6 as u64).wrapping_add(gotbytes as u64) as size_t as size_t;
                ...
                while i < gotbytes {
                    ...
                    if (unsafe { *ptr }) as i32 == '\n' as i32 {
                        ...
                        if unsafe { ((*pp).endofresp).expect("non-null function pointer")(
                            ...
                            let mut n: u64 = (unsafe { ptr.offset_from((*pp).linestart_resp) }) as i64 as size_t;
                            (unsafe { memmove(
                            ...
                            keepon = 0 as i32 != 0;
                            let mut fresh7 = unsafe { &mut ((*pp).linestart_resp) };
                            *fresh7 = unsafe { ptr.offset(1 as i32 as isize) };
                            i += 1;
                            *(borrow_mut(&mut size)).unwrap() = unsafe { (*pp).nread_resp };
                            (unsafe { (*pp).nread_resp = 0 as i32 as size_t });
                            break;
                        } else {
                            perline = 0 as i32 as ssize_t;
                            let mut fresh8 = unsafe { &mut ((*pp).linestart_resp) };
                ...
                if clipamount != 0 {
                    ...
                    let mut fresh9 = unsafe { &mut ((*pp).cache) };
                ...
                if restart {
                    (unsafe { (*pp).nread_resp = 0 as i32 as size_t });
                    let mut fresh10 = unsafe { &mut ((*pp).linestart_resp) };
                    *fresh10 = buf;
                    ptr = *fresh10;
                    perline = 0 as i32 as ssize_t;
                }
...
#[no_mangle]
pub extern "C" fn Curl_pp_getsock<'a1>(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    mut pp: Option<&'a1 mut crate::src::lib::http2::pingpong>,
    mut socks: *mut i32,
) -> i32 {
...
#[no_mangle]
pub extern "C" fn Curl_pp_flushsend(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    mut pp: *mut crate::src::lib::http2::pingpong,
) -> u32 {
    let mut conn: *mut crate::src::lib::http2::connectdata = unsafe { (*data).conn };
    ...
    if written != (unsafe { (*pp).sendleft }) as ssize_t {
        let mut fresh11 = unsafe { &mut ((*pp).sendleft) };
        *fresh11 = (*fresh11 as u64).wrapping_sub(written as u64) as size_t as size_t;
    } else {
        let mut fresh12 = unsafe { &mut ((*pp).sendthis) };
        *fresh12 = 0 as *mut i8;
        let mut fresh13 = unsafe { &mut ((*pp).sendsize) };
...
#[no_mangle]
pub extern "C" fn Curl_pp_disconnect<'a1>(
    mut pp: Option<&'a1 mut crate::src::lib::http2::pingpong>,
) -> u32 {
...
#[no_mangle]
pub extern "C" fn Curl_pp_moredata(mut pp: *mut crate::src::lib::http2::pingpong) -> bool {
