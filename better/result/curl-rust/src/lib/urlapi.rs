...
extern "C" fn free_urlhandle(mut u: *mut crate::src::lib::urlapi::Curl_URL) {
...
extern "C" fn mv_urlhandle(
    mut from: *mut crate::src::lib::urlapi::Curl_URL,
    mut to: *mut crate::src::lib::urlapi::Curl_URL,
) {
    free_urlhandle(to);
    (unsafe { *to = *from });
...
extern "C" fn strlen_url(mut url: *const i8, mut relative: bool) -> u64 {
...
extern "C" fn parse_hostname_login<'a1>(
    ...
    let mut ptr: *mut i8 = unsafe { strchr(*(borrow(&hostname)).unwrap(), '@' as i32) };
    let mut login: *mut i8 = *(borrow_mut(&mut hostname)).unwrap();
    if !ptr.is_null() {
        ptr = unsafe { ptr.offset(1) };
        *(borrow_mut(&mut hostname)).unwrap() = ptr;
        if !(unsafe { (*u).scheme }).is_null() {
            h = Curl_builtin_scheme(unsafe { (*u).scheme });
        }
        ccode = Curl_parse_login_details(
            login,
            ((unsafe { ptr.offset_from(login) }) as i64 - 1 as i32 as i64) as size_t,
            Some(&mut userp),
            Some(&mut passwdp),
            if !h.is_null() && (unsafe { (*h).flags }) & ((1 as i32) << 10 as i32) as u32 != 0 {
                &mut optionsp
            } else {
                0 as *mut *mut i8
            },
        ...
        if ccode as u64 != 0 {
            ...
            if !userp.is_null() {
                if flags & ((1 as i32) << 5 as i32) as u32 != 0 {
                    ...
                    let mut fresh8 = unsafe { &mut ((*u).user) };
                    *fresh8 = userp;
            ...
            match current_block {
                ...
                _ => {
                    if !passwdp.is_null() {
                        let mut fresh9 = unsafe { &mut ((*u).password) };
                        *fresh9 = passwdp;
                    }
                    if !optionsp.is_null() {
                        let mut fresh10 = unsafe { &mut ((*u).options) };
                        *fresh10 = optionsp;
                    }
                    return CURLUE_OK;
                }
...
extern "C" fn Curl_parse_port(
    ...
    if !portptr.is_null() {
        ...
        if Curl_isdigit((unsafe { *portptr.offset(1 as i32 as isize) }) as u8 as i32) == 0 {
        ...
        let mut fresh12 = unsafe { &mut ((*u).port) };
...
extern "C" fn junkscan(mut part: *const i8, mut flags: u32) -> bool {
    if !part.is_null() {
        ...
        let mut n: u64 = unsafe { strlen(part) };
        let mut nfine: u64 = unsafe { strcspn(part, badbytes.as_ptr()) };
        if nfine != n {
            return 1 as i32 != 0;
        }
...
extern "C" fn hostname_check(
    mut u: *mut crate::src::lib::urlapi::Curl_URL,
    mut hostname: *mut i8,
) -> u32 {
    let mut len: u64 = 0;
    let mut hlen: u64 = unsafe { strlen(hostname) };
    if (unsafe { *hostname.offset(0 as i32 as isize) }) as i32 == '[' as i32 {
        ...
        if hlen != len {
            ...
            if (unsafe { *hostname.offset(len as isize) }) as i32 == '%' as i32 {
                ...
                let mut fresh15 = unsafe { &mut ((*u).zoneid) };
...
extern "C" fn ipv4_normalize(mut hostname: *const i8, mut outp: *mut i8, mut olen: u64) -> bool {
...
extern "C" fn seturl(
    ...
    let mut fresh16 = unsafe { &mut ((*u).scratch) };
    *fresh16 = (unsafe { Curl_cmalloc.expect("non-null function pointer")(
    ...
    if url_has_scheme as i32 != 0
        && Curl_strcasecompare(schemebuf.as_mut_ptr(), b"file\0" as *const u8 as *const i8) != 0
    {
        (unsafe { strcpy(path, &*url.offset(5 as i32 as isize)) });
        hostname = 0 as *mut i8;
        let mut fresh17 = unsafe { &mut ((*u).scheme) };
        *fresh17 =
            ...
            && (unsafe { *path.offset(1 as i32 as isize) }) as i32 == '/' as i32
        {
                        ...
                        || (unsafe { *ptr.offset(2 as i32 as isize) }) as i32 == 0 as i32))
            {
                if curl_strnequal(
                    ...
                    ptr,
                    unsafe { strlen(b"localhost/\0" as *const u8 as *const i8) },
                ) == 0
                    && curl_strnequal(
                        b"127.0.0.1/\0" as *const u8 as *const i8,
                        ptr,
                        unsafe { strlen(b"127.0.0.1/\0" as *const u8 as *const i8) },
                    ) == 0
                {
                    return CURLUE_MALFORMED_INPUT;
                }
        ...
        if !schemep.is_null() {
            let mut fresh18 = unsafe { &mut ((*u).scheme) };
    ...
    if flags & ((1 as i32) << 7 as i32) as u32 != 0 && (unsafe { *path.offset(0 as i32 as isize) }) as i32 != 0 {
        ...
        path = newp;
        let mut fresh19 = unsafe { &mut ((*u).temppath) };
        *fresh19 = path;
    }
    ...
    if !fragment.is_null() {
        ...
        if (unsafe { *fragment.offset(0 as i32 as isize) }) != 0 {
            let mut fresh21 = unsafe { &mut ((*u).fragment) };
    ...
    if !query.is_null() {
        ...
        let mut fresh23 = unsafe { &mut ((*u).query) };
    ...
    if (unsafe { *path.offset(0 as i32 as isize) }) == 0 {
        ...
        if flags & ((1 as i32) << 4 as i32) as u32 == 0 {
            ...
            if (unsafe { strcmp(newp_0, path) }) != 0 {
                if path_alloced {
                    ...
                    let mut fresh24 = unsafe { &mut ((*u).temppath) };
                    *fresh24 = 0 as *mut i8;
                }
                path = newp_0;
                let mut fresh25 = unsafe { &mut ((*u).temppath) };
                *fresh25 = path;
                path_alloced = 1 as i32 != 0;
            } else {
        ...
        let mut fresh26 = unsafe { &mut ((*u).path) };
        *fresh26 = if path_alloced as i32 != 0 {
        ...
        let mut fresh27 = unsafe { &mut ((*u).temppath) };
        *fresh27 = 0 as *mut i8;
    }
    if !hostname.is_null() {
        ...
        if flags & ((1 as i32) << 9 as i32) as u32 != 0 && schemep.is_null() {
            if curl_strnequal(
                ...
                hostname,
                unsafe { strlen(b"ftp.\0" as *const u8 as *const i8) },
            ) != 0
            {
                ...
                hostname,
                unsafe { strlen(b"dict.\0" as *const u8 as *const i8) },
            ) != 0
            {
                ...
                hostname,
                unsafe { strlen(b"ldap.\0" as *const u8 as *const i8) },
            ) != 0
            {
                ...
                hostname,
                unsafe { strlen(b"imap.\0" as *const u8 as *const i8) },
            ) != 0
            {
                ...
                hostname,
                unsafe { strlen(b"smtp.\0" as *const u8 as *const i8) },
            ) != 0
            {
                ...
                hostname,
                unsafe { strlen(b"pop3.\0" as *const u8 as *const i8) },
            ) != 0
            {
            ...
            let mut fresh30 = unsafe { &mut ((*u).scheme) };
    ...
    (unsafe { Curl_cfree.expect("non-null function pointer")((*u).scratch as *mut libc::c_void) });
    let mut fresh31 = unsafe { &mut ((*u).scratch) };
    *fresh31 = 0 as *mut i8;
    (unsafe { Curl_cfree.expect("non-null function pointer")((*u).temppath as *mut libc::c_void) });
    let mut fresh32 = unsafe { &mut ((*u).temppath) };
    *fresh32 = 0 as *mut i8;
    return CURLUE_OK;
}
extern "C" fn parseurl(
    mut url: *const i8,
    mut u: *mut crate::src::lib::urlapi::Curl_URL,
    mut flags: u32,
) -> u32 {
...
#[no_mangle]
pub extern "C" fn curl_url() -> *mut crate::src::lib::urlapi::Curl_URL {
...
#[no_mangle]
pub extern "C" fn curl_url_cleanup(mut u: *mut crate::src::lib::urlapi::Curl_URL) {
    if !u.is_null() {
        free_urlhandle(u);
...
#[no_mangle]
pub extern "C" fn curl_url_dup(
    mut in_0: *mut crate::src::lib::urlapi::Curl_URL,
) -> *mut crate::src::lib::urlapi::Curl_URL {
    let mut current_block: u64;
    let mut u: *mut crate::src::lib::urlapi::Curl_URL = (unsafe { Curl_ccalloc
    ...
    if !u.is_null() {
        if !(unsafe { (*in_0).scheme }).is_null() {
            let mut fresh33 = unsafe { &mut ((*u).scheme) };
        ...
        match current_block {
            7815301370352969686 => {
                if !(unsafe { (*in_0).user }).is_null() {
                    let mut fresh34 = unsafe { &mut ((*u).user) };
                ...
                match current_block {
                    ...
                    _ => {
                        if !(unsafe { (*in_0).password }).is_null() {
                            let mut fresh35 = unsafe { &mut ((*u).password) };
                            *fresh35 =
                        ...
                        match current_block {
                            ...
                            _ => {
                                if !(unsafe { (*in_0).options }).is_null() {
                                    let mut fresh36 = unsafe { &mut ((*u).options) };
                                ...
                                match current_block {
                                    ...
                                    _ => {
                                        if !(unsafe { (*in_0).host }).is_null() {
                                            let mut fresh37 = unsafe { &mut ((*u).host) };
                                        ...
                                        match current_block {
                                            ...
                                            _ => {
                                                if !(unsafe { (*in_0).port }).is_null() {
                                                    let mut fresh38 = unsafe { &mut ((*u).port) };
                                                ...
                                                match current_block {
                                                    ...
                                                    _ => {
                                                        if !(unsafe { (*in_0).path }).is_null() {
                                                            let mut fresh39 = unsafe { &mut ((*u).path) };
...
#[no_mangle]
pub extern "C" fn curl_url_get<'a1>(
    mut u: *mut crate::src::lib::urlapi::Curl_URL,
    mut what: u32,
    ...
    *(borrow_mut(&mut part)).unwrap() = 0 as *mut i8;
    match what as u32 {
        ...
        6 => {
            ...
            {
                let mut h: *const crate::src::lib::http2::Curl_handler =
                    Curl_builtin_scheme(unsafe { (*u).scheme });
                if !h.is_null() {
                    (unsafe { curl_msnprintf(
                        portbuf.as_mut_ptr(),
                        ::std::mem::size_of::<[i8; 7]>() as u64,
                ...
                let mut h_0: *const crate::src::lib::http2::Curl_handler =
                    Curl_builtin_scheme(unsafe { (*u).scheme });
                if !h_0.is_null()
        ...
        7 => {
            ptr = unsafe { (*u).path };
            if ptr.is_null() {
                let mut fresh42 = unsafe { &mut ((*u).path) };
        ...
        0 => {
            ...
            if !(unsafe { (*u).scheme }).is_null()
                && Curl_strcasecompare(b"file\0" as *const u8 as *const i8, unsafe { (*u).scheme }) != 0
            {
                ...
                {
                    let mut hostlen: u64 = unsafe { strlen((*u).host) };
    ...
    if !ptr.is_null() {
        *(borrow_mut(&mut part)).unwrap() = unsafe { Curl_cstrdup.expect("non-null function pointer")(ptr) };
        ...
        if urldecode {
            ...
            (unsafe { Curl_cfree.expect("non-null function pointer")(
                *(borrow_mut(&mut part)).unwrap() as *mut libc::c_void
            ) });
            if res as u64 != 0 {
                *(borrow_mut(&mut part)).unwrap() = 0 as *mut i8;
...
pub extern "C" fn curl_url_set(
    ...
    if part.is_null() {
        match what as u32 {
            0 => {}
            1 => {
                storep = Some(unsafe { &mut (*u).scheme });
            }
            2 => {
                storep = Some(unsafe { &mut (*u).user });
            }
            3 => {
                storep = Some(unsafe { &mut (*u).password });
            }
            4 => {
                storep = Some(unsafe { &mut (*u).options });
            }
            5 => {
                storep = Some(unsafe { &mut (*u).host });
            }
            10 => {
                storep = Some(unsafe { &mut (*u).zoneid });
            }
            6 => {
                (unsafe { (*u).portnum = 0 as i32 as i64 });
                storep = Some(unsafe { &mut (*u).port });
            }
            7 => {
                storep = Some(unsafe { &mut (*u).path });
            }
            8 => {
                storep = Some(unsafe { &mut (*u).query });
            }
            9 => {
                storep = Some(unsafe { &mut (*u).fragment });
            }
            _ => return CURLUE_UNKNOWN_PART,
        }
        if !borrow(&storep).is_none() && !(*(borrow_mut(&mut storep)).unwrap()).is_null() {
            (unsafe { Curl_cfree.expect("non-null function pointer")(
                *(borrow_mut(&mut storep)).unwrap() as *mut libc::c_void
            ) });
    ...
    match what as u32 {
        1 => {
            ...
            if flags & ((1 as i32) << 3 as i32) as u32 == 0 && (Curl_builtin_scheme(part)).is_null()
            {
                return CURLUE_UNSUPPORTED_SCHEME;
            }
            storep = Some(unsafe { &mut (*u).scheme });
        ...
        5 => {
            storep = Some(unsafe { &mut (*u).host });
            (unsafe { Curl_cfree.expect("non-null function pointer")((*u).zoneid as *mut libc::c_void) });
            let mut fresh43 = unsafe { &mut ((*u).zoneid) };
            *fresh43 = 0 as *mut i8;
        }
        10 => {
            storep = Some(unsafe { &mut (*u).zoneid });
    ...
    let mut nalloc: u64 = unsafe { strlen(part) };
    ...
    if urlencode {
        ...
        while (unsafe { *i }) != 0 {
            if (unsafe { *i }) as i32 == ' ' as i32 && plusencode as i32 != 0 {
                ...
                o = unsafe { o.offset(1) };
            } else if Curl_isunreserved(unsafe { *i }) as i32 != 0
        ...
        while (unsafe { *p }) != 0 {
            if (unsafe { *p }) as i32 == '%' as i32
                && Curl_isxdigit((unsafe { *p.offset(1 as i32 as isize) }) as u8 as i32) != 0
                && Curl_isxdigit((unsafe { *p.offset(2 as i32 as isize) }) as u8 as i32) != 0
                && (Curl_isupper((unsafe { *p.offset(1 as i32 as isize) }) as u8 as i32) != 0
                    || Curl_isupper((unsafe { *p.offset(2 as i32 as isize) }) as u8 as i32) != 0)
            {
    ...
    if appendquery {
        let mut querylen: u64 = if !(unsafe { (*u).query }).is_null() {
        ...
        let mut addamperand: bool = querylen != 0
            && (unsafe { *((*u).query).offset(querylen.wrapping_sub(1 as i32 as u64) as isize) }) as i32
                != '&' as i32;
        if querylen != 0 {
            let mut newplen: u64 = unsafe { strlen(newp) };
