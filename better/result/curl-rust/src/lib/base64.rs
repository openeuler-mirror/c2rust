...
extern "C" fn decodeQuantum(mut dest: *mut u8, mut src: *const i8) -> u64 {
...
#[no_mangle]
pub extern "C" fn Curl_base64_decode<'a1, 'a2>(
    mut src: *const i8,
...
extern "C" fn base64_encode<'a1, 'a2>(
    ...
    *(borrow_mut(&mut outlen)).unwrap() = unsafe { strlen(base64data) };
    return CURLE_OK;
}
#[no_mangle]
pub extern "C" fn Curl_base64_encode<'a1, 'a2>(
...
#[no_mangle]
pub extern "C" fn Curl_base64url_encode<'a1, 'a2>(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    mut inputbuff: *const i8,
    mut insize: u64,
    mut outptr: Option<&'a1 mut *mut i8>,
