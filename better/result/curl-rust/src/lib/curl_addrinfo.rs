...
#[no_mangle]
pub extern "C" fn Curl_freeaddrinfo(mut cahead: *mut crate::src::lib::http2::Curl_addrinfo) {
...
#[no_mangle]
pub extern "C" fn Curl_getaddrinfo_ex<'a1>(
    ...
    *(borrow_mut(&mut result)).unwrap() = 0 as *mut Curl_addrinfo;
    ...
    ai = aihead;
    while !ai.is_null() {
        let mut namelen: u64 = if !(unsafe { (*ai).ai_canonname }).is_null() {
                ...
                if !((unsafe { (*ai).ai_addr }).is_null() || !((unsafe { (*ai).ai_addrlen }) > 0 as i32 as u32)) {
                    if !(((unsafe { (*ai).ai_addrlen }) as size_t) < ss_size) {
                        ...
                        if ca.is_null() {
                            ...
                            let mut fresh0 = unsafe { &mut ((*ca).ai_addr) };
                            *fresh0 = 0 as *mut sockaddr;
                            let mut fresh1 = unsafe { &mut ((*ca).ai_canonname) };
                            *fresh1 = 0 as *mut i8;
                            let mut fresh2 = unsafe { &mut ((*ca).ai_next) };
                            *fresh2 = 0 as *mut Curl_addrinfo;
                            let mut fresh3 = unsafe { &mut ((*ca).ai_addr) };
                            *fresh3 = (unsafe { (ca as *mut i8)
                            ...
                            if namelen != 0 {
                                let mut fresh4 = unsafe { &mut ((*ca).ai_canonname) };
                            ...
                            if !calast.is_null() {
                                let mut fresh5 = unsafe { &mut ((*calast).ai_next) };
                                *fresh5 = ca;
                            }
                            calast = ca;
                        }
...
#[no_mangle]
pub extern "C" fn Curl_he2ai<'a1, 'a2>(
    ...
    i = 0 as i32;
    loop {
        curr = unsafe { *((*((he).clone()).unwrap()).h_addr_list).offset(i as isize) };
        if curr.is_null() {
            break;
        }
        let mut ss_size: u64 = 0;
        let mut namelen: u64 =
            (unsafe { strlen((*((he).clone()).unwrap()).h_name) }).wrapping_add(1 as i32 as u64);
        ...
        if ai.is_null() {
            ...
            *fresh7 = unsafe { ((*ai).ai_addr as *mut i8).offset(ss_size as isize) };
            ...
            if !prevai.is_null() {
                let mut fresh8 = unsafe { &mut ((*prevai).ai_next) };
                *fresh8 = ai;
            }
            (unsafe { (*ai).ai_family = (*(he).unwrap()).h_addrtype });
            ...
            match unsafe { (*ai).ai_family } {
                2 => {
                    ...
                    (unsafe { (*addr).sin_family = (*(he).unwrap()).h_addrtype as sa_family_t });
                ...
                10 => {
                    ...
                    (unsafe { (*addr6).sin6_family = (*(he).unwrap()).h_addrtype as sa_family_t });
...
pub extern "C" fn Curl_ip2addr(
    ...
    let mut ai: *mut crate::src::lib::http2::Curl_addrinfo = 0 as *mut Curl_addrinfo;
    let mut h: Option<&'_ mut crate::src::lib::curl_addrinfo::hostent<'_>> =
        Option::<&'_ mut crate::src::lib::curl_addrinfo::hostent<'_>>::None;
    ...
    h = Some(unsafe { &mut (*buf).hostentry });
    ...
    *fresh11 = (unsafe { &mut *((*buf).h_addr_list).as_mut_ptr().offset(0 as i32 as isize) }) as *mut *mut i8;
    let mut fresh12 = unsafe { &mut (*((*(borrow(&h)).unwrap()).h_addr_list).offset(0 as i32 as isize)) };
    *fresh12 = addrentry;
    let mut fresh13 = unsafe { &mut (*((*(borrow(&h)).unwrap()).h_addr_list).offset(1 as i32 as isize)) };
    *fresh13 = 0 as *mut i8;
...
#[no_mangle]
pub extern "C" fn Curl_unix2addr<'a1>(
    mut path: *const i8,
    mut longpath: Option<&'a1 mut bool>,
    mut abstract_0: bool,
) -> *mut crate::src::lib::http2::Curl_addrinfo {
    let mut ai: *mut crate::src::lib::http2::Curl_addrinfo = 0 as *mut Curl_addrinfo;
    let mut sa_un: *mut crate::src::lib::connect::sockaddr_un =
    ...
    *(borrow_mut(&mut longpath)).unwrap() = 0 as i32 != 0;
    ...
    let mut fresh14 = unsafe { &mut ((*ai).ai_addr) };
