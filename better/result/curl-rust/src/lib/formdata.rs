...
pub type curl_formget_callback<'a1, 'a2> = Option<
    unsafe extern "C" fn(_: Option<&'a1 mut core::ffi::c_void>, _: Option<&'a2 i8>, _: u64) -> u64,
>;
...
extern "C" fn AddHttpPost<'a1, 'a2>(
    ...
    if !post.is_null() {
        let mut fresh0 = unsafe { &mut ((*post).name) };
        *fresh0 = name;
        ...
        let mut fresh1 = unsafe { &mut ((*post).contents) };
        *fresh1 = value;
        (unsafe { (*post).contentlen = contentslength });
        let mut fresh2 = unsafe { &mut ((*post).buffer) };
        *fresh2 = buffer;
        (unsafe { (*post).bufferlength = bufferlength as i64 });
        let mut fresh3 = unsafe { &mut ((*post).contenttype) };
        *fresh3 = contenttype;
        let mut fresh4 = unsafe { &mut ((*post).contentheader) };
        *fresh4 = contentHeader;
        let mut fresh5 = unsafe { &mut ((*post).showfilename) };
        *fresh5 = showfilename;
        let mut fresh6 = unsafe { &mut ((*post).userp) };
    ...
    if !parent_post.is_null() {
        let mut fresh7 = unsafe { &mut ((*post).more) };
        *fresh7 = unsafe { (*parent_post).more };
        let mut fresh8 = unsafe { &mut ((*parent_post).more) };
        *fresh8 = post;
    } else {
        if !(*(borrow_mut(&mut last_post)).unwrap()).is_null() {
            let mut fresh9 = unsafe { &mut ((**(borrow_mut(&mut last_post)).unwrap()).next) };
            *fresh9 = post;
        } else {
...
extern "C" fn AddFormInfo(
    ...
    if !form_info.is_null() {
        if !value.is_null() {
            let mut fresh10 = unsafe { &mut ((*form_info).value) };
            *fresh10 = value;
        }
        if !contenttype.is_null() {
            let mut fresh11 = unsafe { &mut ((*form_info).contenttype) };
            *fresh11 = contenttype;
        }
    ...
    if !parent_form_info.is_null() {
        let mut fresh12 = unsafe { &mut ((*form_info).more) };
        *fresh12 = unsafe { (*parent_form_info).more };
        let mut fresh13 = unsafe { &mut ((*parent_form_info).more) };
        *fresh13 = form_info;
    }
    return form_info;
}
extern "C" fn FormAdd<'a1, 'a2>(
    mut httppost: Option<&'a1 mut *mut crate::src::lib::http2::curl_httppost>,
    mut last_post: Option<&'a2 mut *mut crate::src::lib::http2::curl_httppost>,
        ...
        match option as u32 {
            ...
            7 => {
                    ...
                    != 0
                {
                    ...
                    if !filename.is_null() {
                        let mut fresh16 = unsafe { &mut ((*current_form).value) };
            ...
            10 => {
                ...
                if !(unsafe { (*current_form).value }).is_null() {
                    ...
                    let mut fresh17 = unsafe { &mut ((*current_form).value) };
            ...
            12 => {
                ...
                if !(unsafe { (*current_form).buffer }).is_null() {
                    ...
                    if !buffer.is_null() {
                        let mut fresh18 = unsafe { &mut ((*current_form).buffer) };
                        *fresh18 = buffer;
                        let mut fresh19 = unsafe { &mut ((*current_form).value) };
                        *fresh19 = buffer;
                    } else {
                        return_value = CURL_FORMADD_NULL;
                    }
            ...
            19 => {
                ...
                if !(unsafe { (*current_form).userp }).is_null() {
                    ...
                    if !userp.is_null() {
                        let mut fresh20 = unsafe { &mut ((*current_form).userp) };
                        *fresh20 = userp;
                        let mut fresh21 = unsafe { &mut ((*current_form).value) };
                        *fresh21 = userp;
                    } else {
                        return_value = CURL_FORMADD_NULL;
                    }
            ...
            14 => {
                ...
                if !(unsafe { (*current_form).contenttype }).is_null() {
                    ...
                    let mut fresh22 = unsafe { &mut ((*current_form).contenttype) };
            ...
            15 => {
                ...
                if !(unsafe { (*current_form).contentheader }).is_null() {
                    ...
                    let mut fresh23 = unsafe { &mut ((*current_form).contentheader) };
                    *fresh23 = list;
                }
                current_block_137 = 2704538829018177290;
            }
            16 | 11 => {
                ...
                if !(unsafe { (*current_form).showfilename }).is_null() {
                    ...
                    let mut fresh24 = unsafe { &mut ((*current_form).showfilename) };
        ...
        match current_block_137 {
            14371220985979925773 => {
                if !(unsafe { (*current_form).name }).is_null() {
                    ...
                    if !name.is_null() {
                        let mut fresh14 = unsafe { &mut ((*current_form).name) };
                        *fresh14 = name;
                    } else {
                        return_value = CURL_FORMADD_NULL;
                    }
            ...
            11213271726480235426 => {
                if !(unsafe { (*current_form).value }).is_null() {
                    ...
                    if !value.is_null() {
                        let mut fresh15 = unsafe { &mut ((*current_form).value) };
                        *fresh15 = value;
                    } else {
                        return_value = CURL_FORMADD_NULL;
                    }
    ...
    if CURL_FORMADD_OK as i32 as u32 != return_value as u32 {
        ...
        while !ptr.is_null() {
            if unsafe { (*ptr).name_alloc } {
                ...
                let mut fresh25 = unsafe { &mut ((*ptr).name) };
                *fresh25 = 0 as *mut i8;
            ...
            if unsafe { (*ptr).value_alloc } {
                ...
                let mut fresh26 = unsafe { &mut ((*ptr).value) };
                *fresh26 = 0 as *mut i8;
            ...
            if unsafe { (*ptr).contenttype_alloc } {
                ...
                let mut fresh27 = unsafe { &mut ((*ptr).contenttype) };
                *fresh27 = 0 as *mut i8;
            ...
            if unsafe { (*ptr).showfilename_alloc } {
                ...
                let mut fresh28 = unsafe { &mut ((*ptr).showfilename) };
                *fresh28 = 0 as *mut i8;
        ...
        while !form.is_null() {
                    ...
                    && (unsafe { (*form).flags }) & ((1 as i32) << 3 as i32) as i64 != 0
            {
                    ...
                    && (unsafe { (*form).contenttype }).is_null()
                {
                    ...
                    let mut fresh29 = unsafe { &mut ((*form).contenttype) };
                ...
                if (unsafe { (*form).flags }) & ((1 as i32) << 2 as i32) as i64 == 0 && form == first_form {
                    if !(unsafe { (*form).name }).is_null() {
                        let mut fresh30 = unsafe { &mut ((*form).name) };
                        *fresh30 = Curl_memdup(
                            (unsafe { (*form).name }) as *const libc::c_void,
                            if (unsafe { (*form).namelength }) != 0 {
                                unsafe { (*form).namelength }
                            } else {
                                (unsafe { strlen((*form).name) }).wrapping_add(1 as i32 as u64)
                            },
                        ) as *mut i8;
                    }
                    if (unsafe { (*form).name }).is_null() {
                ...
                {
                    let mut clen: u64 = (unsafe { (*form).contentslength }) as size_t;
                    if clen == 0 {
                        clen = (unsafe { strlen((*form).value) }).wrapping_add(1 as i32 as u64);
                    }
                    let mut fresh31 = unsafe { &mut ((*form).value) };
                    *fresh31 = Curl_memdup((unsafe { (*form).value }) as *const libc::c_void, clen) as *mut i8;
        ...
        if CURL_FORMADD_OK as i32 as u32 != return_value as u32 {
            ...
            while !ptr_0.is_null() {
                if unsafe { (*ptr_0).name_alloc } {
                    ...
                    let mut fresh32 = unsafe { &mut ((*ptr_0).name) };
                    *fresh32 = 0 as *mut i8;
                ...
                if unsafe { (*ptr_0).value_alloc } {
                    ...
                    let mut fresh33 = unsafe { &mut ((*ptr_0).value) };
                    *fresh33 = 0 as *mut i8;
                ...
                if unsafe { (*ptr_0).contenttype_alloc } {
                    ...
                    let mut fresh34 = unsafe { &mut ((*ptr_0).contenttype) };
                    *fresh34 = 0 as *mut i8;
                ...
                if unsafe { (*ptr_0).showfilename_alloc } {
                    ...
                    let mut fresh35 = unsafe { &mut ((*ptr_0).showfilename) };
                    *fresh35 = 0 as *mut i8;
    ...
    while !first_form.is_null() {
        let mut ptr_1: *mut crate::src::lib::formdata::FormInfo = unsafe { (*first_form).more };
...
pub extern "C" fn curl_formget(
    ...
    mut append: Option<
        unsafe extern "C" fn(_: *mut core::ffi::c_void, _: *const i8, _: u64) -> u64,
    >,
) -> i32 {
...
#[no_mangle]
pub extern "C" fn curl_formfree(mut form: *mut crate::src::lib::http2::curl_httppost) {
...
pub extern "C" fn Curl_getformdata(
    ...
    while result as u64 == 0 && !post.is_null() {
        ...
        while result as u64 == 0 && !file.is_null() {
            ...
            if result as u64 == 0 {
                result = curl_mime_headers(part, unsafe { (*file).contentheader }, 0 as i32);
            }
            if result as u64 == 0 && !(unsafe { (*file).contenttype }).is_null() {
                result = curl_mime_type(part, unsafe { (*file).contenttype });
            }
            if result as u64 == 0 && (unsafe { (*post).more }).is_null() {
                result = setname(part, unsafe { (*post).name }, (unsafe { (*post).namelength }) as size_t);
            }
            if result as u64 == 0 {
                let mut clen: i64 = unsafe { (*post).contentslength };
                ...
                if (unsafe { (*post).flags }) & ((1 as i32) << 0 as i32 | (1 as i32) << 1 as i32) as i64 != 0 {
                    if (unsafe { strcmp((*file).contents, b"-\0" as *const u8 as *const i8) }) == 0 {
                        result = curl_mime_data_cb(
                            ...
                            None,
                            (unsafe { stdin }) as *mut libc::c_void,
                        );
                    } else {
                        result = curl_mime_filedata(part, unsafe { (*file).contents });
                    }
                    ...
                    result = curl_mime_data(
                        part,
                        unsafe { (*post).buffer },
                        (if (unsafe { (*post).bufferlength }) != 0 {
                            unsafe { (*post).bufferlength }
                        } else {
                            -(1 as i32) as i64
                        }) as size_t,
                    );
                    ...
                    result = curl_mime_data_cb(part, clen, fread_func, None, None, unsafe { (*post).userp });
                } else {
                    let mut uclen: u64 = 0;
                    if clen == 0 {
                    ...
                    result = curl_mime_data(part, unsafe { (*post).contents }, uclen);
                }
            }
            if result as u64 == 0 && !(unsafe { (*post).showfilename }).is_null() {
                if !(unsafe { (*post).more }).is_null()
                    || (unsafe { (*post).flags })
                        ...
                        != 0
                {
                    result = curl_mime_filename(part, unsafe { (*post).showfilename });
                }
            }
