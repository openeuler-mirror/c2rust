...
extern "C" {
    ...
    fn ldap_next_message(
        ld: *mut crate::src::lib::openldap::ldap,
        msg: *mut crate::src::lib::openldap::ldapmsg,
    ) -> *mut crate::src::lib::openldap::ldapmsg;
    fn ldap_first_message(
        ld: *mut crate::src::lib::openldap::ldap,
        chain: *mut crate::src::lib::openldap::ldapmsg,
    ) -> *mut crate::src::lib::openldap::ldapmsg;
...
pub struct sockbuf_io {
    pub sbi_setup: Option<
        unsafe extern "C" fn(
            _: *mut crate::src::lib::openldap::sockbuf_io_desc,
            _: *mut core::ffi::c_void,
        ) -> i32,
    >,
    pub sbi_remove:
        Option<unsafe extern "C" fn(_: *mut crate::src::lib::openldap::sockbuf_io_desc) -> i32>,
    pub sbi_ctrl: Option<
        unsafe extern "C" fn(
            _: *mut crate::src::lib::openldap::sockbuf_io_desc,
            _: i32,
...
pub static mut Curl_handler_ldap: crate::src::lib::http2::Curl_handler =  {
    {
        let mut init = Curl_handler {
            ...
            setup_connection: Some(oldap_setup_connection),
            do_it: Some(oldap_do),
            done: Some(oldap_done),
            do_more: None,
            connect_it: Some(oldap_connect),
            connecting: Some(oldap_connecting),
            doing: None,
            proto_getsock: None,
            doing_getsock: None,
            domore_getsock: None,
            perform_getsock: None,
            disconnect: Some(oldap_disconnect),
            readwrite: None,
...
extern "C" fn oldap_setup_connection(
    ...
    let mut fresh0 = unsafe { &mut ((*conn).proto.ldapc) };
    *fresh0 = li;
    Curl_conncontrol(conn, 0 as i32);
    return CURLE_OK;
}
extern "C" fn oldap_connect(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    mut _done: *mut bool,
) -> u32 {
    let mut conn: *mut crate::src::lib::http2::connectdata = unsafe { (*data).conn };
    let mut li: *mut crate::src::lib::openldap::ldapconninfo = unsafe { (*conn).proto.ldapc };
    let mut rc: i32 = 0;
    ...
    if (unsafe { (*(*conn).handler).flags }) & ((1 as i32) << 0 as i32) as u32 != 0 {
        ...
        result =
            Curl_ssl_connect_nonblocking(data, conn, 0 as i32 != 0, 0 as i32, unsafe { &mut (*li).ssldone });
        if result as u64 != 0 {
            return result;
        }
    }
...
extern "C" fn oldap_connecting(
    ...
    if (unsafe { (*(*conn).handler).flags }) & ((1 as i32) << 0 as i32) as u32 != 0 {
        ...
        if !(unsafe { (*li).sslinst }) {
            ...
            let mut fresh2 = unsafe { &mut ((*li).recv) };
            *fresh2 = unsafe { (*conn).recv[0 as i32 as usize] };
            let mut fresh3 = unsafe { &mut ((*li).send) };
    ...
    let mut fresh4 = unsafe { &mut ((*conn).recv[0 as i32 as usize]) };
...
extern "C" fn oldap_do(
    ...
    let mut fresh7 = unsafe { &mut ((*data).req.p.ldap) };
    *fresh7 = lr;
    Curl_setup_transfer(
        data,
        0 as i32,
...
extern "C" fn oldap_done(
    ...
    let mut conn: *mut crate::src::lib::http2::connectdata = unsafe { (*data).conn };
    let mut lr: *mut crate::src::lib::openldap::ldapreqinfo = unsafe { (*data).req.p.ldap };
    if !lr.is_null() {
        ...
        let mut fresh8 = unsafe { &mut ((*data).req.p.ldap) };
    ...
    while !ent.is_null() {
        ...
        if msgtype as u64 == 0x65 as u32 as ber_tag_t {
            ...
            if !(msgtype as u64 != 0x64 as u32 as ber_tag_t) {
                let mut fresh9 = unsafe { &mut ((*lr).nument) };
                *fresh9 += 1;
                ...
                writeerr = Curl_client_write(data, (1 as i32) << 0 as i32, bv.bv_val, bv.bv_len);
                if writeerr as u64 != 0 {
                    (unsafe { *err = writeerr });
                    return -(1 as i32) as ssize_t;
                }
                ...
                *fresh10 = (*fresh10 as u64).wrapping_add((bv.bv_len).wrapping_add(5 as i32 as u64))
                ...
                while rc == 0 as i32 {
                    ...
                    if bvals.is_null() {
                        ...
                        writeerr =
                            Curl_client_write(data, (1 as i32) << 0 as i32, bv.bv_val, bv.bv_len);
                        if writeerr as u64 != 0 {
                            (unsafe { *err = writeerr });
                            return -(1 as i32) as ssize_t;
                        }
                        ...
                        *fresh11 = (*fresh11 as u64)
                        ...
                        while !(unsafe { (*bvals.offset(i as isize)).bv_val }).is_null() {
                            ...
                            *fresh12 = (*fresh12 as u64)
                            ...
                            if binary == 0 {
                                if Curl_isspace(
                                    (unsafe { *((*bvals.offset(i as isize)).bv_val).offset(0 as i32 as isize) })
                                        as u8 as i32,
                                ) != 0
                                    || Curl_isspace(
                                        (unsafe { *((*bvals.offset(i as isize)).bv_val).offset(
                                    ...
                                    ) != 0
                                {
                                    ...
                                    while (j as u64) < (unsafe { (*bvals.offset(i as isize)).bv_len }) {
                                        if Curl_isprint(
                                            (unsafe { *((*bvals.offset(i as isize)).bv_val).offset(j as isize) })
                                                as u8
                                                as i32,
                                        ) == 0
                                        {
                            ...
                            if binary != 0 || binval != 0 {
                                ...
                                let mut error: u32 = Curl_base64_encode(
                                    data,
                                    unsafe { (*bvals.offset(i as isize)).bv_val },
                                ...
                                let mut fresh13 = unsafe { &mut ((*data).req.bytecount) };
                                *fresh13 += 2 as i32 as i64;
                                if val_b64_sz > 0 as i32 as u64 {
                                    ...
                                    let mut fresh14 = unsafe { &mut ((*data).req.bytecount) };
                                ...
                                let mut fresh15 = unsafe { &mut ((*data).req.bytecount) };
                            ...
                            let mut fresh16 = unsafe { &mut ((*data).req.bytecount) };
                            *fresh16 += 1;
                            i += 1;
                        }
                        (unsafe { ber_memfree(bvals as *mut libc::c_void) });
                        ...
                        let mut fresh17 = unsafe { &mut ((*data).req.bytecount) };
                        *fresh17 += 1;
                    }
                    rc = unsafe { ldap_get_attribute_ber((*li).ld, ent, ber, &mut bv, &mut bvals) };
                }
                ...
                let mut fresh18 = unsafe { &mut ((*data).req.bytecount) };
                *fresh18 += 1;
                (unsafe { ber_free(ber, 0 as i32) });
            }
...
extern "C" fn ldapsb_tls_setup(
    mut sbiod: *mut crate::src::lib::openldap::sockbuf_io_desc,
    mut arg: *mut core::ffi::c_void,
) -> i32 {
    let mut fresh19 = unsafe { &mut ((*sbiod).sbiod_pvt) };
    *fresh19 = arg;
    return 0 as i32;
}
extern "C" fn ldapsb_tls_remove(mut sbiod: *mut crate::src::lib::openldap::sockbuf_io_desc) -> i32 {
    let mut fresh20 = unsafe { &mut ((*sbiod).sbiod_pvt) };
...
extern "C" fn ldapsb_tls_ctrl(
    ...
    if opt == 8 as i32 {
        let mut data: *mut crate::src::lib::http2::Curl_easy = (unsafe { (*sbiod).sbiod_pvt }) as *mut Curl_easy;
        return Curl_ssl_data_pending(unsafe { (*data).conn }, 0 as i32) as i32;
    }
    return 0 as i32;
}
...
static mut ldapsb_tls: crate::src::lib::openldap::sockbuf_io =  {
    {
        let mut init = sockbuf_io {
            sbi_setup: Some(ldapsb_tls_setup),
            sbi_remove: Some(ldapsb_tls_remove),
            sbi_ctrl: Some(ldapsb_tls_ctrl),
            sbi_read: Some(ldapsb_tls_read),
            sbi_write: Some(ldapsb_tls_write),
            sbi_close: Some(ldapsb_tls_close),
        };
        init
    }
};
