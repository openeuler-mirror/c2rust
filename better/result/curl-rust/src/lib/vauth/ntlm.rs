...
extern "C" fn ntlm_decode_type2_target<'a1>(
    ...
    if type2len >= 48 as i32 as u64 {
        target_info_len = Curl_read16_le(unsafe { &*type2.offset(40 as i32 as isize) });
        target_info_offset = Curl_read32_le(unsafe { &*type2.offset(44 as i32 as isize) });
        if target_info_len as i32 > 0 as i32 {
            ...
            let mut fresh0 = unsafe { &mut ((*ntlm).target_info) };
...
#[no_mangle]
pub extern "C" fn Curl_auth_decode_ntlm_type2_message<'a1>(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    mut type2ref: Option<&'a1 crate::src::lib::bufref::bufref>,
    mut ntlm: *mut crate::src::lib::http2::ntlmdata,
) -> u32 {
...
extern "C" fn unicodecpy(mut dest: *mut u8, mut src: *const i8, mut length: u64) {
    let mut i: u64 = 0;
...
#[no_mangle]
pub extern "C" fn Curl_auth_create_ntlm_type1_message<'a1, 'a2>(
...
#[no_mangle]
pub extern "C" fn Curl_auth_create_ntlm_type3_message<'a1, 'a2>(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    mut userp: *const i8,
    ...
    if (*(borrow(&ntlm)).unwrap()).flags & ((1 as i32) << 19 as i32) as u32 != 0 {
        ...
        result = Curl_ntlm_core_mk_lmv2_resp(
            ntlmv2hash.as_mut_ptr(),
            entropy.as_mut_ptr(),
            unsafe { &mut *((*(borrow_mut(&mut ntlm)).unwrap()).nonce)
                .as_mut_ptr()
...
#[no_mangle]
pub extern "C" fn Curl_auth_cleanup_ntlm<'a1>(
    mut ntlm: Option<&'a1 mut crate::src::lib::http2::ntlmdata>,
) {
    (unsafe { Curl_cfree.expect("non-null function pointer")((*(borrow_mut(&mut ntlm)).unwrap()).target_info) });
