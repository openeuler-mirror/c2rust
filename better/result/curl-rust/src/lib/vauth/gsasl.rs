...
#[no_mangle]
pub extern "C" fn Curl_auth_gsasl_is_supported<'a1>(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    mut mech: *const i8,
    mut gsasl: Option<&'a1 mut crate::src::lib::http2::gsasldata>,
) -> bool {
    let mut res: i32 = 0;
    res = unsafe { gsasl_init(&mut (*(borrow_mut(&mut gsasl)).unwrap()).ctx) };
    ...
    res = unsafe { gsasl_client_start(
        (*(borrow_mut(&mut gsasl)).unwrap()).ctx,
        mech,
        &mut (*(borrow_mut(&mut gsasl)).unwrap()).client,
    ) };
    if res != GSASL_OK as i32 {
        (unsafe { gsasl_done((*(borrow_mut(&mut gsasl)).unwrap()).ctx) });
        return 0 as i32 != 0;
    }
    return 1 as i32 != 0;
}
#[no_mangle]
pub extern "C" fn Curl_auth_gsasl_start<'a1>(
    mut _data: *mut crate::src::lib::http2::Curl_easy,
    mut userp: *const i8,
    mut passwdp: *const i8,
    mut gsasl: Option<&'a1 mut crate::src::lib::http2::gsasldata>,
) -> u32 {
    (unsafe { gsasl_property_set(
...
#[no_mangle]
pub extern "C" fn Curl_auth_gsasl_token<'a1, 'a2, 'a3>(
    mut data: *mut crate::src::lib::http2::Curl_easy,
...
#[no_mangle]
pub extern "C" fn Curl_auth_gsasl_cleanup<'a1>(
    mut gsasl: Option<&'a1 mut crate::src::lib::http2::gsasldata>,
) {
    (unsafe { gsasl_finish((*(borrow_mut(&mut gsasl)).unwrap()).client) });
