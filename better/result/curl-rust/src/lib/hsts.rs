...
#[no_mangle]
pub extern "C" fn Curl_hsts_init() -> *mut crate::src::lib::easy::hsts {
    let mut h: *mut crate::src::lib::easy::hsts = (unsafe { Curl_ccalloc.expect("non-null function pointer")(
        ::std::mem::size_of::<hsts>() as u64,
        1 as i32 as size_t,
    ) }) as *mut hsts;
    if !h.is_null() {
        Curl_llist_init(Some(unsafe { &mut (*h).list }), None);
    }
    return h;
}
extern "C" fn hsts_free(mut e: *mut crate::src::lib::hsts::stsentry) {
...
#[no_mangle]
pub extern "C" fn Curl_hsts_cleanup<'a1>(
    mut hp: Option<&'a1 mut *mut crate::src::lib::easy::hsts>,
) {
    ...
    if !h.is_null() {
        ...
        while !e.is_null() {
            let mut sts: *mut crate::src::lib::hsts::stsentry = (unsafe { (*e).ptr }) as *mut stsentry;
            n = unsafe { (*e).next };
            hsts_free(sts);
            e = n;
        }
...
extern "C" fn hsts_entry() -> *mut crate::src::lib::hsts::stsentry {
...
extern "C" fn hsts_create(
    ...
    let mut fresh0 = unsafe { &mut ((*sts).host) };
...
pub extern "C" fn Curl_hsts_parse(
    ...
    loop {
        while (unsafe { *p }) as i32 != 0 && Curl_isspace((unsafe { *p }) as u8 as i32) != 0 {
            p = unsafe { p.offset(1) };
        }
    ...
    if expires == 0 {
        ...
        if !sts.is_null() {
            Curl_llist_remove(unsafe { &mut (*h).list }, unsafe { &mut (*sts).node }, 0 as *mut libc::c_void);
            hsts_free(sts);
        }
        return CURLE_OK;
    }
        ...
        while !e.is_null() {
            ...
            if (unsafe { (*sts).expires }) <= now {
                ...
                if subdomain as i32 != 0 && (unsafe { (*sts).includeSubDomains }) as i32 != 0 {
                    let mut ntail: u64 = unsafe { strlen((*sts).host) };
                    if ntail < hlen {
                        ...
                        if (unsafe { *hostname.offset(offs.wrapping_sub(1 as i32 as u64) as isize) }) as i32
                            ...
                            && Curl_strncasecompare(
                                unsafe { &*hostname.offset(offs as isize) },
                                unsafe { (*sts).host },
                                ntail,
                            ) != 0
                        {
                ...
                if Curl_strcasecompare(hostname, unsafe { (*sts).host }) != 0 {
                    return sts;
                }
            }
            e = n;
...
extern "C" fn hsts_push<'a1>(
    ...
    if (unsafe { (*sts).expires }) != 0x7fffffffffffffff as i64 {
        result = Curl_gmtime(unsafe { (*sts).expires }, &mut stamp);
        if result as u64 != 0 {
            return result;
        }
...
extern "C" fn hsts_out(
    ...
    if (unsafe { (*sts).expires }) != 0x7fffffffffffffff as i64 {
        let mut result: u32 = Curl_gmtime(unsafe { (*sts).expires }, &mut stamp);
        if result as u64 != 0 {
            return result;
        }
...
pub extern "C" fn Curl_hsts_save(
    ...
    if unsafe { ((*data).set.hsts_write).is_some() } {
        ...
        e = unsafe { (*h).list.head };
        while !e.is_null() {
            let mut sts_0: *mut crate::src::lib::hsts::stsentry = (unsafe { (*e).ptr }) as *mut stsentry;
...
extern "C" fn hsts_add(mut h: *mut crate::src::lib::easy::hsts, mut line: *mut i8) -> u32 {
...
extern "C" fn hsts_load(mut h: *mut crate::src::lib::easy::hsts, mut file: *const i8) -> u32 {
    let mut result: u32 = CURLE_OK;
    let mut line: *mut i8 = 0 as *mut i8;
    let mut fp: *mut crate::src::lib::http2::_IO_FILE = 0 as *mut FILE;
    (unsafe { Curl_cfree.expect("non-null function pointer")((*h).filename as *mut libc::c_void) });
    let mut fresh1 = unsafe { &mut ((*h).filename) };
    *fresh1 = unsafe { Curl_cstrdup.expect("non-null function pointer")(file) };
    ...
    if !fp.is_null() {
        ...
        if line.is_null() {
            (unsafe { Curl_cfree.expect("non-null function pointer")((*h).filename as *mut libc::c_void) });
            let mut fresh2 = unsafe { &mut ((*h).filename) };
            *fresh2 = 0 as *mut i8;
            (unsafe { fclose(fp) });
            return CURLE_OUT_OF_MEMORY;
        } else {
...
#[no_mangle]
pub extern "C" fn Curl_hsts_loadcb(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    mut h: *mut crate::src::lib::easy::hsts,
) -> u32 {
    if !h.is_null() {
