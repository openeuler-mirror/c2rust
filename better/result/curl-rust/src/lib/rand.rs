...
extern "C" fn randit(mut data: *mut crate::src::lib::http2::Curl_easy, mut rnd: *mut u32) -> u32 {
    let mut r: u32 = 0;
    let mut result: u32 = CURLE_OK;
    static mut randseed: u32 = 0;
    static mut seeded: bool = 0 as i32 != 0;
    result = Curl_ssl_random(data, rnd as *mut u8, ::std::mem::size_of::<u32>() as u64);
...
pub extern "C" fn Curl_rand(
    ...
    while num != 0 {
        let mut r: u32 = 0;
        let mut left: u64 = if num < ::std::mem::size_of::<u32>() as u64 {
            num
        } else {
            ::std::mem::size_of::<u32>() as u64
        };
