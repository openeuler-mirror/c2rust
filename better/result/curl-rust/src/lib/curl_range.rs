...
#[no_mangle]
pub extern "C" fn Curl_range(mut data: *mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut from: i64 = 0;
    let mut to: i64 = 0;
    ...
    if (unsafe { ((*data).state).use_range() }) as i32 != 0 && !(unsafe { (*data).state.range }).is_null() {
        ...
        while (unsafe { *ptr }) as i32 != 0
            && (Curl_isspace((unsafe { *ptr }) as u8 as i32) != 0 || (unsafe { *ptr }) as i32 == '-' as i32)
        {
