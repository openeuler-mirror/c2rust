...
#[no_mangle]
pub extern "C" fn Curl_strntoupper(mut dest: *mut i8, mut src: *const i8, mut n: u64) {
...
#[no_mangle]
pub extern "C" fn Curl_strntolower(mut dest: *mut i8, mut src: *const i8, mut n: u64) {
    if n < 1 as i32 as u64 {
        return;
    }
    loop {
...
#[no_mangle]
pub extern "C" fn curl_strnequal(mut first: *const i8, mut second: *const i8, mut max: u64) -> i32 {
