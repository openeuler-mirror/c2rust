...
pub static mut Curl_handler_gophers: crate::src::lib::http2::Curl_handler =  {
    {
        let mut init = Curl_handler {
            ...
            do_more: None,
            connect_it: Some(gopher_connect),
            connecting: Some(gopher_connecting),
            doing: None,
            proto_getsock: None,
            doing_getsock: None,
            domore_getsock: None,
...
extern "C" fn gopher_do(
    ...
    while !((unsafe { strlen(sel) }) < 1 as i32 as u64) {
        ...
        result = Curl_client_write(data, (1 as i32) << 1 as i32, sel, amount as size_t);
        if result as u64 != 0 {
            break;
        }
        k -= amount;
        ...
        if timeout_ms < 0 as i32 as i64 {
            ...
            what = Curl_socket_check(-(1 as i32), -(1 as i32), sockfd, timeout_ms);
            if what < 0 as i32 {
