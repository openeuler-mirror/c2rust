...
pub type HMAC_hfinal_func<'a1, 'a2> = Option<
    unsafe extern "C" fn(_: Option<&'a1 mut u8>, _: Option<&'a2 mut core::ffi::c_void>) -> (),
>;
pub type HMAC_hupdate_func<'a1, 'a2> = Option<
    unsafe extern "C" fn(_: Option<&'a1 mut core::ffi::c_void>, _: Option<&'a2 u8>, _: u32) -> (),
>;
pub type HMAC_hinit_func<'a1> =
    Option<unsafe extern "C" fn(_: Option<&'a1 mut core::ffi::c_void>) -> ()>;
extern "C" fn sha256_to_hex(mut dst: *mut i8, mut sha: *mut u8, mut dst_l: u64) {
    let mut i: i32 = 0;
    i = 0 as i32;
    while i < 32 as i32 {
...
pub extern "C" fn Curl_output_aws_sigv4(
    ...
    if !(Curl_checkheaders(data, b"Authorization\0" as *const u8 as *const i8)).is_null() {
        return CURLE_OK;
    }
                                                    ...
                                                    if !request_type.is_null() {
                                                        ...
                                                        if !credential_scope.is_null() {
                                                            Curl_sha256it(
                                                                ...
                                                                unsafe { strlen(canonical_request) },
                                                            );
                                                            sha256_to_hex(
                                                                sha_hex.as_mut_ptr(),
                                                                sha_hash.as_mut_ptr(),
                                                            ...
                                                            if !str_to_sign.is_null() {
                                                                ...
                                                                if !secret.is_null() {
                                                                    ret = Curl_hmacit(
                                                                        unsafe { Curl_HMAC_SHA256.as_ptr() },
                                                                        secret as *mut u8,
                                                                        (unsafe { strlen(secret) }) as u32
                                                                            as size_t,
                                                                        date.as_mut_ptr()
                                                                            as *mut u8,
                                                                        (unsafe { strlen(date.as_mut_ptr()) })
                                                                            as u32
                                                                            as size_t,
                                                                                ...
                                                                                as u32)
                                                                        {
                                                                            ...
                                                                            if !(ret as u32
                                                                                != CURLE_OK as i32
                                                                                    as u32)
                                                                            {
                                                                                ret = Curl_hmacit (unsafe { Curl_HMAC_SHA256 . as_ptr () } , tmp_sign0 . as_mut_ptr () , :: std :: mem :: size_of :: < [u8 ; 32] > () as u64 as u32 as size_t , request_type as * mut u8 , (unsafe { strlen (request_type) }) as u32 as size_t , tmp_sign1 . as_mut_ptr () ,) ;
                                                                                if !(ret as u32
                                                                                    != CURLE_OK
                                                                                        as i32
                                                                                        as u32)
                                                                                {
                                                                                    ret = Curl_hmacit (unsafe { Curl_HMAC_SHA256 . as_ptr () } , tmp_sign1 . as_mut_ptr () , :: std :: mem :: size_of :: < [u8 ; 32] > () as u64 as u32 as size_t , str_to_sign as * mut u8 , (unsafe { strlen (str_to_sign) }) as u32 as size_t , tmp_sign0 . as_mut_ptr () ,) ;
                                                                                    if !(ret as u32
                                                                                        != CURLE_OK
                                                                                            as i32
                                                                                            as u32)
                                                                                    {
                                                                                        ...
                                                                                        if ! auth_headers . is_null () { (unsafe { Curl_cfree . expect ("non-null function pointer" ,) ((* data) . state . aptr . userpwd as * mut libc :: c_void) }) ; let mut fresh0 = unsafe { & mut ((* data) . state . aptr . userpwd) } ; * fresh0 = 0 as * mut i8 ; let mut fresh1 = unsafe { & mut ((* data) . state . aptr . userpwd) } ; * fresh1 = auth_headers ; let mut fresh2 = unsafe { & mut ((* data) . state . authhost) } ; (* fresh2) . set_done (1 as i32 as bit) ; ret = CURLE_OK ; }
                                                                                    }
                                                                                }
                                                                            }
                                                                        }
