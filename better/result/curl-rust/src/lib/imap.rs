...
pub static mut Curl_handler_imap: crate::src::lib::http2::Curl_handler =  {
    {
        let mut init = Curl_handler {
            ...
            setup_connection: Some(imap_setup_connection),
            do_it: Some(imap_do),
            done: Some(imap_done),
            do_more: None,
            connect_it: Some(imap_connect),
            connecting: Some(imap_multi_statemach),
            doing: Some(imap_doing),
            proto_getsock: Some(imap_getsock),
            doing_getsock: Some(imap_getsock),
            domore_getsock: None,
            perform_getsock: None,
            disconnect: Some(imap_disconnect),
            readwrite: None,
...
static mut saslimap: crate::src::lib::http2::SASLproto =  {
    {
        let mut init = SASLproto {
            ...
            sendauth: Some(imap_perform_authenticate),
            sendcont: Some(imap_continue_authenticate),
            getmessage: Some(imap_get_message),
        };
        init
    }
};
extern "C" fn imap_to_imaps(mut conn: *mut crate::src::lib::http2::connectdata) {
    let mut fresh0 = unsafe { &mut ((*conn).handler) };
    *fresh0 = unsafe { &Curl_handler_imaps };
    let mut fresh1 = unsafe { &mut ((*conn).bits) };
    (*fresh1).set_tls_upgraded(1 as i32 as bit);
}
extern "C" fn imap_matchresp(mut line: *const i8, mut len: u64, mut cmd: *const i8) -> bool {
    let mut end: *const i8 = unsafe { line.offset(len as isize) };
    let mut cmd_len: u64 = unsafe { strlen(cmd) };
    line = unsafe { line.offset(2 as i32 as isize) };
    if line < end && Curl_isdigit((unsafe { *line }) as u8 as i32) != 0 {
        loop {
...
extern "C" fn imap_endofresp(
    ...
    let mut imap: *mut crate::src::lib::http2::IMAP = unsafe { (*data).req.p.imap };
    let mut imapc: Option<&'_ mut crate::src::lib::http2::imap_conn> =
        Some(unsafe { &mut (*conn).proto.imapc });
    let mut id: *const i8 = ((*(borrow_mut(&mut imapc)).unwrap()).resptag).as_mut_ptr();
    let mut id_len: u64 = unsafe { strlen(id) };
            ...
            7 => {
                if (unsafe { (*imap).custom }).is_null()
                    ...
                    || !(unsafe { (*imap).custom }).is_null()
                        ...
                        && Curl_strcasecompare(unsafe { (*imap).custom }, b"LSUB\0" as *const u8 as *const i8)
                            == 0
                        && Curl_strcasecompare(unsafe { (*imap).custom }, b"UID\0" as *const u8 as *const i8)
                            == 0
                        && Curl_strcasecompare(unsafe { (*imap).custom }, b"NOOP\0" as *const u8 as *const i8)
                            == 0
                {
                    return 0 as i32 != 0;
                }
...
extern "C" fn imap_get_message(mut buffer: *mut i8, mut outptr: *mut *mut i8) {
    let mut len: u64 = unsafe { strlen(buffer) };
...
extern "C" fn state(mut data: *mut crate::src::lib::http2::Curl_easy, mut newstate: u32) {
    let mut imapc: Option<&'_ mut crate::src::lib::http2::imap_conn> =
        Some(unsafe { &mut (*(*data).conn).proto.imapc });
...
extern "C" fn imap_perform_starttls(
    ...
    let mut result: u32 = unsafe { imap_sendf(data, conn, b"STARTTLS\0" as *const u8 as *const i8) };
    if result as u64 == 0 {
...
extern "C" fn imap_perform_upgrade_tls(
    ...
    if result as u64 == 0 {
        if (*(borrow(&imapc)).unwrap()).state as u32 != IMAP_UPGRADETLS as i32 as u32 {
...
extern "C" fn imap_perform_login(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    mut conn: *mut crate::src::lib::http2::connectdata,
) -> u32 {
    let mut result: u32 = CURLE_OK;
...
extern "C" fn imap_perform_authentication(
    ...
    let mut result: u32 = CURLE_OK;
    let mut imapc: *mut crate::src::lib::http2::imap_conn = unsafe { &mut (*conn).proto.imapc };
    let mut progress: u32 = SASL_IDLE;
    if (unsafe { (*imapc).preauth }) as i32 != 0 || !Curl_sasl_can_authenticate(Some(unsafe { &mut (*imapc).sasl }), conn) {
        state(data, IMAP_STOP);
        return result;
    }
    result = Curl_sasl_start(
        unsafe { &mut (*imapc).sasl },
        data,
        conn,
        unsafe { (*imapc).ir_supported },
        Some(&mut progress),
    );
    if result as u64 == 0 {
...
extern "C" fn imap_perform_list(mut data: *mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut result: u32 = CURLE_OK;
...
extern "C" fn imap_perform_select(mut data: *mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut result: u32 = CURLE_OK;
    let mut conn: *mut crate::src::lib::http2::connectdata = unsafe { (*data).conn };
    let mut imap: *mut crate::src::lib::http2::IMAP = unsafe { (*data).req.p.imap };
    let mut imapc: Option<&'_ mut crate::src::lib::http2::imap_conn> =
    ...
    (unsafe { Curl_cfree.expect("non-null function pointer")(
        (*(borrow_mut(&mut imapc)).unwrap()).mailbox as *mut libc::c_void,
    ) });
...
extern "C" fn imap_perform_fetch(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    mut conn: *mut crate::src::lib::http2::connectdata,
) -> u32 {
    let mut result: u32 = CURLE_OK;
...
extern "C" fn imap_perform_append(mut data: *mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut result: u32 = CURLE_OK;
    let mut conn: *mut crate::src::lib::http2::connectdata = unsafe { (*data).conn };
    let mut imap: *mut crate::src::lib::http2::IMAP = unsafe { (*data).req.p.imap };
    let mut mailbox: *mut i8 = 0 as *mut i8;
    ...
    if (unsafe { (*data).set.mimepost.kind }) as u32 != MIMEKIND_NONE as i32 as u32 {
        ...
        curl_mime_headers(unsafe { &mut (*data).set.mimepost }, unsafe { (*data).set.headers }, 0 as i32);
        result = Curl_mime_prepare_headers(
            unsafe { &mut (*data).set.mimepost },
            0 as *const i8,
            0 as *const i8,
            MIMESTRATEGY_MAIL,
        );
        if result as u64 == 0 {
            if (Curl_checkheaders(data, b"Mime-Version\0" as *const u8 as *const i8)).is_null() {
        ...
        if result as u64 == 0 {
            result = Curl_mime_rewind(unsafe { &mut (*data).set.mimepost });
        }
        if result as u64 != 0 {
            return result;
        }
        (unsafe { (*data).state.infilesize = Curl_mime_size(&mut (*data).set.mimepost) });
        let mut fresh5 = unsafe { &mut ((*data).state.fread_func) };
        *fresh5 = unsafe { core::intrinsics::transmute::<
            ...
            >,
        >(Some(Curl_mime_read)) };
        let mut fresh6 = unsafe { &mut ((*data).state.in_0) };
...
extern "C" fn imap_perform_logout(
    ...
    let mut result: u32 = unsafe { imap_sendf(data, conn, b"LOGOUT\0" as *const u8 as *const i8) };
    if result as u64 == 0 {
...
extern "C" fn imap_state_capability_resp(
    ...
    if imapcode == '*' as i32 {
        ...
        if imapcode == 1 as i32
            && (*(borrow(&imapc)).unwrap()).tls_supported as i32 != 0
...
extern "C" fn imap_state_auth_resp(
    ...
    let mut imapc: Option<&'_ mut crate::src::lib::http2::imap_conn> =
        Some(unsafe { &mut (*conn).proto.imapc });
    let mut progress: u32 = SASL_IDLE;
    result = Curl_sasl_continue(
        &mut (*(borrow_mut(&mut imapc)).unwrap()).sasl,
        data,
        conn,
        imapcode,
        Some(&mut progress),
        ...
        match progress as u32 {
            ...
            0 => {
                if !(*(borrow(&imapc)).unwrap()).login_disabled
                    && (*(borrow(&imapc)).unwrap()).preftype & ((1 as i32) << 0 as i32) as u32 != 0
                {
                    result = imap_perform_login(data, conn);
                } else {
                    (unsafe { Curl_failf(
...
extern "C" fn imap_state_listsearch_resp(
    ...
    let mut len: u64 = unsafe { strlen(line) };
    if imapcode == '*' as i32 {
...
extern "C" fn imap_state_select_resp(
    ...
    if imapcode == '*' as i32 {
        ...
        if !(unsafe { (*imap).uidvalidity }).is_null()
            && !((*(borrow(&imapc)).unwrap()).mailbox_uidvalidity).is_null()
            && Curl_strcasecompare(
                unsafe { (*imap).uidvalidity },
                (*(borrow(&imapc)).unwrap()).mailbox_uidvalidity,
            ) == 0
        {
            (unsafe { Curl_failf(
                data,
...
extern "C" fn imap_state_fetch_resp(
    ...
    if parsed {
        ...
        if !((*(borrow(&pp)).unwrap()).cache).is_null() {
            ...
            let mut fresh11 = unsafe { &mut ((*data).req.bytecount) };
        ...
        if (unsafe { (*data).req.bytecount }) == size {
            ...
            Curl_setup_transfer(data, 0 as i32, size, 0 as i32 != 0, -(1 as i32));
        }
    } else {
        (unsafe { Curl_failf(
            data,
...
extern "C" fn imap_statemachine(
    ...
    let mut imapc: *mut crate::src::lib::http2::imap_conn = unsafe { &mut (*conn).proto.imapc };
    let mut pp: *mut crate::src::lib::http2::pingpong = unsafe { &mut (*imapc).pp };
...
extern "C" fn imap_multi_statemach(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    mut done: *mut bool,
) -> u32 {
    let mut result: u32 = CURLE_OK;
    ...
    (unsafe { *done = if (*(borrow(&imapc)).unwrap()).state as u32 == IMAP_STOP as i32 as u32 {
        1 as i32
    } else {
        0 as i32
    } != 0 });
...
extern "C" fn imap_block_statemach(
    ...
    let mut imapc: Option<&'_ mut crate::src::lib::http2::imap_conn> =
        Some(unsafe { &mut (*conn).proto.imapc });
    while (*(borrow(&imapc)).unwrap()).state as u32 != IMAP_STOP as i32 as u32 && result as u64 == 0
    {
        result = Curl_pp_statemach(
            data,
            &mut (*(borrow_mut(&mut imapc)).unwrap()).pp,
...
extern "C" fn imap_init(mut data: *mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut result: u32 = CURLE_OK;
    let mut imap: *mut crate::src::lib::http2::IMAP = 0 as *mut crate::src::lib::http2::IMAP;
    let mut fresh14 = unsafe { &mut ((*data).req.p.imap) };
...
extern "C" fn imap_getsock(
    ...
    return Curl_pp_getsock(data, Some(unsafe { &mut (*conn).proto.imapc.pp }), socks);
}
extern "C" fn imap_connect(
    mut data: *mut crate::src::lib::http2::Curl_easy,
    mut done: *mut bool,
) -> u32 {
    let mut result: u32 = CURLE_OK;
    let mut conn: *mut crate::src::lib::http2::connectdata = unsafe { (*data).conn };
    let mut imapc: *mut crate::src::lib::http2::imap_conn = unsafe { &mut (*conn).proto.imapc };
    let mut pp: Option<&'_ mut crate::src::lib::http2::pingpong> = Some(unsafe { &mut (*imapc).pp });
    ...
    *fresh15 = Some(imap_statemachine);
    let mut fresh16 = &mut ((*(borrow_mut(&mut pp)).unwrap()).endofresp);
    *fresh16 = Some(imap_endofresp);
    (unsafe { (*imapc).preftype = !(0 as u32) });
    Curl_sasl_init(Some(unsafe { &mut (*imapc).sasl }), unsafe { &saslimap });
    Curl_dyn_init(unsafe { &mut (*imapc).dyn_0 }, (64 as i32 * 1024 as i32) as size_t);
...
extern "C" fn imap_perform<'a1>(
    ...
    if !(unsafe { (*imap).mailbox }).is_null()
        && !((*(borrow(&imapc)).unwrap()).mailbox).is_null()
        && Curl_strcasecompare(unsafe { (*imap).mailbox }, (*(borrow(&imapc)).unwrap()).mailbox) != 0
    ...
    *(borrow_mut(&mut connected)).unwrap() = unsafe { (*conn).bits.tcpconnect[0 as i32 as usize] };
    (unsafe { *dophase_done });
    return result;
}
extern "C" fn imap_do(
...
extern "C" fn imap_disconnect(
    ...
    Curl_sasl_cleanup(
        conn,
        (*(borrow_mut(&mut imapc)).unwrap()).sasl.authused as u32,
    );
    (unsafe { Curl_cfree.expect("non-null function pointer")(
        (*(borrow_mut(&mut imapc)).unwrap()).mailbox as *mut libc::c_void,
    ) });
...
extern "C" fn imap_setup_connection(
    ...
    let mut fresh28 = unsafe { &mut ((*conn).bits) };
...
extern "C" fn imap_atom(mut str: *const i8, mut escape_only: bool) -> *mut i8 {
    let atom_specials: [i8; 8] =
        *(unsafe { core::intrinsics::transmute::<&'_ [u8; 8], &'_ [i8; 8]>(b"(){ %*]\0") });
...
extern "C" fn imap_parse_url_options(mut conn: *mut crate::src::lib::http2::connectdata) -> u32 {
    let mut result: u32 = CURLE_OK;
    let mut imapc: Option<&'_ mut crate::src::lib::http2::imap_conn> =
        Some(unsafe { &mut (*conn).proto.imapc });
    ...
    while result as u64 == 0 && !ptr.is_null() && (unsafe { *ptr }) as i32 != 0 {
        ...
        ) != 0
        {
            result = Curl_sasl_parse_url_auth_option(
                ...
                value,
                (unsafe { ptr.offset_from(value) }) as i64 as size_t,
            );
        } else {
...
extern "C" fn imap_parse_url_path(mut data: *mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut result: u32 = CURLE_OK;
    let mut imap: *mut crate::src::lib::http2::IMAP = unsafe { (*data).req.p.imap };
    ...
    if ptr != begin {
        ...
        result = Curl_urldecode(
            data,
            begin,
            (unsafe { end.offset_from(begin) }) as i64 as size_t,
            Some(unsafe { &mut (*imap).mailbox }),
        ...
        let mut fresh30 = unsafe { &mut ((*imap).mailbox) };
        *fresh30 = 0 as *mut i8;
    }
    while (unsafe { *ptr }) as i32 == ';' as i32 {
        ...
        result = Curl_urldecode(
            data,
            begin,
            (unsafe { ptr.offset_from(begin) }) as i64 as size_t,
            Some(&mut name),
            Option::<&'_ mut u64>::None,
            REJECT_CTRL,
        );
        ...
        if Curl_strcasecompare(name, b"UIDVALIDITY\0" as *const u8 as *const i8) != 0
            && (unsafe { (*imap).uidvalidity }).is_null()
        {
            ...
            let mut fresh31 = unsafe { &mut ((*imap).uidvalidity) };
            *fresh31 = value;
            value = 0 as *mut i8;
        } else if Curl_strcasecompare(name, b"UID\0" as *const u8 as *const i8) != 0
            && (unsafe { (*imap).uid }).is_null()
        {
            if valuelen > 0 as i32 as u64
                && (unsafe { *value.offset(valuelen.wrapping_sub(1 as i32 as u64) as isize) }) as i32
            ...
            let mut fresh32 = unsafe { &mut ((*imap).uid) };
            *fresh32 = value;
            value = 0 as *mut i8;
        } else if Curl_strcasecompare(name, b"MAILINDEX\0" as *const u8 as *const i8) != 0
            && (unsafe { (*imap).mindex }).is_null()
        {
            if valuelen > 0 as i32 as u64
                && (unsafe { *value.offset(valuelen.wrapping_sub(1 as i32 as u64) as isize) }) as i32
            ...
            let mut fresh33 = unsafe { &mut ((*imap).mindex) };
            *fresh33 = value;
            value = 0 as *mut i8;
        } else if Curl_strcasecompare(name, b"SECTION\0" as *const u8 as *const i8) != 0
            && (unsafe { (*imap).section }).is_null()
        {
            ...
            let mut fresh34 = unsafe { &mut ((*imap).section) };
            *fresh34 = value;
            value = 0 as *mut i8;
        } else if Curl_strcasecompare(name, b"PARTIAL\0" as *const u8 as *const i8) != 0
            && (unsafe { (*imap).partial }).is_null()
        {
            ...
            let mut fresh35 = unsafe { &mut ((*imap).partial) };
            *fresh35 = value;
            value = 0 as *mut i8;
        } else {
            (unsafe { Curl_cfree.expect("non-null function pointer")(name as *mut libc::c_void) });
...
extern "C" fn imap_parse_custom_request(mut data: *mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut result: u32 = CURLE_OK;
    let mut imap: *mut crate::src::lib::http2::IMAP = unsafe { (*data).req.p.imap };
    ...
    if !custom.is_null() {
        ...
        if result as u64 == 0 {
            ...
            if (unsafe { *params }) != 0 {
                let mut fresh36 = unsafe { &mut ((*imap).custom_params) };
