...
extern "C" {
    ...
    fn UTF8ToHtml(out: *mut u8, outlen: *mut i32, in_0: *const u8, inlen: *mut i32) -> i32;
...
extern "C" fn xmlEncodingErr(mut error: xmlParserErrors, mut msg: *const i8, mut val: *const i8) {
...
#[no_mangle]
pub extern "C" fn xmlDetectCharEncoding(mut in_0: *const u8, mut len: i32) -> xmlCharEncoding {
    if in_0.is_null() {
...
#[no_mangle]
pub extern "C" fn xmlAddEncodingAlias(mut name: *const i8, mut alias: *const i8) -> i32 {
    let mut i: i32 = 0;
    let mut upper: [i8; 100] = [0; 100];
...
#[no_mangle]
pub extern "C" fn xmlParseCharEncoding(mut name: *const i8) -> xmlCharEncoding {
...
#[no_mangle]
pub extern "C" fn xmlGetCharEncodingName(mut enc: xmlCharEncoding) -> *const i8 {
    match enc as i32 {
...
pub extern "C" fn xmlInitCharEncodingHandlers() {
    ...
    xmlNewCharEncodingHandler(
        ...
        Some(UTF8ToUTF8 as unsafe extern "C" fn(*mut u8, *mut i32, *const u8, *mut i32) -> i32),
        Some(UTF8ToUTF8 as unsafe extern "C" fn(*mut u8, *mut i32, *const u8, *mut i32) -> i32),
    );
    (unsafe { xmlUTF16LEHandler = xmlNewCharEncodingHandler(
        b"UTF-16LE\0" as *const u8 as *const i8,
        Some(UTF16LEToUTF8 as unsafe extern "C" fn(*mut u8, *mut i32, *const u8, *mut i32) -> i32),
        Some(UTF8ToUTF16LE as unsafe extern "C" fn(*mut u8, *mut i32, *const u8, *mut i32) -> i32),
    ) });
    (unsafe { xmlUTF16BEHandler = xmlNewCharEncodingHandler(
        b"UTF-16BE\0" as *const u8 as *const i8,
        Some(UTF16BEToUTF8 as unsafe extern "C" fn(*mut u8, *mut i32, *const u8, *mut i32) -> i32),
        Some(UTF8ToUTF16BE as unsafe extern "C" fn(*mut u8, *mut i32, *const u8, *mut i32) -> i32),
    ) });
    xmlNewCharEncodingHandler(
        b"UTF-16\0" as *const u8 as *const i8,
        Some(UTF16LEToUTF8 as unsafe extern "C" fn(*mut u8, *mut i32, *const u8, *mut i32) -> i32),
        Some(UTF8ToUTF16 as unsafe extern "C" fn(*mut u8, *mut i32, *const u8, *mut i32) -> i32),
    );
    xmlNewCharEncodingHandler(
        b"ISO-8859-1\0" as *const u8 as *const i8,
        Some(isolat1ToUTF8 as unsafe extern "C" fn(*mut u8, *mut i32, *const u8, *mut i32) -> i32),
        Some(UTF8Toisolat1 as unsafe extern "C" fn(*mut u8, *mut i32, *const u8, *mut i32) -> i32),
    );
    xmlNewCharEncodingHandler(
        b"ASCII\0" as *const u8 as *const i8,
        Some(asciiToUTF8 as unsafe extern "C" fn(*mut u8, *mut i32, *const u8, *mut i32) -> i32),
        Some(UTF8Toascii as unsafe extern "C" fn(*mut u8, *mut i32, *const u8, *mut i32) -> i32),
    );
    xmlNewCharEncodingHandler(
    ...
    xmlNewCharEncodingHandler(
        ...
        None,
        Some(UTF8ToHtml as unsafe extern "C" fn(*mut u8, *mut i32, *const u8, *mut i32) -> i32),
    );
}
#[no_mangle]
...
#[no_mangle]
pub extern "C" fn xmlRegisterCharEncodingHandler(mut handler: xmlCharEncodingHandlerPtr) {
    if (unsafe { handlers }).is_null() {
    ...
    if handler.is_null() || (unsafe { handlers }).is_null() {
        ...
        let fresh50 = unsafe { nbCharEncodingHandler };
...
#[no_mangle]
pub extern "C" fn xmlGetCharEncodingHandler(mut enc: xmlCharEncoding) -> xmlCharEncodingHandlerPtr {
    let mut handler: xmlCharEncodingHandlerPtr = 0 as *mut xmlCharEncodingHandler;
    if (unsafe { handlers }).is_null() {
        xmlInitCharEncodingHandlers();
    }
...
#[no_mangle]
pub extern "C" fn xmlFindCharEncodingHandler(mut name: *const i8) -> xmlCharEncodingHandlerPtr {
...
pub extern "C" fn xmlCharEncFirstLineInput(
    ...
    toconv = unsafe { xmlBufUse(in_0) };
    if toconv == 0 as i32 as u64 {
        return 0 as i32;
    }
    written = unsafe { xmlBufAvail(out) };
    if len >= 0 as i32 {
    ...
    if toconv.wrapping_mul(2 as i32 as u64) >= written {
        (unsafe { xmlBufGrow(out, toconv.wrapping_mul(2 as i32 as u64) as i32) });
        written = unsafe { xmlBufAvail(out) };
    }
    ...
    ret = xmlEncInputChunk(
        ...
        unsafe { xmlBufEnd(out) },
        &mut c_out,
        unsafe { xmlBufContent(in_0 as *const xmlBuf) },
        &mut c_in,
        0 as i32,
    );
    (unsafe { xmlBufShrink(in_0, c_in as size_t) });
    (unsafe { xmlBufAddLen(out, c_out as size_t) });
    if ret == -(1 as i32) {
        ret = -(3 as i32);
    }
    match ret {
        -2 => {
            ...
            let mut content: *const xmlChar = unsafe { xmlBufContent(in_0 as *const xmlBuf) };
            (unsafe { snprintf(
...
#[no_mangle]
pub extern "C" fn xmlCharEncInput(mut input: xmlParserInputBufferPtr, mut flush: i32) -> i32 {
    let mut ret: i32 = 0;
    let mut written: size_t = 0;
    let mut toconv: size_t = 0;
    let mut c_in: i32 = 0;
...
#[no_mangle]
pub extern "C" fn xmlCharEncOutput(mut output: xmlOutputBufferPtr, mut init: i32) -> i32 {
    let mut ret: i32 = 0;
    let mut written: size_t = 0;
    ...
    let mut out: xmlBufPtr = 0 as *mut xmlBuf;
    if output.is_null()
        || (unsafe { (*output).encoder }).is_null()
        || (unsafe { (*output).buffer }).is_null()
        || (unsafe { (*output).conv }).is_null()
    {
        return -(1 as i32);
    }
    out = unsafe { (*output).conv };
    in_0 = unsafe { (*output).buffer };
    loop {
        written = unsafe { xmlBufAvail(out) };
        if init != 0 {
            c_in = 0 as i32;
        ...
        if toconv.wrapping_mul(4 as i32 as u64) >= written {
            (unsafe { xmlBufGrow(out, toconv.wrapping_mul(4 as i32 as u64) as i32) });
            written = unsafe { xmlBufAvail(out) };
        }
        ...
        match ret {
            ...
            -2 => {
                ...
                let mut len: i32 = (unsafe { xmlBufUse(in_0) }) as i32;
                let mut content: *mut xmlChar = unsafe { xmlBufContent(in_0 as *const xmlBuf) };
                let mut cur: i32 = 0;
                ...
                (unsafe { xmlBufShrink(in_0, len as size_t) });
                (unsafe { xmlBufGrow(out, charrefLen * 4 as i32) });
                c_out = (unsafe { xmlBufAvail(out) }) as i32;
                c_in = charrefLen;
                ret = xmlEncOutputChunk(
                    unsafe { (*output).encoder },
                    unsafe { xmlBufEnd(out) },
                ...
                if ret < 0 as i32 || c_in != charrefLen {
                    ...
                    if (unsafe { xmlBufGetAllocationScheme(in_0) }) != XML_BUFFER_ALLOC_IMMUTABLE as i32 {
        ...
        *fresh60 = (*fresh60).wrapping_add(written as u32);
        ...
        match ret {
            ...
            -2 => {
                ...
                let mut utf: *const xmlChar = (unsafe { (*in_0).content }) as *const xmlChar;
                let mut cur: i32 = 0;
                let mut charrefLen: i32 = 0;
...
#[no_mangle]
pub extern "C" fn xmlCharEncCloseFunc(mut handler: *mut xmlCharEncodingHandler) -> i32 {
...
#[no_mangle]
pub extern "C" fn xmlByteConsumed(mut ctxt: xmlParserCtxtPtr) -> i64 {
    ...
    if !(unsafe { (*in_0).buf }).is_null() && !(unsafe { (*(*in_0).buf).encoder }).is_null() {
        ...
        let mut handler: *mut xmlCharEncodingHandler = unsafe { (*(*in_0).buf).encoder };
