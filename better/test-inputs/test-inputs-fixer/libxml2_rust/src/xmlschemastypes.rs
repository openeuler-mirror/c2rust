...
static mut xmlSchemaTypesBank: xmlHashTablePtr = 0 as *const xmlHashTable as xmlHashTablePtr;
static mut xmlSchemaTypeStringDef: xmlSchemaTypePtr = 0 as *const xmlSchemaType as xmlSchemaTypePtr;
...
static mut xmlSchemaTypeDatetimeDef: xmlSchemaTypePtr =
    0 as *const xmlSchemaType as xmlSchemaTypePtr;
static mut xmlSchemaTypeDateDef: xmlSchemaTypePtr = 0 as *const xmlSchemaType as xmlSchemaTypePtr;
static mut xmlSchemaTypeTimeDef: xmlSchemaTypePtr = 0 as *const xmlSchemaType as xmlSchemaTypePtr;
static mut xmlSchemaTypeGYearDef: xmlSchemaTypePtr = 0 as *const xmlSchemaType as xmlSchemaTypePtr;
static mut xmlSchemaTypeGYearMonthDef: xmlSchemaTypePtr =
    0 as *const xmlSchemaType as xmlSchemaTypePtr;
static mut xmlSchemaTypeGDayDef: xmlSchemaTypePtr = 0 as *const xmlSchemaType as xmlSchemaTypePtr;
static mut xmlSchemaTypeGMonthDayDef: xmlSchemaTypePtr =
    0 as *const xmlSchemaType as xmlSchemaTypePtr;
static mut xmlSchemaTypeGMonthDef: xmlSchemaTypePtr = 0 as *const xmlSchemaType as xmlSchemaTypePtr;
static mut xmlSchemaTypeDurationDef: xmlSchemaTypePtr =
    0 as *const xmlSchemaType as xmlSchemaTypePtr;
static mut xmlSchemaTypeFloatDef: xmlSchemaTypePtr = 0 as *const xmlSchemaType as xmlSchemaTypePtr;
static mut xmlSchemaTypeBooleanDef: xmlSchemaTypePtr =
    0 as *const xmlSchemaType as xmlSchemaTypePtr;
static mut xmlSchemaTypeDoubleDef: xmlSchemaTypePtr = 0 as *const xmlSchemaType as xmlSchemaTypePtr;
static mut xmlSchemaTypeHexBinaryDef: xmlSchemaTypePtr =
    0 as *const xmlSchemaType as xmlSchemaTypePtr;
static mut xmlSchemaTypeBase64BinaryDef: xmlSchemaTypePtr =
    0 as *const xmlSchemaType as xmlSchemaTypePtr;
static mut xmlSchemaTypeAnyURIDef: xmlSchemaTypePtr = 0 as *const xmlSchemaType as xmlSchemaTypePtr;
...
static mut xmlSchemaTypeIntegerDef: xmlSchemaTypePtr =
    0 as *const xmlSchemaType as xmlSchemaTypePtr;
static mut xmlSchemaTypeLongDef: xmlSchemaTypePtr = 0 as *const xmlSchemaType as xmlSchemaTypePtr;
static mut xmlSchemaTypeIntDef: xmlSchemaTypePtr = 0 as *const xmlSchemaType as xmlSchemaTypePtr;
static mut xmlSchemaTypeShortDef: xmlSchemaTypePtr = 0 as *const xmlSchemaType as xmlSchemaTypePtr;
static mut xmlSchemaTypeByteDef: xmlSchemaTypePtr = 0 as *const xmlSchemaType as xmlSchemaTypePtr;
...
static mut xmlSchemaTypeNormStringDef: xmlSchemaTypePtr =
    0 as *const xmlSchemaType as xmlSchemaTypePtr;
static mut xmlSchemaTypeTokenDef: xmlSchemaTypePtr = 0 as *const xmlSchemaType as xmlSchemaTypePtr;
static mut xmlSchemaTypeLanguageDef: xmlSchemaTypePtr =
    0 as *const xmlSchemaType as xmlSchemaTypePtr;
static mut xmlSchemaTypeNameDef: xmlSchemaTypePtr = 0 as *const xmlSchemaType as xmlSchemaTypePtr;
static mut xmlSchemaTypeQNameDef: xmlSchemaTypePtr = 0 as *const xmlSchemaType as xmlSchemaTypePtr;
static mut xmlSchemaTypeNCNameDef: xmlSchemaTypePtr = 0 as *const xmlSchemaType as xmlSchemaTypePtr;
static mut xmlSchemaTypeIdDef: xmlSchemaTypePtr = 0 as *const xmlSchemaType as xmlSchemaTypePtr;
static mut xmlSchemaTypeIdrefDef: xmlSchemaTypePtr = 0 as *const xmlSchemaType as xmlSchemaTypePtr;
static mut xmlSchemaTypeIdrefsDef: xmlSchemaTypePtr = 0 as *const xmlSchemaType as xmlSchemaTypePtr;
static mut xmlSchemaTypeEntityDef: xmlSchemaTypePtr = 0 as *const xmlSchemaType as xmlSchemaTypePtr;
...
static mut xmlSchemaTypeNmtokensDef: xmlSchemaTypePtr =
    0 as *const xmlSchemaType as xmlSchemaTypePtr;
extern "C" fn xmlSchemaTypeErrMemory(mut node: xmlNodePtr, mut extra: *const i8) {
...
extern "C" fn xmlSchemaNewValue(mut type_0: xmlSchemaValType) -> xmlSchemaValPtr {
...
extern "C" fn xmlSchemaNewMinLengthFacet(mut value: i32) -> xmlSchemaFacetPtr {
    let mut ret: xmlSchemaFacetPtr = 0 as *mut xmlSchemaFacet;
    ret = unsafe { xmlSchemaNewFacet() };
    if ret.is_null() {
...
extern "C" fn xmlSchemaInitBasicType(
    mut name: *const i8,
...
extern "C" fn xmlSchemaAddParticle() -> xmlSchemaParticlePtr {
...
extern "C" fn xmlSchemaFreeTypeEntry(mut type_0: *mut libc::c_void, mut _name: *const xmlChar) {
    (unsafe { xmlSchemaFreeType(type_0 as xmlSchemaTypePtr) });
}
#[no_mangle]
pub extern "C" fn xmlSchemaCleanupTypes() {
    ...
    let mut particle: xmlSchemaParticlePtr = 0 as *mut xmlSchemaParticle;
    (unsafe { xmlSchemaFreeWildcard((*xmlSchemaTypeAnyTypeDef).attributeWildcard) });
    particle = (unsafe { (*xmlSchemaTypeAnyTypeDef).subtypes }) as xmlSchemaParticlePtr;
    (unsafe { xmlSchemaFreeWildcard((*(*(*particle).children).children).children as xmlSchemaWildcardPtr) });
    ...
    *fresh14 = 0 as xmlSchemaTypePtr;
    (unsafe { xmlHashFree(
        xmlSchemaTypesBank,
        Some(
            xmlSchemaFreeTypeEntry as unsafe extern "C" fn(*mut libc::c_void, *const xmlChar) -> (),
        ),
    ) });
...
#[no_mangle]
pub extern "C" fn xmlSchemaGetBuiltInType(mut type_0: xmlSchemaValType) -> xmlSchemaTypePtr {
    if (unsafe { xmlSchemaTypesInitialized }) == 0 as i32 {
        xmlSchemaInitTypes();
    }
    match type_0 as u32 {
...
#[no_mangle]
pub extern "C" fn xmlSchemaValueAppend(mut prev: xmlSchemaValPtr, mut cur: xmlSchemaValPtr) -> i32 {
...
#[no_mangle]
pub extern "C" fn xmlSchemaValueGetNext(mut cur: xmlSchemaValPtr) -> xmlSchemaValPtr {
    if cur.is_null() {
        return 0 as xmlSchemaValPtr;
    }
...
#[no_mangle]
pub extern "C" fn xmlSchemaValueGetAsString(mut val: xmlSchemaValPtr) -> *const xmlChar {
    if val.is_null() {
...
#[no_mangle]
pub extern "C" fn xmlSchemaValueGetAsBoolean(mut val: xmlSchemaValPtr) -> i32 {
...
#[no_mangle]
pub extern "C" fn xmlSchemaFreeValue(mut value: xmlSchemaValPtr) {
...
#[no_mangle]
pub extern "C" fn xmlSchemaGetPredefinedType(
    mut name: *const xmlChar,
    mut ns: *const xmlChar,
) -> xmlSchemaTypePtr {
    if (unsafe { xmlSchemaTypesInitialized }) == 0 as i32 {
...
#[no_mangle]
pub extern "C" fn xmlSchemaGetBuiltInListSimpleTypeItemType(
    mut type_0: xmlSchemaTypePtr,
) -> xmlSchemaTypePtr {
...
extern "C" fn _xmlSchemaParseGYear(
    ...
    while (unsafe { *cur }) as i32 >= '0' as i32 && (unsafe { *cur }) as i32 <= '9' as i32 {
        ...
        if (unsafe { (*dt).year }) > 9223372036854775807 as i64 / 10 as i32 as i64 {
            return 2 as i32;
        }
        (unsafe { (*dt).year *= 10 as i32 as i64 });
        if (unsafe { (*dt).year }) > 9223372036854775807 as i64 - digit as i64 {
            return 2 as i32;
        }
        (unsafe { (*dt).year += digit as i64 });
        cur = unsafe { cur.offset(1) };
        digcnt += 1;
    }
    ...
    if isneg != 0 {
        (unsafe { (*dt).year = -(*dt).year });
    }
    if !((unsafe { (*dt).year }) != 0 as i32 as i64) {
        return 2 as i32;
    }
    (unsafe { *str = cur });
    return 0 as i32;
}
extern "C" fn _xmlSchemaParseGMonth(
    mut dt: xmlSchemaValDatePtr,
    mut str: *mut *const xmlChar,
) -> i32 {
    let mut cur: *const xmlChar = unsafe { *str };
    ...
    (unsafe { (*dt).set_mon(value) });
    (unsafe { *str = cur });
    return 0 as i32;
}
extern "C" fn _xmlSchemaParseGDay(
    mut dt: xmlSchemaValDatePtr,
    mut str: *mut *const xmlChar,
) -> i32 {
    let mut cur: *const xmlChar = unsafe { *str };
    ...
    (unsafe { (*dt).set_day(value) });
    (unsafe { *str = cur });
    return 0 as i32;
}
extern "C" fn _xmlSchemaParseTime(
    mut dt: xmlSchemaValDatePtr,
    mut str: *mut *const xmlChar,
) -> i32 {
    let mut cur: *const xmlChar = unsafe { *str };
    ...
    cur = unsafe { cur.offset(1) };
    (unsafe { (*dt).set_hour(value as u32) });
    if ((unsafe { *cur.offset(0 as i32 as isize) }) as i32) < '0' as i32
        || (unsafe { *cur.offset(0 as i32 as isize) }) as i32 > '9' as i32
        || ((unsafe { *cur.offset(1 as i32 as isize) }) as i32) < '0' as i32
        || (unsafe { *cur.offset(1 as i32 as isize) }) as i32 > '9' as i32
    ...
    (unsafe { (*dt).set_min(value as u32) });
    if (unsafe { *cur }) as i32 != ':' as i32 {
        return 1 as i32;
    }
    cur = unsafe { cur.offset(1) };
        ...
        || (unsafe { *cur.offset(1 as i32 as isize) }) as i32 > '9' as i32
    {
        ...
        (unsafe { (*dt).sec = ((*cur.offset(0 as i32 as isize) as i32 - '0' as i32) * 10 as i32
            + (*cur.offset(1 as i32 as isize) as i32 - '0' as i32)) as f64 });
    }
    cur = unsafe { cur.offset(2 as i32 as isize) };
    if ret == 0 && (unsafe { *cur }) as i32 == '.' as i32 {
        ...
        while (unsafe { *cur }) as i32 >= '0' as i32 && (unsafe { *cur }) as i32 <= '9' as i32 {
            ...
            (unsafe { (*dt).sec += (*cur as i32 - '0' as i32) as f64 * mult });
            cur = unsafe { cur.offset(1) };
        }
    }
    if ret != 0 as i32 {
    ...
    if !(((unsafe { (*dt).hour() }) as i32 >= 0 as i32
        && (unsafe { (*dt).hour() }) as i32 <= 23 as i32
        && ((unsafe { (*dt).min() }) as i32 >= 0 as i32 && (unsafe { (*dt).min() }) as i32 <= 59 as i32)
        && ((unsafe { (*dt).sec }) >= 0 as i32 as f64 && (unsafe { (*dt).sec }) < 60 as i32 as f64)
        || (unsafe { (*dt).hour() }) as i32 == 24 as i32
            && (unsafe { (*dt).min() }) as i32 == 0 as i32
            && (unsafe { (*dt).sec }) == 0 as i32 as f64)
        && ((unsafe { (*dt).tzo() }) >= -(840 as i32) && (unsafe { (*dt).tzo() }) <= 840 as i32))
    {
        return 2 as i32;
    }
    (unsafe { *str = cur });
...
extern "C" fn _xmlSchemaParseTimeZone(
    mut dt: xmlSchemaValDatePtr,
    mut str: *mut *const xmlChar,
) -> i32 {
...
extern "C" fn xmlSchemaValidateDates(
    mut type_0: xmlSchemaValType,
        ...
        && (unsafe { *cur.offset(1 as i32 as isize) }) as i32 == '-' as i32
    {
        ...
        if (unsafe { *cur }) as i32 == '-' as i32 {
            if type_0 as u32 == XML_SCHEMAS_GMONTH as i32 as u32 {
                ...
                cur = unsafe { cur.offset(1) };
                ret = _xmlSchemaParseGDay(unsafe { &mut (*dt).value.date }, &mut cur);
                if ret != 0 as i32 {
                    current_block = 2568818999146507592;
                    ...
                    || (unsafe { *cur }) as i32 == '-' as i32
                {
                    ret = _xmlSchemaParseTimeZone(unsafe { &mut (*dt).value.date }, &mut cur);
                    if ret == 0 as i32 {
            ...
            ret = _xmlSchemaParseGMonth(unsafe { &mut (*dt).value.date }, &mut cur);
            if ret != 0 as i32 {
                current_block = 2568818999146507592;
            } else {
                if (unsafe { *cur }) as i32 == '-' as i32 {
        ...
        if (unsafe { *cur }) as i32 >= '0' as i32 && (unsafe { *cur }) as i32 <= '9' as i32 {
            ret = _xmlSchemaParseTime(unsafe { &mut (*dt).value.date }, &mut cur);
            if ret == 0 as i32 {
                if (unsafe { *cur }) as i32 == 0 as i32
                    || (unsafe { *cur }) as i32 == 'Z' as i32
                    || (unsafe { *cur }) as i32 == '+' as i32
        ...
        match current_block {
            ...
            _ => {
                cur = dateTime;
                ret = _xmlSchemaParseGYear(unsafe { &mut (*dt).value.date }, &mut cur);
                if ret != 0 as i32 {
                    current_block = 2568818999146507592;
                } else {
                    if (unsafe { *cur }) as i32 == 0 as i32
...
extern "C" fn xmlSchemaValidateDuration(
    mut _type_0: xmlSchemaTypePtr,
...
extern "C" fn xmlSchemaStrip(mut value: *const xmlChar) -> *mut xmlChar {
    ...
    return unsafe { xmlStrndup(start, end.offset_from(start) as i64 as i32) };
}
#[no_mangle]
pub extern "C" fn xmlSchemaWhiteSpaceReplace(mut value: *const xmlChar) -> *mut xmlChar {
...
#[no_mangle]
pub extern "C" fn xmlSchemaCollapseString(mut value: *const xmlChar) -> *mut xmlChar {
    let mut start: *const xmlChar = value;
    let mut end: *const xmlChar = 0 as *const xmlChar;
    let mut f: *const xmlChar = 0 as *const xmlChar;
...
extern "C" fn xmlSchemaValAtomicListNode(
    mut type_0: xmlSchemaTypePtr,
    mut value: *const xmlChar,
    ...
    val = unsafe { xmlStrdup(value) };
    if val.is_null() {
        return -(1 as i32);
    }
    if !ret.is_null() {
        (unsafe { *ret = 0 as xmlSchemaValPtr });
    }
    cur = val;
    while (unsafe { *cur }) as i32 == 0x20 as i32
        || 0x9 as i32 <= (unsafe { *cur }) as i32 && (unsafe { *cur }) as i32 <= 0xa as i32
...
extern "C" fn xmlSchemaParseUInt(
    mut str: *mut *const xmlChar,
    mut llo: *mut u64,
    mut lmi: *mut u64,
    mut lhi: *mut u64,
...
extern "C" fn xmlSchemaCheckLanguageType(mut value: *const xmlChar) -> i32 {
...
extern "C" fn xmlSchemaValAtomicType(
    mut type_0: xmlSchemaTypePtr,
    mut value: *const xmlChar,
    mut val: *mut xmlSchemaValPtr,
    mut node: xmlNodePtr,
    ...
    if !val.is_null() {
        (unsafe { *val = 0 as xmlSchemaValPtr });
    }
    ...
    match unsafe { (*type_0).builtInType } {
        ...
        45 | 46 => {
            if createStringValue != 0 && !val.is_null() {
                ...
                if !v.is_null() {
                    ...
                    *fresh30 = unsafe { xmlStrdup(value) };
                    (unsafe { *val = v });
                ...
                _ => {
                    if createStringValue != 0 && !val.is_null() {
                        ...
                        if !v.is_null() {
                            ...
                            *fresh31 = unsafe { xmlStrdup(value) };
                            (unsafe { *val = v });
                            current_block = 8031879791157749499;
                        } else {
                            current_block = 8144989253473847324;
                ...
                _ => {
                    if !val.is_null() {
                        ...
                        if !v.is_null() {
                            ...
                            *fresh32 = unsafe { xmlStrdup(value) };
                            (unsafe { *val = v });
                            current_block = 8031879791157749499;
                        } else {
                            current_block = 8144989253473847324;
                                        ...
                                        if len != 0 as i32 as u32 {
                                            ...
                                            if len != 0 as i32 as u32 {
                                                ...
                                                xmlSchemaParseUInt(
                                                    ...
                                                    unsafe { &mut (*v).value.decimal.lo },
                                                    unsafe { &mut (*v).value.decimal.mi },
                                                    unsafe { &mut (*v).value.decimal.hi },
                                                );
                                            }
                                        }
                ...
                _ => {
                    if !val.is_null() {
                        ...
                        if !v.is_null() {
                            ...
                            *fresh49 = unsafe { xmlStrdup(value) };
                            (unsafe { *val = v });
                            current_block = 8031879791157749499;
                        } else {
                            current_block = 8144989253473847324;
            ...
            if xmlSchemaCheckLanguageType(value) == 1 as i32 {
                if !val.is_null() {
                    ...
                    if !v.is_null() {
                        ...
                        *fresh50 = unsafe { xmlStrdup(value) };
                        (unsafe { *val = v });
                        current_block = 8031879791157749499;
                    } else {
                        current_block = 8144989253473847324;
        ...
        18 => {
            if (unsafe { xmlValidateNMToken(value, 1 as i32) }) == 0 as i32 {
                if !val.is_null() {
                    v = xmlSchemaNewValue(XML_SCHEMAS_NMTOKEN);
                    if !v.is_null() {
                        let fresh51 = unsafe { &mut ((*v).value.str_0) };
                        *fresh51 = unsafe { xmlStrdup(value) };
                        (unsafe { *val = v });
                        current_block = 8031879791157749499;
                    } else {
                        current_block = 8144989253473847324;
        ...
        19 => {
            ret = xmlSchemaValAtomicListNode(unsafe { xmlSchemaTypeNmtokenDef }, value, val, node);
            if ret > 0 as i32 {
                ret = 0 as i32;
            } else {
                ret = 1 as i32;
        ...
        20 => {
            ret = unsafe { xmlValidateName(value, 1 as i32) };
            if ret == 0 as i32 && !val.is_null() && !value.is_null() {
                ...
                if !v.is_null() {
                    ...
                    *fresh52 = unsafe { xmlStrndup(start, end.offset_from(start) as i64 as i32) };
                    (unsafe { *val = v });
                    current_block = 3184724535425162531;
                } else {
                    current_block = 8144989253473847324;
        ...
        21 => {
            ...
            ret = unsafe { xmlValidateQName(value, 1 as i32) };
            if ret != 0 as i32 {
                current_block = 3184724535425162531;
            } else {
                if !node.is_null() {
                    ...
                    local = unsafe { xmlSplitQName2(value, &mut prefix) };
                    ns = unsafe { xmlSearchNs((*node).doc, node, prefix) };
                        ...
                        if !val.is_null() {
                            ...
                            if v.is_null() {
                                ...
                                if !local.is_null() {
                                    ...
                                    *fresh54 = unsafe { xmlStrdup(value) };
                                }
                                if !uri.is_null() {
                                    let fresh55 = unsafe { &mut ((*v).value.qname.uri) };
                                    *fresh55 = unsafe { xmlStrdup(uri) };
                                }
                                (unsafe { *val = v });
                                current_block = 3184724535425162531;
                            }
        ...
        23 => {
            ...
            if ret == 0 as i32 && !val.is_null() {
                ...
                if !v.is_null() {
                    ...
                    *fresh57 = unsafe { xmlStrdup(value) };
                    (unsafe { *val = v });
                ...
                _ => {
                        ...
                        && (unsafe { (*node).type_0 }) as u32 == XML_ATTRIBUTE_NODE as i32 as u32
                    {
                        ...
                        if (unsafe { (*attr).atype }) as u32 != XML_ATTRIBUTE_ID as i32 as u32 {
                            ...
                            if !strip.is_null() {
                                res = unsafe { xmlAddID(0 as xmlValidCtxtPtr, (*node).doc, strip, attr) };
                                (unsafe { xmlFree.expect("non-null function pointer")(
                                    strip as *mut libc::c_void,
                                ) });
                            } else {
                                res = unsafe { xmlAddID(0 as xmlValidCtxtPtr, (*node).doc, value, attr) };
                            }
                            if res.is_null() {
                                ret = 2 as i32;
                            } else {
        ...
        24 => {
            ...
            if ret == 0 as i32 && !val.is_null() {
                ...
                if v.is_null() {
                    ...
                    *fresh58 = unsafe { xmlStrdup(value) };
                    (unsafe { *val = v });
            ...
            match current_block {
                ...
                _ => {
                        ...
                        && (unsafe { (*node).type_0 }) as u32 == XML_ATTRIBUTE_NODE as i32 as u32
                    {
                        ...
                        if !strip_0.is_null() {
                            (unsafe { xmlAddRef(0 as xmlValidCtxtPtr, (*node).doc, strip_0, attr_0) });
                            (unsafe { xmlFree.expect("non-null function pointer")(
                                strip_0 as *mut libc::c_void,
                            ) });
                        } else {
                            (unsafe { xmlAddRef(0 as xmlValidCtxtPtr, (*node).doc, value, attr_0) });
                        }
        ...
        25 => {
            ret = xmlSchemaValAtomicListNode(unsafe { xmlSchemaTypeIdrefDef }, value, val, node);
            if ret < 0 as i32 {
                ret = 2 as i32;
            } else {
                ret = 0 as i32;
        ...
        27 => {
            if node.is_null() || (unsafe { (*node).doc }).is_null() {
                ...
                ret = xmlSchemaValAtomicListNode(unsafe { xmlSchemaTypeEntityDef }, value, val, node);
                if ret <= 0 as i32 {
                    ret = 1 as i32;
                } else {
                    ret = 0 as i32;
        ...
        28 => {
            ...
            if ret == 0 as i32 && !node.is_null() {
                ...
                local_0 = unsafe { xmlSplitQName2(value, &mut prefix_0) };
                if !prefix_0.is_null() {
                    let mut ns_0: xmlNsPtr = 0 as *mut xmlNs;
                    ns_0 = unsafe { xmlSearchNs((*node).doc, node, prefix_0) };
                    if ns_0.is_null() {
                        ret = 1 as i32;
                    } else if !val.is_null() {
                        uri_0 = unsafe { xmlStrdup((*ns_0).href) };
                    }
                }
            ...
            if ret == 0 as i32 {
                ret = unsafe { xmlValidateNotationUse(0 as xmlValidCtxtPtr, (*node).doc, value) };
                if ret == 1 as i32 {
                    ret = 0 as i32;
                } else {
                    ret = 1 as i32;
            ...
            if ret == 0 as i32 && !val.is_null() {
                ...
                if !v.is_null() {
                    if !local_0.is_null() {
                        ...
                        *fresh60 = unsafe { xmlStrdup(value) };
                    }
                    if !uri_0.is_null() {
                ...
                _ => {
                    if !val.is_null() {
                        ...
                        if v.is_null() {
                            ...
                            *fresh62 = unsafe { xmlStrdup(value) };
                            (unsafe { *val = v });
                            current_block = 8031879791157749499;
                        }
                    } else {
            ...
            if cur_6.is_null() {
                ...
                if (unsafe { *cur_6 }) as i32 != 0 as i32 {
                    ...
                    if v.is_null() {
                        ...
                        cur_6 = unsafe { xmlStrndup(start_0, i) };
                        if cur_6.is_null() {
                            xmlSchemaTypeErrMemory(
                                node,
...
#[no_mangle]
pub extern "C" fn xmlSchemaValPredefTypeNode(
    mut type_0: xmlSchemaTypePtr,
    mut value: *const xmlChar,
    mut val: *mut xmlSchemaValPtr,
    mut node: xmlNodePtr,
...
#[no_mangle]
pub extern "C" fn xmlSchemaValPredefTypeNodeNoNorm(
    mut type_0: xmlSchemaTypePtr,
    mut value: *const xmlChar,
    mut val: *mut xmlSchemaValPtr,
    mut node: xmlNodePtr,
...
#[no_mangle]
pub extern "C" fn xmlSchemaValidatePredefinedType(
    mut type_0: xmlSchemaTypePtr,
    mut value: *const xmlChar,
    mut val: *mut xmlSchemaValPtr,
) -> i32 {
...
extern "C" fn xmlSchemaCompareDecimals(mut x: xmlSchemaValPtr, mut y: xmlSchemaValPtr) -> i32 {
...
extern "C" fn xmlSchemaCompareDurations(mut x: xmlSchemaValPtr, mut y: xmlSchemaValPtr) -> i32 {
    let mut carry: i64 = 0;
    let mut mon: i64 = 0;
    let mut day: i64 = 0;
    let mut sec: f64 = 0.;
...
extern "C" fn xmlSchemaDupVal(mut v: xmlSchemaValPtr) -> xmlSchemaValPtr {
    let mut ret: xmlSchemaValPtr = xmlSchemaNewValue(unsafe { (*v).type_0 });
    if ret.is_null() {
        return 0 as xmlSchemaValPtr;
    }
    (unsafe { memcpy(
...
#[no_mangle]
pub extern "C" fn xmlSchemaCopyValue(mut val: xmlSchemaValPtr) -> xmlSchemaValPtr {
        ...
        match (unsafe { (*val).type_0 }) as u32 {
            ...
            46 | 1 | 2 | 16 | 17 | 20 | 22 | 23 | 24 | 26 | 18 | 29 => {
                ...
                if !(unsafe { (*val).value.str_0 }).is_null() {
                    ...
                    *fresh76 = unsafe { xmlStrdup((*val).value.str_0) };
                }
            }
            21 | 28 => {
                cur = xmlSchemaDupVal(val);
                if !(unsafe { (*val).value.qname.name }).is_null() {
                    ...
                    *fresh77 = unsafe { xmlStrdup((*val).value.qname.name) };
                }
                if !(unsafe { (*val).value.qname.uri }).is_null() {
                    let fresh78 = unsafe { &mut ((*cur).value.qname.uri) };
                    *fresh78 = unsafe { xmlStrdup((*val).value.qname.uri) };
                }
            }
            43 => {
                cur = xmlSchemaDupVal(val);
                if !(unsafe { (*val).value.hex.str_0 }).is_null() {
                    ...
                    *fresh79 = unsafe { xmlStrdup((*val).value.hex.str_0) };
                }
            }
            44 => {
                cur = xmlSchemaDupVal(val);
                if !(unsafe { (*val).value.base64.str_0 }).is_null() {
                    ...
                    *fresh80 = unsafe { xmlStrdup((*val).value.base64.str_0) };
                }
            }
            _ => {
                cur = xmlSchemaDupVal(val);
...
extern "C" fn _xmlSchemaDateAdd(
    ...
    r = unsafe { &mut (*ret).value.date };
    d = unsafe { &mut (*tmp).value.date };
    u = unsafe { &mut (*dur).value.dur };
    if (unsafe { (*d).mon() }) as i32 == 0 as i32 {
        (unsafe { (*d).set_mon(1 as i32 as u32) });
    }
    (unsafe { (*u).sec -= ((*d).tzo() * 60 as i32) as f64 });
    (unsafe { (*d).set_tzo(0 as i32) });
    if (unsafe { (*d).day() }) as i32 == 0 as i32 {
        (unsafe { (*d).set_day(1 as i32 as u32) });
    }
    carry = (unsafe { (*d).mon() }) as i64 + (unsafe { (*u).mon });
    (unsafe { (*r).set_mon(
        ((carry - 1 as i32 as i64) as f64
            - floor((carry - 1 as i32 as i64) as f64 / (13 as i32 - 1 as i32) as f64)
    ...
    (unsafe { (*r).year = (*d).year + carry });
    if (unsafe { (*r).year }) == 0 as i32 as i64 {
        if (unsafe { (*d).year }) > 0 as i32 as i64 {
            let fresh82 = unsafe { &mut ((*r).year) };
            *fresh82 -= 1;
        } else {
            let fresh83 = unsafe { &mut ((*r).year) };
            *fresh83 += 1;
        }
    }
    (unsafe { (*r).set_tzo((*d).tzo()) });
    (unsafe { (*r).set_tz_flag((*d).tz_flag()) });
    (unsafe { (*r).sec = (*d).sec + (*u).sec });
    carry = (unsafe { floor((*r).sec as i64 as f64 / 60 as i32 as f64) }) as i64;
    if (unsafe { (*r).sec }) != 0.0f64 {
        (unsafe { (*r).sec = (*r).sec - floor((*r).sec / 60.0f64) * 60.0f64 });
    }
    carry += (unsafe { (*d).min() }) as i64;
    (unsafe { (*r).set_min((carry as f64 - floor(carry as f64 / 60 as i32 as f64) * 60 as i32 as f64) as u32) });
    carry = (unsafe { floor(carry as f64 / 60 as i32 as f64) }) as i64;
    carry += (unsafe { (*d).hour() }) as i64;
    (unsafe { (*r).set_hour(
        (carry as f64 - floor(carry as f64 / 24 as i32 as f64) * 24 as i32 as f64) as u32,
    ) });
    carry = (unsafe { floor(carry as f64 / 24 as i32 as f64) }) as i64;
    if (unsafe { (*r).year }) != 0 as i32 as i64
        && ((unsafe { (*r).mon() }) as i32 >= 1 as i32 && (unsafe { (*r).mon() }) as i32 <= 12 as i32)
        && (unsafe { (*d).day() })
            > (if (unsafe { (*r).year }) % 4 as i32 as i64 == 0 as i32 as i64
                && (unsafe { (*r).year }) % 100 as i32 as i64 != 0 as i32 as i64
                || (unsafe { (*r).year }) % 400 as i32 as i64 == 0 as i32 as i64
            {
                unsafe { daysInMonthLeap[((*r).mon() as i32 - 1 as i32) as usize] }
            } else {
                unsafe { daysInMonth[((*r).mon() as i32 - 1 as i32) as usize] }
            })
    {
        tempdays = (if (unsafe { (*r).year }) % 4 as i32 as i64 == 0 as i32 as i64
            && (unsafe { (*r).year }) % 100 as i32 as i64 != 0 as i32 as i64
            || (unsafe { (*r).year }) % 400 as i32 as i64 == 0 as i32 as i64
        {
            unsafe { daysInMonthLeap[((*r).mon() as i32 - 1 as i32) as usize] }
    ...
    } else if ((unsafe { (*d).day() }) as i32) < 1 as i32 {
        tempdays = 1 as i32 as i64;
    } else {
        tempdays = (unsafe { (*d).day() }) as i64;
    }
    tempdays += (unsafe { (*u).day }) + carry;
    loop {
        if tempdays < 1 as i32 as i64 {
            let mut tmon: i64 = (((unsafe { (*r).mon() }) as i32 - 1 as i32 - 1 as i32) as f64
                - (unsafe { floor(
                    ((*r).mon() as i32 - 1 as i32 - 1 as i32) as f64
                        / (13 as i32 - 1 as i32) as f64,
                ) }) * (13 as i32 - 1 as i32) as f64
                + 1 as i32 as f64) as i64;
            let mut tyr: i64 = (unsafe { (*r).year })
                + (unsafe { floor(
                    ((*r).mon() as i32 - 1 as i32 - 1 as i32) as f64
                        / (13 as i32 - 1 as i32) as f64,
                ) }) as i64;
        ...
        temp = (unsafe { (*r).mon() }) as i64 + carry;
        (unsafe { (*r).set_mon(
        ...
        (unsafe { (*r).year = (*r).year
            + floor((temp - 1 as i32 as i64) as f64 / (13 as i32 - 1 as i32) as f64) as i64 });
        if (unsafe { (*r).year }) == 0 as i32 as i64 {
            if temp < 1 as i32 as i64 {
                let fresh84 = unsafe { &mut ((*r).year) };
                *fresh84 -= 1;
            } else {
                let fresh85 = unsafe { &mut ((*r).year) };
                *fresh85 += 1;
            }
        }
    }
    (unsafe { (*r).set_day(tempdays as u32) });
    if (unsafe { (*ret).type_0 }) as u32 != XML_SCHEMAS_DATETIME as i32 as u32 {
        if (unsafe { (*r).hour() }) as i32 != 0 || (unsafe { (*r).min() }) as i32 != 0 || (unsafe { (*r).sec }) != 0. {
            (unsafe { (*ret).type_0 = XML_SCHEMAS_DATETIME });
        } else if (unsafe { (*ret).type_0 }) as u32 != XML_SCHEMAS_DATE as i32 as u32 {
            if (unsafe { (*r).mon() }) as i32 != 1 as i32 && (unsafe { (*r).day() }) as i32 != 1 as i32 {
                (unsafe { (*ret).type_0 = XML_SCHEMAS_DATE });
            } else if (unsafe { (*ret).type_0 }) as u32 != XML_SCHEMAS_GYEARMONTH as i32 as u32
                && (unsafe { (*r).mon() }) as i32 != 1 as i32
            {
...
extern "C" fn xmlSchemaDateNormalize(mut dt: xmlSchemaValPtr, mut offset: f64) -> xmlSchemaValPtr {
    let mut dur: xmlSchemaValPtr = 0 as *mut xmlSchemaVal;
    let mut ret: xmlSchemaValPtr = 0 as *mut xmlSchemaVal;
    if dt.is_null() {
        return 0 as xmlSchemaValPtr;
...
extern "C" fn _xmlSchemaDateCastYMToDays(dt: xmlSchemaValPtr) -> i64 {
    let mut ret: i64 = 0;
    let mut mon: i32 = 0;
...
extern "C" fn xmlSchemaCompareDates(mut x: xmlSchemaValPtr, mut y: xmlSchemaValPtr) -> i32 {
    let mut xmask: u8 = 0;
    let mut ymask: u8 = 0;
...
extern "C" fn xmlSchemaCompareReplacedStrings(mut x: *const xmlChar, mut y: *const xmlChar) -> i32 {
    let mut tmp: i32 = 0;
    while (unsafe { *x }) as i32 != 0 as i32 && (unsafe { *y }) as i32 != 0 as i32 {
        if (unsafe { *y }) as i32 == 0x20 as i32
            || 0x9 as i32 <= (unsafe { *y }) as i32 && (unsafe { *y }) as i32 <= 0xa as i32
...
extern "C" fn xmlSchemaCompareNormStrings(mut x: *const xmlChar, mut y: *const xmlChar) -> i32 {
    let mut tmp: i32 = 0;
...
extern "C" fn xmlSchemaCompareFloats(mut x: xmlSchemaValPtr, mut y: xmlSchemaValPtr) -> i32 {
    let mut d1: f64 = 0.;
    let mut d2: f64 = 0.;
    if x.is_null() || y.is_null() {
        return -(2 as i32);
...
extern "C" fn xmlSchemaCompareValuesInternal(
    ...
    match xtype as u32 {
        ...
        21 | 28 => {
            ...
            {
                if (unsafe { xmlStrEqual((*x).value.qname.name, (*y).value.qname.name) }) != 0
                    && (unsafe { xmlStrEqual((*x).value.qname.uri, (*y).value.qname.uri) }) != 0
                {
                    return 0 as i32;
                }
                return 2 as i32;
        ...
        43 => {
            ...
            if ytype as u32 == XML_SCHEMAS_HEXBINARY as i32 as u32 {
                if (unsafe { (*x).value.hex.total }) == (unsafe { (*y).value.hex.total }) {
                    let mut ret: i32 = unsafe { xmlStrcmp((*x).value.hex.str_0, (*y).value.hex.str_0) };
                    if ret > 0 as i32 {
                        return 1 as i32;
                    } else {
                        if ret == 0 as i32 {
        ...
        44 => {
            ...
            if ytype as u32 == XML_SCHEMAS_BASE64BINARY as i32 as u32 {
                if (unsafe { (*x).value.base64.total }) == (unsafe { (*y).value.base64.total }) {
                    let mut ret_0: i32 =
                        unsafe { xmlStrcmp((*x).value.base64.str_0, (*y).value.base64.str_0) };
                    if ret_0 > 0 as i32 {
                        return 1 as i32;
...
#[no_mangle]
pub extern "C" fn xmlSchemaCompareValues(mut x: xmlSchemaValPtr, mut y: xmlSchemaValPtr) -> i32 {
...
extern "C" fn xmlSchemaNormLen(mut value: *const xmlChar) -> i32 {
...
#[no_mangle]
pub extern "C" fn xmlSchemaGetFacetValueAsULong(mut facet: xmlSchemaFacetPtr) -> u64 {
...
#[no_mangle]
pub extern "C" fn xmlSchemaValidateListSimpleTypeFacet(
    ...
    if (unsafe { (*facet).type_0 }) as u32 == XML_SCHEMA_FACET_LENGTH as i32 as u32 {
        if actualLen != (unsafe { (*(*facet).val).value.decimal.lo }) {
            if !expectedLen.is_null() {
                (unsafe { *expectedLen = (*(*facet).val).value.decimal.lo });
            }
        ...
        return xmlSchemaValidateFacet(0 as xmlSchemaTypePtr, facet, value, 0 as xmlSchemaValPtr);
    }
    return 0 as i32;
}
extern "C" fn xmlSchemaValidateLengthFacetInternal(
    mut facet: xmlSchemaFacetPtr,
            ...
            1 | 2 => {
                if ws as u32 == XML_SCHEMA_WHITESPACE_UNKNOWN as i32 as u32 {
                    if valType as u32 == XML_SCHEMAS_STRING as i32 as u32 {
                        len = (unsafe { xmlUTF8Strlen(value) }) as u32;
                    } else {
...
#[no_mangle]
pub extern "C" fn xmlSchemaValidateLengthFacet(
    mut type_0: xmlSchemaTypePtr,
    mut facet: xmlSchemaFacetPtr,
    mut value: *const xmlChar,
    mut val: xmlSchemaValPtr,
...
#[no_mangle]
pub extern "C" fn xmlSchemaValidateLengthFacetWhtsp(
    mut facet: xmlSchemaFacetPtr,
    mut valType: xmlSchemaValType,
    mut value: *const xmlChar,
    mut val: xmlSchemaValPtr,
...
extern "C" fn xmlSchemaValidateFacetInternal(
    mut facet: xmlSchemaFacetPtr,
    ...
    match (unsafe { (*facet).type_0 }) as u32 {
        1006 => {
            ...
            ret = unsafe { xmlRegexpExec((*facet).regexp, value) };
            if ret == 1 as i32 {
                return 0 as i32;
            }
            if ret == 0 as i32 {
        ...
        1007 => {
            if ws as u32 == XML_SCHEMA_WHITESPACE_UNKNOWN as i32 as u32 {
                if !(unsafe { (*facet).value }).is_null() && (unsafe { xmlStrEqual((*facet).value, value) }) != 0 {
                    return 0 as i32;
                }
            } else {
...
#[no_mangle]
pub extern "C" fn xmlSchemaValidateFacet(
    ...
    if !val.is_null() {
        ...
        if !base.is_null() {
            return xmlSchemaValidateFacetInternal(
                facet,
                XML_SCHEMA_WHITESPACE_UNKNOWN,
                (unsafe { (*base).builtInType }) as xmlSchemaValType,
                value,
                val,
                XML_SCHEMA_WHITESPACE_UNKNOWN,
            );
...
#[no_mangle]
pub extern "C" fn xmlSchemaValidateFacetWhtsp(
    mut facet: xmlSchemaFacetPtr,
    mut fws: xmlSchemaWhitespaceValueType,
    mut valType: xmlSchemaValType,
    mut value: *const xmlChar,
...
#[no_mangle]
pub extern "C" fn xmlSchemaGetCanonValue(
    mut val: xmlSchemaValPtr,
    ...
    (unsafe { *retValue = 0 as *const xmlChar });
    match (unsafe { (*val).type_0 }) as u32 {
        1 => {
            if (unsafe { (*val).value.str_0 }).is_null() {
                (unsafe { *retValue = xmlStrdup(b"\0" as *const u8 as *const i8 as *mut xmlChar) });
            } else {
                (unsafe { *retValue = xmlStrdup((*val).value.str_0 as *const xmlChar) });
            }
        }
        2 => {
            if (unsafe { (*val).value.str_0 }).is_null() {
                ...
                (unsafe { *retValue = xmlSchemaWhiteSpaceReplace((*val).value.str_0 as *const xmlChar) });
                if (unsafe { *retValue }).is_null() {
                    (unsafe { *retValue = xmlStrdup((*val).value.str_0 as *const xmlChar) });
                }
            }
        }
        16 | 17 | 18 | 20 | 22 | 23 | 24 | 26 | 28 | 29 => {
            ...
            (unsafe { *retValue = xmlSchemaCollapseString((*val).value.str_0) });
            if (unsafe { *retValue }).is_null() {
                (unsafe { *retValue = xmlStrdup((*val).value.str_0 as *const xmlChar) });
            }
        }
        21 => {
            if (unsafe { (*val).value.qname.uri }).is_null() {
                (unsafe { *retValue = xmlStrdup((*val).value.qname.name) });
                return 0 as i32;
            } else {
                (unsafe { *retValue = xmlStrdup(b"{\0" as *const u8 as *const i8 as *mut xmlChar) });
                (unsafe { *retValue = xmlStrcat(*retValue as *mut xmlChar, (*val).value.qname.uri) });
                (unsafe { *retValue = xmlStrcat(
        ...
        3 => {
            ...
            {
                (unsafe { *retValue = xmlStrdup(b"0.0\0" as *const u8 as *const i8 as *mut xmlChar) });
            } else {
                let mut dec: xmlSchemaValDecimal = unsafe { (*val).value.decimal };
                ...
                (unsafe { *retValue = buf as *mut xmlChar });
            }
        }
        30 | 34 | 31 | 32 | 33 | 37 | 41 | 39 | 35 | 36 | 38 | 40 | 42 => {
            if (unsafe { ((*val).value.decimal).total() }) as i32 == 1 as i32
                && (unsafe { (*val).value.decimal.lo }) == 0 as i32 as u64
            {
                (unsafe { *retValue = xmlStrdup(b"0\0" as *const u8 as *const i8 as *mut xmlChar) });
            } else {
                let mut dec_0: xmlSchemaValDecimal = unsafe { (*val).value.decimal };
                let mut bufsize_0: i32 = dec_0.total() as i32 + 1 as i32;
                if dec_0.sign() != 0 {
                    bufsize_0 += 1;
                }
                (unsafe { *retValue = xmlMalloc.expect("non-null function pointer")(bufsize_0 as size_t)
                    as *const xmlChar });
                if (unsafe { *retValue }).is_null() {
                    return -(1 as i32);
                }
        ...
        15 => {
            if (unsafe { (*val).value.b }) != 0 {
                (unsafe { *retValue = xmlStrdup(b"true\0" as *const u8 as *const i8 as *mut xmlChar) });
            } else {
                (unsafe { *retValue = xmlStrdup(b"false\0" as *const u8 as *const i8 as *mut xmlChar) });
            }
        }
        12 => {
            ...
            (unsafe { *retValue = xmlStrdup(buf_0.as_mut_ptr() as *mut xmlChar) });
        }
        8 => {
            ...
            (unsafe { *retValue = xmlStrdup(buf_1.as_mut_ptr() as *mut xmlChar) });
        }
        6 => {
            (unsafe { *retValue =
                xmlMalloc.expect("non-null function pointer")(6 as i32 as size_t) as *const xmlChar });
            if (unsafe { *retValue }).is_null() {
                return -(1 as i32);
            }
            (unsafe { snprintf(
        ...
        7 => {
            (unsafe { *retValue =
                xmlMalloc.expect("non-null function pointer")(8 as i32 as size_t) as *const xmlChar });
            if (unsafe { *retValue }).is_null() {
                return -(1 as i32);
            }
            (unsafe { snprintf(
        ...
        9 => {
            ...
            (unsafe { *retValue = xmlStrdup(buf_2.as_mut_ptr() as *mut xmlChar) });
        }
        4 => {
            ...
            (unsafe { *retValue = xmlStrdup(buf_3.as_mut_ptr() as *mut xmlChar) });
        }
        10 => {
            ...
            (unsafe { *retValue = xmlStrdup(buf_4.as_mut_ptr() as *mut xmlChar) });
        }
        11 => {
            ...
            (unsafe { *retValue = xmlStrdup(buf_5.as_mut_ptr() as *mut xmlChar) });
        }
        43 => {
            (unsafe { *retValue = xmlStrdup((*val).value.hex.str_0) });
        }
        44 => {
            (unsafe { *retValue = xmlStrdup((*val).value.base64.str_0) });
        }
        13 => {
            ...
            (unsafe { *retValue = xmlStrdup(buf_6.as_mut_ptr() as *mut xmlChar) });
        }
        14 => {
            ...
            (unsafe { *retValue = xmlStrdup(buf_7.as_mut_ptr() as *mut xmlChar) });
        }
        _ => {
            (unsafe { *retValue = xmlStrdup(b"???\0" as *const u8 as *const i8 as *mut xmlChar) });
            return 1 as i32;
...
#[no_mangle]
pub extern "C" fn xmlSchemaGetCanonValueWhtsp(
    mut val: xmlSchemaValPtr,
    mut retValue: *mut *const xmlChar,
    mut ws: xmlSchemaWhitespaceValueType,
) -> i32 {
    ...
    match (unsafe { (*val).type_0 }) as u32 {
        1 => {
            if (unsafe { (*val).value.str_0 }).is_null() {
                ...
                (unsafe { *retValue = xmlSchemaWhiteSpaceReplace((*val).value.str_0) });
            }
            if (unsafe { *retValue }).is_null() {
                (unsafe { *retValue = xmlStrdup((*val).value.str_0) });
            }
        }
        2 => {
            if (unsafe { (*val).value.str_0 }).is_null() {
...
#[no_mangle]
pub extern "C" fn xmlSchemaGetValType(mut val: xmlSchemaValPtr) -> xmlSchemaValType {
    if val.is_null() {
