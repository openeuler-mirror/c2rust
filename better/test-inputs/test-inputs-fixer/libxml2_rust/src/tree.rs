...
extern "C" fn xmlTreeErr(mut code: i32, mut node: xmlNodePtr, mut extra: *const i8) {
...
#[no_mangle]
pub extern "C" fn xmlSplitQName2(
    mut name: *const xmlChar,
    ...
    (unsafe { *prefix = xmlStrndup(name, len) });
    if (unsafe { *prefix }).is_null() {
        xmlTreeErrMemory(b"QName split\0" as *const u8 as *const i8);
        return 0 as *mut xmlChar;
    }
    ret = unsafe { xmlStrdup(&*name.offset((len + 1 as i32) as isize)) };
    if ret.is_null() {
        xmlTreeErrMemory(b"QName split\0" as *const u8 as *const i8);
        if !(unsafe { *prefix }).is_null() {
...
#[no_mangle]
pub extern "C" fn xmlSplitQName3(mut name: *const xmlChar, mut len: *mut i32) -> *const xmlChar {
...
#[no_mangle]
pub extern "C" fn xmlValidateNCName(mut value: *const xmlChar, mut space: i32) -> i32 {
...
#[no_mangle]
pub extern "C" fn xmlValidateQName(mut value: *const xmlChar, mut space: i32) -> i32 {
...
#[no_mangle]
pub extern "C" fn xmlValidateName(mut value: *const xmlChar, mut space: i32) -> i32 {
    let mut cur: *const xmlChar = value;
    let mut c: i32 = 0;
    let mut l: i32 = 0;
    if value.is_null() {
...
#[no_mangle]
pub extern "C" fn xmlValidateNMToken(mut value: *const xmlChar, mut space: i32) -> i32 {
    let mut cur: *const xmlChar = value;
    let mut c: i32 = 0;
    let mut l: i32 = 0;
    if value.is_null() {
...
#[no_mangle]
pub extern "C" fn xmlSetBufferAllocationScheme(mut scheme: xmlBufferAllocationScheme) {
...
pub extern "C" fn xmlNewNs(
    ...
    if !href.is_null() {
        ...
        *fresh0 = unsafe { xmlStrdup(href) };
    }
    if !prefix.is_null() {
        let fresh1 = unsafe { &mut ((*cur).prefix) };
        *fresh1 = unsafe { xmlStrdup(prefix) };
    }
    if !node.is_null() {
        if (unsafe { (*node).nsDef }).is_null() {
            ...
            *fresh2 = cur;
            ...
            let mut prev: xmlNsPtr = unsafe { (*node).nsDef };
            if (unsafe { (*prev).prefix }).is_null() && (unsafe { (*cur).prefix }).is_null()
                || (unsafe { xmlStrEqual((*prev).prefix, (*cur).prefix) }) != 0
            {
                xmlFreeNs(cur);
                return 0 as xmlNsPtr;
            }
...
#[no_mangle]
pub extern "C" fn xmlSetNs(mut node: xmlNodePtr, mut ns: xmlNsPtr) {
    if node.is_null() {
        return;
    }
    ...
    {
        let fresh4 = unsafe { &mut ((*node).ns) };
        *fresh4 = ns;
    }
}
#[no_mangle]
pub extern "C" fn xmlFreeNs(mut cur: xmlNsPtr) {
    if cur.is_null() {
        return;
    }
...
#[no_mangle]
pub extern "C" fn xmlFreeNsList(mut cur: xmlNsPtr) {
...
pub extern "C" fn xmlNewDtd(
    ...
    if !name.is_null() {
        ...
        *fresh5 = unsafe { xmlStrdup(name) };
    }
    if !ExternalID.is_null() {
        let fresh6 = unsafe { &mut ((*cur).ExternalID) };
        *fresh6 = unsafe { xmlStrdup(ExternalID) };
    }
    if !SystemID.is_null() {
        let fresh7 = unsafe { &mut ((*cur).SystemID) };
        *fresh7 = unsafe { xmlStrdup(SystemID) };
    }
    if !doc.is_null() {
...
#[no_mangle]
pub extern "C" fn xmlGetIntSubset(mut doc: *const xmlDoc) -> xmlDtdPtr {
...
pub extern "C" fn xmlCreateIntSubset(
    ...
    if !ExternalID.is_null() {
        ...
        *fresh11 = unsafe { xmlStrdup(ExternalID) };
    ...
    if !SystemID.is_null() {
        ...
        *fresh12 = unsafe { xmlStrdup(SystemID) };
...
#[no_mangle]
pub extern "C" fn xmlFreeDtd(mut cur: xmlDtdPtr) {
    ...
    if !(unsafe { (*cur).children }).is_null() {
        let mut next: xmlNodePtr = 0 as *mut xmlNode;
        let mut c: xmlNodePtr = unsafe { (*cur).children };
        while !c.is_null() {
            next = unsafe { (*c).next };
    ...
    if !(unsafe { (*cur).notations }).is_null() {
        (unsafe { xmlFreeNotationTable((*cur).notations as xmlNotationTablePtr) });
    }
    if !(unsafe { (*cur).elements }).is_null() {
        (unsafe { xmlFreeElementTable((*cur).elements as xmlElementTablePtr) });
    }
    if !(unsafe { (*cur).attributes }).is_null() {
        (unsafe { xmlFreeAttributeTable((*cur).attributes as xmlAttributeTablePtr) });
    }
...
#[no_mangle]
pub extern "C" fn xmlNewDoc(mut version: *const xmlChar) -> xmlDocPtr {
    ...
    *fresh30 = unsafe { xmlStrdup(version) };
...
#[no_mangle]
pub extern "C" fn xmlFreeDoc(mut cur: xmlDocPtr) {
        ...
        if (unsafe { *cur.offset(0 as i32 as isize) }) as i32 == '&' as i32 {
                ...
                && (unsafe { *cur.offset(1 as i32 as isize) }) as i32 == '#' as i32
            {
                ...
                if cur >= end || (unsafe { *cur }) as i32 == 0 as i32 {
                    ...
                    if cur != q {
                        val = unsafe { xmlStrndup(q, cur.offset_from(q) as i64 as i32) };
...
pub extern "C" fn xmlNodeListGetString(
    ...
    while !node.is_null() {
        ...
        {
            if inLine != 0 {
                ret = unsafe { xmlStrcat(ret, (*node).content) };
            } else {
                ...
                if !buffer.is_null() {
                    ret = unsafe { xmlStrcat(ret, buffer) };
            ...
            if inLine != 0 {
                ...
                if !ent.is_null() {
                    ...
                    if !buffer_0.is_null() {
                        ret = unsafe { xmlStrcat(ret, buffer_0) };
                ...
                ret = unsafe { xmlStrncat(ret, buf.as_mut_ptr(), 1 as i32) };
...
extern "C" fn xmlNewPropInternal(
    ...
    *fresh50 = ns;
    ...
    if !node.is_null() {
        if (unsafe { (*node).properties }).is_null() {
            ...
            *fresh58 = cur;
            ...
            let mut prev: xmlAttrPtr = unsafe { (*node).properties };
            while !(unsafe { (*prev).next }).is_null() {
                prev = unsafe { (*prev).next };
            }
    ...
    if !value.is_null() && !node.is_null() && (unsafe { xmlIsID((*node).doc, node, cur) }) == 1 as i32 {
        (unsafe { xmlAddID(0 as xmlValidCtxtPtr, (*node).doc, value, cur) });
    }
    if (unsafe { __xmlRegisterCallbacks }) != 0 && (unsafe { (*__xmlRegisterNodeDefaultValue()).is_some() }) {
        (unsafe { (*__xmlRegisterNodeDefaultValue()).expect("non-null function pointer")(cur as xmlNodePtr) });
    }
...
#[no_mangle]
pub extern "C" fn xmlFreePropList(mut cur: xmlAttrPtr) {
...
#[no_mangle]
pub extern "C" fn xmlFreeProp(mut cur: xmlAttrPtr) {
    let mut dict: xmlDictPtr = 0 as xmlDictPtr;
    if cur.is_null() {
        return;
    }
    ...
    if !(unsafe { (*cur).doc }).is_null() && (unsafe { (*cur).atype }) as u32 == XML_ATTRIBUTE_ID as i32 as u32 {
        (unsafe { xmlRemoveID((*cur).doc, cur) });
    }
    if !(unsafe { (*cur).children }).is_null() {
        xmlFreeNodeList(unsafe { (*cur).children });
    }
...
#[no_mangle]
pub extern "C" fn xmlRemoveProp(mut cur: xmlAttrPtr) -> i32 {
...
pub extern "C" fn xmlNewDocPI(
    ...
    if !doc.is_null() && !(unsafe { (*doc).dict }).is_null() {
        ...
        *fresh73 = unsafe { xmlStrdup(name) };
    }
    if !content.is_null() {
        let fresh74 = unsafe { &mut ((*cur).content) };
        *fresh74 = unsafe { xmlStrdup(content) };
    }
...
#[no_mangle]
pub extern "C" fn xmlNewPI(mut name: *const xmlChar, mut content: *const xmlChar) -> xmlNodePtr {
    return xmlNewDocPI(0 as xmlDocPtr, name, content);
}
#[no_mangle]
pub extern "C" fn xmlNewNode(mut ns: xmlNsPtr, mut name: *const xmlChar) -> xmlNodePtr {
    let mut cur: xmlNodePtr = 0 as *mut xmlNode;
    if name.is_null() {
        return 0 as xmlNodePtr;
    }
...
#[no_mangle]
pub extern "C" fn xmlNewNodeEatName(mut ns: xmlNsPtr, mut name: *mut xmlChar) -> xmlNodePtr {
    let mut cur: xmlNodePtr = 0 as *mut xmlNode;
    if name.is_null() {
        return 0 as xmlNodePtr;
    }
        ...
        *fresh80 = doc;
        if !content.is_null() {
            ...
            *fresh81 = xmlStringGetNodeList(doc as *const xmlDoc, content);
            if !cur.is_null() {
                let mut ulccur: xmlNodePtr = unsafe { (*cur).children };
                if ulccur.is_null() {
...
#[no_mangle]
pub extern "C" fn xmlNewDocFragment(mut doc: xmlDocPtr) -> xmlNodePtr {
    let mut cur: xmlNodePtr = 0 as *mut xmlNode;
    cur = (unsafe { xmlMalloc.expect("non-null function pointer")(::std::mem::size_of::<xmlNode>() as u64) })
        as xmlNodePtr;
    if cur.is_null() {
...
#[no_mangle]
pub extern "C" fn xmlNewText(mut content: *const xmlChar) -> xmlNodePtr {
    let mut cur: xmlNodePtr = 0 as *mut xmlNode;
    cur = (unsafe { xmlMalloc.expect("non-null function pointer")(::std::mem::size_of::<xmlNode>() as u64) })
        as xmlNodePtr;
    if cur.is_null() {
    ...
    *fresh99 = unsafe { xmlStringText.as_ptr() };
    if !content.is_null() {
        ...
        *fresh100 = unsafe { xmlStrdup(content) };
    }
    if (unsafe { __xmlRegisterCallbacks }) != 0 && (unsafe { (*__xmlRegisterNodeDefaultValue()).is_some() }) {
        (unsafe { (*__xmlRegisterNodeDefaultValue()).expect("non-null function pointer")(cur) });
    }
...
#[no_mangle]
pub extern "C" fn xmlNewCharRef(mut doc: xmlDocPtr, mut name: *const xmlChar) -> xmlNodePtr {
    let mut cur: xmlNodePtr = 0 as *mut xmlNode;
    if name.is_null() {
        return 0 as xmlNodePtr;
    }
...
#[no_mangle]
pub extern "C" fn xmlNewReference(mut doc: *const xmlDoc, mut name: *const xmlChar) -> xmlNodePtr {
    let mut cur: xmlNodePtr = 0 as *mut xmlNode;
    let mut ent: xmlEntityPtr = 0 as *mut xmlEntity;
    if name.is_null() {
        return 0 as xmlNodePtr;
    ...
    *fresh112 = doc as *mut xmlDoc;
    if (unsafe { *name.offset(0 as i32 as isize) }) as i32 == '&' as i32 {
        ...
        if (unsafe { *name.offset((len - 1 as i32) as isize) }) as i32 == ';' as i32 {
            ...
            *fresh113 = unsafe { xmlStrndup(name, len - 1 as i32) };
        } else {
            let fresh114 = unsafe { &mut ((*cur).name) };
            *fresh114 = unsafe { xmlStrndup(name, len) };
        }
    } else {
        let fresh115 = unsafe { &mut ((*cur).name) };
        *fresh115 = unsafe { xmlStrdup(name) };
    }
...
#[no_mangle]
pub extern "C" fn xmlNewDocText(mut doc: *const xmlDoc, mut content: *const xmlChar) -> xmlNodePtr {
    let mut cur: xmlNodePtr = 0 as *mut xmlNode;
...
#[no_mangle]
pub extern "C" fn xmlNewTextLen(mut content: *const xmlChar, mut len: i32) -> xmlNodePtr {
    let mut cur: xmlNodePtr = 0 as *mut xmlNode;
    cur = (unsafe { xmlMalloc.expect("non-null function pointer")(::std::mem::size_of::<xmlNode>() as u64) })
        as xmlNodePtr;
    if cur.is_null() {
    ...
    *fresh120 = unsafe { xmlStringText.as_ptr() };
    if !content.is_null() {
        ...
        *fresh121 = unsafe { xmlStrndup(content, len) };
    }
    if (unsafe { __xmlRegisterCallbacks }) != 0 && (unsafe { (*__xmlRegisterNodeDefaultValue()).is_some() }) {
        (unsafe { (*__xmlRegisterNodeDefaultValue()).expect("non-null function pointer")(cur) });
    }
...
#[no_mangle]
pub extern "C" fn xmlNewComment(mut content: *const xmlChar) -> xmlNodePtr {
    let mut cur: xmlNodePtr = 0 as *mut xmlNode;
    cur = (unsafe { xmlMalloc.expect("non-null function pointer")(::std::mem::size_of::<xmlNode>() as u64) })
        as xmlNodePtr;
    if cur.is_null() {
    ...
    *fresh123 = unsafe { xmlStringComment.as_ptr() };
    if !content.is_null() {
        ...
        *fresh124 = unsafe { xmlStrdup(content) };
    }
    if (unsafe { __xmlRegisterCallbacks }) != 0 && (unsafe { (*__xmlRegisterNodeDefaultValue()).is_some() }) {
        (unsafe { (*__xmlRegisterNodeDefaultValue()).expect("non-null function pointer")(cur) });
    }
...
pub extern "C" fn xmlNewCDataBlock(
    ...
    *fresh125 = doc;
    if !content.is_null() {
        ...
        *fresh126 = unsafe { xmlStrndup(content, len) };
    }
    if (unsafe { __xmlRegisterCallbacks }) != 0 && (unsafe { (*__xmlRegisterNodeDefaultValue()).is_some() }) {
        (unsafe { (*__xmlRegisterNodeDefaultValue()).expect("non-null function pointer")(cur) });
    }
...
#[no_mangle]
pub extern "C" fn xmlNewDocComment(mut doc: xmlDocPtr, mut content: *const xmlChar) -> xmlNodePtr {
    let mut cur: xmlNodePtr = 0 as *mut xmlNode;
    ...
    if !oldValue.is_null() {
        ...
        if oldDictOwnsOldValue != 0 {
            if !newDict.is_null() {
                ...
                newValue = unsafe { xmlStrdup(oldValue) };
            }
        }
    }
    return newValue;
...
#[no_mangle]
pub extern "C" fn xmlSetTreeDoc(mut tree: xmlNodePtr, mut doc: xmlDocPtr) {
    ...
    if (unsafe { (*tree).doc }) != doc {
        let mut oldTreeDict: xmlDictPtr = if !(unsafe { (*tree).doc }).is_null() {
        ...
        if (unsafe { (*tree).type_0 }) as u32 == XML_ELEMENT_NODE as i32 as u32 {
            ...
            while !prop.is_null() {
                if (unsafe { (*prop).atype }) as u32 == XML_ATTRIBUTE_ID as i32 as u32 {
                    (unsafe { xmlRemoveID((*tree).doc, prop) });
                }
                if (unsafe { (*prop).doc }) != doc {
                    let mut oldPropDict: xmlDictPtr = if !(unsafe { (*prop).doc }).is_null() {
...
#[no_mangle]
pub extern "C" fn xmlSetListDoc(mut list: xmlNodePtr, mut doc: xmlDocPtr) {
    let mut cur: xmlNodePtr = 0 as *mut xmlNode;
...
#[no_mangle]
pub extern "C" fn xmlAddNextSibling(mut cur: xmlNodePtr, mut elem: xmlNodePtr) -> xmlNodePtr {
    ...
    if (unsafe { (*elem).type_0 }) as u32 == XML_TEXT_NODE as i32 as u32 {
            ...
            && (unsafe { (*cur).name }) == (unsafe { (*(*cur).next).name })
        {
            ...
            tmp = unsafe { xmlStrdup((*elem).content) };
            tmp = unsafe { xmlStrcat(tmp, (*(*cur).next).content) };
...
#[no_mangle]
pub extern "C" fn xmlAddPrevSibling(mut cur: xmlNodePtr, mut elem: xmlNodePtr) -> xmlNodePtr {
    if cur.is_null() || (unsafe { (*cur).type_0 }) as u32 == XML_NAMESPACE_DECL as i32 as u32 {
        return 0 as xmlNodePtr;
    }
    if elem.is_null() || (unsafe { (*elem).type_0 }) as u32 == XML_NAMESPACE_DECL as i32 as u32 {
    ...
    if (unsafe { (*elem).type_0 }) as u32 == XML_TEXT_NODE as i32 as u32 {
        if (unsafe { (*cur).type_0 }) as u32 == XML_TEXT_NODE as i32 as u32 {
            let mut tmp: *mut xmlChar = 0 as *mut xmlChar;
            tmp = unsafe { xmlStrdup((*elem).content) };
            tmp = unsafe { xmlStrcat(tmp, (*cur).content) };
...
#[no_mangle]
pub extern "C" fn xmlAddSibling(mut cur: xmlNodePtr, mut elem: xmlNodePtr) -> xmlNodePtr {
...
#[no_mangle]
pub extern "C" fn xmlAddChildList(mut parent: xmlNodePtr, mut cur: xmlNodePtr) -> xmlNodePtr {
    let mut prev: xmlNodePtr = 0 as *mut xmlNode;
...
#[no_mangle]
pub extern "C" fn xmlAddChild(mut parent: xmlNodePtr, mut cur: xmlNodePtr) -> xmlNodePtr {
    let mut prev: xmlNodePtr = 0 as *mut xmlNode;
    if parent.is_null() || (unsafe { (*parent).type_0 }) as u32 == XML_NAMESPACE_DECL as i32 as u32 {
        return 0 as xmlNodePtr;
    }
    ...
    if (unsafe { (*cur).type_0 }) as u32 == XML_ATTRIBUTE_NODE as i32 as u32 {
        ...
        if (unsafe { (*parent).properties }).is_null() {
            ...
            *fresh173 = cur as xmlAttrPtr;
            ...
            let mut lastattr_0: xmlAttrPtr = unsafe { (*parent).properties };
...
#[no_mangle]
pub extern "C" fn xmlGetLastChild(mut parent: *const xmlNode) -> xmlNodePtr {
    if parent.is_null() || (unsafe { (*parent).type_0 }) as u32 == XML_NAMESPACE_DECL as i32 as u32 {
        return 0 as xmlNodePtr;
    }
    return unsafe { (*parent).last };
...
#[no_mangle]
pub extern "C" fn xmlChildElementCount(mut parent: xmlNodePtr) -> u64 {
    let mut ret: u64 = 0 as i32 as u64;
    let mut cur: xmlNodePtr = 0 as xmlNodePtr;
    if parent.is_null() {
        return 0 as i32 as u64;
    }
    match (unsafe { (*parent).type_0 }) as u32 {
        1 | 6 | 9 | 11 | 13 => {
            cur = unsafe { (*parent).children };
        }
...
#[no_mangle]
pub extern "C" fn xmlFirstElementChild(mut parent: xmlNodePtr) -> xmlNodePtr {
    let mut cur: xmlNodePtr = 0 as xmlNodePtr;
    if parent.is_null() {
        return 0 as xmlNodePtr;
    }
...
#[no_mangle]
pub extern "C" fn xmlLastElementChild(mut parent: xmlNodePtr) -> xmlNodePtr {
    let mut cur: xmlNodePtr = 0 as xmlNodePtr;
    if parent.is_null() {
        return 0 as xmlNodePtr;
    }
...
#[no_mangle]
pub extern "C" fn xmlPreviousElementSibling(mut node: xmlNodePtr) -> xmlNodePtr {
    if node.is_null() {
        return 0 as xmlNodePtr;
    }
...
#[no_mangle]
pub extern "C" fn xmlNextElementSibling(mut node: xmlNodePtr) -> xmlNodePtr {
    if node.is_null() {
        return 0 as xmlNodePtr;
    }
    match (unsafe { (*node).type_0 }) as u32 {
...
#[no_mangle]
pub extern "C" fn xmlFreeNodeList(mut cur: xmlNodePtr) {
    let mut next: xmlNodePtr = 0 as *mut xmlNode;
    let mut parent: xmlNodePtr = 0 as *mut xmlNode;
    let mut dict: xmlDictPtr = 0 as xmlDictPtr;
...
#[no_mangle]
pub extern "C" fn xmlFreeNode(mut cur: xmlNodePtr) {
    let mut dict: xmlDictPtr = 0 as xmlDictPtr;
    if cur.is_null() {
        return;
    }
...
#[no_mangle]
pub extern "C" fn xmlUnlinkNode(mut cur: xmlNodePtr) {
    if cur.is_null() {
        return;
    }
    if (unsafe { (*cur).type_0 }) as u32 == XML_NAMESPACE_DECL as i32 as u32 {
...
#[no_mangle]
pub extern "C" fn xmlReplaceNode(mut old: xmlNodePtr, mut cur: xmlNodePtr) -> xmlNodePtr {
    if old == cur {
        return 0 as xmlNodePtr;
    }
    if old.is_null()
...
#[no_mangle]
pub extern "C" fn xmlCopyNamespace(mut cur: xmlNsPtr) -> xmlNsPtr {
...
#[no_mangle]
pub extern "C" fn xmlCopyNamespaceList(mut cur: xmlNsPtr) -> xmlNsPtr {
...
extern "C" fn xmlCopyPropInternal(
    ...
    *fresh204 = target;
    if !(unsafe { (*cur).ns }).is_null() && !target.is_null() {
        ...
        } else if (unsafe { xmlStrEqual((*ns).href, (*(*cur).ns).href) }) != 0 {
...
#[no_mangle]
pub extern "C" fn xmlCopyProp(mut target: xmlNodePtr, mut cur: xmlAttrPtr) -> xmlAttrPtr {
    return xmlCopyPropInternal(0 as xmlDocPtr, target, cur);
}
#[no_mangle]
pub extern "C" fn xmlCopyPropList(mut target: xmlNodePtr, mut cur: xmlAttrPtr) -> xmlAttrPtr {
...
extern "C" fn xmlStaticCopyNode(
    ...
    *fresh215 = parent;
    if (unsafe { (*node).name }) == (unsafe { xmlStringText.as_ptr() }) {
        ...
        *fresh218 = unsafe { xmlStringComment.as_ptr() };
        ...
        if !doc.is_null() && !(unsafe { (*doc).dict }).is_null() {
            ...
            *fresh220 = unsafe { xmlStrdup((*node).name) };
        }
    }
    if (unsafe { (*node).type_0 }) as u32 != XML_ELEMENT_NODE as i32 as u32
        ...
        && (unsafe { (*node).type_0 }) as u32 != XML_XINCLUDE_START as i32 as u32
    {
        ...
        *fresh221 = unsafe { xmlStrdup((*node).content) };
    ...
    if !(extended == 0) {
        ...
        if (unsafe { (*node).type_0 }) as u32 == XML_ENTITY_REF_NODE as i32 as u32 {
            ...
            *fresh229 = unsafe { (*ret).children };
            ...
            insert = ret;
            while !cur.is_null() {
                let mut copy: xmlNodePtr = xmlStaticCopyNode(cur, doc, insert, 2 as i32);
                if copy.is_null() {
                    xmlFreeNode(ret);
                    return 0 as xmlNodePtr;
                }
...
#[no_mangle]
pub extern "C" fn xmlCopyNode(mut node: xmlNodePtr, mut extended: i32) -> xmlNodePtr {
    let mut ret: xmlNodePtr = 0 as *mut xmlNode;
...
#[no_mangle]
pub extern "C" fn xmlDocCopyNodeList(mut doc: xmlDocPtr, mut node: xmlNodePtr) -> xmlNodePtr {
    let mut ret: xmlNodePtr = xmlStaticCopyNodeList(node, doc, 0 as xmlNodePtr);
    return ret;
}
#[no_mangle]
pub extern "C" fn xmlCopyNodeList(mut node: xmlNodePtr) -> xmlNodePtr {
    let mut ret: xmlNodePtr = xmlStaticCopyNodeList(node, 0 as xmlDocPtr, 0 as xmlNodePtr);
    return ret;
}
#[no_mangle]
pub extern "C" fn xmlCopyDtd(mut dtd: xmlDtdPtr) -> xmlDtdPtr {
    ...
    if !(unsafe { (*dtd).notations }).is_null() {
        ...
        *fresh241 =
            (unsafe { xmlCopyNotationTable((*dtd).notations as xmlNotationTablePtr) }) as *mut libc::c_void;
    }
    if !(unsafe { (*dtd).elements }).is_null() {
        let fresh242 = unsafe { &mut ((*ret).elements) };
        *fresh242 = (unsafe { xmlCopyElementTable((*dtd).elements as xmlElementTablePtr) }) as *mut libc::c_void;
    }
    if !(unsafe { (*dtd).attributes }).is_null() {
        let fresh243 = unsafe { &mut ((*ret).attributes) };
        *fresh243 =
            (unsafe { xmlCopyAttributeTable((*dtd).attributes as xmlAttributeTablePtr) }) as *mut libc::c_void;
    }
    ...
    while !cur.is_null() {
        ...
        if (unsafe { (*cur).type_0 }) as u32 == XML_ENTITY_DECL as i32 as u32 {
            ...
            q = (unsafe { xmlGetDtdQElementDesc(ret, (*tmp_0).name, (*tmp_0).prefix) }) as xmlNodePtr;
        } else if (unsafe { (*cur).type_0 }) as u32 == XML_ATTRIBUTE_DECL as i32 as u32 {
            let mut tmp_1: xmlAttributePtr = cur as xmlAttributePtr;
            q = (unsafe { xmlGetDtdQAttrDesc(ret, (*tmp_1).elem, (*tmp_1).name, (*tmp_1).prefix) })
                as xmlNodePtr;
...
#[no_mangle]
pub extern "C" fn xmlCopyDoc(mut doc: xmlDocPtr, mut recursive: i32) -> xmlDocPtr {
    ...
    if !(unsafe { (*doc).encoding }).is_null() {
        ...
        *fresh252 = unsafe { xmlStrdup((*doc).encoding) };
    }
    if !(unsafe { (*doc).URL }).is_null() {
        let fresh253 = unsafe { &mut ((*ret).URL) };
        *fresh253 = unsafe { xmlStrdup((*doc).URL) };
    }
...
extern "C" fn xmlGetLineNoInternal(mut node: *const xmlNode, mut depth: i32) -> i64 {
...
#[no_mangle]
pub extern "C" fn xmlGetLineNo(mut node: *const xmlNode) -> i64 {
    return xmlGetLineNoInternal(node, 0 as i32);
}
#[no_mangle]
pub extern "C" fn xmlGetNodePath(mut node: *const xmlNode) -> *mut xmlChar {
    ...
    loop {
                        ...
                        || (unsafe { xmlStrEqual((*cur).name, (*tmp).name) }) != 0
                            && ((unsafe { (*tmp).ns }) == (unsafe { (*cur).ns })
                                || !(unsafe { (*tmp).ns }).is_null()
                                    ...
                                    && (unsafe { xmlStrEqual((*(*cur).ns).prefix, (*(*tmp).ns).prefix) }) != 0))
                {
                    occur += 1;
                }
                tmp = unsafe { (*tmp).prev };
                        ...
                        && (generic != 0
                            || (unsafe { xmlStrEqual((*cur).name, (*tmp).name) }) != 0
                                && ((unsafe { (*tmp).ns }) == (unsafe { (*cur).ns })
                                    || !(unsafe { (*tmp).ns }).is_null()
                                        && !(unsafe { (*cur).ns }).is_null()
                                        && (unsafe { xmlStrEqual((*(*cur).ns).prefix, (*(*tmp).ns).prefix) })
                                            != 0))
                    {
                        occur += 1;
                    }
        ...
        if ((unsafe { xmlStrlen(buffer) }) as u64)
            ...
            > buf_len
        {
            buf_len = (2 as i32 as u64)
                ...
                .wrapping_add((unsafe { xmlStrlen(buffer) }) as u64)
                .wrapping_add(::std::mem::size_of::<[i8; 100]>() as u64)
                .wrapping_add(20 as i32 as u64);
...
#[no_mangle]
pub extern "C" fn xmlDocGetRootElement(mut doc: *const xmlDoc) -> xmlNodePtr {
    let mut ret: xmlNodePtr = 0 as *mut xmlNode;
    if doc.is_null() {
        return 0 as xmlNodePtr;
    }
...
#[no_mangle]
pub extern "C" fn xmlDocSetRootElement(mut doc: xmlDocPtr, mut root: xmlNodePtr) -> xmlNodePtr {
...
#[no_mangle]
pub extern "C" fn xmlNodeSetLang(mut cur: xmlNodePtr, mut lang: *const xmlChar) {
    let mut ns: xmlNsPtr = 0 as *mut xmlNs;
    if cur.is_null() {
        return;
    }
...
#[no_mangle]
pub extern "C" fn xmlNodeGetLang(mut cur: *const xmlNode) -> *mut xmlChar {
...
#[no_mangle]
pub extern "C" fn xmlNodeSetSpacePreserve(mut cur: xmlNodePtr, mut val: i32) {
    let mut ns: xmlNsPtr = 0 as *mut xmlNs;
    if cur.is_null() {
        return;
    }
...
#[no_mangle]
pub extern "C" fn xmlNodeGetSpacePreserve(mut cur: *const xmlNode) -> i32 {
...
#[no_mangle]
pub extern "C" fn xmlNodeSetName(mut cur: xmlNodePtr, mut name: *const xmlChar) {
    let mut doc: xmlDocPtr = 0 as *mut xmlDoc;
    ...
    if !dict.is_null() {
        if !(unsafe { (*cur).name }).is_null() && (unsafe { xmlDictOwns(dict, (*cur).name) }) == 0 {
            freeme = unsafe { (*cur).name };
        }
        let fresh265 = unsafe { &mut ((*cur).name) };
        *fresh265 = unsafe { xmlDictLookup(dict, name, -(1 as i32)) };
    } else {
        if !(unsafe { (*cur).name }).is_null() {
            freeme = unsafe { (*cur).name };
        }
        let fresh266 = unsafe { &mut ((*cur).name) };
        *fresh266 = unsafe { xmlStrdup(name) };
    }
    if !freeme.is_null() {
...
#[no_mangle]
pub extern "C" fn xmlNodeSetBase(mut cur: xmlNodePtr, mut uri: *const xmlChar) {
    let mut ns: xmlNsPtr = 0 as *mut xmlNs;
    ...
    match (unsafe { (*cur).type_0 }) as u32 {
        ...
        9 | 13 => {
            ...
            if uri.is_null() {
                ...
                *fresh268 = unsafe { xmlPathToURI(uri) };
            }
            return;
        }
        1 | 2 | _ => {}
...
#[no_mangle]
pub extern "C" fn xmlNodeGetBase(mut doc: *const xmlDoc, mut cur: *const xmlNode) -> *mut xmlChar {
    ...
    while !cur.is_null() {
        if (unsafe { (*cur).type_0 }) as u32 == XML_ENTITY_DECL as i32 as u32 {
            let mut ent: xmlEntityPtr = cur as xmlEntityPtr;
            return unsafe { xmlStrdup((*ent).URI) };
        }
        if (unsafe { (*cur).type_0 }) as u32 == XML_ELEMENT_NODE as i32 as u32 {
            base = xmlGetNsProp(
                cur,
            ...
            if !base.is_null() {
                if !oldbase.is_null() {
                    newbase = unsafe { xmlBuildURI(oldbase, base) };
                    if !newbase.is_null() {
    ...
    if !doc.is_null() && !(unsafe { (*doc).URL }).is_null() {
        if oldbase.is_null() {
            return unsafe { xmlStrdup((*doc).URL) };
        }
        newbase = unsafe { xmlBuildURI(oldbase, (*doc).URL) };
        (unsafe { xmlFree.expect("non-null function pointer")(oldbase as *mut libc::c_void) });
        return newbase;
    }
    return oldbase;
...
#[no_mangle]
pub extern "C" fn xmlNodeBufGetContent(mut buffer: xmlBufferPtr, mut cur: *const xmlNode) -> i32 {
    let mut buf: xmlBufPtr = 0 as *mut xmlBuf;
    let mut ret: i32 = 0;
...
#[no_mangle]
pub extern "C" fn xmlBufGetNodeContent(mut buf: xmlBufPtr, mut cur: *const xmlNode) -> i32 {
    ...
    match (unsafe { (*cur).type_0 }) as u32 {
        ...
        2 => {
            ...
            let mut tmp_0: xmlNodePtr = unsafe { (*attr).children };
            while !tmp_0.is_null() {
...
#[no_mangle]
pub extern "C" fn xmlNodeGetContent(mut cur: *const xmlNode) -> *mut xmlChar {
    if cur.is_null() {
        return 0 as *mut xmlChar;
    }
    match (unsafe { (*cur).type_0 }) as u32 {
        ...
        8 | 7 => {
            if !(unsafe { (*cur).content }).is_null() {
                return unsafe { xmlStrdup((*cur).content) };
            }
            return 0 as *mut xmlChar;
        }
        5 => {
        ...
        18 => {
            let mut tmp: *mut xmlChar = 0 as *mut xmlChar;
            tmp = unsafe { xmlStrdup((*(cur as xmlNsPtr)).href) };
            return tmp;
        }
...
#[no_mangle]
pub extern "C" fn xmlNodeSetContent(mut cur: xmlNodePtr, mut content: *const xmlChar) {
    if cur.is_null() {
        return;
    }
    match (unsafe { (*cur).type_0 }) as u32 {
        ...
        3 | 4 | 5 | 6 | 7 | 8 => {
            ...
            *fresh275 = *fresh274;
            if !content.is_null() {
                ...
                *fresh276 = unsafe { xmlStrdup(content) };
            } else {
        ...
        3 | 4 | 5 | 6 | 7 | 8 | 12 => {
            ...
            *fresh285 = *fresh284;
            if !content.is_null() {
                ...
                *fresh286 = unsafe { xmlStrndup(content, len) };
            } else {
        ...
        3 | 4 | 5 | 6 | 7 | 8 | 12 => {
            if !content.is_null() {
                        ...
                        && (unsafe { xmlDictOwns((*(*cur).doc).dict, (*cur).content) }) != 0
                {
                    ...
                    *fresh289 = unsafe { xmlStrncatNew((*cur).content, content, len) };
                    let fresh290 = unsafe { &mut ((*cur).properties) };
                    *fresh290 = 0 as *mut _xmlAttr;
                } else {
                    let fresh291 = unsafe { &mut ((*cur).content) };
                    *fresh291 = unsafe { xmlStrncat((*cur).content, content, len) };
                }
            }
        }
...
#[no_mangle]
pub extern "C" fn xmlNodeAddContent(mut cur: xmlNodePtr, mut content: *const xmlChar) {
    let mut len: i32 = 0;
    if cur.is_null() {
        return;
    }
    ...
    len = unsafe { xmlStrlen(content) };
    xmlNodeAddContentLen(cur, content, len);
}
#[no_mangle]
pub extern "C" fn xmlTextMerge(mut first: xmlNodePtr, mut second: xmlNodePtr) -> xmlNodePtr {
    if first.is_null() {
        return second;
    }
    if second.is_null() {
...
#[no_mangle]
pub extern "C" fn xmlGetNsList(mut _doc: *const xmlDoc, mut node: *const xmlNode) -> *mut xmlNsPtr {
    let mut cur: xmlNsPtr = 0 as *mut xmlNs;
            ...
            while !cur.is_null() {
                ...
                while i < nbns {
                    if (unsafe { (*cur).prefix }) == (unsafe { (**ret.offset(i as isize)).prefix })
                        || (unsafe { xmlStrEqual((*cur).prefix, (**ret.offset(i as isize)).prefix) }) != 0
                    {
                        break;
                    }
                    i += 1;
...
extern "C" fn xmlTreeEnsureXMLDecl(mut doc: xmlDocPtr) -> xmlNsPtr {
    if doc.is_null() {
        return 0 as xmlNsPtr;
    }
    if !(unsafe { (*doc).oldNs }).is_null() {
    ...
    *fresh296 = unsafe { xmlStrdup(
        b"http://www.w3.org/XML/1998/namespace\0" as *const u8 as *const i8 as *const xmlChar,
    ) };
    let fresh297 = unsafe { &mut ((*ns).prefix) };
    *fresh297 = unsafe { xmlStrdup(b"xml\0" as *const u8 as *const i8 as *const xmlChar) };
...
pub extern "C" fn xmlSearchNs(
        ...
        ) }) != 0
    {
        if doc.is_null() && (unsafe { (*node).type_0 }) as u32 == XML_ELEMENT_NODE as i32 as u32 {
            ...
            *fresh299 = unsafe { xmlStrdup(
                b"http://www.w3.org/XML/1998/namespace\0" as *const u8 as *const i8
                    as *const xmlChar,
            ) };
            let fresh300 = unsafe { &mut ((*cur).prefix) };
            *fresh300 = unsafe { xmlStrdup(b"xml\0" as *const u8 as *const i8 as *const xmlChar) };
        ...
        if (unsafe { (*node).type_0 }) as u32 == XML_ELEMENT_NODE as i32 as u32 {
            ...
            while !cur.is_null() {
                ...
                if !(unsafe { (*cur).prefix }).is_null()
                    ...
                    && (unsafe { xmlStrEqual((*cur).prefix, nameSpace) }) != 0
                {
                    return cur;
                }
                cur = unsafe { (*cur).next };
        ...
        if (unsafe { (*node).type_0 }) as u32 == XML_ELEMENT_NODE as i32 as u32 {
            ...
            while !tst.is_null() {
                ...
                if !(unsafe { (*tst).prefix }).is_null()
                    && !prefix.is_null()
                    && (unsafe { xmlStrEqual((*tst).prefix, prefix) }) != 0
                {
                    return 0 as i32;
                }
                tst = unsafe { (*tst).next };
...
pub extern "C" fn xmlSearchNsByHref(
    ...
    ) }) != 0
    {
        if doc.is_null() && (unsafe { (*node).type_0 }) as u32 == XML_ELEMENT_NODE as i32 as u32 {
            ...
            *fresh303 = unsafe { xmlStrdup(
                b"http://www.w3.org/XML/1998/namespace\0" as *const u8 as *const i8
                    as *const xmlChar,
            ) };
            let fresh304 = unsafe { &mut ((*cur).prefix) };
            *fresh304 = unsafe { xmlStrdup(b"xml\0" as *const u8 as *const i8 as *const xmlChar) };
    ...
    while !node.is_null() {
        ...
        if (unsafe { (*node).type_0 }) as u32 == XML_ELEMENT_NODE as i32 as u32 {
            ...
            while !cur.is_null() {
                if !(unsafe { (*cur).href }).is_null()
                    && !href.is_null()
                    && (unsafe { xmlStrEqual((*cur).href, href) }) != 0
                {
...
#[no_mangle]
pub extern "C" fn xmlReconciliateNs(mut doc: xmlDocPtr, mut tree: xmlNodePtr) -> i32 {
...
extern "C" fn xmlGetPropNodeInternal(
    ...
    if !(unsafe { (*node).properties }).is_null() {
        ...
        if nsName.is_null() {
            loop {
                if (unsafe { (*prop).ns }).is_null() && (unsafe { xmlStrEqual((*prop).name, name) }) != 0 {
                    return prop;
                }
                prop = unsafe { (*prop).next };
                if prop.is_null() {
            ...
            loop {
                if !(unsafe { (*prop).ns }).is_null()
                    && (unsafe { xmlStrEqual((*prop).name, name) }) != 0
                    && ((unsafe { (*(*prop).ns).href }) == nsName
                        || (unsafe { xmlStrEqual((*(*prop).ns).href, nsName) }) != 0)
                {
                    return prop;
                }
                prop = unsafe { (*prop).next };
    ...
    if !(unsafe { (*node).doc }).is_null() && !(unsafe { (*(*node).doc).intSubset }).is_null() {
        let mut doc: xmlDocPtr = unsafe { (*node).doc };
        ...
        if !(unsafe { (*node).ns }).is_null() && !(unsafe { (*(*node).ns).prefix }).is_null() {
            tmpstr = unsafe { xmlStrdup((*(*node).ns).prefix) };
            tmpstr = unsafe { xmlStrcat(tmpstr, b":\0" as *const u8 as *const i8 as *mut xmlChar) };
            tmpstr = unsafe { xmlStrcat(tmpstr, (*node).name) };
            if tmpstr.is_null() {
                return 0 as xmlAttrPtr;
            }
            elemQName = tmpstr;
        ...
        if nsName.is_null() {
            attrDecl = unsafe { xmlGetDtdQAttrDesc((*doc).intSubset, elemQName, name, 0 as *const xmlChar) };
            if attrDecl.is_null() && !(unsafe { (*doc).extSubset }).is_null() {
                attrDecl =
                    unsafe { xmlGetDtdQAttrDesc((*doc).extSubset, elemQName, name, 0 as *const xmlChar) };
            }
        ...
        {
            attrDecl = unsafe { xmlGetDtdQAttrDesc(
                (*doc).intSubset,
                elemQName,
                name,
            ...
            while !(unsafe { *cur }).is_null() {
                if (unsafe { xmlStrEqual((**cur).href, nsName) }) != 0 {
                    attrDecl =
                        unsafe { xmlGetDtdQAttrDesc((*doc).intSubset, elemQName, name, (**cur).prefix) };
                    if !attrDecl.is_null() {
                        break;
                    }
                    if !(unsafe { (*doc).extSubset }).is_null() {
                        attrDecl =
                            unsafe { xmlGetDtdQAttrDesc((*doc).extSubset, elemQName, name, (**cur).prefix) };
                        if !attrDecl.is_null() {
                            break;
                        }
                    }
...
extern "C" fn xmlGetPropNodeValueInternal(mut prop: *const xmlAttr) -> *mut xmlChar {
    if prop.is_null() {
        return 0 as *mut xmlChar;
    }
    if (unsafe { (*prop).type_0 }) as u32 == XML_ATTRIBUTE_NODE as i32 as u32 {
        if !(unsafe { (*prop).children }).is_null() {
            ...
            {
                return unsafe { xmlStrdup((*(*prop).children).content) };
            } else {
                let mut ret: *mut xmlChar = 0 as *mut xmlChar;
        ...
        if (unsafe { (*prop).type_0 }) as u32 == XML_ATTRIBUTE_DECL as i32 as u32 {
            return unsafe { xmlStrdup((*(prop as xmlAttributePtr)).defaultValue) };
        }
    }
    return 0 as *mut xmlChar;
}
#[no_mangle]
pub extern "C" fn xmlHasProp(mut node: *const xmlNode, mut name: *const xmlChar) -> xmlAttrPtr {
    let mut prop: xmlAttrPtr = 0 as *mut xmlAttr;
    let mut doc: xmlDocPtr = 0 as *mut xmlDoc;
    if node.is_null() || (unsafe { (*node).type_0 }) as u32 != XML_ELEMENT_NODE as i32 as u32 || name.is_null() {
        return 0 as xmlAttrPtr;
    ...
    if !doc.is_null() {
        ...
        if !(unsafe { (*doc).intSubset }).is_null() {
            attrDecl = unsafe { xmlGetDtdAttrDesc((*doc).intSubset, (*node).name, name) };
            if attrDecl.is_null() && !(unsafe { (*doc).extSubset }).is_null() {
                attrDecl = unsafe { xmlGetDtdAttrDesc((*doc).extSubset, (*node).name, name) };
            }
            if !attrDecl.is_null() && !(unsafe { (*attrDecl).defaultValue }).is_null() {
                return attrDecl as xmlAttrPtr;
            }
...
#[no_mangle]
pub extern "C" fn xmlGetProp(mut node: *const xmlNode, mut name: *const xmlChar) -> *mut xmlChar {
    let mut prop: xmlAttrPtr = 0 as *mut xmlAttr;
...
#[no_mangle]
pub extern "C" fn xmlUnsetProp(mut node: xmlNodePtr, mut name: *const xmlChar) -> i32 {
    let mut prop: xmlAttrPtr = 0 as *mut xmlAttr;
...
#[no_mangle]
pub extern "C" fn xmlUnsetNsProp(
    mut node: xmlNodePtr,
    mut ns: xmlNsPtr,
    mut name: *const xmlChar,
) -> i32 {
...
pub extern "C" fn xmlSetProp(
    ...
    if !nqname.is_null() {
        let mut ns: xmlNsPtr = 0 as *mut xmlNs;
        let mut prefix: *mut xmlChar = unsafe { xmlStrndup(name, len) };
...
pub extern "C" fn xmlSetNsProp(
    ...
    if !prop.is_null() {
        if (unsafe { (*prop).atype }) as u32 == XML_ATTRIBUTE_ID as i32 as u32 {
            (unsafe { xmlRemoveID((*node).doc, prop) });
        ...
        *fresh321 = ns;
        ...
        if (unsafe { (*prop).atype }) as u32 == XML_ATTRIBUTE_ID as i32 as u32 {
            (unsafe { xmlAddID(0 as xmlValidCtxtPtr, (*node).doc, value, prop) });
        }
        return prop;
    }
    return xmlNewPropInternal(node, ns, name, value, 0 as i32);
...
#[no_mangle]
pub extern "C" fn xmlNodeIsText(mut node: *const xmlNode) -> i32 {
    if node.is_null() {
        return 0 as i32;
    }
    if (unsafe { (*node).type_0 }) as u32 == XML_TEXT_NODE as i32 as u32 {
...
#[no_mangle]
pub extern "C" fn xmlIsBlankNode(mut node: *const xmlNode) -> i32 {
    let mut cur: *const xmlChar = 0 as *const xmlChar;
    if node.is_null() {
        return 0 as i32;
    }
...
pub extern "C" fn xmlTextConcat(
            ...
            && (unsafe { xmlDictOwns((*(*node).doc).dict, (*node).content) }) != 0
    {
        ...
        *fresh326 = unsafe { xmlStrncatNew((*node).content, content, len) };
    } else {
        let fresh327 = unsafe { &mut ((*node).content) };
        *fresh327 = unsafe { xmlStrncat((*node).content, content, len) };
    }
...
#[no_mangle]
pub extern "C" fn xmlBufferCreate() -> xmlBufferPtr {
...
#[no_mangle]
pub extern "C" fn xmlBufferCreateSize(mut size: size_t) -> xmlBufferPtr {
    let mut ret: xmlBufferPtr = 0 as *mut xmlBuffer;
    if size
...
#[no_mangle]
pub extern "C" fn xmlBufferDetach(mut buf: xmlBufferPtr) -> *mut xmlChar {
    let mut ret: *mut xmlChar = 0 as *mut xmlChar;
    if buf.is_null() {
        return 0 as *mut xmlChar;
    }
    ...
    ret = unsafe { (*buf).content };
    let fresh334 = unsafe { &mut ((*buf).content) };
    *fresh334 = 0 as *mut xmlChar;
    (unsafe { (*buf).size = 0 as i32 as u32 });
...
#[no_mangle]
pub extern "C" fn xmlBufferFree(mut buf: xmlBufferPtr) {
    if buf.is_null() {
        return;
    }
...
#[no_mangle]
pub extern "C" fn xmlBufferEmpty(mut buf: xmlBufferPtr) {
    if buf.is_null() {
        return;
    }
    ...
    {
        let mut start_buf: size_t = (unsafe { ((*buf).content).offset_from((*buf).contentIO) }) as i64 as size_t;
...
#[no_mangle]
pub extern "C" fn xmlBufferShrink(mut buf: xmlBufferPtr, mut len: u32) -> i32 {
    if buf.is_null() {
        return -(1 as i32);
    }
...
#[no_mangle]
pub extern "C" fn xmlBufferGrow(mut buf: xmlBufferPtr, mut len: u32) -> i32 {
    let mut size: u32 = 0;
    ...
    if (unsafe { (*buf).size }) as u64 > len as size_t {
        size = if (unsafe { (*buf).size })
            > (2147483647 as i32 as u32)
                .wrapping_mul(2 as u32)
                .wrapping_add(1 as u32)
                .wrapping_div(2 as i32 as u32)
        {
            ...
            (unsafe { (*buf).size }).wrapping_mul(2 as i32 as u32)
        };
    } else {
    ...
    if (unsafe { (*buf).alloc }) as u32 == XML_BUFFER_ALLOC_IO as i32 as u32 && !(unsafe { (*buf).contentIO }).is_null() {
        ...
        let fresh344 = unsafe { &mut ((*buf).contentIO) };
        *fresh344 = newbuf;
        let fresh345 = unsafe { &mut ((*buf).content) };
        *fresh345 = unsafe { newbuf.offset(start_buf as isize) };
        ...
        let fresh346 = unsafe { &mut ((*buf).content) };
        *fresh346 = newbuf;
    }
...
#[no_mangle]
pub extern "C" fn xmlBufferDump(mut file: *mut FILE, mut buf: xmlBufferPtr) -> i32 {
...
#[no_mangle]
pub extern "C" fn xmlBufferContent(mut buf: *const xmlBuffer) -> *const xmlChar {
    if buf.is_null() {
        return 0 as *const xmlChar;
    }
...
#[no_mangle]
pub extern "C" fn xmlBufferLength(mut buf: *const xmlBuffer) -> i32 {
    if buf.is_null() {
        return 0 as i32;
    }
    return (unsafe { (*buf).use_0 }) as i32;
}
#[no_mangle]
pub extern "C" fn xmlBufferResize(mut buf: xmlBufferPtr, mut size: u32) -> i32 {
...
#[no_mangle]
pub extern "C" fn xmlBufferCat(mut buf: xmlBufferPtr, mut str: *const xmlChar) -> i32 {
    if buf.is_null() {
        return -(1 as i32);
    }
    if (unsafe { (*buf).alloc }) as u32 == XML_BUFFER_ALLOC_IMMUTABLE as i32 as u32 {
...
#[no_mangle]
pub extern "C" fn xmlBufferCCat(mut buf: xmlBufferPtr, mut str: *const i8) -> i32 {
    return xmlBufferCat(buf, str as *const xmlChar);
}
#[no_mangle]
pub extern "C" fn xmlBufferWriteCHAR(mut buf: xmlBufferPtr, mut string: *const xmlChar) {
    if buf.is_null() {
        return;
    }
    if (unsafe { (*buf).alloc }) as u32 == XML_BUFFER_ALLOC_IMMUTABLE as i32 as u32 {
...
#[no_mangle]
pub extern "C" fn xmlBufferWriteChar(mut buf: xmlBufferPtr, mut string: *const i8) {
    if buf.is_null() {
        return;
    }
    if (unsafe { (*buf).alloc }) as u32 == XML_BUFFER_ALLOC_IMMUTABLE as i32 as u32 {
...
#[no_mangle]
pub extern "C" fn xmlBufferWriteQuotedString(mut buf: xmlBufferPtr, mut string: *const xmlChar) {
    let mut cur: *const xmlChar = 0 as *const xmlChar;
...
#[no_mangle]
pub extern "C" fn xmlGetDocCompressMode(mut doc: *const xmlDoc) -> i32 {
    if doc.is_null() {
        return -(1 as i32);
    }
    return unsafe { (*doc).compression };
}
#[no_mangle]
pub extern "C" fn xmlSetDocCompressMode(mut doc: xmlDocPtr, mut mode: i32) {
    if doc.is_null() {
        return;
    }
    if mode < 0 as i32 {
...
extern "C" fn xmlDOMWrapNsMapFree(mut nsmap: xmlNsMapPtr) {
...
extern "C" fn xmlDOMWrapNsMapAddItem(
...
extern "C" fn xmlDOMWrapStoreNs(
    ...
    if !(unsafe { (*ns).next }).is_null() {
        ns = unsafe { (*ns).next };
        while !ns.is_null() {
            if ((unsafe { (*ns).prefix }) == prefix || (unsafe { xmlStrEqual((*ns).prefix, prefix) }) != 0)
                && (unsafe { xmlStrEqual((*ns).href, nsName) }) != 0
            {
                return ns;
            }
            if (unsafe { (*ns).next }).is_null() {
...
#[no_mangle]
pub extern "C" fn xmlDOMWrapNewCtxt() -> xmlDOMWrapCtxtPtr {
...
#[no_mangle]
pub extern "C" fn xmlDOMWrapFreeCtxt(mut ctxt: xmlDOMWrapCtxtPtr) {
    if ctxt.is_null() {
        return;
    }
...
extern "C" fn xmlTreeNSListLookupByPrefix(
    ...
    ns = nsList;
    loop {
        if prefix == (unsafe { (*ns).prefix }) || (unsafe { xmlStrEqual(prefix, (*ns).prefix) }) != 0 {
            return ns;
        }
        ns = unsafe { (*ns).next };
        if ns.is_null() {
...
extern "C" fn xmlDOMWrapNSNormGatherInScopeNs(
    ...
    if map.is_null() || !(unsafe { *map }).is_null() {
        return -(1 as i32);
    }
    if node.is_null() || (unsafe { (*node).type_0 }) as u32 == XML_NAMESPACE_DECL as i32 as u32 {
        return -(1 as i32);
    ...
    while !cur.is_null() && cur != (unsafe { (*cur).doc }) as xmlNodePtr {
        if (unsafe { (*cur).type_0 }) as u32 == XML_ELEMENT_NODE as i32 as u32 {
            if !(unsafe { (*cur).nsDef }).is_null() {
                ...
                loop {
                    shadowed = 0 as i32;
                    if !(unsafe { *map }).is_null() && !(unsafe { (**map).first }).is_null() {
                        mi = unsafe { (**map).first };
                        while !mi.is_null() {
                            if (unsafe { (*ns).prefix }) == (unsafe { (*(*mi).newNs).prefix })
                                || (unsafe { xmlStrEqual((*ns).prefix, (*(*mi).newNs).prefix) }) != 0
                            {
                                shadowed = 1 as i32;
                                break;
                            } else {
                    ...
                    mi = xmlDOMWrapNsMapAddItem(map, 0 as i32, 0 as xmlNsPtr, ns, -(1 as i32));
                    if mi.is_null() {
                        return -(1 as i32);
                    }
                    if shadowed != 0 {
...
extern "C" fn xmlDOMWrapNSNormAddNsMapItem2(
    ...
    if (unsafe { *list }).is_null() {
        (unsafe { *list = xmlMalloc.expect("non-null function pointer")(
        ...
        (unsafe { *size = 3 as i32 });
        (unsafe { *number = 0 as i32 });
    } else if (unsafe { *number }) >= (unsafe { *size }) {
        (unsafe { *size *= 2 as i32 });
        (unsafe { *list = xmlRealloc.expect("non-null function pointer")(
            *list as *mut libc::c_void,
            ((*size * 2 as i32) as u64).wrapping_mul(::std::mem::size_of::<xmlNsPtr>() as u64),
        ) as *mut xmlNsPtr });
        if (unsafe { *list }).is_null() {
    ...
    let fresh369 = unsafe { &mut (*(*list).offset((2 as i32 * *number) as isize)) };
    *fresh369 = oldNs;
    let fresh370 = unsafe { &mut (*(*list).offset((2 as i32 * *number + 1 as i32) as isize)) };
    *fresh370 = newNs;
    (unsafe { *number += 1 });
    return 0 as i32;
}
#[no_mangle]
pub extern "C" fn xmlDOMWrapRemoveNode(
    ...
    's_67: loop {
        match (unsafe { (*node).type_0 }) as u32 {
            1 => {
                if ctxt.is_null() && !(unsafe { (*node).nsDef }).is_null() {
...
extern "C" fn xmlSearchNsByNamespaceStrict(
    mut doc: xmlDocPtr,
    mut node: xmlNodePtr,
    mut nsName: *const xmlChar,
    ...
    (unsafe { *retNs = 0 as xmlNsPtr });
    if (unsafe { xmlStrEqual(
        nsName,
        b"http://www.w3.org/XML/1998/namespace\0" as *const u8 as *const i8 as *const xmlChar,
    ) }) != 0
    {
        (unsafe { *retNs = xmlTreeEnsureXMLDecl(doc) });
        if (unsafe { *retNs }).is_null() {
            return -(1 as i32);
        }
        return 1 as i32;
    }
                ...
                while !ns.is_null() {
                    if !(prefixed != 0 && (unsafe { (*ns).prefix }).is_null()) {
                        if !prev.is_null() {
                            ...
                            while !((unsafe { (*prevns).prefix }) == (unsafe { (*ns).prefix })
                                || !(unsafe { (*prevns).prefix }).is_null()
                                    ...
                                    && (unsafe { xmlStrEqual((*prevns).prefix, (*ns).prefix) }) != 0)
                            {
                        ...
                        match current_block_20 {
                            ...
                            _ => {
                                if nsName == (unsafe { (*ns).href }) || (unsafe { xmlStrEqual(nsName, (*ns).href) }) != 0 {
                                    if !out.is_null() {
                                        let mut ret: i32 = 0;
...
extern "C" fn xmlSearchNsByPrefixStrict(
    mut doc: xmlDocPtr,
    mut node: xmlNodePtr,
    mut prefix: *const xmlChar,
    mut retNs: *mut xmlNsPtr,
...
extern "C" fn xmlDOMWrapNSNormDeclareNsForced(
    ...
    loop {
            ...
            && !(xmlTreeNSListLookupByPrefix(unsafe { (*elem).nsDef }, pref)).is_null())
        {
            ...
            {
                if xmlSearchNsByPrefixStrict(doc, unsafe { (*elem).parent }, pref, 0 as *mut xmlNsPtr)
                    == 1 as i32
                {
                ...
                _ => {
                    ...
                    if (unsafe { (*elem).nsDef }).is_null() {
                        ...
                        *fresh373 = ret;
                        ...
                        let mut ns2: xmlNsPtr = unsafe { (*elem).nsDef };
...
extern "C" fn xmlDOMWrapNSNormAcquireNormalizedNs(
    mut doc: xmlDocPtr,
    mut elem: xmlNodePtr,
    mut ns: xmlNsPtr,
    mut retNs: *mut xmlNsPtr,
    ...
    if !(unsafe { *nsMap }).is_null()
        && !(unsafe { (**nsMap).first }).is_null()
        ...
        while !mi.is_null() {
            if (unsafe { (*mi).depth }) >= -(1 as i32)
                ...
                && ((unsafe { (*(*mi).newNs).href }) == (unsafe { (*ns).href })
                    || (unsafe { xmlStrEqual((*(*mi).newNs).href, (*ns).href) }) != 0)
            {
                let fresh375 = unsafe { &mut ((*mi).oldNs) };
                *fresh375 = ns;
                (unsafe { *retNs = (*mi).newNs });
                return 0 as i32;
            }
            mi = unsafe { (*mi).next };
        }
    ...
    if elem.is_null() {
        ...
        if (xmlDOMWrapNsMapAddItem(nsMap, -(1 as i32), ns, tmpns, -(3 as i32))).is_null() {
            xmlFreeNs(tmpns);
            return -(1 as i32);
        }
        (unsafe { *retNs = tmpns });
        ...
        if (xmlDOMWrapNsMapAddItem(nsMap, -(1 as i32), ns, tmpns_0, depth)).is_null() {
            xmlFreeNs(tmpns_0);
            return -(1 as i32);
        }
        (unsafe { *retNs = tmpns_0 });
    }
    return 0 as i32;
}
#[no_mangle]
pub extern "C" fn xmlDOMWrapReconcileNamespaces(
    mut _ctxt: xmlDOMWrapCtxtPtr,
    mut elem: xmlNodePtr,
    mut options: i32,
) -> i32 {
    let mut current_block: u64;
                    ...
                    while !ns.is_null() {
                        if parnsdone == 0 {
                            if !(unsafe { (*elem).parent }).is_null()
                                && (unsafe { (*(*elem).parent).doc }) as xmlNodePtr != (unsafe { (*elem).parent })
                            {
                                if xmlDOMWrapNSNormGatherInScopeNs(&mut nsMap, unsafe { (*elem).parent })
                                    == -(1 as i32)
                                {
                            ...
                            loop {
                                ...
                                if (unsafe { (*mi).depth }) >= -(1 as i32)
                                    ...
                                    && ((unsafe { (*ns).href }) == (unsafe { (*(*mi).newNs).href })
                                        || (unsafe { xmlStrEqual((*ns).href, (*(*mi).newNs).href) }) != 0)
                                {
                                    if xmlDOMWrapNSNormAddNsMapItem2(
                                        &mut listRedund,
                                        &mut sizeRedund,
                        ...
                        match current_block {
                            652864300344834934 => {
                                ...
                                if !nsMap.is_null() && !(unsafe { (*nsMap).first }).is_null() {
                                    ...
                                    while !mi.is_null() {
                                        if (unsafe { (*mi).depth }) >= -(1 as i32)
                                            && (unsafe { (*mi).shadowDepth }) == -(1 as i32)
                                            && ((unsafe { (*ns).prefix }) == (unsafe { (*(*mi).newNs).prefix })
                                                || (unsafe { xmlStrEqual((*ns).prefix, (*(*mi).newNs).prefix) })
                                                    != 0)
                                        {
                                            (unsafe { (*mi).shadowDepth = depth });
                                        }
                                ...
                                if (xmlDOMWrapNsMapAddItem(&mut nsMap, -(1 as i32), ns, ns, depth))
                                    .is_null()
                                {
                                    current_block = 3912784260007845398;
                                    break 's_51;
...
extern "C" fn xmlDOMWrapAdoptBranch(
    mut ctxt: xmlDOMWrapCtxtPtr,
                        ...
                        match (unsafe { (*cur).type_0 }) as u32 {
                            ...
                            3 | 4 => {
                                    ...
                                    && (unsafe { xmlDictOwns((*sourceDoc).dict, (*cur).content) }) != 0
                                {
                                    if !(unsafe { (*destDoc).dict }).is_null() {
                                        ...
                                        *fresh395 = unsafe { xmlStrdup((*cur).content) };
                                    }
                                }
                                current_block = 16447908953907659923;
                            }
                            ...
                            7 => {
                                if adoptStr != 0 && !(unsafe { (*cur).name }).is_null() {
                                    if !(unsafe { (*destDoc).dict }).is_null() {
                                        let mut old_0: *const xmlChar = unsafe { (*cur).name };
                                        ...
                                        && (unsafe { xmlDictOwns((*sourceDoc).dict, (*cur).name) }) != 0
                                    {
                                        ...
                                        *fresh403 = unsafe { xmlStrdup((*cur).name) };
                                    }
                                }
                                if adoptStr != 0
                                    && !(unsafe { (*cur).content }).is_null()
                                    ...
                                    && (unsafe { xmlDictOwns((*sourceDoc).dict, (*cur).content) }) != 0
                                {
                                    if !(unsafe { (*destDoc).dict }).is_null() {
                                        ...
                                        *fresh405 = unsafe { xmlStrdup((*cur).content) };
                                    }
                                }
                            ...
                            _ => {
                                match current_block {
                                    14835353632257566941 => {
                                        ...
                                        if adoptStr != 0 && !(unsafe { (*cur).name }).is_null() {
                                            if !(unsafe { (*destDoc).dict }).is_null() {
                                                let mut old: *const xmlChar = unsafe { (*cur).name };
                                                ...
                                                && (unsafe { xmlDictOwns((*sourceDoc).dict, (*cur).name) }) != 0
                                            {
                                                ...
                                                *fresh391 = unsafe { xmlStrdup((*cur).name) };
                                            }
                                        }
                                        if (unsafe { (*cur).type_0 }) as u32 == XML_ELEMENT_NODE as i32 as u32 {
                                            ...
                                            *fresh392 = 0 as *mut libc::c_void;
                                            ...
                                            {
                                                (unsafe { xmlRemoveID(sourceDoc, cur as xmlAttrPtr) });
                                            }
...
#[no_mangle]
pub extern "C" fn xmlDOMWrapCloneNode(
    mut ctxt: xmlDOMWrapCtxtPtr,
    mut sourceDoc: xmlDocPtr,
    mut node: xmlNodePtr,
    ...
    (unsafe { *resNode = 0 as xmlNodePtr });
    cur = node;
    if !cur.is_null() && (unsafe { (*cur).type_0 }) as u32 == XML_NAMESPACE_DECL as i32 as u32 {
        return -(1 as i32);
    }
            ...
            *fresh422 = destDoc;
                ...
                *fresh425 = unsafe { xmlStringComment.as_ptr() };
                ...
                if !(unsafe { (*cur).name }).is_null() {
                    if !dict.is_null() {
                        ...
                        *fresh428 = (unsafe { xmlStrdup((*cur).name) }) as *const xmlChar;
                    }
                }
            }
            match (unsafe { (*cur).type_0 }) as u32 {
                ...
                1 => {
                    ...
                    if !(unsafe { (*cur).nsDef }).is_null() {
                        ...
                        cloneNsDefSlot = unsafe { &mut (*clone).nsDef };
                        ns = unsafe { (*cur).nsDef };
                        while !ns.is_null() {
                            ...
                            if !(unsafe { (*ns).href }).is_null() {
                                ...
                                *fresh429 = unsafe { xmlStrdup((*ns).href) };
                            }
                            if !(unsafe { (*ns).prefix }).is_null() {
                                let fresh430 = unsafe { &mut ((*cloneNs).prefix) };
                                *fresh430 = unsafe { xmlStrdup((*ns).prefix) };
                            }
                            (unsafe { *cloneNsDefSlot = cloneNs });
                            cloneNsDefSlot = unsafe { &mut (*cloneNs).next };
                ...
                3 | 4 => {
                    if !(unsafe { (*cur).content }).is_null() {
                        if !dict.is_null() {
                            ...
                            *fresh433 = unsafe { xmlStrdup((*cur).content as *const xmlChar) };
                        }
                    }
                ...
                7 => {
                    if !(unsafe { (*cur).content }).is_null() {
                        if !dict.is_null() {
                            ...
                            *fresh442 = unsafe { xmlStrdup((*cur).content as *const xmlChar) };
                        }
                    }
                    current_block = 17418631935567976705;
                }
                8 => {
                    if !(unsafe { (*cur).content }).is_null() {
                        if !dict.is_null() {
                            ...
                            *fresh445 = unsafe { xmlStrdup((*cur).content as *const xmlChar) };
                        }
                    }
                    current_block = 17418631935567976705;
                }
            ...
            match current_block {
                2544535129495155983 => {
                    ...
                    {
                        if (unsafe { xmlIsID(destDoc, (*clone).parent, clone as xmlAttrPtr) }) != 0 {
    ...
    (unsafe { *resNode = resultClone });
    return ret;
}
extern "C" fn xmlDOMWrapAdoptAttr(
    mut ctxt: xmlDOMWrapCtxtPtr,
    mut sourceDoc: xmlDocPtr,
    mut attr: xmlAttrPtr,
    mut destDoc: xmlDocPtr,
    ...
    match current_block {
        12124785117276362961 => {
            if adoptStr != 0 && !(unsafe { (*attr).name }).is_null() {
                if !(unsafe { (*destDoc).dict }).is_null() {
                    let mut old: *const xmlChar = unsafe { (*attr).name };
                    ...
                    && (unsafe { xmlDictOwns((*sourceDoc).dict, (*attr).name) }) != 0
                {
                    ...
                    *fresh461 = unsafe { xmlStrdup((*attr).name) };
                }
            }
                        ...
                        3 | 4 => {
                                ...
                                && (unsafe { xmlDictOwns((*sourceDoc).dict, (*cur).content) }) != 0
                            {
                                if !(unsafe { (*destDoc).dict }).is_null() {
                                    ...
                                    *fresh465 = unsafe { xmlStrdup((*cur).content) };
                                }
                            }
                        }
                        5 => {
...
#[no_mangle]
pub extern "C" fn xmlDOMWrapAdoptNode(
    mut ctxt: xmlDOMWrapCtxtPtr,
    mut sourceDoc: xmlDocPtr,
    mut node: xmlNodePtr,
    mut destDoc: xmlDocPtr,
                ...
                3 | 4 => {
                        ...
                        && (unsafe { xmlDictOwns((*sourceDoc).dict, (*cur).content) }) != 0
                    {
                        if !(unsafe { (*destDoc).dict }).is_null() {
                            ...
                            *fresh474 = unsafe { xmlStrdup((*cur).content) };
                        }
                    }
                }
                5 => {
                    ...
                    *fresh477 = 0 as *mut _xmlNode;
                    ...
                    if adoptStr != 0 && !(unsafe { (*node).name }).is_null() {
                        if !(unsafe { (*destDoc).dict }).is_null() {
                            let mut old: *const xmlChar = unsafe { (*node).name };
                            ...
                            && (unsafe { xmlDictOwns((*sourceDoc).dict, (*node).name) }) != 0
                        {
                            ...
                            *fresh482 = unsafe { xmlStrdup((*node).name) };
                        }
                    }
                }
                7 => {
                    if adoptStr != 0 && !(unsafe { (*node).name }).is_null() {
                        if !(unsafe { (*destDoc).dict }).is_null() {
                            let mut old_0: *const xmlChar = unsafe { (*node).name };
                            ...
                            && (unsafe { xmlDictOwns((*sourceDoc).dict, (*node).name) }) != 0
                        {
                            ...
                            *fresh484 = unsafe { xmlStrdup((*node).name) };
                        }
                    }
                    if adoptStr != 0
                        && !(unsafe { (*node).content }).is_null()
                        ...
                        && (unsafe { xmlDictOwns((*sourceDoc).dict, (*cur).content) }) != 0
                    {
                        if !(unsafe { (*destDoc).dict }).is_null() {
                            ...
                            *fresh486 = unsafe { xmlStrdup((*cur).content) };
                        }
                    }
                }
                _ => {}
