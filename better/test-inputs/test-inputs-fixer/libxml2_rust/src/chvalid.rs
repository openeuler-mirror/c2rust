...
#[no_mangle]
pub extern "C" fn xmlCharInRange(mut val: u32, mut rptr: *const xmlChRangeGroup) -> i32 {
    let mut low: i32 = 0;
    let mut high: i32 = 0;
    let mut mid: i32 = 0;
    ...
    if val < 0x10000 as i32 as u32 {
        if (unsafe { (*rptr).nbShortRange }) == 0 as i32 {
            return 0 as i32;
        }
        low = 0 as i32;
        high = (unsafe { (*rptr).nbShortRange }) - 1 as i32;
        ...
        if (unsafe { (*rptr).nbLongRange }) == 0 as i32 {
            return 0 as i32;
        }
        low = 0 as i32;
        high = (unsafe { (*rptr).nbLongRange }) - 1 as i32;
...
pub extern "C" fn xmlIsBaseChar(mut ch: u32) -> i32 {
    return if ch < 0x100 as i32 as u32 {
        ...
        xmlCharInRange(ch, unsafe { &xmlIsBaseCharGroup })
    };
}
#[no_mangle]
...
pub extern "C" fn xmlIsCombining(mut ch: u32) -> i32 {
    return if ch < 0x100 as i32 as u32 {
        ...
        xmlCharInRange(ch, unsafe { &xmlIsCombiningGroup })
    };
}
#[no_mangle]
pub extern "C" fn xmlIsDigit(mut ch: u32) -> i32 {
    return if ch < 0x100 as i32 as u32 {
        ...
        xmlCharInRange(ch, unsafe { &xmlIsDigitGroup })
    };
}
#[no_mangle]
pub extern "C" fn xmlIsExtender(mut ch: u32) -> i32 {
    return if ch < 0x100 as i32 as u32 {
        ...
        xmlCharInRange(ch, unsafe { &xmlIsExtenderGroup })
    };
}
#[no_mangle]
