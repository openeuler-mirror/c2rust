...
extern "C" {
    ...
    fn xmlNewInputFromFile(ctxt: xmlParserCtxtPtr, filename: *const i8) -> xmlParserInputPtr;
    ...
    fn xmlNanoHTTPOpen(URL: *const i8, contentType: *mut *mut i8) -> *mut libc::c_void;
    ...
    fn xmlNanoHTTPRead(ctx: *mut libc::c_void, dest: *mut libc::c_void, len: i32) -> i32;
    ...
    fn xmlNanoFTPRead(ctx: *mut libc::c_void, dest: *mut libc::c_void, len: i32) -> i32;
    ...
    fn xmlCatalogLocalResolveURI(catalogs: *mut libc::c_void, URI: *const xmlChar) -> *mut xmlChar;
...
pub type xmlOutputMatchCallback = Option<unsafe extern "C" fn(*const i8) -> i32>;
pub type xmlOutputOpenCallback = Option<unsafe extern "C" fn(*const i8) -> *mut libc::c_void>;
...
#[no_mangle]
pub extern "C" fn xmlNormalizeWindowsPath(mut path: *const xmlChar) -> *mut xmlChar {
    return unsafe { xmlCanonicPath(path) };
}
#[no_mangle]
...
extern "C" fn xmlFdRead(mut context: *mut libc::c_void, mut buffer: *mut i8, mut len: i32) -> i32 {
    let mut ret: i32 = 0;
    ret = (unsafe { read(
...
extern "C" fn xmlFdClose(mut context: *mut libc::c_void) -> i32 {
    let mut ret: i32 = 0;
...
extern "C" fn xmlFileOpen_real(mut filename: *const i8) -> *mut libc::c_void {
...
#[no_mangle]
pub extern "C" fn xmlFileOpen(mut filename: *const i8) -> *mut libc::c_void {
    let mut unescaped: *mut i8 = 0 as *mut i8;
    let mut retval: *mut libc::c_void = 0 as *mut libc::c_void;
    retval = xmlFileOpen_real(filename);
    if retval.is_null() {
        unescaped = unsafe { xmlURIUnescapeString(filename, 0 as i32, 0 as *mut i8) };
...
extern "C" fn xmlFileOpenW(mut filename: *const i8) -> *mut libc::c_void {
...
#[no_mangle]
pub extern "C" fn xmlFileClose(mut context: *mut libc::c_void) -> i32 {
...
extern "C" fn xmlFileFlush(mut context: *mut libc::c_void) -> i32 {
    let mut ret: i32 = 0;
    if context.is_null() {
        return -(1 as i32);
    }
...
extern "C" fn xmlBufferWrite(
    ...
    let mut ret: i32 = 0;
    ret = unsafe { xmlBufferAdd(context as xmlBufferPtr, buffer as *const xmlChar, len) };
    if ret != 0 as i32 {
        return -(1 as i32);
    }
    return len;
...
extern "C" fn xmlGzfileOpen_real(mut filename: *const i8) -> *mut libc::c_void {
    let mut path: *const i8 = 0 as *const i8;
...
extern "C" fn xmlGzfileOpen(mut filename: *const i8) -> *mut libc::c_void {
    let mut unescaped: *mut i8 = 0 as *mut i8;
    let mut retval: *mut libc::c_void = 0 as *mut libc::c_void;
...
extern "C" fn xmlGzfileOpenW(mut filename: *const i8, mut compression: i32) -> *mut libc::c_void {
    let mut path: *const i8 = 0 as *const i8;
...
extern "C" fn xmlGzfileClose(mut context: *mut libc::c_void) -> i32 {
    let mut ret: i32 = 0;
...
extern "C" fn append_reverse_ulong(mut buff: *mut xmlZMemBuff, mut data: u64) {
    let mut idx: i32 = 0;
    if buff.is_null() {
        return;
    }
...
extern "C" fn xmlFreeZMemBuff(mut buff: xmlZMemBuffPtr) {
    if buff.is_null() {
        return;
    }
...
extern "C" fn xmlCreateZMemBuff(mut compression: i32) -> *mut libc::c_void {
    let mut z_err: i32 = 0;
...
extern "C" fn xmlZMemBuffExtend(mut buff: xmlZMemBuffPtr, mut ext_amt: size_t) -> i32 {
...
extern "C" fn xmlZMemBuffAppend(mut buff: xmlZMemBuffPtr, mut src: *const i8, mut len: i32) -> i32 {
    let mut z_err: i32 = 0;
...
extern "C" fn xmlZMemBuffGetContent(mut buff: xmlZMemBuffPtr, mut data_ref: *mut *mut i8) -> i32 {
    ...
    if z_err == 1 as i32 {
        ...
        (unsafe { *data_ref = (*buff).zbuff as *mut i8 });
    } else {
        let mut msg: [xmlChar; 500] = [0; 500];
        (unsafe { xmlStrPrintf(
            msg.as_mut_ptr(),
...
extern "C" fn xmlFreeHTTPWriteCtxt(mut ctxt: xmlIOHTTPWriteCtxtPtr) {
...
#[no_mangle]
pub extern "C" fn xmlIOHTTPOpen(mut filename: *const i8) -> *mut libc::c_void {
...
pub extern "C" fn xmlIOHTTPOpenW(
    ...
    *fresh6 = (unsafe { xmlStrdup(post_uri as *const xmlChar) }) as *mut i8;
    if (unsafe { (*ctxt).uri }).is_null() {
...
extern "C" fn xmlIOHTTPDfltOpenW(mut post_uri: *const i8) -> *mut libc::c_void {
...
#[no_mangle]
pub extern "C" fn xmlIOHTTPClose(mut context: *mut libc::c_void) -> i32 {
    (unsafe { xmlNanoHTTPClose(context) });
    return 0 as i32;
}
extern "C" fn xmlIOHTTPCloseWrite(mut context: *mut libc::c_void, mut http_mthd: *const i8) -> i32 {
    ...
    if (unsafe { (*ctxt).compression }) > 0 as i32 {
        content_lgth = xmlZMemBuffGetContent((unsafe { (*ctxt).doc_buff }) as xmlZMemBuffPtr, &mut http_content);
        content_encoding = b"Content-Encoding: gzip\0" as *const u8 as *const i8 as *mut i8;
    } else {
        let mut dctxt: xmlOutputBufferPtr = (unsafe { (*ctxt).doc_buff }) as xmlOutputBufferPtr;
...
extern "C" fn xmlIOHTTPClosePut(mut ctxt: *mut libc::c_void) -> i32 {
    return xmlIOHTTPCloseWrite(ctxt, b"PUT\0" as *const u8 as *const i8);
}
extern "C" fn xmlIOHTTPClosePost(mut ctxt: *mut libc::c_void) -> i32 {
...
#[no_mangle]
pub extern "C" fn xmlIOFTPOpen(mut filename: *const i8) -> *mut libc::c_void {
...
#[no_mangle]
pub extern "C" fn xmlIOFTPClose(mut context: *mut libc::c_void) -> i32 {
...
pub extern "C" fn xmlRegisterInputCallbacks(
    ...
    let fresh9 = unsafe { xmlInputCallbackNr };
...
pub extern "C" fn xmlRegisterOutputCallbacks(
    ...
    let fresh10 = unsafe { xmlOutputCallbackNr };
...
pub extern "C" fn xmlRegisterDefaultInputCallbacks() {
    ...
    xmlRegisterInputCallbacks(
        ...
        Some(xmlFileOpen as unsafe extern "C" fn(*const i8) -> *mut libc::c_void),
        Some(xmlFileRead as unsafe extern "C" fn(*mut libc::c_void, *mut i8, i32) -> i32),
        Some(xmlFileClose as unsafe extern "C" fn(*mut libc::c_void) -> i32),
    );
    xmlRegisterInputCallbacks(
        Some(xmlGzfileMatch as unsafe extern "C" fn(*const i8) -> i32),
        Some(xmlGzfileOpen as unsafe extern "C" fn(*const i8) -> *mut libc::c_void),
        Some(xmlGzfileRead as unsafe extern "C" fn(*mut libc::c_void, *mut i8, i32) -> i32),
        Some(xmlGzfileClose as unsafe extern "C" fn(*mut libc::c_void) -> i32),
    );
    xmlRegisterInputCallbacks(
        Some(xmlIOHTTPMatch as unsafe extern "C" fn(*const i8) -> i32),
        Some(xmlIOHTTPOpen as unsafe extern "C" fn(*const i8) -> *mut libc::c_void),
        Some(xmlIOHTTPRead as unsafe extern "C" fn(*mut libc::c_void, *mut i8, i32) -> i32),
        Some(xmlIOHTTPClose as unsafe extern "C" fn(*mut libc::c_void) -> i32),
    );
    xmlRegisterInputCallbacks(
        Some(xmlIOFTPMatch as unsafe extern "C" fn(*const i8) -> i32),
        Some(xmlIOFTPOpen as unsafe extern "C" fn(*const i8) -> *mut libc::c_void),
        Some(xmlIOFTPRead as unsafe extern "C" fn(*mut libc::c_void, *mut i8, i32) -> i32),
...
pub extern "C" fn xmlRegisterDefaultOutputCallbacks() {
    ...
    xmlRegisterOutputCallbacks(
        Some(xmlFileMatch as unsafe extern "C" fn(*const i8) -> i32),
        Some(xmlFileOpenW as unsafe extern "C" fn(*const i8) -> *mut libc::c_void),
        Some(xmlFileWrite as unsafe extern "C" fn(*mut libc::c_void, *const i8, i32) -> i32),
        Some(xmlFileClose as unsafe extern "C" fn(*mut libc::c_void) -> i32),
    );
    xmlRegisterOutputCallbacks(
        Some(xmlIOHTTPMatch as unsafe extern "C" fn(*const i8) -> i32),
        Some(xmlIOHTTPDfltOpenW as unsafe extern "C" fn(*const i8) -> *mut libc::c_void),
        Some(xmlIOHTTPWrite as unsafe extern "C" fn(*mut libc::c_void, *const i8, i32) -> i32),
...
pub extern "C" fn xmlRegisterHTTPPostCallbacks() {
    ...
    xmlRegisterOutputCallbacks(
        ...
        Some(xmlIOHTTPDfltOpenW as unsafe extern "C" fn(*const i8) -> *mut libc::c_void),
        Some(xmlIOHTTPWrite as unsafe extern "C" fn(*mut libc::c_void, *const i8, i32) -> i32),
        Some(xmlIOHTTPClosePost as unsafe extern "C" fn(*mut libc::c_void) -> i32),
    );
}
#[no_mangle]
pub extern "C" fn xmlAllocParserInputBuffer(mut enc: xmlCharEncoding) -> xmlParserInputBufferPtr {
...
#[no_mangle]
pub extern "C" fn xmlFreeParserInputBuffer(mut in_0: xmlParserInputBufferPtr) {
    if in_0.is_null() {
        return;
    }
...
#[no_mangle]
pub extern "C" fn xmlOutputBufferClose(mut out: xmlOutputBufferPtr) -> i32 {
...
pub extern "C" fn __xmlParserInputBufferCreateFilename(
    ...
    if !ret.is_null() {
        ...
        *fresh38 = unsafe { xmlInputCallbackTable[i as usize].closecallback };
        if (unsafe { xmlInputCallbackTable[i as usize].opencallback })
            == Some(xmlGzfileOpen as unsafe extern "C" fn(*const i8) -> *mut libc::c_void)
...
pub extern "C" fn __xmlOutputBufferCreateFilename(
    ...
    if !puri.is_null() {
        ...
        {
            unescaped = unsafe { xmlURIUnescapeString(URI, 0 as i32, 0 as *mut i8) };
        }
        (unsafe { xmlFreeURI(puri) });
    }
    if !unescaped.is_null() {
        ...
        while i >= 0 as i32 {
            if (unsafe { (xmlOutputCallbackTable[i as usize].matchcallback).is_some() })
                && (unsafe { (xmlOutputCallbackTable[i as usize].matchcallback)
                    ...
                    != 0 as i32
            {
                if (unsafe { xmlOutputCallbackTable[i as usize].matchcallback })
                    == Some(xmlIOHTTPMatch as unsafe extern "C" fn(*const i8) -> i32)
                {
...
pub extern "C" fn xmlParserInputBufferCreateFile(
    ...
    if !ret.is_null() {
        ...
        *fresh50 = Some(xmlFileFlush as unsafe extern "C" fn(*mut libc::c_void) -> i32);
    }
    return ret;
}
#[no_mangle]
pub extern "C" fn xmlOutputBufferCreateFile(
    ...
    if !ret.is_null() {
        ...
        *fresh53 = Some(xmlFileFlush as unsafe extern "C" fn(*mut libc::c_void) -> i32);
    }
    return ret;
}
#[no_mangle]
pub extern "C" fn xmlOutputBufferCreateBuffer(
    ...
    ret = xmlOutputBufferCreateIO(
        Some(xmlBufferWrite as unsafe extern "C" fn(*mut libc::c_void, *const i8, i32) -> i32),
        None,
...
#[no_mangle]
pub extern "C" fn xmlOutputBufferGetContent(mut out: xmlOutputBufferPtr) -> *const xmlChar {
    if out.is_null() || (unsafe { (*out).buffer }).is_null() {
        return 0 as *const xmlChar;
    }
    return unsafe { xmlBufContent((*out).buffer as *const xmlBuf) };
}
#[no_mangle]
pub extern "C" fn xmlOutputBufferGetSize(mut out: xmlOutputBufferPtr) -> size_t {
    if out.is_null() || (unsafe { (*out).buffer }).is_null() {
        return 0 as i32 as size_t;
    }
    return unsafe { xmlBufUse((*out).buffer) };
}
#[no_mangle]
pub extern "C" fn xmlParserInputBufferCreateFd(
    ...
    if !ret.is_null() {
        ...
        *fresh55 = Some(xmlFdRead as unsafe extern "C" fn(*mut libc::c_void, *mut i8, i32) -> i32);
        let fresh56 = unsafe { &mut ((*ret).closecallback) };
        *fresh56 = Some(xmlFdClose as unsafe extern "C" fn(*mut libc::c_void) -> i32);
    }
    return ret;
}
#[no_mangle]
pub extern "C" fn xmlParserInputBufferCreateMem(
    ...
    if !ret.is_null() {
        ...
        *fresh58 = Some(
            xmlInputReadCallbackNop as unsafe extern "C" fn(*mut libc::c_void, *mut i8, i32) -> i32,
        );
...
pub extern "C" fn xmlOutputBufferCreateFd(
    ...
    if !ret.is_null() {
        ...
        *fresh68 =
            Some(xmlFdWrite as unsafe extern "C" fn(*mut libc::c_void, *const i8, i32) -> i32);
...
pub extern "C" fn xmlOutputBufferCreateFilenameDefault(
    ...
    let mut old: xmlOutputBufferCreateFilenameFunc = unsafe { *__xmlOutputBufferCreateFilenameValue() };
    if old.is_none() {
        old = Some(
...
extern "C" fn endOfInput(mut _context: *mut libc::c_void, mut _buffer: *mut i8, mut _len: i32) -> i32 {
    return 0 as i32;
}
#[no_mangle]
pub extern "C" fn xmlParserInputBufferGrow(mut in_0: xmlParserInputBufferPtr, mut len: i32) -> i32 {
    ...
    if unsafe { ((*in_0).readcallback).is_some() } {
        ...
        if res <= 0 as i32 {
            ...
            *fresh80 =
                Some(endOfInput as unsafe extern "C" fn(*mut libc::c_void, *mut i8, i32) -> i32);
        }
    } else {
...
#[no_mangle]
pub extern "C" fn xmlParserInputBufferRead(mut in_0: xmlParserInputBufferPtr, mut len: i32) -> i32 {
    if in_0.is_null() || (unsafe { (*in_0).error }) != 0 {
        return -(1 as i32);
    }
    if unsafe { ((*in_0).readcallback).is_some() } {
...
#[no_mangle]
pub extern "C" fn xmlOutputBufferFlush(mut out: xmlOutputBufferPtr) -> i32 {
    let mut nbchars: i32 = 0 as i32;
    let mut ret: i32 = 0 as i32;
    if out.is_null() || (unsafe { (*out).error }) != 0 {
        return -(1 as i32);
...
pub extern "C" fn xmlParserGetDirectory(mut filename: *const i8) -> *mut i8 {
    ...
    cur = (unsafe { &mut *dir
        .as_mut_ptr()
        .offset((strlen as unsafe extern "C" fn(*const i8) -> u64)(dir.as_mut_ptr()) as isize) })
        as *mut i8;
        ...
        && !(unsafe { (*(*ret).buf).context }).is_null()
    {
        ...
        if code >= 400 as i32 {
                ...
                .is_null()
            {
                ...
                if !encoding.is_null() {
                    ...
                    if (unsafe { (*ret).encoding }).is_null() {
                        ...
                        *fresh104 = unsafe { xmlStrdup(encoding as *mut xmlChar) };
                    }
                }
            }
            ...
            if !redir.is_null() {
                ...
                *fresh106 = (unsafe { xmlStrdup(redir as *const xmlChar) }) as *mut i8;
            }
        }
    }
    return ret;
...
extern "C" fn xmlResolveResourceFromCatalog(
    ...
    if pref as u32 != XML_CATA_ALLOW_NONE as i32 as u32 && xmlNoNetExists(URL) == 0 {
        ...
        if resource.is_null() && !URL.is_null() {
            resource = unsafe { xmlStrdup(URL as *const xmlChar) };
        }
...
#[no_mangle]
pub extern "C" fn xmlSetExternalEntityLoader(mut f: xmlExternalEntityLoader) {
    (unsafe { xmlCurrentExternalEntityLoader = f });
}
#[no_mangle]
pub extern "C" fn xmlGetExternalEntityLoader() -> xmlExternalEntityLoader {
...
pub extern "C" fn xmlLoadExternalEntity(
    ...
    if !URL.is_null() && xmlNoNetExists(URL) == 0 as i32 {
        ...
        canonicFilename = (unsafe { xmlCanonicPath(URL as *const xmlChar) }) as *mut i8;
