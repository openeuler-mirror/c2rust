...
extern "C" fn xmlBufMemoryError(mut buf: xmlBufPtr, mut extra: *const i8) {
...
extern "C" fn xmlBufOverflowError(mut buf: xmlBufPtr, mut extra: *const i8) {
    (unsafe { __xmlSimpleError(
        XML_FROM_BUFFER as i32,
...
#[no_mangle]
pub extern "C" fn xmlBufCreate() -> xmlBufPtr {
    ...
    *fresh0 = 0 as xmlBufferPtr;
    (unsafe { (*ret).size = *__xmlDefaultBufferSize() as size_t });
...
#[no_mangle]
pub extern "C" fn xmlBufCreateSize(mut size: size_t) -> xmlBufPtr {
    let mut ret: xmlBufPtr = 0 as *mut xmlBuf;
...
#[no_mangle]
pub extern "C" fn xmlBufDetach(mut buf: xmlBufPtr) -> *mut xmlChar {
    ...
    let fresh7 = unsafe { &mut ((*buf).content) };
    *fresh7 = 0 as *mut xmlChar;
    (unsafe { (*buf).size = 0 as i32 as size_t });
...
#[no_mangle]
pub extern "C" fn xmlBufCreateStatic(mut mem: *mut libc::c_void, mut size: size_t) -> xmlBufPtr {
    let mut ret: xmlBufPtr = 0 as *mut xmlBuf;
    if mem.is_null() {
        return 0 as xmlBufPtr;
    }
...
#[no_mangle]
pub extern "C" fn xmlBufGetAllocationScheme(mut buf: xmlBufPtr) -> i32 {
    if buf.is_null() {
        return -(1 as i32);
    }
...
#[no_mangle]
pub extern "C" fn xmlBufFree(mut buf: xmlBufPtr) {
    if buf.is_null() {
        return;
    }
...
#[no_mangle]
pub extern "C" fn xmlBufEmpty(mut buf: xmlBufPtr) {
    if buf.is_null() || (unsafe { (*buf).error }) != 0 as i32 {
        return;
    }
...
#[no_mangle]
pub extern "C" fn xmlBufShrink(mut buf: xmlBufPtr, mut len: size_t) -> size_t {
    if buf.is_null() || (unsafe { (*buf).error }) != 0 as i32 {
...
extern "C" fn xmlBufGrowInternal(mut buf: xmlBufPtr, mut len: size_t) -> size_t {
...
#[no_mangle]
pub extern "C" fn xmlBufGrow(mut buf: xmlBufPtr, mut len: i32) -> i32 {
...
#[no_mangle]
pub extern "C" fn xmlBufDump(mut file: *mut FILE, mut buf: xmlBufPtr) -> size_t {
    let mut ret: size_t = 0;
    if buf.is_null() || (unsafe { (*buf).error }) != 0 as i32 {
        return 0 as i32 as size_t;
    }
...
#[no_mangle]
pub extern "C" fn xmlBufContent(mut buf: *const xmlBuf) -> *mut xmlChar {
...
#[no_mangle]
pub extern "C" fn xmlBufEnd(mut buf: xmlBufPtr) -> *mut xmlChar {
    if buf.is_null() || (unsafe { (*buf).error }) != 0 {
        return 0 as *mut xmlChar;
    }
    if (unsafe { (*buf).size }) != (unsafe { (*buf).compat_size }) as size_t {
...
#[no_mangle]
pub extern "C" fn xmlBufAddLen(mut buf: xmlBufPtr, mut len: size_t) -> i32 {
    if buf.is_null() || (unsafe { (*buf).error }) != 0 {
        return -(1 as i32);
    }
    if (unsafe { (*buf).size }) != (unsafe { (*buf).compat_size }) as size_t {
...
#[no_mangle]
pub extern "C" fn xmlBufLength(buf: xmlBufPtr) -> size_t {
    if buf.is_null() || (unsafe { (*buf).error }) != 0 {
        return 0 as i32 as size_t;
    }
    if (unsafe { (*buf).size }) != (unsafe { (*buf).compat_size }) as size_t {
...
#[no_mangle]
pub extern "C" fn xmlBufUse(buf: xmlBufPtr) -> size_t {
    if buf.is_null() || (unsafe { (*buf).error }) != 0 {
        return 0 as i32 as size_t;
    }
    if (unsafe { (*buf).size }) != (unsafe { (*buf).compat_size }) as size_t {
...
#[no_mangle]
pub extern "C" fn xmlBufAvail(buf: xmlBufPtr) -> size_t {
    if buf.is_null() || (unsafe { (*buf).error }) != 0 {
        return 0 as i32 as size_t;
    }
    if (unsafe { (*buf).size }) != (unsafe { (*buf).compat_size }) as size_t {
...
#[no_mangle]
pub extern "C" fn xmlBufIsEmpty(buf: xmlBufPtr) -> i32 {
    if buf.is_null() || (unsafe { (*buf).error }) != 0 {
        return -(1 as i32);
    }
    if (unsafe { (*buf).size }) != (unsafe { (*buf).compat_size }) as size_t {
...
#[no_mangle]
pub extern "C" fn xmlBufResize(mut buf: xmlBufPtr, mut size: size_t) -> i32 {
...
#[no_mangle]
pub extern "C" fn xmlBufAdd(mut buf: xmlBufPtr, mut str: *const xmlChar, mut len: i32) -> i32 {
...
#[no_mangle]
pub extern "C" fn xmlBufCat(mut buf: xmlBufPtr, mut str: *const xmlChar) -> i32 {
    if buf.is_null() || (unsafe { (*buf).error }) != 0 {
        return -(1 as i32);
    }
    if (unsafe { (*buf).size }) != (unsafe { (*buf).compat_size }) as size_t {
...
#[no_mangle]
pub extern "C" fn xmlBufCCat(mut buf: xmlBufPtr, mut str: *const i8) -> i32 {
    return xmlBufCat(buf, str as *const xmlChar);
}
#[no_mangle]
pub extern "C" fn xmlBufWriteQuotedString(mut buf: xmlBufPtr, mut string: *const xmlChar) -> i32 {
...
#[no_mangle]
pub extern "C" fn xmlBufFromBuffer(mut buffer: xmlBufferPtr) -> xmlBufPtr {
    let mut ret: xmlBufPtr = 0 as *mut xmlBuf;
    if buffer.is_null() {
        return 0 as xmlBufPtr;
    }
...
#[no_mangle]
pub extern "C" fn xmlBufBackToBuffer(mut buf: xmlBufPtr) -> xmlBufferPtr {
...
#[no_mangle]
pub extern "C" fn xmlBufMergeBuffer(mut buf: xmlBufPtr, mut buffer: xmlBufferPtr) -> i32 {
...
#[no_mangle]
pub extern "C" fn xmlBufResetInput(mut buf: xmlBufPtr, mut input: xmlParserInputPtr) -> i32 {
...
#[no_mangle]
pub extern "C" fn xmlBufGetInputBase(mut buf: xmlBufPtr, mut input: xmlParserInputPtr) -> size_t {
