...
extern "C" fn xmlRngPErrMemory(mut ctxt: xmlRelaxNGParserCtxtPtr, mut extra: *const i8) {
...
extern "C" fn xmlRngVErrMemory(mut ctxt: xmlRelaxNGValidCtxtPtr, mut extra: *const i8) {
    let mut schannel: xmlStructuredErrorFunc = None;
    let mut channel: xmlGenericErrorFunc = None;
    let mut data: *mut libc::c_void = 0 as *mut libc::c_void;
    if !ctxt.is_null() {
...
extern "C" fn xmlRelaxNGFreeDocument(mut docu: xmlRelaxNGDocumentPtr) {
    if docu.is_null() {
        return;
    }
...
extern "C" fn xmlRelaxNGFreeDocumentList(mut docu: xmlRelaxNGDocumentPtr) {
...
extern "C" fn xmlRelaxNGFreeInclude(mut incl: xmlRelaxNGIncludePtr) {
    if incl.is_null() {
        return;
    }
...
extern "C" fn xmlRelaxNGFreeIncludeList(mut incl: xmlRelaxNGIncludePtr) {
...
extern "C" fn xmlRelaxNGNewRelaxNG(mut ctxt: xmlRelaxNGParserCtxtPtr) -> xmlRelaxNGPtr {
...
extern "C" fn xmlRelaxNGFreeInnerSchema(mut schema: xmlRelaxNGPtr) {
    if schema.is_null() {
        return;
    }
...
#[no_mangle]
pub extern "C" fn xmlRelaxNGFree(mut schema: xmlRelaxNGPtr) {
    if schema.is_null() {
        return;
    }
...
extern "C" fn xmlRelaxNGNewGrammar(mut ctxt: xmlRelaxNGParserCtxtPtr) -> xmlRelaxNGGrammarPtr {
...
extern "C" fn xmlRelaxNGFreeGrammar(mut grammar: xmlRelaxNGGrammarPtr) {
    if grammar.is_null() {
        return;
    }
...
extern "C" fn xmlRelaxNGFreePartition(mut partitions: xmlRelaxNGPartitionPtr) {
    ...
    if !partitions.is_null() {
        ...
        if !(unsafe { (*partitions).triage }).is_null() {
            (unsafe { xmlHashFree((*partitions).triage, None) });
        }
        (unsafe { xmlFree.expect("non-null function pointer")(partitions as *mut libc::c_void) });
    }
}
extern "C" fn xmlRelaxNGFreeDefine(mut define: xmlRelaxNGDefinePtr) {
    if define.is_null() {
        return;
    }
    ...
    if !(unsafe { (*define).data }).is_null() && (unsafe { (*define).type_0 }) as i32 == XML_RELAXNG_CHOICE as i32 {
        (unsafe { xmlHashFree((*define).data as xmlHashTablePtr, None) });
    }
...
extern "C" fn xmlRelaxNGNewStates(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
    mut size: i32,
) -> xmlRelaxNGStatesPtr {
...
extern "C" fn xmlRelaxNGAddStatesUniq(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
...
extern "C" fn xmlRelaxNGAddStates(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
    mut states: xmlRelaxNGStatesPtr,
    mut state: xmlRelaxNGValidStatePtr,
) -> i32 {
...
extern "C" fn xmlRelaxNGFreeStates(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
    mut states: xmlRelaxNGStatesPtr,
) {
    if states.is_null() {
...
extern "C" fn xmlRelaxNGNewValidState(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
    mut node: xmlNodePtr,
...
extern "C" fn xmlRelaxNGCopyValidState(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
    mut state: xmlRelaxNGValidStatePtr,
) -> xmlRelaxNGValidStatePtr {
    let mut ret: xmlRelaxNGValidStatePtr = 0 as *mut xmlRelaxNGValidState;
...
extern "C" fn xmlRelaxNGEqualValidState(
    mut _ctxt: xmlRelaxNGValidCtxtPtr,
...
extern "C" fn xmlRelaxNGFreeValidState(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
    mut state: xmlRelaxNGValidStatePtr,
) {
    if state.is_null() {
...
#[no_mangle]
pub extern "C" fn xmlRelaxParserSetFlag(mut ctxt: xmlRelaxNGParserCtxtPtr, mut flags: i32) -> i32 {
    if ctxt.is_null() {
        return -(1 as i32);
    }
    if flags & XML_RELAXNGP_FREE_DOC as i32 != 0 {
        (unsafe { (*ctxt).crng |= XML_RELAXNGP_FREE_DOC as i32 });
        flags -= XML_RELAXNGP_FREE_DOC as i32;
    }
    if flags & XML_RELAXNGP_CRNG as i32 != 0 {
        (unsafe { (*ctxt).crng |= XML_RELAXNGP_CRNG as i32 });
...
extern "C" fn xmlRelaxNGIncludePush(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
...
extern "C" fn xmlRelaxNGIncludePop(mut ctxt: xmlRelaxNGParserCtxtPtr) -> xmlRelaxNGIncludePtr {
...
extern "C" fn xmlRelaxNGRemoveRedefine(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
    ...
    while !tmp.is_null() {
            ...
            && (unsafe { xmlStrEqual((*(*tmp).ns).href, xmlRelaxNGNs) }) != 0
        {
            ...
            let mut inc: xmlRelaxNGDocumentPtr = (unsafe { (*tmp).psvi }) as xmlRelaxNGDocumentPtr;
...
extern "C" fn xmlRelaxNGLoadInclude(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
    mut URL: *const xmlChar,
    mut node: xmlNodePtr,
    ...
    doc = unsafe { xmlReadFile(URL as *const i8, 0 as *const i8, 0 as i32) };
    if doc.is_null() {
        xmlRngPErr(
            ctxt,
            node,
...
extern "C" fn xmlRelaxNGValidErrorPush(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
    ...
    if (unsafe { (*ctxt).errTab }).is_null() {
        ...
        *fresh57 = (unsafe { xmlMalloc.expect("non-null function pointer")(
        ...
        let fresh58 = unsafe { &mut ((*ctxt).err) };
    ...
    if (unsafe { (*ctxt).errNr }) >= (unsafe { (*ctxt).errMax }) {
        ...
        *fresh59 = (unsafe { xmlRealloc.expect("non-null function pointer")(
        ...
        let fresh60 = unsafe { &mut ((*ctxt).err) };
        *fresh60 = (unsafe { &mut *((*ctxt).errTab).offset(((*ctxt).errNr - 1 as i32) as isize) })
            as *mut xmlRelaxNGValidError;
    }
    if !(unsafe { (*ctxt).err }).is_null()
        && !(unsafe { (*ctxt).state }).is_null()
        && (unsafe { (*(*ctxt).err).node }) == (unsafe { (*(*ctxt).state).node })
        && (unsafe { (*(*ctxt).err).err }) as u32 == err as u32
    {
        return unsafe { (*ctxt).errNr };
    }
    cur = (unsafe { &mut *((*ctxt).errTab).offset((*ctxt).errNr as isize) }) as *mut xmlRelaxNGValidError;
    (unsafe { (*cur).err = err });
    if dup != 0 {
        let fresh61 = unsafe { &mut ((*cur).arg1) };
        *fresh61 = unsafe { xmlStrdup(arg1) };
        let fresh62 = unsafe { &mut ((*cur).arg2) };
        *fresh62 = unsafe { xmlStrdup(arg2) };
        (unsafe { (*cur).flags = 1 as i32 });
    } else {
        let fresh63 = unsafe { &mut ((*cur).arg1) };
        *fresh63 = arg1;
        let fresh64 = unsafe { &mut ((*cur).arg2) };
        *fresh64 = arg2;
        (unsafe { (*cur).flags = 0 as i32 });
    }
    if !(unsafe { (*ctxt).state }).is_null() {
        let fresh65 = unsafe { &mut ((*cur).node) };
        *fresh65 = unsafe { (*(*ctxt).state).node };
        let fresh66 = unsafe { &mut ((*cur).seq) };
        *fresh66 = unsafe { (*(*ctxt).state).seq };
    } else {
        let fresh67 = unsafe { &mut ((*cur).node) };
        *fresh67 = 0 as xmlNodePtr;
        let fresh68 = unsafe { &mut ((*cur).seq) };
        *fresh68 = 0 as xmlNodePtr;
    }
    let fresh69 = unsafe { &mut ((*ctxt).err) };
    *fresh69 = cur;
...
extern "C" fn xmlRelaxNGValidErrorPop(mut ctxt: xmlRelaxNGValidCtxtPtr) {
    let mut cur: xmlRelaxNGValidErrorPtr = 0 as *mut xmlRelaxNGValidError;
    if (unsafe { (*ctxt).errNr }) <= 0 as i32 {
        let fresh72 = unsafe { &mut ((*ctxt).err) };
    ...
    *fresh73 -= 1;
    if (unsafe { (*ctxt).errNr }) > 0 as i32 {
        let fresh74 = unsafe { &mut ((*ctxt).err) };
        *fresh74 = (unsafe { &mut *((*ctxt).errTab).offset(((*ctxt).errNr - 1 as i32) as isize) })
            as *mut xmlRelaxNGValidError;
    } else {
        let fresh75 = unsafe { &mut ((*ctxt).err) };
        *fresh75 = 0 as xmlRelaxNGValidErrorPtr;
    }
    cur = (unsafe { &mut *((*ctxt).errTab).offset((*ctxt).errNr as isize) }) as *mut xmlRelaxNGValidError;
    if (unsafe { (*cur).flags }) & 1 as i32 != 0 {
        if !(unsafe { (*cur).arg1 }).is_null() {
            (unsafe { xmlFree.expect("non-null function pointer")(
                (*cur).arg1 as *mut xmlChar as *mut libc::c_void,
            ) });
        }
        let fresh76 = unsafe { &mut ((*cur).arg1) };
        *fresh76 = 0 as *const xmlChar;
        if !(unsafe { (*cur).arg2 }).is_null() {
            (unsafe { xmlFree.expect("non-null function pointer")(
                (*cur).arg2 as *mut xmlChar as *mut libc::c_void,
            ) });
        }
        let fresh77 = unsafe { &mut ((*cur).arg2) };
        *fresh77 = 0 as *const xmlChar;
        (unsafe { (*cur).flags = 0 as i32 });
    }
}
extern "C" fn xmlRelaxNGDocumentPush(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
...
extern "C" fn xmlRelaxNGDocumentPop(mut ctxt: xmlRelaxNGParserCtxtPtr) -> xmlRelaxNGDocumentPtr {
...
extern "C" fn xmlRelaxNGLoadExternalRef(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
    mut URL: *const xmlChar,
    mut ns: *const xmlChar,
...
extern "C" fn xmlRelaxNGDefName(mut def: xmlRelaxNGDefinePtr) -> *const i8 {
    if def.is_null() {
...
extern "C" fn xmlRelaxNGShowValidError(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
    mut err: xmlRelaxNGValidErr,
    mut node: xmlNodePtr,
...
extern "C" fn xmlRelaxNGPopErrors(mut ctxt: xmlRelaxNGValidCtxtPtr, mut level: i32) {
    let mut i: i32 = 0;
    let mut err: xmlRelaxNGValidErrorPtr = 0 as *mut xmlRelaxNGValidError;
    i = level;
    while i < (unsafe { (*ctxt).errNr }) {
        err = (unsafe { &mut *((*ctxt).errTab).offset(i as isize) }) as *mut xmlRelaxNGValidError;
        if (unsafe { (*err).flags }) & 1 as i32 != 0 {
            if !(unsafe { (*err).arg1 }).is_null() {
                (unsafe { xmlFree.expect("non-null function pointer")(
                    (*err).arg1 as *mut xmlChar as *mut libc::c_void,
                ) });
            }
            let fresh93 = unsafe { &mut ((*err).arg1) };
            *fresh93 = 0 as *const xmlChar;
            if !(unsafe { (*err).arg2 }).is_null() {
                (unsafe { xmlFree.expect("non-null function pointer")(
                    (*err).arg2 as *mut xmlChar as *mut libc::c_void,
                ) });
            }
            let fresh94 = unsafe { &mut ((*err).arg2) };
            *fresh94 = 0 as *const xmlChar;
            (unsafe { (*err).flags = 0 as i32 });
        }
        i += 1;
    }
    (unsafe { (*ctxt).errNr = level });
    if (unsafe { (*ctxt).errNr }) <= 0 as i32 {
        let fresh95 = unsafe { &mut ((*ctxt).err) };
        *fresh95 = 0 as xmlRelaxNGValidErrorPtr;
    }
}
extern "C" fn xmlRelaxNGDumpValidError(mut ctxt: xmlRelaxNGValidCtxtPtr) {
    let mut i: i32 = 0;
    let mut j: i32 = 0;
    let mut k: i32 = 0;
    let mut err: xmlRelaxNGValidErrorPtr = 0 as *mut xmlRelaxNGValidError;
    ...
    while i < (unsafe { (*ctxt).errNr }) {
        ...
        if k < 5 as i32 {
            ...
            loop {
                ...
                dup = (unsafe { &mut *((*ctxt).errTab).offset(j as isize) }) as *mut xmlRelaxNGValidError;
                if (unsafe { (*err).err }) as u32 == (unsafe { (*dup).err }) as u32
                    && (unsafe { (*err).node }) == (unsafe { (*dup).node })
                    && (unsafe { xmlStrEqual((*err).arg1, (*dup).arg1) }) != 0
                    && (unsafe { xmlStrEqual((*err).arg2, (*dup).arg2) }) != 0
                {
        ...
        if (unsafe { (*err).flags }) & 1 as i32 != 0 {
            ...
            let fresh96 = unsafe { &mut ((*err).arg1) };
            *fresh96 = 0 as *const xmlChar;
            ...
            let fresh97 = unsafe { &mut ((*err).arg2) };
...
extern "C" fn xmlRelaxNGAddValidError(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
    mut err: xmlRelaxNGValidErr,
    mut arg1: *const xmlChar,
    mut arg2: *const xmlChar,
...
extern "C" fn xmlRelaxNGSchemaFreeValue(mut _data: *mut libc::c_void, mut value: *mut libc::c_void) {
...
extern "C" fn xmlRelaxNGDefaultTypeCheck(
    ...
    mut type_0: *const xmlChar,
    mut value: *const xmlChar,
    mut _result: *mut *mut libc::c_void,
...
extern "C" fn xmlRelaxNGDefaultTypeCompare(
    ...
    mut type_0: *const xmlChar,
    mut value1: *const xmlChar,
    mut _ctxt1: xmlNodePtr,
    mut _comp1: *mut libc::c_void,
    mut value2: *const xmlChar,
    mut _ctxt2: xmlNodePtr,
) -> i32 {
...
static mut xmlRelaxNGRegisteredTypes: xmlHashTablePtr = 0 as *const xmlHashTable as xmlHashTablePtr;
extern "C" fn xmlRelaxNGFreeTypeLibrary(
    mut payload: *mut libc::c_void,
    mut _namespace: *const xmlChar,
) {
...
extern "C" fn xmlRelaxNGRegisterTypeLibrary(
    ...
    if !(unsafe { xmlHashLookup(xmlRelaxNGRegisteredTypes, namespace) }).is_null() {
...
extern "C" fn xmlRelaxNGIsCompilable(mut def: xmlRelaxNGDefinePtr) -> i32 {
    let mut ret: i32 = -(1 as i32);
    if def.is_null() {
        return -(1 as i32);
    }
    ...
    match (unsafe { (*def).type_0 }) as i32 {
        20 => {
            if xmlRelaxNGIsCompilable(def) == 1 as i32 && (unsafe { (*def).depth }) as i32 != -(25 as i32) {
                let mut oldam: xmlAutomataPtr = unsafe { (*ctxt).am };
        ...
        4 => {
            ...
            {
                let mut oldam_0: xmlAutomataPtr = unsafe { (*ctxt).am };
                let mut oldstate_0: xmlAutomataStatePtr = unsafe { (*ctxt).state };
                (unsafe { (*def).depth = -(25 as i32) as i16 });
                list = unsafe { (*def).content };
                ...
                *fresh123 = oldam_0;
                ...
                let mut oldam_1: xmlAutomataPtr = unsafe { (*ctxt).am };
        ...
        14 => {
            let mut oldstate_1: xmlAutomataStatePtr = unsafe { (*ctxt).state };
            list = unsafe { (*def).content };
            while !list.is_null() {
                xmlRelaxNGCompile(ctxt, list);
                list = unsafe { (*list).next };
        ...
        17 => {
            ...
            let mut oldstate_4: xmlAutomataStatePtr = unsafe { (*ctxt).state };
            list = unsafe { (*def).content };
            while !list.is_null() {
...
extern "C" fn xmlRelaxNGTryCompile(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
    mut def: xmlRelaxNGDefinePtr,
) -> i32 {
    let mut ret: i32 = 0 as i32;
...
extern "C" fn xmlRelaxNGIsNullable(mut define: xmlRelaxNGDefinePtr) -> i32 {
    ...
    match (unsafe { (*define).type_0 }) as i32 {
        ...
        17 => {
            let mut list: xmlRelaxNGDefinePtr = unsafe { (*define).content };
            loop {
                if list.is_null() {
        ...
        20 | 19 | 18 => {
            let mut list_0: xmlRelaxNGDefinePtr = unsafe { (*define).content };
            loop {
                if list_0.is_null() {
...
extern "C" fn xmlRelaxNGIsBlank(mut str: *mut xmlChar) -> i32 {
    if str.is_null() {
        return 1 as i32;
    }
...
extern "C" fn xmlRelaxNGGetDataTypeLibrary(
    mut _ctxt: xmlRelaxNGParserCtxtPtr,
    mut node: xmlNodePtr,
) -> *mut xmlChar {
...
extern "C" fn xmlRelaxNGParseValue(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
    mut node: xmlNodePtr,
) -> xmlRelaxNGDefinePtr {
    ...
    if !type_0.is_null() {
        ...
        *fresh137 = library;
        lib = (unsafe { xmlHashLookup(xmlRelaxNGRegisteredTypes, library) }) as xmlRelaxNGTypeLibraryPtr;
        if lib.is_null() {
            xmlRngPErr(
                ctxt,
                node,
...
extern "C" fn xmlRelaxNGParseData(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
    mut node: xmlNodePtr,
) -> xmlRelaxNGDefinePtr {
    let mut def: xmlRelaxNGDefinePtr = 0 as xmlRelaxNGDefinePtr;
...
static mut invalidName: *const xmlChar = b"\x01\0" as *const u8 as *const i8 as *mut xmlChar;
...
extern "C" fn xmlRelaxNGCompareElemDefLists(
    mut _ctxt: xmlRelaxNGParserCtxtPtr,
...
extern "C" fn xmlRelaxNGGenerateAttributes(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
    mut def: xmlRelaxNGDefinePtr,
) -> i32 {
...
extern "C" fn xmlRelaxNGGetElements(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
    mut def: xmlRelaxNGDefinePtr,
    mut eora: i32,
...
extern "C" fn xmlRelaxNGCheckChoiceDeterminism(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
    mut def: xmlRelaxNGDefinePtr,
) {
    ...
    if is_nullable == 0 as i32 {
        triage = unsafe { xmlHashCreate(10 as i32) };
    } else {
        is_triable = 0 as i32;
    }
    cur = unsafe { (*def).content };
...
extern "C" fn xmlRelaxNGComputeInterleaves(
    ...
    let mut groups: *mut xmlRelaxNGInterleaveGroupPtr = 0 as *mut xmlRelaxNGInterleaveGroupPtr;
    let mut group: xmlRelaxNGInterleaveGroupPtr = 0 as *mut xmlRelaxNGInterleaveGroup;
    let mut i: i32 = 0;
    let mut j: i32 = 0;
    let mut ret: i32 = 0;
        ...
        match current_block {
            ...
            _ => {
                ...
                if !partitions.is_null() {
                    ...
                    *fresh171 = unsafe { xmlHashCreate(nbgroups) };
                    i = 0 as i32;
                    while i < nbgroups {
...
extern "C" fn xmlRelaxNGParseInterleave(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
    mut node: xmlNodePtr,
) -> xmlRelaxNGDefinePtr {
    let mut def: xmlRelaxNGDefinePtr = 0 as xmlRelaxNGDefinePtr;
    ...
    if (unsafe { (*ctxt).interleaves }).is_null() {
        ...
        *fresh175 = unsafe { xmlHashCreate(10 as i32) };
    }
    if (unsafe { (*ctxt).interleaves }).is_null() {
...
extern "C" fn xmlRelaxNGParseInclude(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
    mut node: xmlNodePtr,
) -> i32 {
...
extern "C" fn xmlRelaxNGParseDefine(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
    mut node: xmlNodePtr,
) -> i32 {
    let mut name: *mut xmlChar = 0 as *mut xmlChar;
    ...
    if name.is_null() {
        ...
        *fresh181 = name;
        ...
        if (unsafe { (*(*ctxt).grammar).defs }).is_null() {
            ...
            *fresh185 = unsafe { xmlHashCreate(10 as i32) };
        }
        if (unsafe { (*(*ctxt).grammar).defs }).is_null() {
            xmlRngPErr(
                ctxt,
            ...
            tmp = unsafe { xmlHashAddEntry((*(*ctxt).grammar).defs, name, def as *mut libc::c_void) };
            if tmp < 0 as i32 {
                let mut prev: xmlRelaxNGDefinePtr = 0 as *mut xmlRelaxNGDefine;
                prev = (unsafe { xmlHashLookup((*(*ctxt).grammar).defs, name) }) as xmlRelaxNGDefinePtr;
                if prev.is_null() {
                    xmlRngPErr(
                        ctxt,
                        node,
...
extern "C" fn xmlRelaxNGParseImportRef(
    ...
    *fresh187 = (*fresh187 as i32 | (1 as i32) << 8 as i32) as i16;
    tmp = unsafe { xmlHashAddEntry((*(*ctxt).grammar).refs, name, def as *mut libc::c_void) };
    if tmp < 0 as i32 {
        let mut prev: xmlRelaxNGDefinePtr = 0 as *mut xmlRelaxNGDefine;
        prev = (unsafe { xmlHashLookup((*(*ctxt).grammar).refs, (*def).name) }) as xmlRelaxNGDefinePtr;
        if prev.is_null() {
...
extern "C" fn xmlRelaxNGParseImportRefs(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
    ...
    if (unsafe { (*(*ctxt).grammar).refs }).is_null() {
        ...
        *fresh190 = unsafe { xmlHashCreate(10 as i32) };
    }
    if (unsafe { (*(*ctxt).grammar).refs }).is_null() {
        xmlRngPErr(
            ctxt,
...
extern "C" fn xmlRelaxNGProcessExternalRef(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
    mut node: xmlNodePtr,
) -> xmlRelaxNGDefinePtr {
...
extern "C" fn xmlRelaxNGParsePattern(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
    mut node: xmlNodePtr,
) -> xmlRelaxNGDefinePtr {
    let mut def: xmlRelaxNGDefinePtr = 0 as xmlRelaxNGDefinePtr;
        ...
        && (unsafe { xmlStrEqual((*(*node).ns).href, xmlRelaxNGNs) }) != 0
    {
        ...
        *fresh199 = unsafe { xmlGetProp(
        ...
        if (unsafe { (*(*ctxt).grammar).refs }).is_null() {
            ...
            *fresh200 = unsafe { xmlHashCreate(10 as i32) };
        }
        if (unsafe { (*(*ctxt).grammar).refs }).is_null() {
            xmlRngPErr(
                ctxt,
        ...
        && (unsafe { xmlStrEqual((*(*node).ns).href, xmlRelaxNGNs) }) != 0
    {
        ...
        *fresh207 = unsafe { xmlGetProp(
        ...
        if (unsafe { (*(*ctxt).parentgrammar).refs }).is_null() {
            ...
            *fresh208 = unsafe { xmlHashCreate(10 as i32) };
        }
        if (unsafe { (*(*ctxt).parentgrammar).refs }).is_null() {
            xmlRngPErr(
                ctxt,
            ...
            if tmp_0 < 0 as i32 {
                ...
                prev_0 = (unsafe { xmlHashLookup((*(*ctxt).parentgrammar).refs, (*def).name) })
                    as xmlRelaxNGDefinePtr;
                if prev_0.is_null() {
                    xmlRngPErr(
                        ctxt,
...
extern "C" fn xmlRelaxNGParseAttribute(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
    mut node: xmlNodePtr,
) -> xmlRelaxNGDefinePtr {
    let mut ret: xmlRelaxNGDefinePtr = 0 as *mut xmlRelaxNGDefine;
...
extern "C" fn xmlRelaxNGParseExceptNameClass(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
    mut node: xmlNodePtr,
    mut attr: i32,
) -> xmlRelaxNGDefinePtr {
...
extern "C" fn xmlRelaxNGParseNameClass(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
    mut node: xmlNodePtr,
    mut def: xmlRelaxNGDefinePtr,
) -> xmlRelaxNGDefinePtr {
...
extern "C" fn xmlRelaxNGParseElement(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
    mut node: xmlNodePtr,
) -> xmlRelaxNGDefinePtr {
    let mut ret: xmlRelaxNGDefinePtr = 0 as *mut xmlRelaxNGDefine;
...
extern "C" fn xmlRelaxNGParsePatterns(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
...
extern "C" fn xmlRelaxNGParseStart(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
    mut nodes: xmlNodePtr,
) -> i32 {
    let mut ret: i32 = 0 as i32;
...
extern "C" fn xmlRelaxNGParseGrammarContent(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
    mut nodes: xmlNodePtr,
) -> i32 {
    let mut ret: i32 = 0 as i32;
...
extern "C" fn xmlRelaxNGCheckReference(
    ...
    if !(unsafe { (*grammar).defs }).is_null() {
        def = (unsafe { xmlHashLookup((*grammar).defs, name) }) as xmlRelaxNGDefinePtr;
        if !def.is_null() {
            cur = ref_0;
            while !cur.is_null() {
    ...
    *fresh255 = cur;
    if choiceOrInterleave == 0 as i32 {
        if (unsafe { (*ctxt).interleaves }).is_null() {
            ...
            *fresh256 = unsafe { xmlHashCreate(10 as i32) };
        }
        if (unsafe { (*ctxt).interleaves }).is_null() {
            xmlRngPErr(
                ctxt,
...
extern "C" fn xmlRelaxNGCombineStart(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
    mut grammar: xmlRelaxNGGrammarPtr,
) {
    ...
    *fresh260 = cur;
    if choiceOrInterleave == 0 as i32 {
        if (unsafe { (*ctxt).interleaves }).is_null() {
            ...
            *fresh261 = unsafe { xmlHashCreate(10 as i32) };
        }
        if (unsafe { (*ctxt).interleaves }).is_null() {
            xmlRngPErr(
                ctxt,
...
extern "C" fn xmlRelaxNGCheckCycles(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
...
extern "C" fn xmlRelaxNGTryUnlink(
    mut _ctxt: xmlRelaxNGParserCtxtPtr,
    mut cur: xmlRelaxNGDefinePtr,
...
extern "C" fn xmlRelaxNGSimplify(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
    mut cur: xmlRelaxNGDefinePtr,
    mut parent: xmlRelaxNGDefinePtr,
) {
...
extern "C" fn xmlRelaxNGCheckRules(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
    mut cur: xmlRelaxNGDefinePtr,
    mut flags: i32,
...
extern "C" fn xmlRelaxNGParseGrammar(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
    mut nodes: xmlNodePtr,
...
extern "C" fn xmlRelaxNGParseDocument(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
    mut node: xmlNodePtr,
) -> xmlRelaxNGPtr {
...
#[no_mangle]
pub extern "C" fn xmlRelaxNGNewParserCtxt(mut URL: *const i8) -> xmlRelaxNGParserCtxtPtr {
    ...
    *fresh298 = unsafe { *__xmlGenericError() };
    let fresh299 = unsafe { &mut ((*ret).userData) };
    *fresh299 = unsafe { *__xmlGenericErrorContext() };
    return ret;
}
#[no_mangle]
pub extern "C" fn xmlRelaxNGNewMemParserCtxt(
    mut buffer: *const i8,
    mut size: i32,
    ...
    *fresh301 = unsafe { *__xmlGenericError() };
    let fresh302 = unsafe { &mut ((*ret).userData) };
    *fresh302 = unsafe { *__xmlGenericErrorContext() };
    return ret;
}
#[no_mangle]
pub extern "C" fn xmlRelaxNGNewDocParserCtxt(mut doc: xmlDocPtr) -> xmlRelaxNGParserCtxtPtr {
    let mut ret: xmlRelaxNGParserCtxtPtr = 0 as *mut xmlRelaxNGParserCtxt;
    ...
    *fresh304 = unsafe { *__xmlGenericErrorContext() };
    return ret;
}
#[no_mangle]
pub extern "C" fn xmlRelaxNGFreeParserCtxt(mut ctxt: xmlRelaxNGParserCtxtPtr) {
    if ctxt.is_null() {
        return;
    }
    ...
    if !(unsafe { (*ctxt).interleaves }).is_null() {
        (unsafe { xmlHashFree((*ctxt).interleaves, None) });
    }
...
extern "C" fn xmlRelaxNGNormExtSpace(mut value: *mut xmlChar) {
...
extern "C" fn xmlRelaxNGCleanupAttributes(mut ctxt: xmlRelaxNGParserCtxtPtr, mut node: xmlNodePtr) {
...
extern "C" fn xmlRelaxNGCleanupTree(mut ctxt: xmlRelaxNGParserCtxtPtr, mut root: xmlNodePtr) {
    let mut current_block: u64;
    let mut cur: xmlNodePtr = 0 as *mut xmlNode;
...
extern "C" fn xmlRelaxNGCleanupDoc(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
    mut doc: xmlDocPtr,
) -> xmlDocPtr {
    let mut root: xmlNodePtr = 0 as *mut xmlNode;
...
#[no_mangle]
pub extern "C" fn xmlRelaxNGParse(mut ctxt: xmlRelaxNGParserCtxtPtr) -> xmlRelaxNGPtr {
    ...
    if !(unsafe { (*ctxt).URL }).is_null() {
        doc = unsafe { xmlReadFile((*ctxt).URL as *const i8, 0 as *const i8, 0 as i32) };
        if doc.is_null() {
            xmlRngPErr(
                ctxt,
                0 as xmlNodePtr,
...
#[no_mangle]
pub extern "C" fn xmlRelaxNGSetParserErrors(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
...
#[no_mangle]
pub extern "C" fn xmlRelaxNGGetParserErrors(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
    ...
    if !err.is_null() {
        (unsafe { *err = (*ctxt).error });
    }
    if !warn.is_null() {
        (unsafe { *warn = (*ctxt).warning });
    }
    if !ctx.is_null() {
        (unsafe { *ctx = (*ctxt).userData });
    }
    return 0 as i32;
}
#[no_mangle]
pub extern "C" fn xmlRelaxNGSetParserStructuredErrors(
    mut ctxt: xmlRelaxNGParserCtxtPtr,
    ...
    let fresh334 = unsafe { &mut ((*ctxt).serror) };
    *fresh334 = serror;
    let fresh335 = unsafe { &mut ((*ctxt).error) };
    *fresh335 = None;
    let fresh336 = unsafe { &mut ((*ctxt).warning) };
    *fresh336 = None;
    let fresh337 = unsafe { &mut ((*ctxt).userData) };
    *fresh337 = ctx;
}
extern "C" fn xmlRelaxNGDumpDefines(mut output: *mut FILE, mut defines: xmlRelaxNGDefinePtr) {
    while !defines.is_null() {
        xmlRelaxNGDumpDefine(output, defines);
        defines = unsafe { (*defines).next };
    }
}
extern "C" fn xmlRelaxNGDumpDefine(mut output: *mut FILE, mut define: xmlRelaxNGDefinePtr) {
    if define.is_null() {
        return;
    }
    match (unsafe { (*define).type_0 }) as i32 {
...
extern "C" fn xmlRelaxNGDumpGrammar(
    mut output: *mut FILE,
    mut grammar: xmlRelaxNGGrammarPtr,
    mut top: i32,
) {
...
#[no_mangle]
pub extern "C" fn xmlRelaxNGDump(mut output: *mut FILE, mut schema: xmlRelaxNGPtr) {
    if output.is_null() {
        return;
    }
    if schema.is_null() {
    ...
    } else if !(unsafe { (*(*schema).doc).URL }).is_null() {
        (unsafe { fprintf(
            output,
            b"%s\n\0" as *const u8 as *const i8,
            (*(*schema).doc).URL,
    ...
    xmlRelaxNGDumpGrammar(output, unsafe { (*schema).topgrammar }, 1 as i32);
}
#[no_mangle]
pub extern "C" fn xmlRelaxNGDumpTree(mut output: *mut FILE, mut schema: xmlRelaxNGPtr) {
    if output.is_null() {
        return;
    }
    if schema.is_null() {
    ...
    if (unsafe { (*schema).doc }).is_null() {
        ...
        (unsafe { xmlDocDump(output, (*schema).doc) });
    };
}
extern "C" fn xmlRelaxNGValidateCompiledCallback(
    mut _exec: xmlRegExecCtxtPtr,
...
extern "C" fn xmlRelaxNGValidateCompiledContent(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
...
extern "C" fn xmlRelaxNGElemPush(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
...
extern "C" fn xmlRelaxNGElemPop(mut ctxt: xmlRelaxNGValidCtxtPtr) -> xmlRegExecCtxtPtr {
...
#[no_mangle]
pub extern "C" fn xmlRelaxNGValidatePushElement(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
    mut _doc: xmlDocPtr,
    mut elem: xmlNodePtr,
) -> i32 {
...
#[no_mangle]
pub extern "C" fn xmlRelaxNGValidatePushCData(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
    mut data: *const xmlChar,
    mut _len: i32,
) -> i32 {
    let mut ret: i32 = 1 as i32;
    if ctxt.is_null() || (unsafe { (*ctxt).elem }).is_null() || data.is_null() {
        return -(1 as i32);
    }
    while (unsafe { *data }) as i32 != 0 as i32 {
        if !((unsafe { *data }) as i32 == 0x20 as i32
            || 0x9 as i32 <= (unsafe { *data }) as i32 && (unsafe { *data }) as i32 <= 0xa as i32
            || (unsafe { *data }) as i32 == 0xd as i32)
        {
            break;
        }
        data = unsafe { data.offset(1) };
    }
    if (unsafe { *data }) as i32 == 0 as i32 {
        return 1 as i32;
    }
    ret = unsafe { xmlRegExecPushString(
        (*ctxt).elem,
...
#[no_mangle]
pub extern "C" fn xmlRelaxNGValidatePopElement(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
    mut _doc: xmlDocPtr,
    mut elem: xmlNodePtr,
) -> i32 {
    let mut ret: i32 = 0;
    let mut exec: xmlRegExecCtxtPtr = 0 as *mut xmlRegExecCtxt;
    if ctxt.is_null() || (unsafe { (*ctxt).elem }).is_null() || elem.is_null() {
        return -(1 as i32);
    }
...
#[no_mangle]
pub extern "C" fn xmlRelaxNGValidateFullElement(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
    mut _doc: xmlDocPtr,
    mut elem: xmlNodePtr,
) -> i32 {
...
extern "C" fn xmlRelaxNGSkipIgnored(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
    mut node: xmlNodePtr,
) -> xmlNodePtr {
    while !node.is_null()
...
extern "C" fn xmlRelaxNGNormalize(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
...
extern "C" fn xmlRelaxNGValidateDatatype(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
    mut value: *const xmlChar,
...
extern "C" fn xmlRelaxNGNextValue(mut ctxt: xmlRelaxNGValidCtxtPtr) -> i32 {
...
extern "C" fn xmlRelaxNGValidateValueList(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
...
extern "C" fn xmlRelaxNGValidateValue(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
    mut define: xmlRelaxNGDefinePtr,
) -> i32 {
    let mut ret: i32 = 0 as i32;
...
extern "C" fn xmlRelaxNGValidateValueContent(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
    mut defines: xmlRelaxNGDefinePtr,
) -> i32 {
    let mut ret: i32 = 0 as i32;
...
extern "C" fn xmlRelaxNGAttributeMatch(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
    mut define: xmlRelaxNGDefinePtr,
    mut prop: xmlAttrPtr,
) -> i32 {
...
extern "C" fn xmlRelaxNGValidateAttribute(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
    mut define: xmlRelaxNGDefinePtr,
) -> i32 {
    let mut ret: i32 = 0 as i32;
...
extern "C" fn xmlRelaxNGValidateAttributeList(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
    mut defines: xmlRelaxNGDefinePtr,
) -> i32 {
    let mut ret: i32 = 0 as i32;
...
extern "C" fn xmlRelaxNGValidateInterleave(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
    mut define: xmlRelaxNGDefinePtr,
) -> i32 {
    let mut current_block: u64;
        ...
        *fresh399 = cur;
        if !(unsafe { (*partitions).triage }).is_null() && (unsafe { (*partitions).flags }) & 1 as i32 != 0 {
                ...
                || (unsafe { (*cur).type_0 }) as u32 == XML_CDATA_SECTION_NODE as i32 as u32
            {
                ...
                if !(unsafe { (*cur).ns }).is_null() {
                    tmp = unsafe { xmlHashLookup2((*partitions).triage, (*cur).name, (*(*cur).ns).href) };
                    if tmp.is_null() {
                        tmp = unsafe { xmlHashLookup2(
                            (*partitions).triage,
                            b"#any\0" as *const u8 as *const i8 as *mut xmlChar,
                    ...
                    tmp = unsafe { xmlHashLookup2((*partitions).triage, (*cur).name, 0 as *const xmlChar) };
                }
                if tmp.is_null() {
                    tmp = unsafe { xmlHashLookup2(
                        (*partitions).triage,
...
extern "C" fn xmlRelaxNGValidateDefinitionList(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
    mut defines: xmlRelaxNGDefinePtr,
) -> i32 {
    let mut ret: i32 = 0 as i32;
...
extern "C" fn xmlRelaxNGElementMatch(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
    mut define: xmlRelaxNGDefinePtr,
    mut elem: xmlNodePtr,
) -> i32 {
...
extern "C" fn xmlRelaxNGBestState(mut ctxt: xmlRelaxNGValidCtxtPtr) -> i32 {
    let mut state: xmlRelaxNGValidStatePtr = 0 as *mut xmlRelaxNGValidState;
    let mut i: i32 = 0;
    let mut tmp: i32 = 0;
    let mut best: i32 = -(1 as i32);
...
extern "C" fn xmlRelaxNGLogBestError(mut ctxt: xmlRelaxNGValidCtxtPtr) {
    let mut best: i32 = 0;
    if ctxt.is_null() || (unsafe { (*ctxt).states }).is_null() || (unsafe { (*(*ctxt).states).nbState }) <= 0 as i32 {
        return;
    }
...
extern "C" fn xmlRelaxNGValidateElementEnd(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
    mut dolog: i32,
) -> i32 {
    let mut i: i32 = 0;
...
extern "C" fn xmlRelaxNGValidateState(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
    mut define: xmlRelaxNGDefinePtr,
) -> i32 {
    let mut node: xmlNodePtr = 0 as *mut xmlNode;
    ...
    match (unsafe { (*define).type_0 }) as i32 {
        ...
        4 => {
            ...
            if node.is_null() {
                ...
                *fresh422 = xmlRelaxNGSkipIgnored(ctxt, unsafe { (*node).next });
                ...
                if (unsafe { (*ctxt).errNr }) != 0 as i32 {
                    while !(unsafe { (*ctxt).err }).is_null()
                        && ((unsafe { (*(*ctxt).err).err }) as u32 == XML_RELAXNG_ERR_ELEMNAME as i32 as u32
                            && (unsafe { xmlStrEqual((*(*ctxt).err).arg2, (*node).name) }) != 0
                            || (unsafe { (*(*ctxt).err).err }) as u32
                                == XML_RELAXNG_ERR_ELEMEXTRANS as i32 as u32
                                && (unsafe { xmlStrEqual((*(*ctxt).err).arg1, (*node).name) }) != 0
                            || (unsafe { (*(*ctxt).err).err }) as u32 == XML_RELAXNG_ERR_NOELEM as i32 as u32
                            || (unsafe { (*(*ctxt).err).err }) as u32 == XML_RELAXNG_ERR_NOTELEM as i32 as u32)
                    {
                    ...
                    if state.is_null() {
                        ...
                        *fresh423 = state;
                        ...
                        if !(unsafe { (*define).contModel }).is_null() {
                            ...
                            let mut tmpstate: xmlRelaxNGValidStatePtr = unsafe { (*ctxt).state };
                            let mut tmpstates: xmlRelaxNGStatesPtr = unsafe { (*ctxt).states };
        ...
        17 => {
            ...
            if (unsafe { (*define).dflags }) as i32 & (1 as i32) << 4 as i32 != 0
                ...
                && !node.is_null()
            {
                let mut triage: xmlHashTablePtr = (unsafe { (*define).data }) as xmlHashTablePtr;
                if (unsafe { (*node).type_0 }) as u32 == XML_TEXT_NODE as i32 as u32
                    || (unsafe { (*node).type_0 }) as u32 == XML_CDATA_SECTION_NODE as i32 as u32
                {
                    list = (unsafe { xmlHashLookup2(
                        triage,
                        b"#text\0" as *const u8 as *const i8 as *mut xmlChar,
                        0 as *const xmlChar,
                    ) }) as xmlRelaxNGDefinePtr;
                    ...
                    if !(unsafe { (*node).ns }).is_null() {
                        list = (unsafe { xmlHashLookup2(triage, (*node).name, (*(*node).ns).href) })
                            as xmlRelaxNGDefinePtr;
                        if list.is_null() {
                            list = (unsafe { xmlHashLookup2(
                                triage,
                        ...
                        list = (unsafe { xmlHashLookup2(triage, (*node).name, 0 as *const xmlChar) })
                            as xmlRelaxNGDefinePtr;
                    }
                    if list.is_null() {
                        list = (unsafe { xmlHashLookup2(
...
extern "C" fn xmlRelaxNGValidateDefinition(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
    mut define: xmlRelaxNGDefinePtr,
) -> i32 {
...
extern "C" fn xmlRelaxNGValidateDocument(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
    mut doc: xmlDocPtr,
) -> i32 {
    let mut ret: i32 = 0;
...
extern "C" fn xmlRelaxNGCleanPSVI(mut node: xmlNodePtr) {
    let mut cur: xmlNodePtr = 0 as *mut xmlNode;
    if node.is_null()
        || (unsafe { (*node).type_0 }) as u32 != XML_ELEMENT_NODE as i32 as u32
...
#[no_mangle]
pub extern "C" fn xmlRelaxNGNewValidCtxt(mut schema: xmlRelaxNGPtr) -> xmlRelaxNGValidCtxtPtr {
    ...
    *fresh497 = unsafe { *__xmlGenericError() };
    let fresh498 = unsafe { &mut ((*ret).userData) };
    *fresh498 = unsafe { *__xmlGenericErrorContext() };
    (unsafe { (*ret).errNr = 0 as i32 });
    (unsafe { (*ret).errMax = 0 as i32 });
    let fresh499 = unsafe { &mut ((*ret).err) };
...
#[no_mangle]
pub extern "C" fn xmlRelaxNGFreeValidCtxt(mut ctxt: xmlRelaxNGValidCtxtPtr) {
    let mut k: i32 = 0;
    if ctxt.is_null() {
        return;
    }
...
#[no_mangle]
pub extern "C" fn xmlRelaxNGSetValidErrors(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
    mut err: xmlRelaxNGValidityErrorFunc,
    mut warn: xmlRelaxNGValidityWarningFunc,
    mut ctx: *mut libc::c_void,
...
#[no_mangle]
pub extern "C" fn xmlRelaxNGSetValidStructuredErrors(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
    mut serror: xmlStructuredErrorFunc,
    mut ctx: *mut libc::c_void,
) {
    ...
    let fresh508 = unsafe { &mut ((*ctxt).serror) };
    *fresh508 = serror;
    let fresh509 = unsafe { &mut ((*ctxt).error) };
    *fresh509 = None;
    let fresh510 = unsafe { &mut ((*ctxt).warning) };
    *fresh510 = None;
    let fresh511 = unsafe { &mut ((*ctxt).userData) };
    *fresh511 = ctx;
}
#[no_mangle]
pub extern "C" fn xmlRelaxNGGetValidErrors(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
    mut err: *mut xmlRelaxNGValidityErrorFunc,
    mut warn: *mut xmlRelaxNGValidityWarningFunc,
    mut ctx: *mut *mut libc::c_void,
...
#[no_mangle]
pub extern "C" fn xmlRelaxNGValidateDoc(
    mut ctxt: xmlRelaxNGValidCtxtPtr,
    mut doc: xmlDocPtr,
) -> i32 {
    let mut ret: i32 = 0;
