...
extern "C" fn htmlErrMemory(mut ctxt: xmlParserCtxtPtr, mut extra: *const i8) {
    if !ctxt.is_null()
...
extern "C" fn htmlnamePush(mut ctxt: htmlParserCtxtPtr, mut value: *const xmlChar) -> i32 {
...
extern "C" fn htmlnamePop(mut ctxt: htmlParserCtxtPtr) -> *const xmlChar {
...
extern "C" fn htmlNodeInfoPush(
    ...
    (unsafe { *((*ctxt).nodeInfoTab).offset((*ctxt).nodeInfoNr as isize) = *value });
...
extern "C" fn htmlNodeInfoPop(mut ctxt: htmlParserCtxtPtr) -> *mut htmlParserNodeInfo {
    ...
    *fresh13 -= 1;
    ...
    return (unsafe { &mut *((*ctxt).nodeInfoTab).offset((*ctxt).nodeInfoNr as isize) })
        as *mut xmlParserNodeInfo;
}
extern "C" fn htmlFindEncoding(mut ctxt: xmlParserCtxtPtr) -> *mut xmlChar {
...
extern "C" fn htmlCurrentChar(mut ctxt: xmlParserCtxtPtr, mut len: *mut i32) -> i32 {
    ...
    if (unsafe { (*ctxt).charset }) != XML_CHAR_ENCODING_UTF8 as i32 {
        ...
        if guess.is_null() {
            (unsafe { xmlSwitchEncoding(ctxt, XML_CHAR_ENCODING_8859_1) });
        } else {
            ...
            *fresh16 = guess;
            handler = unsafe { xmlFindCharEncodingHandler(guess as *const i8) };
            if !handler.is_null() {
                ...
                {
                    (unsafe { xmlSwitchToEncoding(ctxt, handler) });
                }
            } else {
                htmlParseErr(
                    ctxt,
...
extern "C" fn htmlSkipBlankChars(mut ctxt: xmlParserCtxtPtr) -> i32 {
    ...
    {
        if (unsafe { *(*(*ctxt).input).cur }) as i32 == 0 as i32
            && (unsafe { xmlParserInputGrow((*ctxt).input, 250 as i32) }) <= 0 as i32
        {
...
#[no_mangle]
pub extern "C" fn htmlTagLookup(mut tag: *const xmlChar) -> *const htmlElemDesc {
    if tag.is_null() {
...
extern "C" fn htmlGetEndPriority(mut name: *const xmlChar) -> i32 {
...
extern "C" fn htmlCheckAutoClose(mut newtag: *const xmlChar, mut oldtag: *const xmlChar) -> i32 {
...
extern "C" fn htmlAutoCloseOnClose(mut ctxt: htmlParserCtxtPtr, mut newtag: *const xmlChar) {
...
extern "C" fn htmlAutoCloseOnEnd(mut ctxt: htmlParserCtxtPtr) {
    let mut i: i32 = 0;
    if (unsafe { (*ctxt).nameNr }) == 0 as i32 {
        return;
    }
...
extern "C" fn htmlAutoClose(mut ctxt: htmlParserCtxtPtr, mut newtag: *const xmlChar) {
...
#[no_mangle]
pub extern "C" fn htmlAutoCloseTag(
    mut doc: htmlDocPtr,
...
#[no_mangle]
pub extern "C" fn htmlIsAutoClosed(mut doc: htmlDocPtr, mut elem: htmlNodePtr) -> i32 {
    let mut child: htmlNodePtr = 0 as *mut xmlNode;
    if elem.is_null() {
        return 1 as i32;
    }
    child = unsafe { (*elem).children };
    while !child.is_null() {
        if htmlAutoCloseTag(doc, unsafe { (*elem).name }, child) != 0 {
            return 1 as i32;
        }
        child = unsafe { (*child).next };
    }
...
extern "C" fn htmlCheckImplied(mut ctxt: htmlParserCtxtPtr, mut newtag: *const xmlChar) {
    let mut i: i32 = 0;
...
extern "C" fn htmlCheckParagraph(mut ctxt: htmlParserCtxtPtr) -> i32 {
...
#[no_mangle]
pub extern "C" fn htmlIsScriptAttribute(mut name: *const xmlChar) -> i32 {
    let mut i: u32 = 0;
    if name.is_null() {
        return 0 as i32;
    }
...
#[no_mangle]
pub extern "C" fn htmlEntityLookup(mut name: *const xmlChar) -> *const htmlEntityDesc {
    let mut i: u32 = 0;
    i = 0 as i32 as u32;
    while (i as u64)
            ...
            .wrapping_div(::std::mem::size_of::<htmlEntityDesc>() as u64)
    {
        if (unsafe { xmlStrEqual(name, html40EntitiesTable[i as usize].name as *mut xmlChar) }) != 0 {
            return (unsafe { &*html40EntitiesTable.as_ptr().offset(i as isize) }) as *const htmlEntityDesc
...
#[no_mangle]
pub extern "C" fn htmlEntityValueLookup(mut value: u32) -> *const htmlEntityDesc {
    let mut i: u32 = 0;
    i = 0 as i32 as u32;
    while (i as u64)
        < (::std::mem::size_of::<[htmlEntityDesc; 253]>() as u64)
...
#[no_mangle]
pub extern "C" fn htmlEncodeEntities(
    mut out: *mut u8,
    mut outlen: *mut i32,
    mut in_0: *const u8,
    mut inlen: *mut i32,
...
extern "C" fn htmlNewInputStream(mut ctxt: htmlParserCtxtPtr) -> htmlParserInputPtr {
...
extern "C" fn areBlanks(mut ctxt: htmlParserCtxtPtr, mut str: *const xmlChar, mut len: i32) -> i32 {
    let mut i: u32 = 0;
    let mut j: i32 = 0;
...
extern "C" fn htmlSkipBogusComment(mut ctxt: htmlParserCtxtPtr) {
    let mut c: i32 = 0;
    htmlParseErr(
        ctxt,
...
extern "C" fn htmlParseHTMLName(mut ctxt: htmlParserCtxtPtr) -> *const xmlChar {
    let mut i: i32 = 0 as i32;
    ...
    return unsafe { xmlDictLookup((*ctxt).dict, loc.as_mut_ptr(), i) };
}
extern "C" fn htmlParseHTMLName_nonInvasive(mut ctxt: htmlParserCtxtPtr) -> *const xmlChar {
    let mut i: i32 = 0 as i32;
    let mut loc: [xmlChar; 100] = [0; 100];
...
extern "C" fn htmlParseName(mut ctxt: htmlParserCtxtPtr) -> *const xmlChar {
...
extern "C" fn htmlParseNameComplex(mut ctxt: xmlParserCtxtPtr) -> *const xmlChar {
    let mut len: i32 = 0 as i32;
    let mut l: i32 = 0;
    let mut c: i32 = 0;
    let mut count: i32 = 0 as i32;
    let mut base: *const xmlChar = unsafe { (*(*ctxt).input).base };
    if (unsafe { (*ctxt).progressive }) == 0 as i32
        && ((unsafe { ((*(*ctxt).input).end).offset_from((*(*ctxt).input).cur) }) as i64) < 250 as i32 as i64
    {
        (unsafe { xmlParserInputGrow((*ctxt).input, 250 as i32) });
...
extern "C" fn htmlParseHTMLAttribute(mut ctxt: htmlParserCtxtPtr, stop: xmlChar) -> *mut xmlChar {
...
#[no_mangle]
pub extern "C" fn htmlParseEntityRef(
    mut ctxt: htmlParserCtxtPtr,
...
extern "C" fn htmlParseAttValue(mut ctxt: htmlParserCtxtPtr) -> *mut xmlChar {
...
extern "C" fn htmlParseSystemLiteral(mut ctxt: htmlParserCtxtPtr) -> *mut xmlChar {
...
extern "C" fn htmlParsePubidLiteral(mut ctxt: htmlParserCtxtPtr) -> *mut xmlChar {
    let mut len: size_t = 0 as i32 as size_t;
    let mut startPosition: size_t = 0 as i32 as size_t;
    let mut err: i32 = 0 as i32;
    let mut quote: i32 = 0;
...
extern "C" fn htmlParseScript(mut ctxt: htmlParserCtxtPtr) {
    ...
    while cur != 0 as i32 {
        ...
        } != 0
        {
            if l == 1 as i32 {
                ...
                nbchar += unsafe { xmlCopyChar(l, &mut *buf.as_mut_ptr().offset(nbchar as isize), cur) };
            }
        } else {
            htmlParseErrInt(
                ctxt,
...
extern "C" fn htmlParseCharDataInternal(mut ctxt: htmlParserCtxtPtr, mut readahead: i32) {
...
extern "C" fn htmlParseCharData(mut ctxt: htmlParserCtxtPtr) {
    htmlParseCharDataInternal(ctxt, 0 as i32);
}
extern "C" fn htmlParseExternalID(
    mut ctxt: htmlParserCtxtPtr,
...
extern "C" fn htmlParsePI(mut ctxt: htmlParserCtxtPtr) {
            ...
            while cur != 0 as i32 && cur != '>' as i32 {
                ...
                } != 0
                {
                    if l == 1 as i32 {
                        ...
                        len += unsafe { xmlCopyChar(l, &mut *buf.offset(len as isize), cur) };
                    }
                } else {
                    htmlParseErrInt(
                        ctxt,
...
extern "C" fn htmlParseComment(mut ctxt: htmlParserCtxtPtr) {
    let mut current_block: u64;
    let mut buf: *mut xmlChar = 0 as *mut xmlChar;
    let mut len: i32 = 0;
    let mut size: i32 = 100 as i32;
                            ...
                            && next == '>' as i32
                        {
                            ...
                            } != 0
                            {
                                if ql == 1 as i32 {
                                    ...
                                    len += unsafe { xmlCopyChar(ql, &mut *buf.offset(len as isize), q) };
                                }
                            } else {
                                htmlParseErrInt(
                                    ctxt,
...
#[no_mangle]
pub extern "C" fn htmlParseCharRef(mut ctxt: htmlParserCtxtPtr) -> i32 {
...
extern "C" fn htmlParseDocTypeDecl(mut ctxt: htmlParserCtxtPtr) {
    let mut name: *const xmlChar = 0 as *const xmlChar;
...
extern "C" fn htmlParseAttribute(
    mut ctxt: htmlParserCtxtPtr,
...
extern "C" fn htmlCheckEncodingDirect(mut ctxt: htmlParserCtxtPtr, mut encoding: *const xmlChar) {
    ...
    if !encoding.is_null() {
        ...
        *fresh106 = unsafe { xmlStrdup(encoding) };
            ...
            && !(unsafe { (*(*(*ctxt).input).buf).buffer }).is_null()
        {
            ...
            (unsafe { xmlBufShrink((*(*(*ctxt).input).buf).buffer, processed as size_t) });
            nbchars = unsafe { xmlCharEncInput((*(*ctxt).input).buf, 1 as i32) };
            (unsafe { xmlBufResetInput((*(*(*ctxt).input).buf).buffer, (*ctxt).input) });
            if nbchars < 0 as i32 {
                htmlParseErr(
                    ctxt,
                    XML_ERR_INVALID_ENCODING,
...
extern "C" fn htmlCheckEncoding(mut ctxt: htmlParserCtxtPtr, mut attvalue: *const xmlChar) {
...
extern "C" fn htmlCheckMeta(mut ctxt: htmlParserCtxtPtr, mut atts: *mut *const xmlChar) {
    let mut i: i32 = 0;
...
extern "C" fn htmlParseStartTag(mut ctxt: htmlParserCtxtPtr) -> i32 {
    let mut current_block: u64;
    let mut name: *const xmlChar = 0 as *const xmlChar;
...
extern "C" fn htmlParseEndTag(mut ctxt: htmlParserCtxtPtr) -> i32 {
    let mut name: *const xmlChar = 0 as *const xmlChar;
...
extern "C" fn htmlParseReference(mut ctxt: htmlParserCtxtPtr) {
    let mut ent: *const htmlEntityDesc = 0 as *const htmlEntityDesc;
    ...
    if (unsafe { *((*(*ctxt).input).cur).offset(1 as i32 as isize) }) as i32 == '#' as i32 {
        ...
        if ent.is_null() || !((unsafe { (*ent).value }) > 0 as i32 as u32) {
            htmlCheckParagraph(ctxt);
            if !(unsafe { (*ctxt).sax }).is_null() && (unsafe { ((*(*ctxt).sax).characters).is_some() }) {
                (unsafe { ((*(*ctxt).sax).characters).expect("non-null function pointer")(
                    (*ctxt).userData,
...
extern "C" fn htmlParseContent(mut ctxt: htmlParserCtxtPtr) {
...
#[no_mangle]
pub extern "C" fn htmlParseElement(mut ctxt: htmlParserCtxtPtr) {
    let mut name: *const xmlChar = 0 as *const xmlChar;
    let mut currentNode: *mut xmlChar = 0 as *mut xmlChar;
    let mut info: *const htmlElemDesc = 0 as *const htmlElemDesc;
...
extern "C" fn htmlParserFinishElementParsing(mut ctxt: htmlParserCtxtPtr) {
...
extern "C" fn htmlParseElementInternal(mut ctxt: htmlParserCtxtPtr) {
    let mut name: *const xmlChar = 0 as *const xmlChar;
    let mut info: *const htmlElemDesc = 0 as *const htmlElemDesc;
...
extern "C" fn htmlParseContentInternal(mut ctxt: htmlParserCtxtPtr) {
    let mut currentNode: *mut xmlChar = 0 as *mut xmlChar;
    let mut depth: i32 = 0;
    let mut name: *const xmlChar = 0 as *const xmlChar;
    currentNode = unsafe { xmlStrdup((*ctxt).name) };
...
#[no_mangle]
pub extern "C" fn __htmlParseContent(mut ctxt: *mut libc::c_void) {
    if !ctxt.is_null() {
        htmlParseContentInternal(ctxt as htmlParserCtxtPtr);
    }
}
#[no_mangle]
pub extern "C" fn htmlParseDocument(mut ctxt: htmlParserCtxtPtr) -> i32 {
...
extern "C" fn htmlInitParserCtxt(mut ctxt: htmlParserCtxtPtr) -> i32 {
    ...
    *fresh152 = 0 as *mut xmlParserNodeInfo;
    ...
    if sax.is_null() {
        ...
        *fresh153 = (unsafe { __htmlDefaultSAXHandler() }) as xmlSAXHandlerPtr;
    } else {
    ...
    *fresh156 = 0 as xmlDocPtr;
    ...
    (unsafe { (*ctxt).linenumbers = *__xmlLineNumbersDefaultValue() });
    (unsafe { (*ctxt).keepBlanks = *__xmlKeepBlanksDefaultValue() });
    (unsafe { (*ctxt).html = 1 as i32 });
    ...
    *fresh159 = Some(
        xmlParserValidityWarning as unsafe extern "C" fn(*mut libc::c_void, *const i8, ...) -> (),
    );
...
#[no_mangle]
pub extern "C" fn htmlFreeParserCtxt(mut ctxt: htmlParserCtxtPtr) {
    (unsafe { xmlFreeParserCtxt(ctxt) });
}
#[no_mangle]
pub extern "C" fn htmlNewParserCtxt() -> htmlParserCtxtPtr {
...
pub extern "C" fn htmlCreateMemoryParserCtxt(
    ...
    *fresh162 = buf;
    (unsafe { xmlBufResetInput((*buf).buffer, input) });
    (unsafe { inputPush(ctxt, input) });
    return ctxt;
}
extern "C" fn htmlCreateDocParserCtxt(
    ...
    if !encoding.is_null() {
        ...
        *fresh163 = unsafe { xmlStrdup(encoding as *const xmlChar) };
        enc = unsafe { xmlParseCharEncoding(encoding) };
        if enc as i32 != XML_CHAR_ENCODING_ERROR as i32 {
            (unsafe { xmlSwitchEncoding(ctxt, enc) });
...
extern "C" fn htmlParseLookupCommentEnd(mut ctxt: htmlParserCtxtPtr) -> i32 {
...
extern "C" fn htmlParseTryOrFinish(mut ctxt: htmlParserCtxtPtr, mut terminate: i32) -> i32 {
    ...
    loop {
        ...
        if (unsafe { (*in_0).buf }).is_null() {
            ...
            avail = (unsafe { xmlBufUse((*(*in_0).buf).buffer) }) as ptrdiff_t
...
pub extern "C" fn htmlCreatePushParserCtxt(
    ...
    if !sax.is_null() {
        if (unsafe { (*ctxt).sax }) != (unsafe { __htmlDefaultSAXHandler() }) as xmlSAXHandlerPtr {
...
#[no_mangle]
pub extern "C" fn htmlParseDoc(mut cur: *const xmlChar, mut encoding: *const i8) -> htmlDocPtr {
...
pub extern "C" fn htmlCreateFileParserCtxt(
    ...
    let mut content_line: *mut xmlChar = b"charset=\0" as *const u8 as *const i8 as *mut xmlChar;
    if filename.is_null() {
        return 0 as htmlParserCtxtPtr;
    }
    ctxt = htmlNewParserCtxt();
    ...
    (unsafe { inputPush(ctxt, inputStream) });
    if !encoding.is_null() {
        let mut l: size_t = unsafe { strlen(encoding) };
...
#[no_mangle]
pub extern "C" fn htmlParseFile(mut filename: *const i8, mut encoding: *const i8) -> htmlDocPtr {
...
#[no_mangle]
pub extern "C" fn htmlNodeStatus(node: htmlNodePtr, mut legacy: i32) -> htmlStatus {
    if node.is_null() {
        return HTML_INVALID;
    }
    match (unsafe { (*node).type_0 }) as u32 {
        1 => {
            return (if legacy != 0 {
                (if htmlElementAllowedHere(htmlTagLookup(unsafe { (*(*node).parent).name }), unsafe { (*node).name }) != 0
                {
                    HTML_VALID as i32
                } else {
                    HTML_INVALID as i32
                ...
                htmlElementStatusHere(
                    htmlTagLookup(unsafe { (*(*node).parent).name }),
                    htmlTagLookup(unsafe { (*node).name }),
                ) as u32
            }) as htmlStatus;
        }
        2 => {
            return htmlAttrAllowed(htmlTagLookup(unsafe { (*(*node).parent).name }), unsafe { (*node).name }, legacy);
        }
        _ => return HTML_NA,
    };
}
#[no_mangle]
pub extern "C" fn htmlCtxtReset(mut ctxt: htmlParserCtxtPtr) {
    let mut input: xmlParserInputPtr = 0 as *mut xmlParserInput;
...
#[no_mangle]
pub extern "C" fn htmlCtxtUseOptions(mut ctxt: htmlParserCtxtPtr, mut options: i32) -> i32 {
    if ctxt.is_null() {
        return -(1 as i32);
    }
...
pub extern "C" fn htmlReadMemory(
    ...
    let mut ctxt: htmlParserCtxtPtr = 0 as *mut xmlParserCtxt;
    (unsafe { xmlInitParser() });
    ctxt = unsafe { xmlCreateMemoryParserCtxt(buffer, size) };
    if ctxt.is_null() {
        return 0 as htmlDocPtr;
    }
    (unsafe { htmlDefaultSAXHandlerInit() });
