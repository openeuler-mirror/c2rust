...
static mut xmlCatalogXMLFiles: xmlHashTablePtr = 0 as *const xmlHashTable as xmlHashTablePtr;
...
extern "C" fn xmlFreeCatalogEntry(mut payload: *mut libc::c_void, mut _name: *const xmlChar) {
...
extern "C" fn xmlFreeCatalogEntryList(mut ret: xmlCatalogEntryPtr) {
...
extern "C" fn xmlCreateNewCatalog(
    ...
    if (unsafe { (*ret).type_0 }) as u32 == XML_SGML_CATALOG_TYPE as i32 as u32 {
        ...
        *fresh11 = unsafe { xmlHashCreate(10 as i32) };
    }
    return ret;
}
#[no_mangle]
pub extern "C" fn xmlFreeCatalog(mut catal: xmlCatalogPtr) {
    if catal.is_null() {
        return;
    }
...
extern "C" fn xmlDumpXMLCatalog(mut out: *mut FILE, mut catal: xmlCatalogEntryPtr) -> i32 {
    let mut ret: i32 = 0;
...
extern "C" fn xmlCatalogConvertEntry(
    ...
    (unsafe { xmlHashRemoveEntry((*catal).sgml, (*entry).name, None) });
...
#[no_mangle]
pub extern "C" fn xmlConvertSGMLCatalog(mut catal: xmlCatalogPtr) -> i32 {
...
extern "C" fn xmlCatalogUnWrapURN(mut urn: *const xmlChar) -> *mut xmlChar {
...
#[no_mangle]
pub extern "C" fn xmlParseCatalogFile(mut filename: *const i8) -> xmlDocPtr {
...
extern "C" fn xmlLoadFileContent(mut filename: *const i8) -> *mut xmlChar {
    let mut fd: i32 = 0;
    let mut len: i32 = 0;
    let mut size: i64 = 0;
...
extern "C" fn xmlCatalogNormalizePublic(mut pubID: *const xmlChar) -> *mut xmlChar {
...
extern "C" fn xmlGetXMLCatalogEntryType(mut name: *const xmlChar) -> xmlCatalogEntryType {
...
extern "C" fn xmlFetchXMLCatalogFile(mut catal: xmlCatalogEntryPtr) -> i32 {
    ...
    if !(unsafe { xmlCatalogXMLFiles }).is_null() {
        doc = (unsafe { xmlHashLookup(xmlCatalogXMLFiles, (*catal).URL) }) as xmlCatalogEntryPtr;
        if !doc.is_null() {
            if (unsafe { xmlDebugCatalogs }) != 0 {
                (unsafe { (*__xmlGenericError()).expect("non-null function pointer")(
                    *__xmlGenericErrorContext(),
    ...
    if !(unsafe { xmlCatalogXMLFiles }).is_null() {
        ...
        (unsafe { xmlHashAddEntry(xmlCatalogXMLFiles, (*catal).URL, doc as *mut libc::c_void) });
    }
    (unsafe { xmlRMutexUnlock(xmlCatalogMutex) });
    return 0 as i32;
}
extern "C" fn xmlAddXMLCatalog(
    ...
    if doregister != 0 {
        ...
        cur = (unsafe { xmlHashLookup(xmlCatalogXMLFiles, (*catal).URL) }) as xmlCatalogEntryPtr;
        if !cur.is_null() {
...
extern "C" fn xmlDelXMLCatalog(mut catal: xmlCatalogEntryPtr, mut value: *const xmlChar) -> i32 {
    let mut cur: xmlCatalogEntryPtr = 0 as *mut xmlCatalogEntry;
...
extern "C" fn xmlParseSGMLCatalogComment(mut cur: *const xmlChar) -> *const xmlChar {
...
extern "C" fn xmlParseSGMLCatalogPubid(
...
extern "C" fn xmlParseSGMLCatalogName(
    mut cur: *const xmlChar,
    ...
    (unsafe { *name = xmlStrndup(buf.as_mut_ptr(), len) });
    return cur;
}
extern "C" fn xmlGetSGMLCatalogEntryType(mut name: *const xmlChar) -> xmlCatalogEntryType {
    let mut type_0: xmlCatalogEntryType = XML_CATA_NONE;
    if (unsafe { xmlStrEqual(
        name,
        b"SYSTEM\0" as *const u8 as *const i8 as *const xmlChar,
...
extern "C" fn xmlParseSGMLCatalog(
                ...
                if cur.is_null() {
                        ...
                        || type_0 as i32 == SGML_CATA_SYSTEM as i32
                    {
                        ...
                        if !filename.is_null() {
                            ...
                            res = unsafe { xmlHashAddEntry((*catal).sgml, name, entry as *mut libc::c_void) };
                            if res < 0 as i32 {
                                xmlFreeCatalogEntry(
                        ...
                        if super_0 != 0 {
                            let mut entry_0: xmlCatalogEntryPtr = 0 as *mut xmlCatalogEntry;
                            ...
                            res =
                                unsafe { xmlHashAddEntry((*catal).sgml, sysid, entry_0 as *mut libc::c_void) };
                            if res < 0 as i32 {
                                xmlFreeCatalogEntry(
...
extern "C" fn xmlCatalogGetSGMLPublic(
    ...
    entry = (unsafe { xmlHashLookup(catal, pubID) }) as xmlCatalogEntryPtr;
    if entry.is_null() {
        if !normid.is_null() {
            (unsafe { xmlFree.expect("non-null function pointer")(normid as *mut libc::c_void) });
        }
...
extern "C" fn xmlCatalogGetSGMLSystem(
    ...
    entry = (unsafe { xmlHashLookup(catal, sysID) }) as xmlCatalogEntryPtr;
    if entry.is_null() {
        return 0 as *const xmlChar;
    }
...
extern "C" fn xmlCatalogSGMLResolve(
    mut catal: xmlCatalogPtr,
    mut pubID: *const xmlChar,
    mut sysID: *const xmlChar,
) -> *const xmlChar {
...
#[no_mangle]
pub extern "C" fn xmlLoadSGMLSuperCatalog(mut filename: *const i8) -> xmlCatalogPtr {
    let mut content: *mut xmlChar = 0 as *mut xmlChar;
...
#[no_mangle]
pub extern "C" fn xmlLoadACatalog(mut filename: *const i8) -> xmlCatalogPtr {
    let mut content: *mut xmlChar = 0 as *mut xmlChar;
...
extern "C" fn xmlExpandCatalog(mut catal: xmlCatalogPtr, mut filename: *const i8) -> i32 {
    let mut ret: i32 = 0;
...
#[no_mangle]
pub extern "C" fn xmlACatalogResolveSystem(
    mut catal: xmlCatalogPtr,
    mut sysID: *const xmlChar,
) -> *mut xmlChar {
    let mut ret: *mut xmlChar = 0 as *mut xmlChar;
...
#[no_mangle]
pub extern "C" fn xmlACatalogResolvePublic(
    mut catal: xmlCatalogPtr,
    mut pubID: *const xmlChar,
) -> *mut xmlChar {
    let mut ret: *mut xmlChar = 0 as *mut xmlChar;
...
#[no_mangle]
pub extern "C" fn xmlACatalogResolve(
    mut catal: xmlCatalogPtr,
    mut pubID: *const xmlChar,
    mut sysID: *const xmlChar,
) -> *mut xmlChar {
...
#[no_mangle]
pub extern "C" fn xmlACatalogResolveURI(
    mut catal: xmlCatalogPtr,
    mut URI: *const xmlChar,
) -> *mut xmlChar {
    let mut ret: *mut xmlChar = 0 as *mut xmlChar;
...
#[no_mangle]
pub extern "C" fn xmlACatalogDump(mut catal: xmlCatalogPtr, mut out: *mut FILE) {
...
#[no_mangle]
pub extern "C" fn xmlACatalogAdd(
    mut catal: xmlCatalogPtr,
    mut type_0: *const xmlChar,
    mut orig: *const xmlChar,
    mut replace: *const xmlChar,
    ...
    if (unsafe { (*catal).type_0 }) as u32 == XML_XML_CATALOG_TYPE as i32 as u32 {
        ...
        if cattype as i32 != XML_CATA_NONE as i32 {
            ...
            if (unsafe { (*catal).sgml }).is_null() {
                ...
                *fresh68 = unsafe { xmlHashCreate(10 as i32) };
            }
            res = unsafe { xmlHashAddEntry((*catal).sgml, orig, entry as *mut libc::c_void) };
        }
    }
    return res;
}
#[no_mangle]
pub extern "C" fn xmlACatalogRemove(mut catal: xmlCatalogPtr, mut value: *const xmlChar) -> i32 {
    let mut res: i32 = -(1 as i32);
...
#[no_mangle]
pub extern "C" fn xmlNewCatalog(mut sgml: i32) -> xmlCatalogPtr {
    ...
    if sgml != 0 {
        ...
        if !catal.is_null() && (unsafe { (*catal).sgml }).is_null() {
            ...
            *fresh69 = unsafe { xmlHashCreate(10 as i32) };
        }
    } else {
        catal = xmlCreateNewCatalog(XML_XML_CATALOG_TYPE, unsafe { xmlCatalogDefaultPrefer });
    }
...
#[no_mangle]
pub extern "C" fn xmlCatalogIsEmpty(mut catal: xmlCatalogPtr) -> i32 {
    if catal.is_null() {
        return -(1 as i32);
    }
    if (unsafe { (*catal).type_0 }) as u32 == XML_XML_CATALOG_TYPE as i32 as u32 {
        ...
        if (unsafe { (*(*catal).xml).type_0 }) as i32 != XML_CATA_CATALOG as i32
            && (unsafe { (*(*catal).xml).type_0 }) as i32 != XML_CATA_BROKEN_CATALOG as i32
        {
            return -(1 as i32);
        }
        if (unsafe { (*(*catal).xml).children }).is_null() {
        ...
        res = unsafe { xmlHashSize((*catal).sgml) };
        if res == 0 as i32 {
            return 1 as i32;
        }
        if res < 0 as i32 {
        ...
        if !catal.is_null() {
            ...
            while (unsafe { *cur }) as i32 != '\u{0}' as i32 {
                ...
                if (unsafe { *cur }) as i32 != 0 as i32 {
                    ...
                    if !path.is_null() {
                        (unsafe { *nextent = xmlNewCatalogEntry(
                            XML_CATA_CATALOG,
                            0 as *const xmlChar,
                            0 as *const xmlChar,
                            path as *mut xmlChar,
                        ...
                        if !(unsafe { *nextent }).is_null() {
                            nextent = unsafe { &mut (**nextent).next };
                        }
...
#[no_mangle]
pub extern "C" fn xmlCatalogResolveSystem(mut sysID: *const xmlChar) -> *mut xmlChar {
    let mut ret: *mut xmlChar = 0 as *mut xmlChar;
    if (unsafe { xmlCatalogInitialized }) == 0 {
...
#[no_mangle]
pub extern "C" fn xmlCatalogResolvePublic(mut pubID: *const xmlChar) -> *mut xmlChar {
    let mut ret: *mut xmlChar = 0 as *mut xmlChar;
    if (unsafe { xmlCatalogInitialized }) == 0 {
        xmlInitializeCatalog();
    }
...
#[no_mangle]
pub extern "C" fn xmlCatalogResolve(
    mut pubID: *const xmlChar,
    mut sysID: *const xmlChar,
) -> *mut xmlChar {
    let mut ret: *mut xmlChar = 0 as *mut xmlChar;
...
#[no_mangle]
pub extern "C" fn xmlCatalogResolveURI(mut URI: *const xmlChar) -> *mut xmlChar {
    let mut ret: *mut xmlChar = 0 as *mut xmlChar;
    if (unsafe { xmlCatalogInitialized }) == 0 {
        xmlInitializeCatalog();
    }
...
#[no_mangle]
pub extern "C" fn xmlCatalogDump(mut out: *mut FILE) {
    if out.is_null() {
        return;
    }
    if (unsafe { xmlCatalogInitialized }) == 0 {
...
#[no_mangle]
pub extern "C" fn xmlCatalogRemove(mut value: *const xmlChar) -> i32 {
    let mut res: i32 = 0;
    if (unsafe { xmlCatalogInitialized }) == 0 {
        xmlInitializeCatalog();
    }
...
#[no_mangle]
pub extern "C" fn xmlCatalogGetDefaults() -> xmlCatalogAllow {
    return unsafe { xmlCatalogDefaultAllow };
}
#[no_mangle]
pub extern "C" fn xmlCatalogSetDefaults(mut allow: xmlCatalogAllow) {
    if (unsafe { xmlDebugCatalogs }) != 0 {
        match allow as u32 {
            0 => {
                (unsafe { (*__xmlGenericError()).expect("non-null function pointer")(
...
#[no_mangle]
pub extern "C" fn xmlCatalogSetDefaultPrefer(mut prefer: xmlCatalogPrefer) -> xmlCatalogPrefer {
    let mut ret: xmlCatalogPrefer = unsafe { xmlCatalogDefaultPrefer };
...
#[no_mangle]
pub extern "C" fn xmlCatalogFreeLocal(mut catalogs: *mut libc::c_void) {
...
#[no_mangle]
pub extern "C" fn xmlCatalogGetSystem(mut sysID: *const xmlChar) -> *const xmlChar {
    let mut ret: *mut xmlChar = 0 as *mut xmlChar;
...
#[no_mangle]
pub extern "C" fn xmlCatalogGetPublic(mut pubID: *const xmlChar) -> *const xmlChar {
    let mut ret: *mut xmlChar = 0 as *mut xmlChar;
    static mut result: [xmlChar; 1000] = [0; 1000];
    static mut msg: i32 = 0 as i32;
    if (unsafe { xmlCatalogInitialized }) == 0 {
