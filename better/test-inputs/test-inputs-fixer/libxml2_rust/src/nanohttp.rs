...
extern "C" fn xmlNanoHTTPScanURL(mut ctxt: xmlNanoHTTPCtxtPtr, mut URL: *const i8) {
...
extern "C" fn xmlNanoHTTPNewCtxt(mut URL: *const i8) -> xmlNanoHTTPCtxtPtr {
...
extern "C" fn xmlNanoHTTPFreeCtxt(mut ctxt: xmlNanoHTTPCtxtPtr) {
    if ctxt.is_null() {
        return;
    }
    if !(unsafe { (*ctxt).hostname }).is_null() {
...
extern "C" fn xmlNanoHTTPRecv(mut ctxt: xmlNanoHTTPCtxtPtr) -> i32 {
    let mut p: pollfd = pollfd {
        fd: 0,
        events: 0,
        revents: 0,
...
extern "C" fn xmlNanoHTTPReadLine(mut ctxt: xmlNanoHTTPCtxtPtr) -> *mut i8 {
...
extern "C" fn xmlNanoHTTPScanAnswer(mut ctxt: xmlNanoHTTPCtxtPtr, mut line: *const i8) {
    ...
    ) }) == 0
    {
        ...
        if (unsafe { *cur }) as i32 == '/' as i32 {
            ...
            let mut tmp_loc: *mut xmlChar = unsafe { xmlStrcat(tmp_http, (*ctxt).hostname as *const xmlChar) };
...
extern "C" fn xmlNanoHTTPConnectAttempt(mut addr: *mut sockaddr) -> i32 {
    let mut p: pollfd = pollfd {
        fd: 0,
        events: 0,
        revents: 0,
...
#[no_mangle]
pub extern "C" fn xmlNanoHTTPOpen(
    mut URL: *const i8,
    mut contentType: *mut *mut i8,
) -> *mut libc::c_void {
    if !contentType.is_null() {
        (unsafe { *contentType = 0 as *mut i8 });
    }
...
#[no_mangle]
pub extern "C" fn xmlNanoHTTPOpenRedir(
    mut URL: *const i8,
    mut contentType: *mut *mut i8,
...
#[no_mangle]
pub extern "C" fn xmlNanoHTTPClose(mut ctx: *mut libc::c_void) {
    let mut ctxt: xmlNanoHTTPCtxtPtr = ctx as xmlNanoHTTPCtxtPtr;
    if ctx.is_null() {
        return;
    }
...
#[no_mangle]
pub extern "C" fn xmlNanoHTTPMethodRedir(
    mut URL: *const i8,
    mut method: *const i8,
    mut input: *const i8,
    mut contentType: *mut *mut i8,
    ...
    loop {
        ...
        if !contentType.is_null() && !(unsafe { *contentType }).is_null() {
            blen = (blen as u64).wrapping_add((unsafe { strlen(*contentType) }).wrapping_add(16 as i32 as u64))
                as i32 as i32;
        }
        if !(unsafe { (*ctxt).query }).is_null() {
...
#[no_mangle]
pub extern "C" fn xmlNanoHTTPMethod(
    mut URL: *const i8,
    mut method: *const i8,
    mut input: *const i8,
    mut contentType: *mut *mut i8,
...
#[no_mangle]
pub extern "C" fn xmlNanoHTTPFetch(
    mut URL: *const i8,
    ...
    if (unsafe { strcmp(filename, b"-\0" as *const u8 as *const i8) }) == 0 {
        ...
        if fd < 0 as i32 {
            ...
            if !contentType.is_null() && !(unsafe { *contentType }).is_null() {
                (unsafe { xmlFree.expect("non-null function pointer")(*contentType as *mut libc::c_void) });
                (unsafe { *contentType = 0 as *mut i8 });
            }
            return -(1 as i32);
        }
...
#[no_mangle]
pub extern "C" fn xmlNanoHTTPSave(mut ctxt: *mut libc::c_void, mut filename: *const i8) -> i32 {
    let mut buf: *mut i8 = 0 as *mut i8;
    let mut fd: i32 = 0;
    let mut len: i32 = 0;
    let mut ret: i32 = 0 as i32;
...
#[no_mangle]
pub extern "C" fn xmlNanoHTTPReturnCode(mut ctx: *mut libc::c_void) -> i32 {
    let mut ctxt: xmlNanoHTTPCtxtPtr = ctx as xmlNanoHTTPCtxtPtr;
    if ctxt.is_null() {
        return -(1 as i32);
    }
...
#[no_mangle]
pub extern "C" fn xmlNanoHTTPAuthHeader(mut ctx: *mut libc::c_void) -> *const i8 {
    let mut ctxt: xmlNanoHTTPCtxtPtr = ctx as xmlNanoHTTPCtxtPtr;
    if ctxt.is_null() {
...
#[no_mangle]
pub extern "C" fn xmlNanoHTTPContentLength(mut ctx: *mut libc::c_void) -> i32 {
    let mut ctxt: xmlNanoHTTPCtxtPtr = ctx as xmlNanoHTTPCtxtPtr;
...
#[no_mangle]
pub extern "C" fn xmlNanoHTTPRedir(mut ctx: *mut libc::c_void) -> *const i8 {
    let mut ctxt: xmlNanoHTTPCtxtPtr = ctx as xmlNanoHTTPCtxtPtr;
    return if ctxt.is_null() {
        0 as *mut i8
    } else {
...
#[no_mangle]
pub extern "C" fn xmlNanoHTTPEncoding(mut ctx: *mut libc::c_void) -> *const i8 {
    let mut ctxt: xmlNanoHTTPCtxtPtr = ctx as xmlNanoHTTPCtxtPtr;
    return if ctxt.is_null() {
        0 as *mut i8
    } else {
...
#[no_mangle]
pub extern "C" fn xmlNanoHTTPMimeType(mut ctx: *mut libc::c_void) -> *const i8 {
    let mut ctxt: xmlNanoHTTPCtxtPtr = ctx as xmlNanoHTTPCtxtPtr;
    return if ctxt.is_null() {
        0 as *mut i8
    } else {
