...
extern "C" {
    ...
    fn array_list_new2(free_fn: Option<array_list_free_fn>, initial_size: i32) -> *mut array_list;
    fn array_list_free(al: *mut array_list);
    fn array_list_get_idx(al: *mut array_list, i: size_t) -> *mut libc::c_void;
    fn array_list_put_idx(al: *mut array_list, i: size_t, data: *mut libc::c_void) -> i32;
    fn array_list_add(al: *mut array_list, data: *mut libc::c_void) -> i32;
    fn array_list_length(al: *mut array_list) -> size_t;
    fn array_list_sort(
        arr: *mut array_list,
        compar: Option<unsafe extern "C" fn(*const libc::c_void, *const libc::c_void) -> i32>,
    );
    ...
    fn array_list_del_idx(arr: *mut array_list, idx: size_t, count: size_t) -> i32;
    fn array_list_shrink(arr: *mut array_list, empty_slots: size_t) -> i32;
    fn _json_c_set_last_err(err_fmt: *const i8, _: ...);
    fn json_parse_int64(buf: *const i8, retval: *mut int64_t) -> i32;
    fn json_parse_uint64(buf: *const i8, retval: *mut uint64_t) -> i32;
    fn lh_kchar_table_new(size: i32, free_fn: Option<lh_entry_free_fn>) -> *mut lh_table;
    ...
    fn lh_table_delete(t: *mut lh_table, k: *const libc::c_void) -> i32;
...
#[inline]
extern "C" fn lh_entry_k_is_constant(mut e: *const lh_entry) -> i32 {
...
#[inline]
extern "C" fn lh_entry_set_val(mut e: *mut lh_entry, mut newval: *mut libc::c_void) {
    let fresh0 = unsafe { &mut ((*e).v) };
    *fresh0 = newval;
}
#[inline]
...
#[inline]
extern "C" fn JC_OBJECT_C(mut jso: *const json_object) -> *const json_object_object {
...
#[inline]
extern "C" fn JC_ARRAY_C(mut jso: *const json_object) -> *const json_object_array {
...
#[inline]
extern "C" fn JC_BOOL_C(mut jso: *const json_object) -> *const json_object_boolean {
...
#[inline]
extern "C" fn JC_DOUBLE_C(mut jso: *const json_object) -> *const json_object_double {
...
#[inline]
extern "C" fn JC_STRING_C(mut jso: *const json_object) -> *const json_object_string {
    return jso as *const libc::c_void as *const json_object_string;
}
#[inline]
extern "C" fn get_string_component_mutable(mut jso: *mut json_object) -> *mut i8 {
...
#[inline]
extern "C" fn get_string_component(mut jso: *const json_object) -> *const i8 {
            ...
            8 | 10 | 13 | 9 | 12 | 34 | 92 | 47 => {
                if flags & (1 as i32) << 4 as i32 != 0 && c as i32 == '/' as i32 {
                    ...
                    if c as i32 == '\u{8}' as i32 {
                        (unsafe { printbuf_memappend(pb, b"\\b\0" as *const u8 as *const i8, 2 as i32) });
                    } else if c as i32 == '\n' as i32 {
                        (unsafe { printbuf_memappend(pb, b"\\n\0" as *const u8 as *const i8, 2 as i32) });
                    } else if c as i32 == '\r' as i32 {
                        (unsafe { printbuf_memappend(pb, b"\\r\0" as *const u8 as *const i8, 2 as i32) });
                    } else if c as i32 == '\t' as i32 {
                        (unsafe { printbuf_memappend(pb, b"\\t\0" as *const u8 as *const i8, 2 as i32) });
                    } else if c as i32 == '\u{c}' as i32 {
                        (unsafe { printbuf_memappend(pb, b"\\f\0" as *const u8 as *const i8, 2 as i32) });
                    } else if c as i32 == '"' as i32 {
                        (unsafe { printbuf_memappend(pb, b"\\\"\0" as *const u8 as *const i8, 2 as i32) });
                    } else if c as i32 == '\\' as i32 {
                        (unsafe { printbuf_memappend(pb, b"\\\\\0" as *const u8 as *const i8, 2 as i32) });
...
#[no_mangle]
pub extern "C" fn json_object_get(mut jso: *mut json_object) -> *mut json_object {
    if jso.is_null() {
        return jso;
    }
    ...
    let fresh1 = unsafe { &mut ((*jso)._ref_count) };
    *fresh1 = (*fresh1).wrapping_add(1);
    return jso;
}
#[no_mangle]
pub extern "C" fn json_object_put(mut jso: *mut json_object) -> i32 {
    if jso.is_null() {
        return 0 as i32;
    }
    ...
    let fresh2 = unsafe { &mut ((*jso)._ref_count) };
...
extern "C" fn json_object_generic_delete(mut jso: *mut json_object) {
    (unsafe { printbuf_free((*jso)._pb) });
...
extern "C" fn json_object_new(
    ...
    let fresh3 = unsafe { &mut ((*jso)._to_json_string) };
    *fresh3 = to_json_string;
    let fresh4 = unsafe { &mut ((*jso)._pb) };
    *fresh4 = 0 as *mut printbuf;
    let fresh5 = unsafe { &mut ((*jso)._user_delete) };
    *fresh5 = None;
    let fresh6 = unsafe { &mut ((*jso)._userdata) };
    *fresh6 = 0 as *mut libc::c_void;
    return jso;
}
#[no_mangle]
pub extern "C" fn json_object_is_type(mut jso: *const json_object, mut type_0: json_type) -> i32 {
    if jso.is_null() {
...
#[no_mangle]
pub extern "C" fn json_object_get_type(mut jso: *const json_object) -> json_type {
    if jso.is_null() {
...
#[no_mangle]
pub extern "C" fn json_object_get_userdata(mut jso: *mut json_object) -> *mut libc::c_void {
...
pub extern "C" fn json_object_set_userdata(
    ...
    let fresh7 = unsafe { &mut ((*jso)._userdata) };
    *fresh7 = userdata;
    let fresh8 = unsafe { &mut ((*jso)._user_delete) };
    *fresh8 = user_delete;
}
#[no_mangle]
pub extern "C" fn json_object_set_serializer(
    ...
    if to_string_func.is_none() {
        match (unsafe { (*jso).o_type }) as u32 {
            0 => {
                let fresh9 = unsafe { &mut ((*jso)._to_json_string) };
                *fresh9 = None;
            }
            1 => {
                let fresh10 = unsafe { &mut ((*jso)._to_json_string) };
                *fresh10 =
                    Some(json_object_boolean_to_json_string as json_object_to_json_string_fn);
            }
            2 => {
                let fresh11 = unsafe { &mut ((*jso)._to_json_string) };
                *fresh11 = Some(
                    json_object_double_to_json_string_default as json_object_to_json_string_fn,
                );
            }
            3 => {
                let fresh12 = unsafe { &mut ((*jso)._to_json_string) };
                *fresh12 = Some(json_object_int_to_json_string as json_object_to_json_string_fn);
            }
            4 => {
                let fresh13 = unsafe { &mut ((*jso)._to_json_string) };
                *fresh13 = Some(json_object_object_to_json_string as json_object_to_json_string_fn);
            }
            5 => {
                let fresh14 = unsafe { &mut ((*jso)._to_json_string) };
                *fresh14 = Some(json_object_array_to_json_string as json_object_to_json_string_fn);
            }
            6 => {
                let fresh15 = unsafe { &mut ((*jso)._to_json_string) };
                *fresh15 = Some(json_object_string_to_json_string as json_object_to_json_string_fn);
            }
            _ => {}
        }
        return;
    }
    let fresh16 = unsafe { &mut ((*jso)._to_json_string) };
    *fresh16 = to_string_func;
}
#[no_mangle]
pub extern "C" fn json_object_to_json_string_length(
    mut jso: *mut json_object,
    mut flags: i32,
    ...
    if jso.is_null() {
        ...
        let fresh17 = unsafe { &mut ((*jso)._pb) };
        *fresh17 = unsafe { printbuf_new() };
        !(*fresh17).is_null()
    } {
        (unsafe { printbuf_reset((*jso)._pb) });
...
#[no_mangle]
pub extern "C" fn json_object_to_json_string(mut jso: *mut json_object) -> *const i8 {
    return json_object_to_json_string_ext(jso, (1 as i32) << 0 as i32);
}
extern "C" fn indent(mut pb: *mut printbuf, mut level: i32, mut flags: i32) {
    if flags & (1 as i32) << 1 as i32 != 0 {
        if flags & (1 as i32) << 3 as i32 != 0 {
            (unsafe { printbuf_memset(pb, -(1 as i32), '\t' as i32, level) });
        } else {
            (unsafe { printbuf_memset(pb, -(1 as i32), ' ' as i32, level * 2 as i32) });
        }
    }
}
extern "C" fn json_object_object_to_json_string(
    ...
    if flags & (1 as i32) << 0 as i32 != 0 && flags & (1 as i32) << 1 as i32 == 0 {
        return unsafe { printbuf_memappend(
            pb,
            b" }\0" as *const u8 as *const i8,
            (::std::mem::size_of::<[i8; 3]>() as u64).wrapping_sub(1 as i32 as u64) as i32,
        ) };
...
extern "C" fn json_object_lh_entry_free(mut ent: *mut lh_entry) {
    if lh_entry_k_is_constant(ent) == 0 {
        (unsafe { free(lh_entry_k(ent)) });
    }
    json_object_put(lh_entry_v(ent) as *mut json_object);
}
extern "C" fn json_object_object_delete(mut jso_base: *mut json_object) {
    (unsafe { lh_table_free((*JC_OBJECT(jso_base)).c_object) });
    json_object_generic_delete(jso_base);
}
#[no_mangle]
pub extern "C" fn json_object_new_object() -> *mut json_object {
    ...
    let fresh18 = unsafe { &mut ((*jso).c_object) };
    *fresh18 = unsafe { lh_kchar_table_new(
        16 as i32,
...
#[no_mangle]
pub extern "C" fn json_object_get_object(mut jso: *const json_object) -> *mut lh_table {
    if jso.is_null() {
...
pub extern "C" fn json_object_object_add_ex(
    ...
    if json_object_get_type(jso) as u32 == json_type_object as i32 as u32 {
        ...
        (unsafe { __assert_fail (b"json_object_get_type(jso) == json_type_object\0" as * const u8 as * const i8 , b"/home/xial/json-c/json_object.c\0" as * const u8 as * const i8 , 544 as i32 as u32 , (* :: std :: mem :: transmute :: < & [u8 ; 118] , & [i8 ; 118] , > (b"int json_object_object_add_ex(struct json_object *, const char *const, struct json_object *const, const unsigned int)\0" ,)) . as_ptr () ,) }) ;
    }
    hash = lh_get_hash(unsafe { (*JC_OBJECT(jso)).c_object }, key as *const libc::c_void);
    existing_entry = if opts & ((1 as i32) << 1 as i32) as u32 != 0 {
        0 as *mut lh_entry
    } else {
        unsafe { lh_table_lookup_entry_w_hash((*JC_OBJECT(jso)).c_object, key as *const libc::c_void, hash) }
    };
    if jso == val {
        return -(1 as i32);
    }
    if existing_entry.is_null() {
        let k: *const libc::c_void = if opts & ((1 as i32) << 2 as i32) as u32 != 0 {
        ...
        return unsafe { lh_table_insert_w_hash(
...
#[no_mangle]
pub extern "C" fn json_object_object_length(mut jso: *const json_object) -> i32 {
    if json_object_get_type(jso) as u32 == json_type_object as i32 as u32 {
    } else {
        (unsafe { __assert_fail(
    ...
    return unsafe { lh_table_length((*JC_OBJECT_C(jso)).c_object) };
}
#[no_mangle]
...
pub extern "C" fn json_object_object_get_ex(
    ...
    match (unsafe { (*jso).o_type }) as u32 {
        4 => {
            return unsafe { lh_table_lookup_ex(
...
#[no_mangle]
pub extern "C" fn json_object_object_del(mut jso: *mut json_object, mut key: *const i8) {
    if json_object_get_type(jso) as u32 == json_type_object as i32 as u32 {
    } else {
        (unsafe { __assert_fail(
            b"json_object_get_type(jso) == json_type_object\0" as *const u8 as *const i8,
    ...
    (unsafe { lh_table_delete((*JC_OBJECT(jso)).c_object, key as *const libc::c_void) });
}
...
#[no_mangle]
pub extern "C" fn json_object_new_boolean(mut b: json_bool) -> *mut json_object {
...
#[no_mangle]
pub extern "C" fn json_object_get_boolean(mut jso: *const json_object) -> json_bool {
    if jso.is_null() {
        return 0 as i32;
    }
    match (unsafe { (*jso).o_type }) as u32 {
...
extern "C" fn json_object_int_to_json_string(
    ...
    return unsafe { printbuf_memappend(pb, sbuf.as_mut_ptr(), strlen(sbuf.as_mut_ptr()) as i32) };
}
#[no_mangle]
pub extern "C" fn json_object_new_int(mut i: int32_t) -> *mut json_object {
    return json_object_new_int64(i as int64_t);
}
#[no_mangle]
pub extern "C" fn json_object_get_int(mut jso: *const json_object) -> int32_t {
    ...
    if o_type as u32 == json_type_int as i32 as u32 {
        ...
        if (unsafe { json_parse_int64(get_string_component(jso), &mut cint64) }) != 0 as i32 {
            return 0 as i32;
        }
...
#[no_mangle]
pub extern "C" fn json_object_set_int(mut jso: *mut json_object, mut new_value: i32) -> i32 {
    return json_object_set_int64(jso, new_value as int64_t);
}
#[no_mangle]
pub extern "C" fn json_object_new_int64(mut i: int64_t) -> *mut json_object {
...
#[no_mangle]
pub extern "C" fn json_object_new_uint64(mut i: uint64_t) -> *mut json_object {
    let mut jso: *mut json_object_int = json_object_new(
        json_type_int,
        ::std::mem::size_of::<json_object_int>() as u64,
        Some(json_object_int_to_json_string as json_object_to_json_string_fn),
...
#[no_mangle]
pub extern "C" fn json_object_get_int64(mut jso: *const json_object) -> int64_t {
    ...
    match (unsafe { (*jso).o_type }) as u32 {
        ...
        6 => {
            if (unsafe { json_parse_int64(get_string_component(jso), &mut cint) }) == 0 as i32 {
                return cint;
            }
        }
        _ => {}
...
#[no_mangle]
pub extern "C" fn json_object_get_uint64(mut jso: *const json_object) -> uint64_t {
    ...
    match (unsafe { (*jso).o_type }) as u32 {
        ...
        6 => {
            if (unsafe { json_parse_uint64(get_string_component(jso), &mut cuint) }) == 0 as i32 {
                return cuint;
            }
        }
        _ => {}
...
#[no_mangle]
pub extern "C" fn json_object_set_int64(mut jso: *mut json_object, mut new_value: int64_t) -> i32 {
...
#[no_mangle]
pub extern "C" fn json_object_int_inc(mut jso: *mut json_object, mut val: int64_t) -> i32 {
    ...
    match (unsafe { (*jsoint).cint_type }) as u32 {
        0 => {
                ...
                && (unsafe { (*jsoint).cint.c_int64 }) < -(9223372036854775807 as i64) - 1 as i32 as i64 - val
            {
                ...
                let fresh19 = unsafe { &mut ((*jsoint).cint.c_int64) };
                *fresh19 += val;
            }
            return 1 as i32;
        }
        1 => {
                    ...
                    > (18446744073709551615 as u64).wrapping_sub(val as uint64_t)
            {
                ...
                let fresh20 = unsafe { &mut ((*jsoint).cint.c_uint64) };
                *fresh20 = (*fresh20 as u64).wrapping_sub(-val as uint64_t) as uint64_t as uint64_t;
            } else {
                let fresh21 = unsafe { &mut ((*jsoint).cint.c_uint64) };
...
extern "C" fn json_object_double_to_json_string_format(
    ...
    (unsafe { printbuf_memappend(pb, buf.as_mut_ptr(), size) });
    return size;
}
...
#[no_mangle]
pub extern "C" fn json_object_new_double(mut d: f64) -> *mut json_object {
    ...
    let fresh22 = unsafe { &mut ((*jso).base._to_json_string) };
    *fresh22 = Some(json_object_double_to_json_string_default as json_object_to_json_string_fn);
    (unsafe { (*jso).c_double = d });
    return unsafe { &mut (*jso).base };
}
#[no_mangle]
pub extern "C" fn json_object_new_double_s(mut d: f64, mut ds: *const i8) -> *mut json_object {
...
pub extern "C" fn json_object_userdata_to_json_string(
    ...
    (unsafe { printbuf_memappend(pb, (*jso)._userdata as *const i8, userdata_len) });
    return userdata_len;
}
#[no_mangle]
pub extern "C" fn json_object_free_userdata(
    mut _jso: *mut json_object,
    mut userdata: *mut libc::c_void,
) {
    (unsafe { free(userdata) });
}
#[no_mangle]
pub extern "C" fn json_object_get_double(mut jso: *const json_object) -> f64 {
    let mut cdouble: f64 = 0.;
...
#[no_mangle]
pub extern "C" fn json_object_set_double(mut jso: *mut json_object, mut new_value: f64) -> i32 {
    if jso.is_null() || (unsafe { (*jso).o_type }) as u32 != json_type_double as i32 as u32 {
        return 0 as i32;
    }
    (unsafe { (*JC_DOUBLE(jso)).c_double = new_value });
    if (unsafe { (*jso)._to_json_string })
        == Some(_json_object_userdata_to_json_string as json_object_to_json_string_fn)
    {
...
extern "C" fn json_object_string_to_json_string(
    ...
    let mut len: ssize_t = unsafe { (*JC_STRING(jso)).len };
    (unsafe { printbuf_memappend(
        pb,
        b"\"\0" as *const u8 as *const i8,
        (::std::mem::size_of::<[i8; 2]>() as u64).wrapping_sub(1 as i32 as u64) as i32,
...
extern "C" fn json_object_string_delete(mut jso: *mut json_object) {
    if (unsafe { (*JC_STRING(jso)).len }) < 0 as i32 as i64 {
        (unsafe { free((*JC_STRING(jso)).c_string.pdata as *mut libc::c_void) });
    }
    json_object_generic_delete(jso);
}
extern "C" fn _json_object_new_string(mut s: *const i8, len: size_t) -> *mut json_object {
...
#[no_mangle]
pub extern "C" fn json_object_new_string(mut s: *const i8) -> *mut json_object {
    return _json_object_new_string(s, unsafe { strlen(s) });
}
#[no_mangle]
pub extern "C" fn json_object_new_string_len(mut s: *const i8, len: i32) -> *mut json_object {
    return _json_object_new_string(s, len as size_t);
}
#[no_mangle]
pub extern "C" fn json_object_get_string(mut jso: *mut json_object) -> *const i8 {
    if jso.is_null() {
...
#[inline]
extern "C" fn _json_object_get_string_len(mut jso: *const json_object_string) -> ssize_t {
    let mut len: ssize_t = 0;
    len = unsafe { (*jso).len };
    return if len < 0 as i32 as i64 { -len } else { len };
}
#[no_mangle]
pub extern "C" fn json_object_get_string_len(mut jso: *const json_object) -> i32 {
    if jso.is_null() {
        return 0 as i32;
    }
    match (unsafe { (*jso).o_type }) as u32 {
...
extern "C" fn _json_object_set_string_len(
    ...
    if len as ssize_t > curlen {
        ...
        let fresh23 = unsafe { &mut ((*JC_STRING(jso)).c_string.pdata) };
        *fresh23 = dstbuf;
        newlen = -(len as ssize_t);
...
#[no_mangle]
pub extern "C" fn json_object_set_string(mut jso: *mut json_object, mut s: *const i8) -> i32 {
...
extern "C" fn json_object_array_entry_free(mut data: *mut libc::c_void) {
    json_object_put(data as *mut json_object);
}
extern "C" fn json_object_array_delete(mut jso: *mut json_object) {
    (unsafe { array_list_free((*JC_ARRAY(jso)).c_array) });
    json_object_generic_delete(jso);
}
#[no_mangle]
pub extern "C" fn json_object_new_array() -> *mut json_object {
    return json_object_new_array_ext(32 as i32);
}
#[no_mangle]
pub extern "C" fn json_object_new_array_ext(mut initial_size: i32) -> *mut json_object {
    ...
    let fresh24 = unsafe { &mut ((*jso).c_array) };
    *fresh24 = unsafe { array_list_new2(
        Some(json_object_array_entry_free as unsafe extern "C" fn(*mut libc::c_void) -> ()),
        initial_size,
    ) };
...
#[no_mangle]
pub extern "C" fn json_object_get_array(mut jso: *const json_object) -> *mut array_list {
    if jso.is_null() {
...
pub extern "C" fn json_object_array_sort(
    mut jso: *mut json_object,
    mut sort_fn: Option<unsafe extern "C" fn(*const libc::c_void, *const libc::c_void) -> i32>,
) {
    if json_object_get_type(jso) as u32 == json_type_array as i32 as u32 {
    } else {
        (unsafe { __assert_fail (b"json_object_get_type(jso) == json_type_array\0" as * const u8 as * const i8 , b"/home/xial/json-c/json_object.c\0" as * const u8 as * const i8 , 1453 as i32 as u32 , (* :: std :: mem :: transmute :: < & [u8 ; 87] , & [i8 ; 87] , > (b"void json_object_array_sort(struct json_object *, int (*)(const void *, const void *))\0" ,)) . as_ptr () ,) }) ;
    }
    (unsafe { array_list_sort((*JC_ARRAY(jso)).c_array, sort_fn) });
}
#[no_mangle]
pub extern "C" fn json_object_array_bsearch(
    ...
    if json_object_get_type(jso) as u32 == json_type_array as i32 as u32 {
        ...
        (unsafe { __assert_fail (b"json_object_get_type(jso) == json_type_array\0" as * const u8 as * const i8 , b"/home/xial/json-c/json_object.c\0" as * const u8 as * const i8 , 1463 as i32 as u32 , (* :: std :: mem :: transmute :: < & [u8 ; 139] , & [i8 ; 139] , > (b"struct json_object *json_object_array_bsearch(const struct json_object *, const struct json_object *, int (*)(const void *, const void *))\0" ,)) . as_ptr () ,) }) ;
    }
    result = (unsafe { array_list_bsearch(
...
#[no_mangle]
pub extern "C" fn json_object_array_length(mut jso: *const json_object) -> size_t {
    if json_object_get_type(jso) as u32 == json_type_array as i32 as u32 {
    } else {
        (unsafe { __assert_fail(
    ...
    return unsafe { array_list_length((*JC_ARRAY_C(jso)).c_array) };
}
#[no_mangle]
pub extern "C" fn json_object_array_add(
    ...
    return unsafe { array_list_add((*JC_ARRAY(jso)).c_array, val as *mut libc::c_void) };
}
#[no_mangle]
pub extern "C" fn json_object_array_put_idx(
    ...
    if json_object_get_type(jso) as u32 == json_type_array as i32 as u32 {
        ...
        (unsafe { __assert_fail (b"json_object_get_type(jso) == json_type_array\0" as * const u8 as * const i8 , b"/home/xial/json-c/json_object.c\0" as * const u8 as * const i8 , 1486 as i32 as u32 , (* :: std :: mem :: transmute :: < & [u8 ; 82] , & [i8 ; 82] , > (b"int json_object_array_put_idx(struct json_object *, size_t, struct json_object *)\0" ,)) . as_ptr () ,) }) ;
    }
    return unsafe { array_list_put_idx((*JC_ARRAY(jso)).c_array, idx, val as *mut libc::c_void) };
}
#[no_mangle]
pub extern "C" fn json_object_array_del_idx(
    ...
    return unsafe { array_list_del_idx((*JC_ARRAY(jso)).c_array, idx, count) };
}
#[no_mangle]
pub extern "C" fn json_object_array_get_idx(
    ...
    if json_object_get_type(jso) as u32 == json_type_array as i32 as u32 {
        ...
        (unsafe { __assert_fail (b"json_object_get_type(jso) == json_type_array\0" as * const u8 as * const i8 , b"/home/xial/json-c/json_object.c\0" as * const u8 as * const i8 , 1498 as i32 as u32 , (* :: std :: mem :: transmute :: < & [u8 ; 82] , & [i8 ; 82] , > (b"struct json_object *json_object_array_get_idx(const struct json_object *, size_t)\0" ,)) . as_ptr () ,) }) ;
    }
    return (unsafe { array_list_get_idx((*JC_ARRAY_C(jso)).c_array, idx) }) as *mut json_object;
}
extern "C" fn json_array_equal(mut jso1: *mut json_object, mut jso2: *mut json_object) -> i32 {
...
#[no_mangle]
pub extern "C" fn json_object_array_shrink(mut jso: *mut json_object, mut empty_slots: i32) -> i32 {
    ...
    return unsafe { array_list_shrink((*JC_ARRAY(jso)).c_array, empty_slots as size_t) };
}
#[no_mangle]
...
#[no_mangle]
pub extern "C" fn json_object_equal(mut jso1: *mut json_object, mut jso2: *mut json_object) -> i32 {
    if jso1 == jso2 {
        return 1 as i32;
    }
...
extern "C" fn json_object_copy_serializer_data(
    ...
    if (unsafe { (*dst)._to_json_string })
        == Some(json_object_userdata_to_json_string as json_object_to_json_string_fn)
        || (unsafe { (*dst)._to_json_string })
            == Some(_json_object_userdata_to_json_string as json_object_to_json_string_fn)
    {
        let mut p: *mut i8 = 0 as *mut i8;
        if !(unsafe { (*src)._userdata }).is_null() {
        } else {
            (unsafe { __assert_fail (b"src->_userdata\0" as * const u8 as * const i8 , b"/home/xial/json-c/json_object.c\0" as * const u8 as * const i8 , 1623 as i32 as u32 , (* :: std :: mem :: transmute :: < & [u8 ; 81] , & [i8 ; 81] , > (b"int json_object_copy_serializer_data(struct json_object *, struct json_object *)\0" ,)) . as_ptr () ,) }) ;
        }
        ...
        let fresh25 = unsafe { &mut ((*dst)._userdata) };
        *fresh25 = p as *mut libc::c_void;
    } else {
        (unsafe { _json_c_set_last_err(
            b"json_object_copy_serializer_data: unable to copy unknown serializer data: %p\n\0"
                as *const u8 as *const i8,
            ::std::mem::transmute::<Option<json_object_to_json_string_fn>, *mut libc::c_void>(
                (*dst)._to_json_string,
            ),
        ) });
        return -(1 as i32);
    }
    let fresh26 = unsafe { &mut ((*dst)._user_delete) };
...
pub extern "C" fn json_c_shallow_copy_default(
    ...
    let fresh27 = unsafe { &mut ((**dst)._to_json_string) };
...
extern "C" fn json_object_deep_copy_recursive(
    ...
    if !(unsafe { *dst }).is_null() {
        ...
        (unsafe { __assert_fail (b"*dst != NULL\0" as * const u8 as * const i8 , b"/home/xial/json-c/json_object.c\0" as * const u8 as * const i8 , 1718 as i32 as u32 , (* :: std :: mem :: transmute :: < & [u8 ; 151] , & [i8 ; 151] , > (b"int json_object_deep_copy_recursive(struct json_object *, struct json_object *, const char *, size_t, struct json_object **, json_c_shallow_copy_fn *)\0" ,)) . as_ptr () ,) }) ;
    }
    match (unsafe { (*src).o_type }) as u32 {
        4 => {
