...
static mut categories: [category_descriptors; 23] = [
    {
        let mut init = category_descriptors {
            ...
            desc: b"Different types of authentication methods\0" as *const u8 as *const i8,
    ...
    },
    {
        let mut init = category_descriptors {
            ...
            desc: b"Low level networking operations\0" as *const u8 as *const i8,
    ...
    },
    {
        let mut init = category_descriptors {
            ...
            desc: b"HTTP and HTTPS protocol options\0" as *const u8 as *const i8,
    ...
    },
    {
        let mut init = category_descriptors {
            ...
            desc: b"Options that don't fit into any other category\0" as *const u8 as *const i8,
    ...
    },
    {
        let mut init = category_descriptors {
            ...
            desc: b"All options related to proxies\0" as *const u8 as *const i8,
    ...
    },
    {
        let mut init = category_descriptors {
            ...
            desc: b"Options related to any kind of command line output of curl\0" as *const u8
                as *const i8,
...
static mut helptext: [helptxt; 243] = [
    {
        let mut init = helptxt {
            opt: b"    --abstract-unix-socket <path>\0" as *const u8 as *const i8,
            desc: b"Connect via abstract Unix domain socket\0" as *const u8 as *const i8,
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Enable alt-svc with this cache file\0" as *const u8 as *const i8,
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Pick any authentication method\0" as *const u8 as *const i8,
            categories: (1 as u32) << 7 as u32 | (1 as u32) << 14 as u32 | (1 as u32) << 1 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Append to target file when uploading\0" as *const u8 as *const i8,
            categories: (1 as u32) << 6 as u32 | (1 as u32) << 16 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            opt: b"    --aws-sigv4 <provider1[:provider2[:region[:service]]]>\0" as *const u8
                as *const i8,
            desc: b"Use AWS V4 signature authentication\0" as *const u8 as *const i8,
            categories: (1 as u32) << 1 as u32 | (1 as u32) << 7 as u32,
        };
        init
    },
    {
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"CA certificate to verify peer against\0" as *const u8 as *const i8,
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"CA directory to verify peer against\0" as *const u8 as *const i8,
            categories: (1 as u32) << 21 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            opt: b"-E, --cert <certificate[:password]>\0" as *const u8 as *const i8,
            desc: b"Client certificate file and password\0" as *const u8 as *const i8,
            categories: (1 as u32) << 21 as u32,
        };
        init
    },
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Certificate type (DER/PEM/ENG)\0" as *const u8 as *const i8,
            categories: (1 as u32) << 21 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            opt: b"    --ciphers <list of ciphers>\0" as *const u8 as *const i8,
    ...
    },
    {
        let mut init = helptxt {
            ...
            categories: (1 as u32) << 15 as u32 | (1 as u32) << 18 as u32,
        };
        init
    },
    {
    ...
    {
        let mut init = helptxt {
            opt: b"    --connect-timeout <fractional seconds>\0" as *const u8 as *const i8,
            desc: b"Maximum time allowed for connection\0" as *const u8 as *const i8,
            categories: (1 as u32) << 2 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            opt: b"    --connect-to <HOST1:PORT1:HOST2:PORT2>\0" as *const u8 as *const i8,
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Write cookies to <filename> after operation\0" as *const u8 as *const i8,
            categories: (1 as u32) << 7 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Create necessary local directory hierarchy\0" as *const u8 as *const i8,
            categories: (1 as u32) << 3 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"File mode (octal) for created files\0" as *const u8 as *const i8,
    ...
    },
    {
        let mut init = helptxt {
            ...
            categories: (1 as u32) << 6 as u32 | (1 as u32) << 17 as u32,
        };
        init
    },
    {
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"(EC) TLS key exchange algorithm(s) to request\0" as *const u8 as *const i8,
            categories: (1 as u32) << 21 as u32,
        };
        init
    },
    ...
    },
    {
        let mut init = helptxt {
            ...
            categories: (1 as u32) << 7 as u32 | (1 as u32) << 13 as u32 | (1 as u32) << 22 as u32,
        };
        init
    },
    {
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Use HTTP Digest Authentication\0" as *const u8 as *const i8,
            categories: (1 as u32) << 14 as u32 | (1 as u32) << 1 as u32 | (1 as u32) << 7 as u32,
        };
        init
    },
    {
    ...
    },
    {
        let mut init = helptxt {
            ...
            categories: (1 as u32) << 3 as u32 | (1 as u32) << 7 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            opt: b"    --dns-interface <interface>\0" as *const u8 as *const i8,
            desc: b"Interface to use for DNS requests\0" as *const u8 as *const i8,
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"IPv4 address to use for DNS requests\0" as *const u8 as *const i8,
            categories: (1 as u32) << 4 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"IPv6 address to use for DNS requests\0" as *const u8 as *const i8,
            categories: (1 as u32) << 4 as u32,
        };
        init
    },
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Verify the status of the DoH server cert via OCSP-staple\0" as *const u8
                as *const i8,
            categories: (1 as u32) << 4 as u32 | (1 as u32) << 21 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Allow insecure DoH server connections\0" as *const u8 as *const i8,
            categories: (1 as u32) << 4 as u32 | (1 as u32) << 21 as u32,
        };
        init
    },
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Write the received headers to <filename>\0" as *const u8 as *const i8,
            categories: (1 as u32) << 7 as u32 | (1 as u32) << 6 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"EGD socket path for random data\0" as *const u8 as *const i8,
            categories: (1 as u32) << 21 as u32,
        };
        init
    },
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Pass an ETag from a file as a custom header\0" as *const u8 as *const i8,
            categories: (1 as u32) << 7 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Parse ETag from a request and save it to a file\0" as *const u8 as *const i8,
            categories: (1 as u32) << 7 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            opt: b"    --expect100-timeout <seconds>\0" as *const u8 as *const i8,
            desc: b"How long to wait for 100-continue\0" as *const u8 as *const i8,
            categories: (1 as u32) << 7 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Fail silently (no output at all) on HTTP errors\0" as *const u8 as *const i8,
            categories: (1 as u32) << 9 as u32 | (1 as u32) << 7 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Fail on first transfer error, do not continue\0" as *const u8 as *const i8,
            categories: (1 as u32) << 3 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Fail on HTTP errors but save the body\0" as *const u8 as *const i8,
            categories: (1 as u32) << 7 as u32 | (1 as u32) << 11 as u32,
        };
        init
    },
    {
    ...
    },
    {
        let mut init = helptxt {
            ...
            categories: (1 as u32) << 7 as u32 | (1 as u32) << 22 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            opt: b"    --form-string <name=string>\0" as *const u8 as *const i8,
            desc: b"Specify multipart MIME data\0" as *const u8 as *const i8,
            categories: (1 as u32) << 7 as u32 | (1 as u32) << 22 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            categories: (1 as u32) << 6 as u32 | (1 as u32) << 1 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            opt: b"    --ftp-alternative-to-user <command>\0" as *const u8 as *const i8,
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Create the remote dirs if not present\0" as *const u8 as *const i8,
            categories: (1 as u32) << 6 as u32 | (1 as u32) << 16 as u32 | (1 as u32) << 3 as u32,
        };
        init
    },
    {
    ...
    },
    {
        let mut init = helptxt {
            ...
            categories: (1 as u32) << 6 as u32 | (1 as u32) << 21 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            opt: b"    --ftp-ssl-ccc-mode <active/passive>\0" as *const u8 as *const i8,
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Require SSL/TLS for FTP login, clear for transfer\0" as *const u8 as *const i8,
            categories: (1 as u32) << 6 as u32 | (1 as u32) << 21 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Put the post data in the URL and use GET\0" as *const u8 as *const i8,
            categories: (1 as u32) << 7 as u32 | (1 as u32) << 22 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Disable URL sequences and ranges using {} and []\0" as *const u8 as *const i8,
            categories: (1 as u32) << 3 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            opt: b"    --happy-eyeballs-timeout-ms <milliseconds>\0" as *const u8 as *const i8,
            desc: b"Time for IPv6 before trying IPv4\0" as *const u8 as *const i8,
            categories: (1 as u32) << 2 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Send HAProxy PROXY protocol v1 header\0" as *const u8 as *const i8,
            categories: (1 as u32) << 7 as u32 | (1 as u32) << 14 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            categories: (1 as u32) << 7 as u32 | (1 as u32) << 6 as u32 | (1 as u32) << 5 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Pass custom header(s) to server\0" as *const u8 as *const i8,
            categories: (1 as u32) << 7 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            categories: (1 as u32) << 9 as u32 | (1 as u32) << 3 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Acceptable MD5 hash of the host public key\0" as *const u8 as *const i8,
            categories: (1 as u32) << 16 as u32 | (1 as u32) << 15 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Enable HSTS with this cache file\0" as *const u8 as *const i8,
            categories: (1 as u32) << 7 as u32,
        };
        init
    },
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Use HTTP 2 without HTTP/1.1 Upgrade\0" as *const u8 as *const i8,
            categories: (1 as u32) << 7 as u32,
        };
        init
    },
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Ignore the size of the remote resource\0" as *const u8 as *const i8,
            categories: (1 as u32) << 7 as u32 | (1 as u32) << 6 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Include protocol response headers in the output\0" as *const u8 as *const i8,
            categories: (1 as u32) << 9 as u32 | (1 as u32) << 23 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Allow insecure server connections when using SSL\0" as *const u8 as *const i8,
            categories: (1 as u32) << 21 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Use network INTERFACE (or address)\0" as *const u8 as *const i8,
            categories: (1 as u32) << 2 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Resolve names to IPv4 addresses\0" as *const u8 as *const i8,
            categories: (1 as u32) << 2 as u32 | (1 as u32) << 4 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Resolve names to IPv6 addresses\0" as *const u8 as *const i8,
            categories: (1 as u32) << 2 as u32 | (1 as u32) << 4 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Ignore session cookies read from file\0" as *const u8 as *const i8,
            categories: (1 as u32) << 7 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Interval time for keepalive probes\0" as *const u8 as *const i8,
            categories: (1 as u32) << 2 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            categories: (1 as u32) << 21 as u32 | (1 as u32) << 18 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Private key file type (DER/PEM/ENG)\0" as *const u8 as *const i8,
            categories: (1 as u32) << 21 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Enable Kerberos with security <level>\0" as *const u8 as *const i8,
            categories: (1 as u32) << 6 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Dump libcurl equivalent code of this command line\0" as *const u8 as *const i8,
            categories: (1 as u32) << 3 as u32,
        };
        init
    },
    ...
    },
    {
        let mut init = helptxt {
            ...
            categories: (1 as u32) << 6 as u32 | (1 as u32) << 12 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Force use of RANGE for local port numbers\0" as *const u8 as *const i8,
            categories: (1 as u32) << 2 as u32,
        };
        init
    },
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Like --location, and send auth to other hosts\0" as *const u8 as *const i8,
            categories: (1 as u32) << 7 as u32 | (1 as u32) << 1 as u32,
        };
        init
    },
    {
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Originator address of the original email\0" as *const u8 as *const i8,
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Allow RCPT TO command to fail for some recipients\0" as *const u8 as *const i8,
            categories: (1 as u32) << 17 as u32,
        };
        init
    },
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Maximum number of redirects allowed\0" as *const u8 as *const i8,
            categories: (1 as u32) << 7 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            opt: b"-m, --max-time <fractional seconds>\0" as *const u8 as *const i8,
            desc: b"Maximum time allowed for the transfer\0" as *const u8 as *const i8,
            categories: (1 as u32) << 2 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Process given URLs as metalink XML file\0" as *const u8 as *const i8,
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Use HTTP Negotiate (SPNEGO) authentication\0" as *const u8 as *const i8,
            categories: (1 as u32) << 1 as u32 | (1 as u32) << 7 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Must read .netrc for user name and password\0" as *const u8 as *const i8,
            categories: (1 as u32) << 3 as u32,
        };
        init
    },
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Make next URL use its separate set of options\0" as *const u8 as *const i8,
            categories: (1 as u32) << 3 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Disable the ALPN TLS extension\0" as *const u8 as *const i8,
            categories: (1 as u32) << 21 as u32 | (1 as u32) << 7 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Disable buffering of the output stream\0" as *const u8 as *const i8,
            categories: (1 as u32) << 3 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Disable TCP keepalive on the connection\0" as *const u8 as *const i8,
            categories: (1 as u32) << 2 as u32,
        };
        init
    },
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Do not show the progress meter\0" as *const u8 as *const i8,
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Disable SSL session-ID reusing\0" as *const u8 as *const i8,
            categories: (1 as u32) << 21 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"List of hosts which do not use proxy\0" as *const u8 as *const i8,
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Use HTTP NTLM authentication with winbind\0" as *const u8 as *const i8,
            categories: (1 as u32) << 1 as u32 | (1 as u32) << 7 as u32,
        };
        init
    },
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Write to file instead of stdout\0" as *const u8 as *const i8,
            categories: (1 as u32) << 9 as u32 | (1 as u32) << 3 as u32,
        };
        init
    },
    ...
    },
    {
        let mut init = helptxt {
            ...
            categories: (1 as u32) << 2 as u32 | (1 as u32) << 3 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Do not wait for multiplexing (with --parallel)\0" as *const u8 as *const i8,
            categories: (1 as u32) << 2 as u32 | (1 as u32) << 3 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Maximum concurrency for parallel transfers\0" as *const u8 as *const i8,
            categories: (1 as u32) << 2 as u32 | (1 as u32) << 3 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Pass phrase for the private key\0" as *const u8 as *const i8,
            categories: (1 as u32) << 18 as u32 | (1 as u32) << 21 as u32 | (1 as u32) << 1 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Do not squash .. sequences in URL path\0" as *const u8 as *const i8,
            categories: (1 as u32) << 3 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"FILE/HASHES Public key to verify peer against\0" as *const u8 as *const i8,
            categories: (1 as u32) << 21 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Do not switch to GET after following a 301\0" as *const u8 as *const i8,
            categories: (1 as u32) << 7 as u32 | (1 as u32) << 13 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Do not switch to GET after following a 302\0" as *const u8 as *const i8,
            categories: (1 as u32) << 7 as u32 | (1 as u32) << 13 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Do not switch to GET after following a 303\0" as *const u8 as *const i8,
            categories: (1 as u32) << 7 as u32 | (1 as u32) << 13 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            opt: b"    --preproxy [protocol://]host[:port]\0" as *const u8 as *const i8,
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Display transfer progress as a bar\0" as *const u8 as *const i8,
            categories: (1 as u32) << 23 as u32,
        };
        init
    },
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Use PROTOCOL for any URL missing a scheme\0" as *const u8 as *const i8,
            categories: (1 as u32) << 2 as u32 | (1 as u32) << 3 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Enable/disable PROTOCOLS on redirect\0" as *const u8 as *const i8,
            categories: (1 as u32) << 2 as u32 | (1 as u32) << 3 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            opt: b"-x, --proxy [protocol://]host[:port]\0" as *const u8 as *const i8,
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Pick any proxy authentication method\0" as *const u8 as *const i8,
            categories: (1 as u32) << 14 as u32 | (1 as u32) << 1 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Use Basic authentication on the proxy\0" as *const u8 as *const i8,
            categories: (1 as u32) << 14 as u32 | (1 as u32) << 1 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"CA certificate to verify peer against for proxy\0" as *const u8 as *const i8,
            categories: (1 as u32) << 14 as u32 | (1 as u32) << 21 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"CA directory to verify peer against for proxy\0" as *const u8 as *const i8,
            categories: (1 as u32) << 14 as u32 | (1 as u32) << 21 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            opt: b"    --proxy-cert <cert[:passwd]>\0" as *const u8 as *const i8,
            desc: b"Set client certificate for proxy\0" as *const u8 as *const i8,
            categories: (1 as u32) << 14 as u32 | (1 as u32) << 21 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Client certificate type for HTTPS proxy\0" as *const u8 as *const i8,
            categories: (1 as u32) << 14 as u32 | (1 as u32) << 21 as u32,
        };
        init
    },
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Use Digest authentication on the proxy\0" as *const u8 as *const i8,
            categories: (1 as u32) << 14 as u32 | (1 as u32) << 21 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            opt: b"    --proxy-header <header/@file>\0" as *const u8 as *const i8,
            desc: b"Pass custom header(s) to proxy\0" as *const u8 as *const i8,
            categories: (1 as u32) << 14 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Do HTTPS proxy connections without verifying the proxy\0" as *const u8
                as *const i8,
            categories: (1 as u32) << 14 as u32 | (1 as u32) << 21 as u32,
        };
        init
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Private key file type for proxy\0" as *const u8 as *const i8,
            categories: (1 as u32) << 14 as u32 | (1 as u32) << 21 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Use HTTP Negotiate (SPNEGO) authentication on the proxy\0" as *const u8
                as *const i8,
            categories: (1 as u32) << 14 as u32 | (1 as u32) << 1 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Use NTLM authentication on the proxy\0" as *const u8 as *const i8,
            categories: (1 as u32) << 14 as u32 | (1 as u32) << 1 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Pass phrase for the private key for HTTPS proxy\0" as *const u8 as *const i8,
            categories: (1 as u32) << 14 as u32 | (1 as u32) << 21 as u32 | (1 as u32) << 1 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            opt: b"    --proxy-pinnedpubkey <hashes>\0" as *const u8 as *const i8,
            desc: b"FILE/HASHES public key to verify proxy with\0" as *const u8 as *const i8,
            categories: (1 as u32) << 14 as u32 | (1 as u32) << 21 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            opt: b"    --proxy-service-name <name>\0" as *const u8 as *const i8,
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Allow security flaw for interop for HTTPS proxy\0" as *const u8 as *const i8,
            categories: (1 as u32) << 14 as u32 | (1 as u32) << 21 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            opt: b"    --proxy-ssl-auto-client-cert\0" as *const u8 as *const i8,
            desc: b"Use auto client certificate for proxy (Schannel)\0" as *const u8 as *const i8,
            categories: (1 as u32) << 14 as u32 | (1 as u32) << 21 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            opt: b"    --proxy-tls13-ciphers <ciphersuite list>\0" as *const u8 as *const i8,
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"TLS authentication type for HTTPS proxy\0" as *const u8 as *const i8,
            categories: (1 as u32) << 14 as u32 | (1 as u32) << 21 as u32 | (1 as u32) << 1 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            opt: b"    --proxy-tlspassword <string>\0" as *const u8 as *const i8,
    ...
    {
        let mut init = helptxt {
            opt: b"-U, --proxy-user <user:password>\0" as *const u8 as *const i8,
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Use HTTP/1.0 proxy on given port\0" as *const u8 as *const i8,
            categories: (1 as u32) << 14 as u32,
        };
        init
    },
    ...
    },
    {
        let mut init = helptxt {
            ...
            categories: (1 as u32) << 16 as u32 | (1 as u32) << 15 as u32 | (1 as u32) << 1 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Send command(s) to server before transfer\0" as *const u8 as *const i8,
            categories: (1 as u32) << 6 as u32 | (1 as u32) << 16 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"File for reading random data from\0" as *const u8 as *const i8,
            categories: (1 as u32) << 10 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Retrieve only the bytes within RANGE\0" as *const u8 as *const i8,
            categories: (1 as u32) << 7 as u32
                | (1 as u32) << 6 as u32
                | (1 as u32) << 16 as u32
                | (1 as u32) << 5 as u32,
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Do HTTP \"raw\"; no transfer decoding\0" as *const u8 as *const i8,
            categories: (1 as u32) << 7 as u32,
        };
        init
    },
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Use the header-provided filename\0" as *const u8 as *const i8,
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Write output to a file named as the remote file\0" as *const u8 as *const i8,
            categories: (1 as u32) << 9 as u32 | (1 as u32) << 11 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Use the remote file name for all URLs\0" as *const u8 as *const i8,
            categories: (1 as u32) << 11 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Set the remote file's time on the local output\0" as *const u8 as *const i8,
            categories: (1 as u32) << 11 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Specify request command to use\0" as *const u8 as *const i8,
            categories: (1 as u32) << 2 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Specify the target for this request\0" as *const u8 as *const i8,
            categories: (1 as u32) << 7 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            opt: b"    --resolve <[+]host:port:addr[,addr]...>\0" as *const u8 as *const i8,
            desc: b"Resolve the host+port to this address\0" as *const u8 as *const i8,
            categories: (1 as u32) << 2 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Retry request if transient problems occur\0" as *const u8 as *const i8,
            categories: (1 as u32) << 3 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Retry all errors (use with --retry)\0" as *const u8 as *const i8,
            categories: (1 as u32) << 3 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Retry on connection refused (use with --retry)\0" as *const u8 as *const i8,
            categories: (1 as u32) << 3 as u32,
        };
        init
    },
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Identity for SASL PLAIN authentication\0" as *const u8 as *const i8,
            categories: (1 as u32) << 1 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Enable initial response in SASL authentication\0" as *const u8 as *const i8,
            categories: (1 as u32) << 1 as u32,
        };
        init
    },
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Show error even when -s is used\0" as *const u8 as *const i8,
            categories: (1 as u32) << 3 as u32,
        };
        init
    },
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"SOCKS4 proxy on given host + port\0" as *const u8 as *const i8,
            categories: (1 as u32) << 14 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"SOCKS4a proxy on given host + port\0" as *const u8 as *const i8,
            categories: (1 as u32) << 14 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"SOCKS5 proxy on given host + port\0" as *const u8 as *const i8,
            categories: (1 as u32) << 14 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Enable username/password auth for SOCKS5 proxies\0" as *const u8 as *const i8,
            categories: (1 as u32) << 14 as u32 | (1 as u32) << 1 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Enable GSS-API auth for SOCKS5 proxies\0" as *const u8 as *const i8,
            categories: (1 as u32) << 14 as u32 | (1 as u32) << 1 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Compatibility with NEC SOCKS5 server\0" as *const u8 as *const i8,
            categories: (1 as u32) << 14 as u32 | (1 as u32) << 1 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            opt: b"    --socks5-gssapi-service <name>\0" as *const u8 as *const i8,
            desc: b"SOCKS5 proxy service name for GSS-API\0" as *const u8 as *const i8,
            categories: (1 as u32) << 14 as u32 | (1 as u32) << 1 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            opt: b"    --socks5-hostname <host[:port]>\0" as *const u8 as *const i8,
            desc: b"SOCKS5 proxy, pass host name to proxy\0" as *const u8 as *const i8,
            categories: (1 as u32) << 14 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Stop transfers slower than this\0" as *const u8 as *const i8,
            categories: (1 as u32) << 2 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Trigger 'speed-limit' abort after this time\0" as *const u8 as *const i8,
            categories: (1 as u32) << 2 as u32,
        };
        init
    },
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Allow security flaw to improve interop\0" as *const u8 as *const i8,
            categories: (1 as u32) << 21 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Use auto client certificate (Schannel)\0" as *const u8 as *const i8,
            categories: (1 as u32) << 21 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Disable cert revocation checks (Schannel)\0" as *const u8 as *const i8,
            categories: (1 as u32) << 21 as u32,
        };
        init
    },
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Ignore missing/offline cert CRL dist points\0" as *const u8 as *const i8,
            categories: (1 as u32) << 21 as u32,
        };
        init
    },
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Enable styled output for HTTP headers\0" as *const u8 as *const i8,
            categories: (1 as u32) << 23 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Suppress proxy CONNECT response headers\0" as *const u8 as *const i8,
            categories: (1 as u32) << 14 as u32,
        };
        init
    },
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Transfer based on a time condition\0" as *const u8 as *const i8,
            categories: (1 as u32) << 7 as u32 | (1 as u32) << 6 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Set maximum allowed TLS version\0" as *const u8 as *const i8,
            categories: (1 as u32) << 21 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            opt: b"    --tls13-ciphers <ciphersuite list>\0" as *const u8 as *const i8,
    ...
    },
    {
        let mut init = helptxt {
            ...
            categories: (1 as u32) << 21 as u32 | (1 as u32) << 1 as u32,
        };
        init
    },
    {
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Request compressed transfer encoding\0" as *const u8 as *const i8,
            categories: (1 as u32) << 7 as u32,
        };
        init
    },
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Like --trace, but without hex output\0" as *const u8 as *const i8,
            categories: (1 as u32) << 23 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Add time stamps to trace/verbose output\0" as *const u8 as *const i8,
            categories: (1 as u32) << 23 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Connect through this Unix domain socket\0" as *const u8 as *const i8,
            categories: (1 as u32) << 2 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Transfer local FILE to destination\0" as *const u8 as *const i8,
            categories: (1 as u32) << 9 as u32 | (1 as u32) << 22 as u32,
        };
        init
    },
    {
    ...
    },
    {
        let mut init = helptxt {
            ...
            categories: (1 as u32) << 9 as u32 | (1 as u32) << 1 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Send User-Agent <name> to server\0" as *const u8 as *const i8,
            categories: (1 as u32) << 9 as u32 | (1 as u32) << 7 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Make the operation more talkative\0" as *const u8 as *const i8,
            categories: (1 as u32) << 9 as u32 | (1 as u32) << 23 as u32,
        };
        init
    },
    ...
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Use output FORMAT after completion\0" as *const u8 as *const i8,
            categories: (1 as u32) << 23 as u32,
        };
        init
    },
    {
        let mut init = helptxt {
            ...
            desc: b"Store metadata in extended file attributes\0" as *const u8 as *const i8,
            categories: (1 as u32) << 10 as u32,
        };
        init
    },
...
extern "C" fn print_category(mut category: curlhelp_t) {
    let mut i: u32 = 0;
    i = 0 as i32 as u32;
    while !(unsafe { helptext[i as usize].opt }).is_null() {
        if (unsafe { helptext[i as usize].categories }) & category != 0 {
            (unsafe { curl_mprintf(
...
extern "C" fn get_category_content(mut category: *const i8) -> i32 {
    let mut i: u32 = 0;
    i = 0 as i32 as u32;
    while !(unsafe { categories[i as usize].opt }).is_null() {
        if (unsafe { curl_strequal(categories[i as usize].opt, category) }) != 0 {
            (unsafe { curl_mprintf(
                b"%s: %s\n\0" as *const u8 as *const i8,
                categories[i as usize].opt,
                categories[i as usize].desc,
            ) });
            print_category(unsafe { categories[i as usize].category });
            return 0 as i32;
        }
        i = i.wrapping_add(1);
    }
...
#[no_mangle]
pub extern "C" fn tool_help(mut category: *mut i8) {
    (unsafe { puts(b"Usage: curl [options...] <url>\0" as *const u8 as *const i8) });
    if category.is_null() {
        let mut category_note : * const i8 = b"\nThis is not the full help, this menu is stripped into categories.\nUse \"--help category\" to get an overview of all categories.\nFor all options use the manual or \"--help all\".\0" as * const u8 as * const i8 ;
        print_category((1 as u32) << 9 as u32);
        (unsafe { puts(category_note) });
    } else if (unsafe { curl_strequal(category, b"all\0" as *const u8 as *const i8) }) != 0 {
        print_category(!((1 as u32) << 0 as u32));
    } else if (unsafe { curl_strequal(category, b"category\0" as *const u8 as *const i8) }) != 0 {
        get_categories();
    ...
    (unsafe { free(category as *mut libc::c_void) });
}
extern "C" fn featcomp(mut p1: *const libc::c_void, mut p2: *const libc::c_void) -> i32 {
    return unsafe { strcasecmp(*(p1 as *const *mut i8), *(p2 as *const *mut i8)) };
}
#[no_mangle]
pub extern "C" fn tool_version_info() {
    ...
    if !(unsafe { (*curlinfo).protocols }).is_null() {
        (unsafe { curl_mprintf(b"Protocols: \0" as *const u8 as *const i8) });
        proto = unsafe { (*curlinfo).protocols };
        while !(unsafe { *proto }).is_null() {
            (unsafe { curl_mprintf(b"%s \0" as *const u8 as *const i8, *proto) });
            proto = unsafe { proto.offset(1) };
        }
        (unsafe { puts(b"\0" as *const u8 as *const i8) });
    }
    if (unsafe { (*curlinfo).features }) != 0 {
        let mut featp: [*mut i8; 29] = [0 as *mut i8; 29];
        let mut numfeat: size_t = 0 as i32 as size_t;
        let mut i: u32 = 0;
        (unsafe { curl_mprintf(b"Features:\0" as *const u8 as *const i8) });
        i = 0 as i32 as u32;
        while (i as u64)
            < (::std::mem::size_of::<[feat; 28]>() as u64)
                .wrapping_div(::std::mem::size_of::<feat>() as u64)
        {
            if (unsafe { (*curlinfo).features }) & (unsafe { feats[i as usize].bitmask }) != 0 {
                let fresh0 = numfeat;
                numfeat = numfeat.wrapping_add(1);
                featp[fresh0 as usize] = (unsafe { feats[i as usize].name }) as *mut i8;
            }
            i = i.wrapping_add(1);
        }
        (unsafe { qsort(
            &mut *featp.as_mut_ptr().offset(0 as i32 as isize) as *mut *mut i8 as *mut libc::c_void,
            numfeat,
            ::std::mem::size_of::<*mut i8>() as u64,
            Some(featcomp as unsafe extern "C" fn(*const libc::c_void, *const libc::c_void) -> i32),
        ) });
        i = 0 as i32 as u32;
        while (i as u64) < numfeat {
            (unsafe { curl_mprintf(b" %s\0" as *const u8 as *const i8, featp[i as usize]) });
            i = i.wrapping_add(1);
        }
        (unsafe { puts(b"\0" as *const u8 as *const i8) });
    }
    if (unsafe { strcmp(b"7.79.1\0" as *const u8 as *const i8, (*curlinfo).version) }) != 0 {
        (unsafe { curl_mprintf(
...
#[no_mangle]
pub extern "C" fn tool_list_engines() {
    ...
    (unsafe { curl_easy_getinfo(
        ...
        &mut engines as *mut *mut curl_slist,
    ) });
    (unsafe { puts(b"Build-time engines:\0" as *const u8 as *const i8) });
    if !engines.is_null() {
        while !engines.is_null() {
            (unsafe { curl_mprintf(b"  %s\n\0" as *const u8 as *const i8, (*engines).data) });
            engines = unsafe { (*engines).next };
        }
    } else {
        (unsafe { puts(b"  <none>\0" as *const u8 as *const i8) });
    }
    (unsafe { curl_slist_free_all(engines) });
