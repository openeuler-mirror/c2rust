...
extern "C" {
    ...
    fn DES_set_key(key: *mut const_DES_cblock, schedule: *mut DES_key_schedule) -> i32;
    ...
    fn Curl_md4it(output: *mut u8, input: *const u8, len: size_t);
...
extern "C" fn extend_key_56_to_64(mut key_56: *const u8, mut key: *mut i8) {
    (unsafe { *key.offset(0 as i32 as isize) = *key_56.offset(0 as i32 as isize) as i8 });
    (unsafe { *key.offset(1 as i32 as isize) =
        ((*key_56.offset(0 as i32 as isize) as i32) << 7 as i32 & 0xff as i32
            | *key_56.offset(1 as i32 as isize) as i32 >> 1 as i32) as u8 as i8 });
    (unsafe { *key.offset(2 as i32 as isize) =
        ((*key_56.offset(1 as i32 as isize) as i32) << 6 as i32 & 0xff as i32
            | *key_56.offset(2 as i32 as isize) as i32 >> 2 as i32) as u8 as i8 });
    (unsafe { *key.offset(3 as i32 as isize) =
        ((*key_56.offset(2 as i32 as isize) as i32) << 5 as i32 & 0xff as i32
            | *key_56.offset(3 as i32 as isize) as i32 >> 3 as i32) as u8 as i8 });
    (unsafe { *key.offset(4 as i32 as isize) =
        ((*key_56.offset(3 as i32 as isize) as i32) << 4 as i32 & 0xff as i32
            | *key_56.offset(4 as i32 as isize) as i32 >> 4 as i32) as u8 as i8 });
    (unsafe { *key.offset(5 as i32 as isize) =
        ((*key_56.offset(4 as i32 as isize) as i32) << 3 as i32 & 0xff as i32
            | *key_56.offset(5 as i32 as isize) as i32 >> 5 as i32) as u8 as i8 });
    (unsafe { *key.offset(6 as i32 as isize) =
        ((*key_56.offset(5 as i32 as isize) as i32) << 2 as i32 & 0xff as i32
            | *key_56.offset(6 as i32 as isize) as i32 >> 6 as i32) as u8 as i8 });
    (unsafe { *key.offset(7 as i32 as isize) =
        ((*key_56.offset(6 as i32 as isize) as i32) << 1 as i32 & 0xff as i32) as u8 as i8 });
}
extern "C" fn setup_des_key(mut key_56: *const u8, mut ks: *mut DES_key_schedule) {
    let mut key: DES_cblock = [0; 8];
    extend_key_56_to_64(key_56, &mut key as *mut DES_cblock as *mut i8);
    (unsafe { DES_set_odd_parity(&mut key) });
    (unsafe { DES_set_key(&mut key, ks) });
}
#[no_mangle]
pub extern "C" fn Curl_ntlm_core_lm_resp(
    mut keys: *const u8,
    ...
    (unsafe { DES_ecb_encrypt(
        plaintext as *mut DES_cblock,
        results as *mut DES_cblock,
        &mut ks,
        1 as i32,
    ) });
    setup_des_key(unsafe { keys.offset(7 as i32 as isize) }, &mut ks);
    (unsafe { DES_ecb_encrypt(
        plaintext as *mut DES_cblock,
    ...
    setup_des_key(unsafe { keys.offset(14 as i32 as isize) }, &mut ks);
    (unsafe { DES_ecb_encrypt(
        plaintext as *mut DES_cblock,
...
#[no_mangle]
pub extern "C" fn Curl_ntlm_core_mk_lm_hash(
    ...
    let mut len: size_t = if (unsafe { strlen(password) }) < 14 as i32 as u64 {
        unsafe { strlen(password) }
    } else {
        14 as i32 as u64
    };
    (unsafe { Curl_strntoupper(pw.as_mut_ptr() as *mut i8, password, len) });
    (unsafe { memset(
        &mut *pw.as_mut_ptr().offset(len as isize) as *mut u8 as *mut libc::c_void,
        0 as i32,
    ...
    setup_des_key(unsafe { pw.as_mut_ptr().offset(7 as i32 as isize) }, &mut ks);
    (unsafe { DES_ecb_encrypt(
        magic.as_ptr() as *mut DES_cblock,
...
extern "C" fn ascii_to_unicode_le(mut dest: *mut u8, mut src: *const i8, mut srclen: size_t) {
    let mut i: size_t = 0;
...
extern "C" fn ascii_uppercase_to_unicode_le(
    mut dest: *mut u8,
    mut src: *const i8,
    mut srclen: size_t,
) {
    ...
    i = 0 as i32 as size_t;
    while i < srclen {
        (unsafe { *dest.offset((2 as i32 as u64).wrapping_mul(i) as isize) =
...
#[no_mangle]
pub extern "C" fn Curl_ntlm_core_mk_nt_hash(
    mut _data: *mut Curl_easy,
    mut password: *const i8,
    mut ntbuffer: *mut u8,
) -> CURLcode {
    let mut len: size_t = unsafe { strlen(password) };
    let mut pw: *mut u8 = 0 as *mut u8;
    let mut result: CURLcode = CURLE_OK;
    if len > (18446744073709551615 as u64).wrapping_div(2 as i32 as u64) {
        return CURLE_OUT_OF_MEMORY;
    }
    pw = (if len != 0 {
        unsafe { Curl_cmalloc.expect("non-null function pointer")(len.wrapping_mul(2 as i32 as u64)) }
    } else {
        (unsafe { Curl_cstrdup.expect("non-null function pointer")(b"\0" as *const u8 as *const i8) }) as *mut u8
            as *mut libc::c_void
    }) as *mut u8;
    if pw.is_null() {
        return CURLE_OUT_OF_MEMORY;
    ...
    result = CURLE_OK as i32 as CURLcode;
    if result as u64 == 0 {
        (unsafe { Curl_md4it(ntbuffer, pw, (2 as i32 as u64).wrapping_mul(len)) });
        (unsafe { memset(
    ...
    (unsafe { Curl_cfree.expect("non-null function pointer")(pw as *mut libc::c_void) });
    return result;
}
extern "C" fn time2filetime(mut ft: *mut ms_filetime, mut t: time_t) {
    t = (t + 11644473600 as i64) * 10000000 as i32 as i64;
    (unsafe { (*ft).dwLowDateTime = (t & 0xffffffff as u32 as i64) as u32 });
    (unsafe { (*ft).dwHighDateTime = (t >> 32 as i32) as u32 });
}
#[no_mangle]
pub extern "C" fn Curl_ntlm_core_mk_ntlmv2_hash(
    mut user: *const i8,
    mut userlen: size_t,
    mut domain: *const i8,
    mut domlen: size_t,
    ...
    let mut result: CURLcode = CURLE_OK;
    if userlen > 8000000 as i32 as u64 || domlen > 8000000 as i32 as u64 {
        return CURLE_OUT_OF_MEMORY;
    }
    identity_len = userlen.wrapping_add(domlen).wrapping_mul(2 as i32 as u64);
    identity = (unsafe { Curl_cmalloc.expect("non-null function pointer")(
    ...
    ascii_to_unicode_le(
        unsafe { identity.offset((userlen << 1 as i32) as isize) },
        domain,
        domlen,
    );
    result = unsafe { Curl_hmacit(
    ...
    (unsafe { Curl_cfree.expect("non-null function pointer")(identity as *mut libc::c_void) });
    return result;
}
#[no_mangle]
pub extern "C" fn Curl_ntlm_core_mk_ntlmv2_resp(
    mut ntlmv2hash: *mut u8,
    ...
    let mut result: CURLcode = CURLE_OK;
    time2filetime(&mut tw, unsafe { time(0 as *mut time_t) });
    len = (16 as i32 as u32).wrapping_add(
        ((44 as i32 - 16 as i32) as u32)
            .wrapping_add(unsafe { (*ntlm).target_info_len })
            .wrapping_add(4 as i32 as u32),
    );
    ptr = (unsafe { Curl_ccalloc.expect("non-null function pointer")(1 as i32 as size_t, len as size_t) })
        as *mut u8;
    if ptr.is_null() {
        return CURLE_OUT_OF_MEMORY;
    }
    (unsafe { curl_msnprintf(
        ...
        (*::std::mem::transmute::<&[u8; 5], &[i8; 5]>(b"\x01\x01\0\0\0"))[0 as i32 as usize] as i32,
        (*::std::mem::transmute::<&[u8; 5], &[i8; 5]>(b"\x01\x01\0\0\0"))[1 as i32 as usize] as i32,
        (*::std::mem::transmute::<&[u8; 5], &[i8; 5]>(b"\x01\x01\0\0\0"))[2 as i32 as usize] as i32,
        (*::std::mem::transmute::<&[u8; 5], &[i8; 5]>(b"\x01\x01\0\0\0"))[3 as i32 as usize] as i32,
        0 as i32,
        0 as i32,
        0 as i32,
        0 as i32,
        (tw.dwLowDateTime & 0xff as i32 as u32) as i32,
        (tw.dwLowDateTime >> 8 as i32 & 0xff as i32 as u32) as i32,
        (tw.dwLowDateTime >> 16 as i32 & 0xff as i32 as u32) as i32,
        (tw.dwLowDateTime >> 24 as i32 & 0xff as i32 as u32) as i32,
        (tw.dwHighDateTime & 0xff as i32 as u32) as i32,
        (tw.dwHighDateTime >> 8 as i32 & 0xff as i32 as u32) as i32,
        (tw.dwHighDateTime >> 16 as i32 & 0xff as i32 as u32) as i32,
        (tw.dwHighDateTime >> 24 as i32 & 0xff as i32 as u32) as i32,
    ) });
    (unsafe { memcpy(
    ...
    (unsafe { memcpy(
        ...
        &mut *((*ntlm).nonce).as_mut_ptr().offset(0 as i32 as isize) as *mut u8
    ...
    (unsafe { *ntresp = ptr });
    (unsafe { *ntresp_len = len });
    return result;
}
#[no_mangle]
pub extern "C" fn Curl_ntlm_core_mk_lmv2_resp(
    mut ntlmv2hash: *mut u8,
    mut challenge_client: *mut u8,
    ...
    let mut result: CURLcode = CURLE_OK;
    (unsafe { memcpy(
        &mut *data.as_mut_ptr().offset(0 as i32 as isize) as *mut u8 as *mut libc::c_void,
        challenge_server as *const libc::c_void,
        8 as i32 as u64,
    ) });
    (unsafe { memcpy(
        &mut *data.as_mut_ptr().offset(8 as i32 as isize) as *mut u8 as *mut libc::c_void,
        challenge_client as *const libc::c_void,
        8 as i32 as u64,
    ) });
    result = unsafe { Curl_hmacit(
