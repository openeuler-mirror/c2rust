...
extern "C" fn sha256_to_hex(mut dst: *mut i8, mut sha: *mut u8, mut dst_l: size_t) {
    let mut i: i32 = 0;
    i = 0 as i32;
    while i < 32 as i32 {
...
#[no_mangle]
pub extern "C" fn Curl_output_aws_sigv4(mut data: *mut Curl_easy, mut _proxy: bool) -> CURLcode {
    ...
    let mut hostname: *const i8 = unsafe { (*conn).host.name };
    ...
    let mut post_data: *const i8 = (if !(unsafe { (*data).set.postfields }).is_null() {
    ...
    let mut user: *const i8 = if !(unsafe { (*data).state.aptr.user }).is_null() {
    ...
    if !(unsafe { Curl_checkheaders(data, b"Authorization\0" as *const u8 as *const i8) }).is_null() {
        return CURLE_OK;
    }
    tmp0 = if !(unsafe { (*data).set.str_0[STRING_AWS_SIGV4 as i32 as usize] }).is_null() {
        (unsafe { (*data).set.str_0[STRING_AWS_SIGV4 as i32 as usize] }) as *const i8
    } else {
        b"aws:amz\0" as *const u8 as *const i8
    };
    tmp1 = unsafe { strchr(tmp0, ':' as i32) };
    len = if !tmp1.is_null() {
        (unsafe { tmp1.offset_from(tmp0) }) as i64 as size_t
    } else {
        unsafe { strlen(tmp0) }
    };
    if len < 1 as i32 as u64 {
        ...
        provider0_low =
            (unsafe { Curl_cmalloc.expect("non-null function pointer")(len.wrapping_add(1 as i32 as u64)) })
                as *mut i8;
        provider0_up =
            (unsafe { Curl_cmalloc.expect("non-null function pointer")(len.wrapping_add(1 as i32 as u64)) })
                as *mut i8;
        if !(provider0_low.is_null() || provider0_up.is_null()) {
            (unsafe { Curl_strntolower(provider0_low, tmp0, len) });
            (unsafe { *provider0_low.offset(len as isize) = '\u{0}' as i32 as i8 });
            (unsafe { Curl_strntoupper(provider0_up, tmp0, len) });
            (unsafe { *provider0_up.offset(len as isize) = '\u{0}' as i32 as i8 });
            if !tmp1.is_null() {
                tmp0 = unsafe { tmp1.offset(1 as i32 as isize) };
                tmp1 = unsafe { strchr(tmp0, ':' as i32) };
                len = if !tmp1.is_null() {
                    (unsafe { tmp1.offset_from(tmp0) }) as i64 as size_t
                } else {
                ...
                if len < 1 as i32 as u64 {
                    (unsafe { Curl_infof(
                        data,
                        b"second provider can't be empty\0" as *const u8 as *const i8,
                    ) });
                    ret = CURLE_BAD_FUNCTION_ARGUMENT;
                    current_block = 5950501356679075927;
                } else {
                    provider1_low = (unsafe { Curl_cmalloc.expect("non-null function pointer")(
                        len.wrapping_add(1 as i32 as u64),
                    ) }) as *mut i8;
                    provider1_mid = (unsafe { Curl_cmalloc.expect("non-null function pointer")(
                        len.wrapping_add(1 as i32 as u64),
                    ) }) as *mut i8;
                    if provider1_low.is_null() || provider1_mid.is_null() {
                        current_block = 5950501356679075927;
                    } else {
                        (unsafe { Curl_strntolower(provider1_low, tmp0, len) });
                        (unsafe { *provider1_low.offset(len as isize) = '\u{0}' as i32 as i8 });
                        (unsafe { Curl_strntolower(provider1_mid, tmp0, len) });
                        (unsafe { *provider1_mid.offset(0 as i32 as isize) =
                            Curl_raw_toupper(*provider1_mid.offset(0 as i32 as isize)) });
                        (unsafe { *provider1_mid.offset(len as isize) = '\u{0}' as i32 as i8 });
                        if !tmp1.is_null() {
                            tmp0 = unsafe { tmp1.offset(1 as i32 as isize) };
                            tmp1 = unsafe { strchr(tmp0, ':' as i32) };
                            len = if !tmp1.is_null() {
                            ...
                            if len < 1 as i32 as u64 {
                                (unsafe { Curl_infof(
                                    data,
                                    b"region can't be empty\0" as *const u8 as *const i8,
                                ) });
                                ret = CURLE_BAD_FUNCTION_ARGUMENT;
                                current_block = 5950501356679075927;
                            } else {
                                region = (unsafe { Curl_memdup(
                                ...
                                if region.is_null() {
                                    ...
                                    (unsafe { *region.offset(len as isize) = '\u{0}' as i32 as i8 });
                                    if !tmp1.is_null() {
                                        tmp0 = unsafe { tmp1.offset(1 as i32 as isize) };
                                        service =
                                        ...
                                        if service.is_null() {
                                            current_block = 5950501356679075927;
                                        } else if (unsafe { strlen(service) }) < 1 as i32 as u64 {
                                            (unsafe { Curl_infof(
                                                data,
                ...
                provider1_low = (unsafe { Curl_memdup(
                    provider0_low as *const libc::c_void,
                    len.wrapping_add(1 as i32 as u64),
                ) }) as *mut i8;
                provider1_mid = (unsafe { Curl_memdup(
                    provider0_low as *const libc::c_void,
                    len.wrapping_add(1 as i32 as u64),
                ) }) as *mut i8;
                if provider1_low.is_null() || provider1_mid.is_null() {
            ...
            match current_block {
                ...
                _ => {
                    if service.is_null() {
                        tmp0 = hostname;
                        tmp1 = unsafe { strchr(tmp0, '.' as i32) };
                        len = (unsafe { tmp1.offset_from(tmp0) }) as i64 as size_t;
                        if tmp1.is_null() || len < 1 as i32 as u64 {
                            ...
                            if service.is_null() {
                                ...
                                (unsafe { *service.offset(len as isize) = '\u{0}' as i32 as i8 });
                                if region.is_null() {
                                    tmp0 = unsafe { tmp1.offset(1 as i32 as isize) };
                                    tmp1 = unsafe { strchr(tmp0, '.' as i32) };
                                    len = (unsafe { tmp1.offset_from(tmp0) }) as i64 as size_t;
                        ...
                        _ => {
                            ...
                            if !(ret as u32 != CURLE_OK as i32 as u32) {
                                ...
                                ) }) == 0)
                                {
                                    ...
                                    date[(::std::mem::size_of::<[i8; 9]>() as u64)
                                    ...
                                    if !content_type.is_null() {
                                        ...
                                        if content_type.is_null() {
                                            ...
                                            canonical_headers = unsafe { curl_maprintf(
                                                b"content-type:%s\nhost:%s\nx-%s-date:%s\n\0"
                                                    as *const u8
                                                    as *const i8,
                                                content_type,
                                            ...
                                            signed_headers = unsafe { curl_maprintf(
                                    ...
                                    match current_block {
                                        ...
                                        _ => {
                                                ...
                                                || signed_headers.is_null())
                                            {
                                                ...
                                                (unsafe { Curl_http_method(
                                                    data,
                                                    conn,
                                                    &mut method,
                                                    &mut httpreq,
                                                ) });
                                                canonical_request = unsafe { curl_maprintf(
                                                    b"%s\n%s\n%s\n%s\n%s\n%s\0" as *const u8
                                                        as *const i8,
                                                    method,
                                                    (*data).state.up.path,
                                                ...
                                                if !canonical_request.is_null() {
                                                    request_type = unsafe { curl_maprintf(
                                                        b"%s4_request\0" as *const u8 as *const i8,
                                                        provider0_low,
                                                    ) };
                                                    if !request_type.is_null() {
                                                        credential_scope = unsafe { curl_maprintf(
                                                        ...
                                                        if !credential_scope.is_null() {
                                                            ...
                                                            sha256_to_hex(
                                                                sha_hex.as_mut_ptr(),
                                                                sha_hash.as_mut_ptr(),
                                                                ::std::mem::size_of::<[i8; 65]>()
                                                                    as u64,
                                                            );
                                                            str_to_sign = unsafe { curl_maprintf(
                                                                b"%s4-HMAC-SHA256\n%s\n%s\n%s\0"
                                                                    as *const u8
                                                                    as *const i8,
                                                                provider0_up,
                                                            ...
                                                            if !str_to_sign.is_null() {
                                                                ...
                                                                if !secret.is_null() {
                                                                    ret = unsafe { Curl_hmacit(
                                                                        Curl_HMAC_SHA256.as_ptr(),
                                                                        secret as *mut u8,
                                                                        strlen(secret) as u32
                                                                            as size_t,
                                                                        date.as_mut_ptr()
                                                                            as *mut u8,
                                                                                ...
                                                                                as u32)
                                                                        {
                                                                            ...
                                                                            if !(ret as u32
                                                                                != CURLE_OK as i32
                                                                                    as u32)
                                                                            {
                                                                                ret = unsafe { Curl_hmacit (Curl_HMAC_SHA256 . as_ptr () , tmp_sign0 . as_mut_ptr () , :: std :: mem :: size_of :: < [u8 ; 32] > () as u64 as u32 as size_t , request_type as * mut u8 , strlen (request_type) as u32 as size_t , tmp_sign1 . as_mut_ptr () ,) } ;
                                                                                if !(ret as u32
                                                                                    != CURLE_OK
                                                                                        as i32
                                                                                        as u32)
                                                                                {
                                                                                    ret = unsafe { Curl_hmacit (Curl_HMAC_SHA256 . as_ptr () , tmp_sign1 . as_mut_ptr () , :: std :: mem :: size_of :: < [u8 ; 32] > () as u64 as u32 as size_t , str_to_sign as * mut u8 , strlen (str_to_sign) as u32 as size_t , tmp_sign0 . as_mut_ptr () ,) } ;
                                                                                    if !(ret as u32
                                                                                        != CURLE_OK
                                                                                            as i32
                                                                                            as u32)
                                                                                    {
                                                                                        sha256_to_hex (sha_hex . as_mut_ptr () , tmp_sign0 . as_mut_ptr () , :: std :: mem :: size_of :: < [i8 ; 65] > () as u64 ,) ;
                                                                                        auth_headers = unsafe { curl_maprintf (b"Authorization: %s4-HMAC-SHA256 Credential=%s/%s, SignedHeaders=%s, Signature=%s\r\nX-%s-Date: %s\r\n\0" as * const u8 as * const i8 , provider0_up , user , credential_scope , signed_headers , sha_hex . as_mut_ptr () , provider1_mid , timestamp . as_mut_ptr () ,) } ;
                                                                                        if ! auth_headers . is_null () { (unsafe { Curl_cfree . expect ("non-null function pointer" ,) ((* data) . state . aptr . userpwd as * mut libc :: c_void) }) ; let fresh0 = unsafe { & mut ((* data) . state . aptr . userpwd) } ; * fresh0 = 0 as * mut i8 ; let fresh1 = unsafe { & mut ((* data) . state . aptr . userpwd) } ; * fresh1 = auth_headers ; let fresh2 = unsafe { & mut ((* data) . state . authhost) } ; (* fresh2) . set_done (1 as i32 as bit) ; ret = CURLE_OK ; }
                                                                                    }
                                                                                }
                                                                            }
                                                                        }
    ...
    (unsafe { Curl_cfree.expect("non-null function pointer")(provider0_low as *mut libc::c_void) });
    (unsafe { Curl_cfree.expect("non-null function pointer")(provider0_up as *mut libc::c_void) });
    (unsafe { Curl_cfree.expect("non-null function pointer")(provider1_low as *mut libc::c_void) });
    (unsafe { Curl_cfree.expect("non-null function pointer")(provider1_mid as *mut libc::c_void) });
    (unsafe { Curl_cfree.expect("non-null function pointer")(region as *mut libc::c_void) });
    (unsafe { Curl_cfree.expect("non-null function pointer")(service as *mut libc::c_void) });
    (unsafe { Curl_cfree.expect("non-null function pointer")(canonical_headers as *mut libc::c_void) });
    (unsafe { Curl_cfree.expect("non-null function pointer")(signed_headers as *mut libc::c_void) });
    (unsafe { Curl_cfree.expect("non-null function pointer")(canonical_request as *mut libc::c_void) });
    (unsafe { Curl_cfree.expect("non-null function pointer")(request_type as *mut libc::c_void) });
    (unsafe { Curl_cfree.expect("non-null function pointer")(credential_scope as *mut libc::c_void) });
    (unsafe { Curl_cfree.expect("non-null function pointer")(str_to_sign as *mut libc::c_void) });
    (unsafe { Curl_cfree.expect("non-null function pointer")(secret as *mut libc::c_void) });
    return ret;
}
