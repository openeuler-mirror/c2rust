...
#[no_mangle]
pub extern "C" fn curl_multi_strerror(mut error: CURLMcode) -> *const i8 {
    match error as i32 {
        -1 => {
...
#[no_mangle]
pub extern "C" fn curl_share_strerror(mut error: CURLSHcode) -> *const i8 {
    match error as u32 {
        0 => return b"No error\0" as *const u8 as *const i8,
...
#[no_mangle]
pub extern "C" fn Curl_strerror(mut err: i32, mut buf: *mut i8, mut buflen: size_t) -> *const i8 {
