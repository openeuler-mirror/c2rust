...
extern "C" {
    ...
    fn gsasl_client_start(ctx: *mut Gsasl, mech: *const i8, sctx: *mut *mut Gsasl_session) -> i32;
    fn gsasl_strerror(err: i32) -> *const i8;
    fn gsasl_init(ctx: *mut *mut Gsasl) -> i32;
    fn gsasl_property_set(sctx: *mut Gsasl_session, prop: Gsasl_property, data: *const i8);
...
#[no_mangle]
pub extern "C" fn Curl_auth_gsasl_is_supported(
    mut data: *mut Curl_easy,
    mut mech: *const i8,
    mut gsasl: *mut gsasldata,
) -> bool {
    let mut res: i32 = 0;
    res = unsafe { gsasl_init(&mut (*gsasl).ctx) };
    ...
    res = unsafe { gsasl_client_start((*gsasl).ctx, mech, &mut (*gsasl).client) };
    if res != GSASL_OK as i32 {
        (unsafe { gsasl_done((*gsasl).ctx) });
        return 0 as i32 != 0;
    }
    return 1 as i32 != 0;
}
#[no_mangle]
pub extern "C" fn Curl_auth_gsasl_start(
    mut _data: *mut Curl_easy,
    mut userp: *const i8,
    mut passwdp: *const i8,
    mut gsasl: *mut gsasldata,
) -> CURLcode {
    (unsafe { gsasl_property_set((*gsasl).client, GSASL_AUTHID, userp) });
    (unsafe { gsasl_property_set((*gsasl).client, GSASL_PASSWORD, passwdp) });
    return CURLE_OK;
}
#[no_mangle]
pub extern "C" fn Curl_auth_gsasl_token(
    mut data: *mut Curl_easy,
...
#[no_mangle]
pub extern "C" fn Curl_auth_gsasl_cleanup(mut gsasl: *mut gsasldata) {
    (unsafe { gsasl_finish((*gsasl).client) });
    let fresh0 = unsafe { &mut ((*gsasl).client) };
    *fresh0 = 0 as *mut Gsasl_session;
    (unsafe { gsasl_done((*gsasl).ctx) });
    let fresh1 = unsafe { &mut ((*gsasl).ctx) };
