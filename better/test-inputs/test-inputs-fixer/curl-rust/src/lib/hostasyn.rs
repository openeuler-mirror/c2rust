...
#[no_mangle]
pub extern "C" fn Curl_addrinfo_callback(
    ...
    (unsafe { (*data).state.async_0.status = status });
...
#[no_mangle]
pub extern "C" fn Curl_getaddrinfo(
    mut data: *mut Curl_easy,
    mut hostname: *const i8,
    mut port: i32,
    mut waitp: *mut i32,
) -> *mut Curl_addrinfo {
    return unsafe { Curl_resolver_getaddrinfo(data, hostname, port, waitp) };
}
