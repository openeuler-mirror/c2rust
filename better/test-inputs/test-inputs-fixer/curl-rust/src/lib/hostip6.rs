...
#[no_mangle]
pub extern "C" fn Curl_ipvalid(mut data: *mut Curl_easy, mut conn: *mut connectdata) -> bool {
    if (unsafe { (*conn).ip_version }) as i32 == 2 as i32 {
        return unsafe { Curl_ipv6works(data) };
    }
    return 1 as i32 != 0;
}
