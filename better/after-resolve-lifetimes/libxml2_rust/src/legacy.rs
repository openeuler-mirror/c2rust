...
pub unsafe extern "C" fn xmlGetFeaturesList<'a1, 'a2>(
    ...
    while i < *(borrow(& len)).unwrap() {
        let fresh0 = &mut ((*crate::__laertes_array::GetMut::<&mut _>::get_offset_mut(result.as_mut().unwrap(), (i as isize))));
...
pub unsafe extern "C" fn xmlSetFeature<'a1>(
    ...
    if strcmp(name, b"validate\0" as *const u8 as *const i8) == 0 {
        ...
        *fresh35 = *(value as *mut xmlSAXHandlerPtr);
        ...
        {
        let fresh36 = &mut ((*(*(borrow_mut(&mut ctxt)).unwrap()).sax).internalSubset);
        *fresh36 = *(value as *mut internalSubsetSAXFunc);
        ...
        {
        let fresh37 = &mut ((*(*(borrow_mut(&mut ctxt)).unwrap()).sax).isStandalone);
        *fresh37 = *(value as *mut isStandaloneSAXFunc);
        ...
        {
        let fresh38 = &mut ((*(*(borrow_mut(&mut ctxt)).unwrap()).sax).hasInternalSubset);
        *fresh38 = *(value as *mut hasInternalSubsetSAXFunc);
        ...
        {
        let fresh39 = &mut ((*(*(borrow_mut(&mut ctxt)).unwrap()).sax).hasExternalSubset);
        *fresh39 = *(value as *mut hasExternalSubsetSAXFunc);
        ...
        {
        let fresh40 = &mut ((*(*(borrow_mut(&mut ctxt)).unwrap()).sax).resolveEntity);
        *fresh40 = *(value as *mut resolveEntitySAXFunc);
        ...
        {
        let fresh41 = &mut ((*(*(borrow_mut(&mut ctxt)).unwrap()).sax).getEntity);
        *fresh41 = *(value as *mut getEntitySAXFunc);
        ...
        {
        let fresh42 = &mut ((*(*(borrow_mut(&mut ctxt)).unwrap()).sax).entityDecl);
        *fresh42 = *(value as *mut entityDeclSAXFunc);
        ...
        {
        let fresh43 = &mut ((*(*(borrow_mut(&mut ctxt)).unwrap()).sax).notationDecl);
        *fresh43 = *(value as *mut notationDeclSAXFunc);
        ...
        {
        let fresh44 = &mut ((*(*(borrow_mut(&mut ctxt)).unwrap()).sax).attributeDecl);
        *fresh44 = *(value as *mut attributeDeclSAXFunc);
        ...
        {
        let fresh45 = &mut ((*(*(borrow_mut(&mut ctxt)).unwrap()).sax).elementDecl);
        *fresh45 = *(value as *mut elementDeclSAXFunc);
        ...
        {
        let fresh46 = &mut ((*(*(borrow_mut(&mut ctxt)).unwrap()).sax).unparsedEntityDecl);
        *fresh46 = *(value as *mut unparsedEntityDeclSAXFunc);
        ...
        {
        let fresh47 = &mut ((*(*(borrow_mut(&mut ctxt)).unwrap()).sax).setDocumentLocator);
        *fresh47 = *(value as *mut setDocumentLocatorSAXFunc);
        ...
        {
        let fresh48 = &mut ((*(*(borrow_mut(&mut ctxt)).unwrap()).sax).startDocument);
        *fresh48 = *(value as *mut startDocumentSAXFunc);
        ...
        {
        let fresh49 = &mut ((*(*(borrow_mut(&mut ctxt)).unwrap()).sax).endDocument);
        *fresh49 = *(value as *mut endDocumentSAXFunc);
        ...
        {
        let fresh50 = &mut ((*(*(borrow_mut(&mut ctxt)).unwrap()).sax).startElement);
        *fresh50 = *(value as *mut startElementSAXFunc);
        ...
        {
        let fresh51 = &mut ((*(*(borrow_mut(&mut ctxt)).unwrap()).sax).endElement);
        *fresh51 = *(value as *mut endElementSAXFunc);
        ...
        {
        let fresh52 = &mut ((*(*(borrow_mut(&mut ctxt)).unwrap()).sax).reference);
        *fresh52 = *(value as *mut referenceSAXFunc);
        ...
        {
        let fresh53 = &mut ((*(*(borrow_mut(&mut ctxt)).unwrap()).sax).characters);
        *fresh53 = *(value as *mut charactersSAXFunc);
        ...
        {
        let fresh54 = &mut ((*(*(borrow_mut(&mut ctxt)).unwrap()).sax).ignorableWhitespace);
        *fresh54 = *(value as *mut ignorableWhitespaceSAXFunc);
        ...
        {
        let fresh55 = &mut ((*(*(borrow_mut(&mut ctxt)).unwrap()).sax).processingInstruction);
        *fresh55 = *(value as *mut processingInstructionSAXFunc);
    } else if strcmp(name, b"SAX function comment\0" as *const u8 as *const i8)
            == 0
        {
        let fresh56 = &mut ((*(*(borrow_mut(&mut ctxt)).unwrap()).sax).comment);
        *fresh56 = *(value as *mut commentSAXFunc);
    } else if strcmp(name, b"SAX function warning\0" as *const u8 as *const i8)
            == 0
        {
        let fresh57 = &mut ((*(*(borrow_mut(&mut ctxt)).unwrap()).sax).warning);
        *fresh57 = *(value as *mut warningSAXFunc);
    } else if strcmp(name, b"SAX function error\0" as *const u8 as *const i8)
            == 0
        {
        let fresh58 = &mut ((*(*(borrow_mut(&mut ctxt)).unwrap()).sax).error);
        *fresh58 = *(value as *mut errorSAXFunc);
        ...
        {
        let fresh59 = &mut ((*(*(borrow_mut(&mut ctxt)).unwrap()).sax).fatalError);
        *fresh59 = *(value as *mut fatalErrorSAXFunc);
        ...
        {
        let fresh60 = &mut ((*(*(borrow_mut(&mut ctxt)).unwrap()).sax).getParameterEntity);
        *fresh60 = *(value as *mut getParameterEntitySAXFunc);
        ...
        {
        let fresh61 = &mut ((*(*(borrow_mut(&mut ctxt)).unwrap()).sax).cdataBlock);
        *fresh61 = *(value as *mut cdataBlockSAXFunc);
        ...
        {
        let fresh62 = &mut ((*(*(borrow_mut(&mut ctxt)).unwrap()).sax).externalSubset);
