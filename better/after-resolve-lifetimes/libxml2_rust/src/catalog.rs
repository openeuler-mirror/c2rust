...
unsafe extern "C" fn xmlFreeCatalogEntry(mut payload: *mut core::ffi::c_void, mut name: *const u8) {
...
unsafe extern "C" fn xmlCreateNewCatalog<'a1>(
    ...
    ret = xmlMalloc.expect("non-null function pointer")(::std::mem::size_of::<xmlCatalog>() as u64)
        as xmlCatalogPtr;
    if ret.is_null() {
    ...
    (*ret).prefer = prefer;
    if (*ret).type_0 as u32 == XML_SGML_CATALOG_TYPE as i32 as u32 {
...
#[no_mangle]
pub unsafe extern "C" fn xmlFreeCatalog<'a1>(
    ...
    if !((*catal).sgml).is_null() {
        xmlHashFree((*catal).sgml, Some(xmlFreeCatalogEntry));
    }
...
unsafe extern "C" fn xmlCatalogDumpEntry(
    ...
    match (*entry).type_0 as i32 {
        15 | 16 | 17 | 18 | 19 | 14 | 13 | 20 => {
            fprintf(out, b" \"%s\"\0" as *const u8 as *const i8, (*entry).value);
        }
        _ => {}
    }
    fprintf(out, b"\n\0" as *const u8 as *const i8);
...
unsafe extern "C" fn xmlCatalogConvertEntry(
    ...
    match (*entry).type_0 as i32 {
        ...
        _ => {
            xmlHashRemoveEntry((*catal).sgml, (*entry).name, Some(xmlFreeCatalogEntry));
            return;
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn xmlConvertSGMLCatalog<'a1>(
    mut catal: *mut crate::src::catalog::_xmlCatalog<'a1>,
) -> i32 {
    if catal.is_null() || (*catal).type_0 as u32 != XML_SGML_CATALOG_TYPE as i32 as u32 {
        return -(1 as i32);
    }
    if xmlDebugCatalogs != 0 {
        (*(borrow(&__xmlGenericError())).unwrap()).expect("non-null function pointer")(
    ...
    while *urn as i32 != 0 as i32 {
        ...
        if *urn as i32 == '+' as i32 {
                ...
                && *urn.offset(2 as i32 as isize) as i32 == 'B' as i32
            {
                ...
                && *urn.offset(2 as i32 as isize) as i32 == '7' as i32
            {
                let mut fresh26 = i;
                i = i.wrapping_add(1);
                ...
                && *urn.offset(2 as i32 as isize) as i32 == 'F' as i32
            {
                ...
                && *urn.offset(2 as i32 as isize) as i32 == '3' as i32
            {
                let mut fresh28 = i;
                i = i.wrapping_add(1);
                result[fresh28 as usize] = '#' as i32 as xmlChar;
            } else if *urn.offset(1 as i32 as isize) as i32 == '2' as i32
                && *urn.offset(2 as i32 as isize) as i32 == '5' as i32
            {
                let mut fresh29 = i;
                i = i.wrapping_add(1);
...
unsafe extern "C" fn xmlLoadFileContent(mut filename: *const i8) -> *mut u8 {
    let mut fd: i32 = 0;
    let mut len: i32 = 0;
    let mut size: i64 = 0;
    ...
    size = info.st_size;
    content =
        xmlMallocAtomic.expect("non-null function pointer")((size + 10 as i32 as i64) as size_t)
            as *mut xmlChar;
    if content.is_null() {
...
unsafe extern "C" fn xmlCatalogNormalizePublic(mut pubID: *const u8) -> *mut u8 {
    ...
    while *p as i32 != 0 as i32 && ok != 0 {
        if !(*p as i32 == 0x20 as i32
            || 0x9 as i32 <= *p as i32 && *p as i32 <= 0xa as i32
            || *p as i32 == 0xd as i32)
        {
            white = 0 as i32;
...
unsafe extern "C" fn xmlGetXMLCatalogEntryType(mut name: *const u8) -> i32 {
    ...
    } else if xmlStrEqual(name, b"uri\0" as *const u8 as *const i8 as *const xmlChar) != 0 {
        type_0 = XML_CATA_URI;
    } else if xmlStrEqual(
        name,
...
unsafe extern "C" fn xmlParseXMLCatalogNode(
    ...
    ) != 0
    {
        ...
        if !prop.is_null() {
            if xmlStrEqual(prop, b"system\0" as *const u8 as *const i8 as *mut xmlChar) != 0 {
                prefer = XML_CATA_PREFER_SYSTEM;
            } else if xmlStrEqual(prop, b"public\0" as *const u8 as *const i8 as *mut xmlChar) != 0
            {
    ...
    if !cur.is_null() {
        while !cur.is_null() {
                ...
                && xmlStrEqual(orig, (*cur).name) != 0
            {
                ...
                if !((*cur).value).is_null() {
                    xmlFree.expect("non-null function pointer")((*cur).value as *mut libc::c_void);
                }
                if !((*cur).URL).is_null() {
                    xmlFree.expect("non-null function pointer")((*cur).URL as *mut libc::c_void);
                }
    ...
    *fresh50 += 1;
    ...
    if !pubID.is_null() {
            ...
            match (*cur).type_0 as i32 {
                ...
                8 => {
                    if xmlStrncmp(pubID, (*cur).name, xmlStrlen((*cur).name)) == 0
                        && (*cur).prefer as u32 == XML_CATA_PREFER_PUBLIC as i32 as u32
                    {
                        haveDelegate += 1;
                    }
                }
        ...
        if haveDelegate != 0 {
            ...
            cur = catal;
            while !cur.is_null() {
                if (*cur).type_0 as i32 == XML_CATA_DELEGATE_PUBLIC as i32
                    && (*cur).prefer as u32 == XML_CATA_PREFER_PUBLIC as i32 as u32
...
unsafe extern "C" fn xmlParseSGMLCatalogComment(mut cur: *const u8) -> *const u8 {
...
unsafe extern "C" fn xmlParseSGMLCatalogPubid<'a1>(
    ...
    *(borrow_mut(&mut id)).unwrap() = 0 as *mut xmlChar;
    ...
    while xmlIsPubidChar_tab[*cur as usize] as i32 != 0 || *cur as i32 == '?' as i32 {
        if *cur as i32 == stop as i32 && stop as i32 != ' ' as i32 {
            break;
        }
...
unsafe extern "C" fn xmlGetSGMLCatalogEntryType(mut name: *const u8) -> i32 {
    let mut type_0: i32 = XML_CATA_NONE;
    if xmlStrEqual(
        name,
        b"SYSTEM\0" as *const u8 as *const i8 as *const xmlChar,
    ...
    } else if xmlStrEqual(name, b"BASE\0" as *const u8 as *const i8 as *const xmlChar) != 0 {
...
unsafe extern "C" fn xmlParseSGMLCatalog<'a1>(
    ...
    while !cur.is_null() && *cur.offset(0 as i32 as isize) as i32 != 0 as i32 {
            ...
            && *cur.offset(1 as i32 as isize) as i32 == '-' as i32
        {
                ...
                || *cur as i32 == 0xd as i32)
            {
                ...
                {
                    type_0 = SGML_CATA_CATALOG;
                } else if xmlStrEqual(name, b"BASE\0" as *const u8 as *const i8 as *const xmlChar)
                    != 0
                {
                    type_0 = SGML_CATA_BASE;
                } else if xmlStrEqual(
                ...
                if cur.is_null() {
                        ...
                        || type_0 as i32 == SGML_CATA_SYSTEM as i32
                    {
                        ...
                        if !filename.is_null() {
                            ...
                            res = xmlHashAddEntry((*catal).sgml, name, entry as *mut libc::c_void);
                            if res < 0 as i32 {
                                xmlFreeCatalogEntry(
                        ...
                        if super_0 != 0 {
                            ...
                            res =
                                xmlHashAddEntry((*catal).sgml, sysid, entry_0 as *mut libc::c_void);
                            if res < 0 as i32 {
                                xmlFreeCatalogEntry(
...
unsafe extern "C" fn xmlExpandCatalog<'a1>(
    ...
    if (*catal).type_0 as u32 == XML_SGML_CATALOG_TYPE as i32 as u32 {
        let mut content: *mut u8 = 0 as *mut xmlChar;
        content = xmlLoadFileContent(filename);
        if content.is_null() {
            return -(1 as i32);
...
pub unsafe extern "C" fn xmlACatalogResolveSystem<'a1>(
    ...
    if (*catal).type_0 as u32 == XML_XML_CATALOG_TYPE as i32 as u32 {
...
#[no_mangle]
pub unsafe extern "C" fn xmlACatalogDump<'a1>(
    mut catal: *mut crate::src::catalog::_xmlCatalog<'a1>,
    mut out: *mut crate::src::HTMLtree::_IO_FILE,
) {
...
pub unsafe extern "C" fn xmlACatalogRemove<'a1>(
    ...
    if (*catal).type_0 as u32 == XML_XML_CATALOG_TYPE as i32 as u32 {
        ...
        res = xmlHashRemoveEntry((*catal).sgml, value, Some(xmlFreeCatalogEntry));
        if res == 0 as i32 {
            res = 1 as i32;
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn xmlNewCatalog<'a1>(
    mut sgml: i32,
) -> *mut crate::src::catalog::_xmlCatalog<'a1> {
...
#[no_mangle]
pub unsafe extern "C" fn xmlCatalogIsEmpty<'a1, 'a2>(
    ...
    if (*(borrow(&catal)).unwrap()).type_0 as u32 == XML_XML_CATALOG_TYPE as i32 as u32 {
        ...
        if (*(*(borrow(&catal)).unwrap()).xml).type_0 as i32 != XML_CATA_CATALOG as i32
            && (*(*(borrow(&catal)).unwrap()).xml).type_0 as i32 != XML_CATA_BROKEN_CATALOG as i32
        {
            return -(1 as i32);
        }
...
pub unsafe extern "C" fn xmlInitializeCatalog() {
    ...
    if xmlDefaultCatalog.is_null() {
        ...
        catalogs = getenv(b"XML_CATALOG_FILES\0" as *const u8 as *const i8) as *const i8;
        if catalogs.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn xmlLoadCatalog(mut filename: *const i8) -> i32 {
    let mut ret: i32 = 0;
    let mut catal: *mut crate::src::catalog::_xmlCatalog<'_> = 0 as *mut xmlCatalog;
...
pub unsafe extern "C" fn xmlCatalogCleanup() {
    ...
    if !xmlCatalogXMLFiles.is_null() {
        xmlHashFree(xmlCatalogXMLFiles, Some(xmlFreeCatalogHashEntryList));
    }
...
#[no_mangle]
pub unsafe extern "C" fn xmlCatalogResolveSystem(mut sysID: *const u8) -> *mut u8 {
    let mut ret: *mut u8 = 0 as *mut xmlChar;
    if xmlCatalogInitialized == 0 {
...
#[no_mangle]
pub unsafe extern "C" fn xmlCatalogResolvePublic(mut pubID: *const u8) -> *mut u8 {
    let mut ret: *mut u8 = 0 as *mut xmlChar;
    if xmlCatalogInitialized == 0 {
        xmlInitializeCatalog();
    }
...
#[no_mangle]
pub unsafe extern "C" fn xmlCatalogResolve(mut pubID: *const u8, mut sysID: *const u8) -> *mut u8 {
    let mut ret: *mut u8 = 0 as *mut xmlChar;
    if xmlCatalogInitialized == 0 {
        xmlInitializeCatalog();
    }
...
#[no_mangle]
pub unsafe extern "C" fn xmlCatalogSetDefaultPrefer(mut prefer: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn xmlCatalogGetSystem(mut sysID: *const u8) -> *const u8 {
    let mut ret: *mut u8 = 0 as *mut xmlChar;
    ...
    if !xmlDefaultCatalog.is_null() {
        ret = xmlCatalogListXMLResolve((*xmlDefaultCatalog).xml, 0 as *const xmlChar, sysID);
        if !ret.is_null() && ret != -(1 as i32) as *mut xmlChar {
            snprintf(
            ...
            result[(::std::mem::size_of::<[xmlChar; 1000]>() as u64).wrapping_sub(1 as i32 as u64)
...
#[no_mangle]
pub unsafe extern "C" fn xmlCatalogGetPublic(mut pubID: *const u8) -> *const u8 {
    let mut ret: *mut u8 = 0 as *mut xmlChar;
    static mut result: [u8; 1000] = [0; 1000];
    static mut msg: i32 = 0 as i32;
    if xmlCatalogInitialized == 0 {
    ...
    if !xmlDefaultCatalog.is_null() {
        ret = xmlCatalogListXMLResolve((*xmlDefaultCatalog).xml, pubID, 0 as *const xmlChar);
        if !ret.is_null() && ret != -(1 as i32) as *mut xmlChar {
            snprintf(
                result.as_mut_ptr() as *mut i8,
                (::std::mem::size_of::<[xmlChar; 1000]>() as u64).wrapping_sub(1 as i32 as u64),
